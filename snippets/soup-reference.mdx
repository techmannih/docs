...
```json
{
  ...
  "ftype": "cillum Duis laborum Ut reprehenderit",
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "veniam voluptate labore",
  "supplier_part_numbers": {
    "irure_5b": ["anim elit", "adipisicing"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "incididunt dolore occaecat ex",
    "enim qui dolore in Excepteur",
    "pariatur est esse",
    "amet"
  ],
  "is_power": false,
  "trace_width": 7212164.910213888
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "officia sunt deserunt eiusmod",
  "supplier_part_numbers": {
    "exercitation_29": ["in ea et est ad", "labore"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "Duis dolor id",
  "supplier_part_numbers": {
    "nulla_f8": ["cillum nisi in dolor sed", "anim fugiat ipsum dolor aute"],
    "in__54": [],
    "non_": [
      "nisi in",
      "in laboris enim",
      "exercitation est ea sint et",
      "fugiat enim qui aute"
    ],
    "sit9b1": ["adipisicing", "veniam in ex dolore", "et ut officia"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ut est",
  "supplier_part_numbers": {
    "do0a": [
      "Lorem irure in ullamco",
      "culpa consectetur in dolore",
      "sed Lorem",
      "sunt",
      "dolore do sit in"
    ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "minim quis id",
  "supplier_part_numbers": {
    "veniame": ["ut labore culpa Duis commodo"],
    "exercitation6c": [
      "esse Duis",
      "anim exercitation",
      "culpa Lorem Duis",
      "quis nulla voluptate ut tempor"
    ],
    "adipisicing7": ["ex"],
    "proident04_": ["officia", "fugiat voluptate ut", "in"],
    "ina1": ["dolor in ullamco labore"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "dolore laborum Duis laboris consequat",
  "supplier_part_numbers": {
    "ut641": [
      "consectetur",
      "dolor aliquip sed deserunt",
      "do dolore",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "laboris fugiat Duis Excepteur",
  "supplier_part_numbers": {
    "voluptate_c": ["ut", "Lorem", "tempor pariatur esse Duis labore", "sunt"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "Duis adipisicing esse",
  "supplier_part_numbers": {
    "officiad_8": ["pariatur Lorem"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["esse", "dolore ut", "dolore Lorem"],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -89695066.55909054,
  "pin_styles": {},
  "box_width": 99714055.74142662,
  "symbol_name": "Lorem ullamco irure magna aute",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "route": [],
  "stroke_width": "0.1mm",
  "color": "nostrud incididunt in aliquip"
}
```
...
```json
{
  ...
  "radius_x": -66542814.32522069,
  "radius_y": -90792942.07874225,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "dolore commodo aliquip pariatur",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "anim voluptate Excepteur adipisicing"
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
  ...
  "layer": "top",
  "footprinter_string": "aliqua id non",
  "model_obj_url": "officia",
  "model_stl_url": "nisi consectetur",
  "model_3mf_url": "cupidatat",
  "model_jscad": {}
}
```
...
{
  "velit__48": {
    "left_margin": 23787641.387396842,
    "right_margin": "sit minim ea officia"
  },
  "aliquip_6f": {
    "left_margin": -6298199.403535768,
    "right_margin": -57803610.851281695,
    "top_margin": "ipsum sunt",
    "bottom_margin": 15825468.762907222
  },
  "consequat_a": {
    "left_margin": "Excepteur aliqua nostrud enim Lorem",
    "right_margin": "nisi Excepteur et velit eu",
    "top_margin": "non in Duis"
  }
}
```
