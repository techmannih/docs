...
```json
{
  ...
  "name": "V1",
  "manufacturer_part_number": "ut voluptate est Excepteur reprehenderit",
  "supplier_part_numbers": {
    "in457": [
      "labore commodo est dolor",
      "laboris irure sit consectetur incididunt",
      "tempor sint exercitation",
      "reprehenderit nostrud non tempor enim",
      "voluptate quis veniam ex et"
    ],
    "exercitation_5a": []
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "Excepteur_02f": ["reprehenderit amet nisi in"],
    "velit_ca": [
      "do pariatur proident",
      "tempor est ullamco elit",
      "incididunt tempor cupidatat ea",
      "nulla nisi cupidatat irure mollit",
      "consequat in ullamco velit aute"
    ]
  }
}
```
...
```json
{
  ...
  "trace_width": 17512777.972457588
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "sintc": [
      ...
      "ipsum",
      "officia incididunt",
      "proident eiusmod voluptate ut",
      "Lorem ullamco do"
    ],
    "et_7_": [
      "qui nulla proident",
      "sint consectetur adipisicing id",
      "in tempor consequat"
    ],
    "sunt_8_": ["labore quis eu ipsum"],
    "sint_05_": []
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "non exercitation",
  "supplier_part_numbers": {
    "proident_64e": [
      "laboris reprehenderit exercitation amet",
      "qui aute",
      "ut in",
      "aliqua dolor dolore aute dolore"
    ],
    "est_f": [
      "eu in laborum",
      "officia laboris anim",
      "ad",
      "labore mollit magna fugiat"
    ],
    "nulla54": [
      "sit ut",
      "sit ullamco",
      "sit",
      "irure qui ad aliquip adipisicing",
      "elit dolor voluptate"
    ],
    "elite": ["ipsum", "eiusmod in cillum sit dolor", "est Excepteur nostrud"],
    "eiusmod_2": ["ex veniam nostrud consequat proident", "cillum"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "fugiat laborum",
  "supplier_part_numbers": {
    "Excepteur_d": ["cillum non commodo aliquip dolore", "nulla elit"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "deserunt",
  "supplier_part_numbers": {
    "cillum_23": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "eiusmod velit voluptate",
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "cupidatat Duis proident enim do",
  "supplier_part_numbers": {
    "cupidatat_ac2": ["occaecat magna pariatur dolor officia"],
    "esse_f9": [
      "officia incididunt do",
      "Duis in deserunt ut aliqua",
      "laborum anim ea nulla"
    ],
    "Duis0": ["Lorem irure", "voluptate quis in", "ut laborum"],
    "sit56": [
      "proident",
      "non dolore",
      "esse dolore proident aliquip",
      "in",
      "irure"
    ]
  },
...
```json
{
  ...
  "connected_source_net_ids": ["eiusmod id eu Duis amet", "sed eu irure"]
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "labore exercitation officia"
}
```
...
```json
{
  ...
  "message": "in est ad culpa officia"
}
```
...
```json
{
  ...
  "message": "aliquip ad veniam elit",
...
```json
{
  ...
  "radius_x": "minim irure",
  "radius_y": "consequat ea sed ex labore",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "non irure sit pariatur sed",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "sunt pariatur anim ut labore",
  "supplier_part_numbers": {
    "dolore_6": [
      "occaecat ut aliqua ipsum",
      "aute proident",
      "est aliqua qui",
      "sint"
    ]
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "nulla cupidatat Ut Excepteur nostrud",
  "model_obj_url": "dolore occaecat cupidatat fugiat",
  "model_stl_url": "nostrud incididunt mollit ea enim",
  "model_3mf_url": "cupidatat amet in",
  "model_jscad": {}
}
```
...
```json
{
  "type": "pcb_plated_hole",
  "shape": "pill",
  "outer_width": 1805394.8550782055,
  "outer_height": -70941963.61635214,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "ad81": {
    "left_margin": "in fugiat consectetur culpa"
  },
  "et_c6d": {
    "bottom_margin": 97958408.6535843
  },
  "velit_6_": {
    "right_margin": "ex velit cillum nisi pariatur",
    "top_margin": "Duis et pariatur",
    "bottom_margin": "dolor"
  }
}
```
