...
```json
{
  ...
  "supplier_part_numbers": {
    "labore_0": ["sunt cillum veniam magna"],
    "labore_4": [
      "ad velit laborum reprehenderit dolor",
      "adipisicing aliquip ullamco",
      "do deserunt",
      "est dolor dolor cillum",
      "Excepteur"
    ],
    "ullamco8": ["nostrud quis"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "in ullamco ut irure qui",
  "supplier_part_numbers": {
    "in_0": [
      "Excepteur ullamco ut non",
      "ipsum in reprehenderit exercitation proident",
      "ipsum non enim irure",
      "minim deserunt",
      "ea tempor aliquip"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "culpa reprehenderit sit mollit",
  "supplier_part_numbers": {
    "exercitation_c2f": [
      "Ut laboris",
      "eu non",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "sunt dolor Duis adipisicing ipsum",
  "supplier_part_numbers": {
    "irure_52e": ["voluptate dolor labore irure", "elit non ad"],
    "exercitation6a": ["eu cillum"],
    "ex_31": [
      "consequat",
      "irure minim veniam magna nulla",
      "Excepteur cupidatat non",
      "commodo"
    ],
    "dolore_8": [
      "dolor",
      "mollit aute Excepteur velit dolore",
      "in qui eu",
      "sed"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "deserunt sint amet",
  "supplier_part_numbers": {
    "nisi_05": ["velit aute dolor", "enim", "elit"],
    "veniam48_": ["amet dolor commodo", "sunt sint do amet"],
    "occaecat_a05": []
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "nostrud in in dolore",
  "supplier_part_numbers": {
    "dolorec": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "occaecat voluptate consequat laboris",
  "supplier_part_numbers": {
    "temporb": ["dolore culpa", "nisi sed labore", "culpa ipsum"],
    "cillum147": [
      "mollit nulla in et enim",
      "consequat anim dolor cupidatat officia",
      "Ut deserunt sit cillum aliqua",
      "nostrud Ut velit"
    ],
    "veniam_cfa": [
      "incididunt sit",
    ...
    "sunt_c5": [
      ...
      "eiusmod nulla sunt",
      "amet",
      "laborum culpa ex reprehenderit"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    ...
    "ex ullamco aute ut est"
  ],
  "connected_source_net_ids": [
    "in",
    "occaecat id ullamco aute",
    "ex dolore",
    "in ullamco eu minim Ut",
    "amet"
  ]
}
```
...
```json
{
  ...
  "pin_spacing": "do",
  "pin_styles": {},
  "box_width": -68689942.41909444,
  "symbol_name": "minim incididunt veniam cupidatat dolor",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "officia dolore adipisicing"
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "ea et reprehenderit sint irure"
}
```
...
```json
{
  ...
  "color": "officia magna consequat ut non"
}
```
...
```json
{
  ...
  "message": "cillum sed labore incididunt id",
...
```json
{
  ...
  "radius_x": "magna voluptate reprehenderit",
  "radius_y": 39454240.74271199,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ipsum consequat adipisicing elit pariatur",
  "supplier_part_numbers": {
    "culpa_a16": [
      "pariatur minim ea quis sunt",
      "consequat sed",
      "ut veniam in",
      "ad"
    ],
    "ad_45c": [
      ...
      "sunt",
      "et irure",
      "dolore mollit sit proident pariatur"
    ],
    "eiusmod_8f6": ["dolore"]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "eu officia fugiat nisi id",
  "model_obj_url": "Duis ad ea",
  "model_stl_url": "ex commodo quis",
  "model_3mf_url": "consectetur esse deserunt aliqua",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 42055002.49304515,
  "outer_height": -48689280.10776776,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "sint id sunt adipisicing irure"
}
```
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": "cupidatat Excepteur ut"
}
```
...
{
  "incididuntcf9": {
    "bottom_margin": "voluptate"
  },
  "aliquipf65": {
    "left_margin": 87049866.83733237,
    "right_margin": 66972079.36942625,
    "top_margin": -14258946.66268839,
    "bottom_margin": "culpa Excepteur ea in dolor"
  }
}
```
