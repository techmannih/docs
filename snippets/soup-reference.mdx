...
```json
{
  ...
  "ftype": "pariatur dolore in esse",
  "source_component_id": "source_component_1",
  "name": "P1",
  "supplier_part_numbers": {
    "deserunt_574": ["pariatur fugiat anim commodo"],
    "amet8b": ["occaecat nulla"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "culpa88": [
      "in laborum officia",
      "minim Duis mollit nulla laboris",
      "laborum Duis",
      "occaecat ut in culpa"
    ]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    ...
    "laborum nisi labore ullamco in",
    "aliqua consequat in amet",
    "eiusmod qui enim cillum",
    "labore cupidatat quis irure deserunt"
  ],
  "is_power": true,
  "is_ground": true,
...
```json
{
  ...
  "supplier_part_numbers": {
    "velit_97b": [
      "exercitation nisi cillum sed",
      "in aliqua Lorem nostrud ad",
      "id dolor consectetur",
      "sint",
      "dolor amet esse velit aliqua"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "consequat1": [
      "amet aliqua",
      "Excepteur dolor commodo ut esse",
      "minim commodo anim",
      "nisi incididunt nulla dolore",
      "nisi dolor et in"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "supplier_part_numbers": {
    "do_164": [
      "dolore tempor dolor nulla",
      "aute consequat pariatur laborum",
      "veniam ex tempor sint",
      "consequat",
      "esse mollit"
    ],
    "laborum_7_": [
      "reprehenderit elit nostrud exercitation",
      "minim nulla",
      "ipsum aliquip aute occaecat"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "anim0": [
      "consequat mollit voluptate id Ut",
      "proident non aute",
      "in dolor sit"
    ]
  }
...
```json
{
  ...
  "name": "P1",
  "supplier_part_numbers": {
    "commodo0": ["nisi", "sunt ipsum dolor", "ut"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "consequat0": ["in"],
    "labore_4": [
      "reprehenderit cupidatat consectetur velit ad",
...
```json
{
  ...
  "connected_source_port_ids": [
    ...
    "sit Ut laborum sed occaecat",
    "proident in anim",
    "sit non"
  ],
  "connected_source_net_ids": [
    "cupidatat do qui incididunt veniam",
    "ut nisi ea"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 74572655.29183304,
  "box_width": "in enim ipsum",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "nostrud officia incididunt id"
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": 36706090.724814415
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "mollit in deserunt"
  },
  "layer": "top",
  "model_obj_url": "eu voluptate",
  "model_stl_url": "eu Duis consequat",
  "model_3mf_url": "commodo ex",
  "model_jscad": []
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -37140230.13695398,
  "outer_height": 459390.0977011025,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "qui cupidatat ut tempor dolore"
}
```
