...
```json
{
  ...
  "ftype": "do esse consequat in quis",
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "dolore aliquip non fugiat adipisicing",
  "supplier_part_numbers": {
    "fugiat2": [],
    "magna554": [],
    "eiusmodc3": ["adipisicing irure", "in"],
    "ut_e05": ["sunt", "eu nulla"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "sit magna",
  "supplier_part_numbers": {
    "aliquip_59": [
      "in deserunt sunt",
      "ullamco nisi dolore culpa adipisicing",
      "est tempor",
      "voluptate in aliqua sed",
      "in sit cupidatat id adipisicing"
    ]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["exercitation"],
  "is_power": false,
  "is_ground": false,
  "is_digital_signal": false,
  "is_analog_signal": true,
  "trace_width": 66118461.34664664
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "ullamco id ad",
  "supplier_part_numbers": {
    "mollit__61": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "dolor consectetur ad est",
  "supplier_part_numbers": {
    "Excepteur8": [
      "id aliqua magna sint proident",
      "reprehenderit est consectetur esse minim",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "aute reprehenderit laborum amet exercitation",
  "supplier_part_numbers": {
    "essef": [
      "veniam nisi enim ea dolore",
      "et",
      "amet consectetur reprehenderit",
      "Duis"
    ],
    "anim_e": [],
    "Excepteur_a": ["in", "amet qui", "Duis deserunt", "aute"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "in exercitation est",
  "supplier_part_numbers": {
    "consequat61": [
      "ea non",
      "ex ut anim laborum cillum",
      "aliqua dolore adipisicing eiusmod in",
      "ut ut dolore laborum",
      "anim ea laborum"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "non nostrud ex reprehenderit",
  "supplier_part_numbers": {
    "commodo_5a8": ["Lorem voluptate eu deserunt", "cillum enim"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "aliqua velit eiusmod",
  "supplier_part_numbers": {
    "in7": [
      "officia in velit proident",
      "voluptate proident",
      "aute amet consequat dolor",
      "cillum dolor magna",
      "cillum consequat mollit magna"
    ],
    "dolore58": [
      "in ut dolor cillum eu",
      "ullamco ad culpa",
      "dolor Duis",
      "commodo in aliquip"
    ],
    "ipsum_279": ["cupidatat"],
    "eu1d7": ["elit Ut eiusmod", "elit quis dolore"],
    "dolorf": ["sed"]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": ["eu ad", "do laborum", "consequat"],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 19799755.573393613,
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "cillum laborum proident enim"
}
```
...
```json
{
  ...
  "message": "aliquip occaecat in pariatur incididunt",
  "pcb_trace_id": "pcb_trace_1",
  "source_trace_id": "source_trace_1",
  "pcb_component_ids": ["pcb_component_1"],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "enim mollit velit",
  "supplier_part_numbers": {
    "mollit_9": [
      "reprehenderit",
      "ea exercitation ipsum minim dolore",
      "enim minim ut",
      "aliqua"
    ],
    "fugiatd8": ["exercitation ea anim", "ut sunt in"],
    "ipsumb9": [
      "voluptate deserunt",
      "amet nostrud",
      "mollit voluptate",
      "veniam magna cillum Ut in",
      "velit ullamco qui irure labore"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "minim officia esse ad sint",
  "supplier_part_numbers": {
    "in9": ["Ut consectetur dolore ut ipsum", "sit commodo quis enim"],
    "nisib8": ["aliqua est"]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "model_stl_url": "consectetur dolore irure",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "pariatur in deserunt"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 67407399.94843948,
  "outer_height": -80718507.67705491,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "nullaf53": {
    "left_margin": "esse ut",
    "right_margin": "laborum cillum qui esse laboris",
    "top_margin": "officia mollit eiusmod veniam",
    "bottom_margin": "ullamco enim et"
  }
}
```
