...
```json
{
  ...
  "ftype": "dolor et nisi Ut ullamco",
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "ea",
  "supplier_part_numbers": {
    "ipsumd1": ["adipisicing magna", "Duis laborum cillum consectetur culpa"],
    "incididunt_0b": [
      "proident",
      "qui tempor consequat ut",
      "ut in non laborum velit",
      "nulla"
    ],
    "ex_5": [
      "cupidatat laboris in pariatur tempor",
      "dolore exercitation esse consequat",
      "commodo culpa"
    ],
    "fugiat1": ["veniam laborum occaecat", "sint ut ea"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "magna aliquip Duis ipsum",
  "supplier_part_numbers": {
    "deserunt_1bb": ["laborum tempor amet in nisi", "nisi est quis Excepteur"],
    "laborisb": ["Ut sit", "nulla fugiat", "in"],
    "do_5c5": ["veniam"],
    "amet_2": [
      "in aliqua laboris Lorem ex",
      "Ut eu commodo adipisicing exercitation",
      "nisi et aute incididunt exercitation"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "cupidatat adipisicing quis aliqua ea",
  "supplier_part_numbers": {
    "amet_58": [
      "consequat magna occaecat in sint",
      "labore culpa dolor ad",
      "id exercitation aliqua sit dolore"
    ],
    "dolor74": ["minim adipisicing"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "adipisicing consequat",
  "supplier_part_numbers": {
    "sintf2c": ["sit tempor dolore eiusmod aute", "nostrud pariatur minim"],
    "ipsumcb": ["dolore Excepteur velit Lorem non", "ut velit"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ipsum officia",
  "supplier_part_numbers": {
    "aute09": [
      "ex",
      "aliquip nulla deserunt",
      "ipsum id dolor laborum elit",
      "esse dolor ut tempor adipisicing",
      "enim dolor ut nulla exercitation"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "culpa deserunt",
  "supplier_part_numbers": {
    "nostrud_9dc": [
      "nostrud cupidatat ex Duis",
      "labore est commodo consequat sit",
      "Ut cillum"
    ],
    "ametcb5": [
      "officia exercitation",
      "sunt Ut nisi veniam consequat",
      "cillum ut",
      "in ea consequat magna"
    ],
    "ex_8": ["aliquip incididunt ut minim", "dolore dolore"]
  }
}
```
...
```json
{
  ...
  "name": "G1",
  "supplier_part_numbers": {
    "aliquip_e": ["aute consequat officia"],
    "commodod9": ["ut incididunt eiusmod sint", "commodo"],
    "aute_2c0": [
      "amet ex nisi ipsum esse",
      "deserunt",
      "ut ex",
      "adipisicing",
      "in do eiusmod ut labore"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "sunt ut",
  "supplier_part_numbers": {
    "qui__9": [
      "anim aliqua aliquip proident",
      "ad Excepteur",
      "fugiat labore reprehenderit dolor sunt",
      "aliqua do",
      "ut do esse velit"
    ],
    "ipsum_d": ["cupidatat sit"],
    "ut52_": [
      "eu deserunt est commodo pariatur",
      "consequat ut enim",
      "Excepteur cillum tempor ad pariatur",
      "labore veniam reprehenderit ex",
      "sit Lorem labore"
    ]
  },
  "voltage": "5V"
...
```json
{
  ...
  "supplier_part_numbers": {
    "nisi_9": ["laboris Ut ipsum cupidatat", "irure eu dolor"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "nisi",
    "in",
    "Excepteur ut sunt ea esse",
    "anim"
  ],
  "connected_source_net_ids": [
    "dolore quis labore in mollit",
    "anim labore",
    "irure cupidatat ea",
    "non"
  ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -75200922.53458963,
  "box_width": "consectetur minim",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "amet in ullamco in Excepteur"
}
```
...
```json
{
  ...
  "radius_x": 41531155.94079459,
  "radius_y": 59154289.96116537,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "velit ad elit cupidatat enim",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "est anim",
  "supplier_part_numbers": {
    "Lorem830": ["velit in Excepteur cupidatat", "officia nulla"],
    "labore_029": ["ex anim non", "incididunt"],
    "veniam_99": ["sint dolore sed voluptate", "amet ut veniam"],
    "do_c05": ["ullamco", "adipisicing in est"]
  }
}
```
...
```json
{
  ...
  "footprinter_string": "est ad",
  "model_obj_url": "nisi non",
  "model_3mf_url": "commodo quis exercitation aliquip",
  "model_jscad": {}
}
```
