...
```json
{
  ...
  "ftype": "nulla ut et dolore Duis",
  "source_component_id": "source_component_1",
  "name": "N1",
  "supplier_part_numbers": {
    "utf73": ["officia incididunt aute dolor irure"],
    "aliquab": ["quis officia", "adipisicing tempor do ad", "in nisi"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["elit cillum dolore sed deserunt"],
  "is_power": true,
  "is_ground": false,
...
```json
{
  ...
  "supplier_part_numbers": {
    "sit68": [
      "non",
      "sint ullamco est nulla",
      "occaecat mollit nisi dolore voluptate",
      "exercitation anim ad ut Excepteur",
      "ex cupidatat"
    ]
  }
}
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "enim_08": ["eu elit sit sed", "ullamco cupidatat aute"],
    "culpa_ae0": [
      "elit laboris consequat ex culpa",
      "ut",
      "dolor adipisicing mollit ex",
      "dolor laborum",
      "officia qui nisi exercitation amet"
    ],
    "incididunt_31f": [
      "sunt aliqua sed",
      "anim culpa",
      "voluptate velit id non deserunt",
      "ullamco",
      "anim cupidatat"
    ]
  },
...
```json
{
  ...
  "supplier_part_numbers": {
    "consecteturac": [
      ...
      "nostrud",
      "officia dolore aute",
      "nisi ea deserunt Lorem"
    ],
    "consequatf8": [
      "consectetur magna tempor",
      "ex",
      "non Excepteur commodo irure sint",
      "nostrud voluptate id dolore",
      "ut"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "ad_2_": [
      "eiusmod proident fugiat sunt",
      "nisi veniam ea incididunt id",
      "exercitation ipsum culpa eiusmod Lorem",
      "anim sunt aute in ut",
      "elit"
    ]
  },
  "voltage": "5V"
...
```json
{
  ...
  "supplier_part_numbers": {
    "nulla1": [
      "ut tempor Lorem",
      "sed officia non enim anim",
      "ex laborum aute Duis",
      "voluptate deserunt",
...
```json
{
  ...
  "connected_source_port_ids": [
    "et exercitation nostrud irure",
    "occaecat enim dolore veniam ut",
    "Duis aliquip",
    "enim Excepteur sunt in velit"
  ],
  "connected_source_net_ids": ["culpa ex velit laborum proident"]
}
```
...
```json
{
  ...
  "radius_x": 35476992.50392592,
  "radius_y": -48790188.30468018,
  "layer": "top"
}
```
