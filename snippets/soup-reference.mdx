...
{
  "type": "pcb_text",
  "text": "nostrud Duis aliqua deserunt elit",
  "x": "3mm",
  "y": "1mm",
  "align": "bottom-left",
  "width": "5mm",
...
```json
{
  ...
  "route": [
    ...
    },
    {
      ...
      "y": "1mm",
      "width": "5mm",
      "layer": "proident cupidatat culpa"
    },
    {
      "route_type": "wire",
      "x": "3mm",
      ...
      "width": "5mm",
      "start_pcb_port_id": "start_pcb_port_1",
      "layer": "exercitation est nostrud in"
    }
  ]
}
```
...
| x              | string, number | Yes      |             |
| y              | string, number | Yes      |             |
| outer_diameter | string, number | Yes      |             |
| hole_diameter  | string, number | Yes      |             |
| from_layer     | undefined      | Yes      |             |
| to_layer       | undefined      | Yes      |             |
