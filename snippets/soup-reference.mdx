...
```json
{
  ...
  "ftype": "exercitation ut",
  "source_component_id": "source_component_1",
  "name": "E1",
  "manufacturer_part_number": "sint est",
  "supplier_part_numbers": {
    "Lorem4f": ["sed", "ex"],
    "cupidatat___c": [
      "cillum in laboris sed",
      "labore enim eu officia proident"
    ],
    "laboris2": ["elit est dolore labore", "amet", "ut adipisicing"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolore_8_4": ["ut", "esse", "ea fugiat magna", "ex"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "elit do eu sed officia",
    "Duis aliqua veniam",
    "ipsum sit qui reprehenderit",
    "reprehenderit labore",
    "aute ad consequat ut"
  ],
  "is_power": true,
  "is_ground": false,
  "is_digital_signal": false,
  "is_analog_signal": false,
  "trace_width": 48782537.174980104
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "reprehenderit minim",
  "supplier_part_numbers": {
    "laborume_1": [
      "irure",
      "dolor elit dolore aute",
      "sunt nisi officia qui Ut",
      "ea"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "sit ullamco in",
  "supplier_part_numbers": {
    "in_86": [
      "proident occaecat",
      "ipsum labore ea ad commodo",
      "laboris culpa incididunt",
      "officia ex labore ea"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "officia veniam proident dolore",
  "supplier_part_numbers": {
    "et_dd": [
      "velit enim ullamco",
      "laboris nisi minim",
      "Duis consequat reprehenderit",
      "non nulla dolore"
    ],
    "animb": [
      "quis do",
    ...
    "cupidatat_9": ["elit esse magna mollit nisi"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "sunt non dolor",
  "supplier_part_numbers": {
    "Duis1": ["in", "Lorem et", "nulla Excepteur quis consectetur ea"],
    "occaecatc": [
      "dolor dolore Excepteur",
      "nisi et est consectetur dolore",
      "in nisi proident velit Excepteur",
      "tempor in"
    ],
    "nostrud49f": ["ex", "Lorem dolore", "aliquip ex"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["cillum nostrud reprehenderit", "amet ea"],
  "connected_source_net_ids": ["magna in"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "deserunt proident elit consectetur nulla",
  "pin_styles": {},
  "box_width": "pariatur dolor veniam",
  "symbol_name": "aliquip sed",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "laborum aute adipisicing"
}
```
...
```json
{
  ...
  "message": "Duis adipisicing deserunt"
}
```
...
```json
{
  ...
  "radius_x": "amet Lorem pariatur deserunt",
  "radius_y": "consequat ea commodo ut",
  "layer": "top"
}
```
...
```json
{
  ...
  "route": [
    ...
    },
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": "irure velit dolore non adipisicing"
    }
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "in culpa fugiat",
  "supplier_part_numbers": {
    "Ut_3": [
      "reprehenderit ullamco",
      "enim minim id magna",
      "consectetur",
      "Duis aliqua commodo magna",
      "voluptate commodo Excepteur incididunt labore"
    ],
    "proident_92_": ["nisi", "in", "consequat commodo", "non", "et sit"]
  }
}
```
...
```json
{
  ...
  "model_3mf_url": "occaecat est adipisicing magna elit"
}
```
