...
```json
{
  ...
  "ftype": "dolore cupidatat qui ea ut",
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "laboris ut minim et ex",
  "supplier_part_numbers": {
    "sint_bf": ["qui enim voluptate"],
    "velit_6aa": ["aliqua minim voluptate"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "anim sed Excepteur",
  "supplier_part_numbers": {
    "est_e97": ["nulla sint dolor ut", "laboris pariatur Lorem", "ea deserunt"],
    "Duis3d": ["aliqua velit", "id quis elit in", "in dolore nisi irure sit"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["sit irure mollit dolore"],
  "is_power": false,
  "is_ground": false,
  "is_digital_signal": false,
  "is_analog_signal": true,
  "trace_width": 58665875.10855678
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "est",
  "supplier_part_numbers": {
    "ad_8ab": ["dolor", "sunt", "sed"],
    "laborum_2d8": [
      "eiusmod",
      "fugiat culpa veniam aliqua cillum",
      "Duis eiusmod labore",
      "esse sit dolor aute adipisicing"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "occaecat sint dolore est",
  "supplier_part_numbers": {
    "reprehenderit3": ["irure nulla", "reprehenderit laborum sint voluptate"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "ut ut nisi"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "nulla magna reprehenderit",
  "supplier_part_numbers": {
    "consequat5": [
      "irure occaecat",
      "dolore",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "fugiat do incididunt",
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["cupidatat officia commodo fugiat"],
  "connected_source_net_ids": [
    "ut dolore",
    "minim nostrud aliqua ut",
    "reprehenderit quis"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -17034499.541893393,
  "pin_styles": {},
  "box_width": -74206829.6412023,
  "symbol_name": "aliquip",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "message": "enim proident laboris irure adipisicing"
}
```
...
```json
{
  ...
  "radius_x": "nulla non ut ullamco labore",
  "radius_y": "proident ea Ut",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "Lorem elit",
  "supplier_part_numbers": {
    "in_4": [
      "ullamco",
      "magna veniam in ut",
      "Lorem cupidatat ipsum esse Duis",
      "et cillum minim",
      "incididunt veniam labore"
    ],
    "incididunt8d3": [
      "magna cillum fugiat Excepteur deserunt",
      "mollit minim irure laborum consequat",
      "veniam velit ipsum"
    ]
  }
}
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": 51511286.688774854
  },
  "rotation": "90deg",
  "layer": "top",
  "footprinter_string": "veniam cupidatat esse",
  "model_obj_url": "sint sed do",
  "model_stl_url": "commodo culpa consequat quis labore",
  "model_3mf_url": "aute laboris anim officia",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "deserunt mollit Excepteur cillum"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 32922153.900051624,
  "outer_height": 65588314.30924538,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "Excepteur5": {
    "left_margin": 16489735.20308888,
    "right_margin": "id dolore adipisicing Duis ex",
    "top_margin": -25751932.11803648,
    "bottom_margin": "aliquip laboris enim ut do"
  },
  "sunt_41": {
    "left_margin": "cupidatat minim ut",
    "right_margin": 1380524.0475381017,
    "top_margin": 72283122.71601042
  }
}
```
