...
```json
{
  ...
  "member_source_group_ids": [
    "ad aliquip proident anim dolore",
    "nostrud occaecat deserunt",
    "cupidatat dolore fugiat ea",
    "et pariatur",
    "ipsum et ut"
  ],
  "is_power": false,
...
```json
{
  ...
  "supplier_part_numbers": {
    "animf": [
      "mollit nisi in laboris elit",
      "culpa",
      "non Duis",
      "mollit laboris velit cupidatat dolor",
      "esse aute"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "ad_1": [
      "minim qui esse reprehenderit",
      "cillum",
      "velit laboris",
      "Ut in exercitation Excepteur veniam"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ipsum_3d": [
      "eiusmod aliquip reprehenderit consectetur dolore",
      "tempor",
      "do officia dolor tempor ut",
...
```json
{
  ...
  "connected_source_port_ids": [
    "eu do incididunt in minim",
    "incididunt",
    "eiusmod adipisicing pariatur sint",
    "sint quis eu qui",
    "magna ullamco mollit Duis"
  ],
  "connected_source_net_ids": [
    "cillum consectetur do velit occaecat",
    "qui ex ut enim",
    "eiusmod veniam",
    "est laboris",
    "mollit"
...
```json
{
  ...
  "message": "in ex nulla aliquip elit",
  "pcb_trace_id": "pcb_trace_1",
  "source_trace_id": "source_trace_1",
  "pcb_component_ids": ["pcb_component_1"],
...
```json
{
  ...
  "supplier_part_numbers": {
    "fugiatbda": [
      "nulla proident laborum commodo voluptate",
      "deserunt eu sed aute",
      "fugiat Duis voluptate esse aliqua",
      "tempor elit"
    ]
  }
}
