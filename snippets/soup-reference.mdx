...
```json
{
  ...
  "ftype": "ullamco enim Ut",
  "source_component_id": "source_component_1",
  "name": "U1",
  "manufacturer_part_number": "nisi ea et",
  "supplier_part_numbers": {
    "in_b43": ["non sint et", "cillum", "pariatur commodo anim", "deserunt ea"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ex0": [
      "sed id aliquip fugiat in",
      "pariatur sunt enim esse ex",
      "ut aute"
    ],
    "non_f": ["pariatur", "mollit aliqua nostrud", "Duis"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "mollit qui",
  "supplier_part_numbers": {
    "Loremda8": ["dolore", "ut incididunt adipisicing", "est"],
    "irure_23a": ["quis pariatur eiusmod dolor", "esse quis"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ad ut",
  "supplier_part_numbers": {
    "commodo_8c8": [
      "aliqua sunt deserunt id",
      "minim labore nisi id",
      "officia"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "occaecat id voluptate",
  "supplier_part_numbers": {
    "amet__04": ["Lorem eu"]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "consequat in sed cupidatat",
  "supplier_part_numbers": {
    "magnaf": ["id et laboris sint"],
    "in2": ["ea dolore dolore"],
    "nulla4c9": [
      "voluptate ut mollit Duis ut",
      "Lorem",
      "ullamco ut sint est qui"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "Ut minim aliqua consectetur",
  "supplier_part_numbers": {
    "ex8d": ["ipsum consectetur"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "elit dolore",
  "supplier_part_numbers": {
    "reprehenderite54": ["qui sit nostrud anim ut"],
    "id_bc": ["deserunt ullamco dolore labore magna"],
    "magna89": ["ut minim", "fugiat dolore mollit cupidatat", "Lorem"],
    "sed_9": [
      "amet ea culpa",
      "consequat elit mollit occaecat",
      "nostrud veniam enim quis laborum",
      "adipisicing nisi ea",
      "culpa in"
    ]
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "in magna irure",
  "supplier_part_numbers": {
    "nostrudb_": [
      "pariatur",
      "nulla cillum quis deserunt",
      "anim exercitation cillum ea",
      "et est dolore mollit Excepteur"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_net_ids": ["adipisicing velit consequat aliqua"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 20989188.74025926,
  "pin_styles": {},
  "box_width": "in",
  "symbol_name": "cillum sunt amet Excepteur dolor",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "color": "adipisicing ea ut fugiat"
}
```
...
```json
{
  ...
  "message": "proident exercitation et ex mollit"
}
```
...
```json
{
  ...
  "message": "consequat enim cupidatat",
...
```json
{
  ...
  "radius_x": -73306992.54320207,
  "radius_y": "in dolore et dolor",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "eu fugiat enim officia",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "supplier_part_numbers": {
    "consequat_11": [
      "cillum eiusmod laborum nulla ea",
      "exercitation sed enim",
      "occaecat ad magna",
      "proident",
      "incididunt id ea minim"
    ],
    "voluptatec5": [
      "veniam incididunt",
      "adipisicing eu in nisi minim",
      "ut proident nulla eu",
      "deserunt",
      "occaecat et reprehenderit qui"
    ],
    "enimf": ["ex consectetur", "tempor amet ex"]
  }
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "eiusmod aliquip",
  "model_obj_url": "aliqua Ut culpa ut anim",
  "model_stl_url": "velit"
}
```
...
{
  "minim_02": {
    "left_margin": "laborum elit",
    "right_margin": "elit cillum sunt deserunt ipsum",
    "top_margin": "qui Excepteur in",
    "bottom_margin": 17147203.187874064
  },
  "nisi_26": {
    "left_margin": -17903617.676594004,
    "right_margin": 60044269.26760396
  },
  "Lorem_cc0": {
    "left_margin": -53492829.16434102,
    "right_margin": "consectetur in Duis voluptate",
    "top_margin": "officia ut",
    "bottom_margin": "adipisicing sint elit"
  },
  "ut_9": {
    "left_margin": -86473048.18730825,
    "right_margin": "consequat",
    "top_margin": 6920386.347994164,
    "bottom_margin": "do"
  },
  "consequat_6": {
    "left_margin": -54569724.66262084,
    "right_margin": "consequat nisi",
    "top_margin": "Lorem eu sunt",
    "bottom_margin": 98494312.2998667
  }
}
```
