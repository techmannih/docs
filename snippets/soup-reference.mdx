...
```json
{
  ...
  "ftype": "officia amet reprehenderit in",
  "source_component_id": "source_component_1",
  "name": "O1",
  "manufacturer_part_number": "enim",
  "supplier_part_numbers": {
    "commodo__a1": [
      "in aliquip laboris occaecat",
      "labore ullamco",
      "dolore est non laboris eu"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "Duis sit quis",
  "supplier_part_numbers": {
    "este91": ["nostrud non minim proident", "eu eiusmod sit", "enim occaecat"],
    "labore_d": ["nulla"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    ...
    "deserunt mollit ex proident",
    "adipisicing aute dolor reprehenderit",
    "Excepteur",
    "deserunt in dolor ad"
  ],
  "is_power": false,
  "is_ground": false,
  "is_digital_signal": false,
  "is_analog_signal": false,
  "trace_width": -53782886.67449369
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "ullamco minim reprehenderit et dolor"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "qui44d": [
      "fugiat sunt ex culpa",
      "aliquip velit sed",
      "mollit voluptate sit"
    ],
    "nisia6": ["in elit", "deserunt enim"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "pariatur_3": [
      "eu reprehenderit dolor enim anim",
      "nostrud quis in et",
      "elit fugiat Duis"
    ],
    "sed_5": ["irure", "occaecat"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "velit sed voluptate reprehenderit ea",
  "supplier_part_numbers": {
    "pariatur__0": ["exercitation eu"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "deserunt et Lorem",
  "supplier_part_numbers": {
    "cupidatat0cf": [
      "magna non Duis aliquip",
      "nisi ut ipsum Ut",
      "non pariatur",
      "nostrud"
    ],
    "consequat9": [
      "aliquip occaecat",
      "amet pariatur Ut eu",
      "laboris qui magna consequat",
      "et ex ut minim laborum"
    ],
    "adipisicing_187": [
      "ut non in incididunt fugiat",
      "ipsum ad eu labore elit"
    ],
    "et_8": [
      "in",
      "in",
      "adipisicing commodo ut proident",
      "exercitation ex est dolor",
      "in eu voluptate"
    ],
    "ut_0b": [
      "aliquip mollit minim Duis",
      "sed mollit veniam deserunt",
      "dolor labore aliqua ut",
      "mollit in commodo do incididunt"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": ["quis"],
  "connected_source_net_ids": ["ullamco culpa in", "enim ullamco"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -50525538.58910751,
  "pin_styles": {},
  "box_width": "sit",
  "symbol_name": "in do consectetur nulla quis",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "nisi magna enim eu exercitation"
}
```
...
```json
{
  ...
  "radius_x": 18074905.188726217,
  "radius_y": 38111614.02119833,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "laboris velit dolore occaecat incididunt",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "cupidatat adipisicing anim cillum",
  "supplier_part_numbers": {
    "Loremcb": ["do Lorem nostrud ut deserunt", "aliquip in nulla", "in"]
  }
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "incididunt eiusmod magna",
  "model_obj_url": "proident",
  "model_stl_url": "enim voluptate",
  "model_3mf_url": "do",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": 58269198.786685556
}
```
...
{
  "mollit_": {
    "left_margin": -71509324.15798281,
    "right_margin": "anim elit dolor deserunt aliquip",
    "top_margin": "quis cupidatat",
    "bottom_margin": "cupidatat dolor ut sit"
  },
  "pariatur_72b": {
    "left_margin": "nulla eu laboris",
    "right_margin": -92479068.20465319
  },
  "sit_3f": {}
}
```
