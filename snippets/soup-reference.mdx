...
```json
{
  ...
  "member_source_group_ids": [
    "nostrud non",
    "pariatur culpa commodo Lorem sunt",
    "proident cillum"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "eiusmod sed veniam nisi est",
  "supplier_part_numbers": {
    "laborisd6": ["proident", "adipisicing laboris proident"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "occaecat_2d": ["laborum sed Duis culpa ex", "ut", "dolore occaecat"],
    "ipsumbd": [
      "ad Excepteur consequat sunt eu",
      "ad commodo",
      "pariatur nulla sint",
      "proident minim sint",
      "et enim dolore sunt Lorem"
    ],
    "incididunt58": ["minim sed sit in consectetur", "officia"],
    "dolora5_": ["dolor quis ut", "sit sunt cillum labore ex", "mollit"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "Lorem mollit culpa pariatur",
  "supplier_part_numbers": {
    "ullamcoa_f": ["mollit ea", "mollit aute ipsum Ut", "sed"],
    "amet_93": [
      "in cupidatat et deserunt cillum",
      "fugiat anim ut elit laborum",
      "occaecat dolore veniam eu",
      "mollit commodo Ut anim nulla"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "labore est nostrud mollit anim"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "nostrud tempor culpa ex officia",
  "supplier_part_numbers": {
    "nulla_a41": [],
    "Duis5": ["eu cillum ex est"],
    "qui_3": [
      "in",
      "mollit amet dolor eu est",
      "Excepteur aute",
      "aliqua",
      "ea"
    ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "minim exercitation",
  "supplier_part_numbers": {
    "consequatd": [
...
```json
{
  ...
  "connected_source_port_ids": [
    "irure Ut enim ex in",
    "velit veniam Excepteur nisi in"
  ],
  "connected_source_net_ids": [
    "enim sunt reprehenderit et Ut",
    "nulla qui do et",
    "voluptate incididunt in cillum",
    "dolore in ex ipsum"
  ]
}
```
...
```json
{
  ...
  "symbol_name": "dolor non enim commodo",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "ad nisi laboris dolore"
}
```
...
```json
{
  ...
  "message": "fugiat in exercitation qui",
...
```json
{
  ...
  "radius_x": "ut magna esse reprehenderit fugiat",
  "radius_y": -4327238.472829014,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "et Ut enim",
  "supplier_part_numbers": {
    "esse_d": []
  }
}
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "eiusmod sed consectetur"
  },
  "rotation": "90deg",
  "layer": "top",
  "footprinter_string": "esse",
  "model_obj_url": "veniam fugiat",
  "model_stl_url": "sint amet",
  "model_3mf_url": "ullamco deserunt dolor sed",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "dolor Excepteur nostrud"
}
```
