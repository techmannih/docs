...
```json
{
  ...
  "supplier_part_numbers": {
    "incididuntb_9": [
      "elit nisi Excepteur dolor",
      "ullamco laborum amet ut enim",
      "est dolor"
    ]
  }
}
...
```json
{
  ...
  "member_source_group_ids": [
    "dolor consequat Ut id sed",
    "dolor et velit adipisicing",
    "irure Excepteur",
    "sit in eiusmod aliqua",
    "dolor veniam laborum"
  ],
  "is_power": true,
  "is_ground": false,
  "trace_width": 80739403.75366694
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "Lorem do tempor nisi",
  "supplier_part_numbers": {
    "in_85d": [
      "pariatur",
      "aliqua Ut esse",
      "amet",
      "est aute adipisicing eiusmod in",
      "sunt in cupidatat"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "sit veniam",
  "supplier_part_numbers": {
    "tempor_5": [
      "mollit anim nostrud voluptate",
      "exercitation deserunt laboris sit sunt",
      "aliquip adipisicing dolore sint"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "Lorem irure incididunt",
  "supplier_part_numbers": {
    "incididunt_7__": [
      "dolor Excepteur enim ea in",
      "dolore do adipisicing dolore"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "quis ut exercitation dolore ea",
  "supplier_part_numbers": {
    "amet2": [
      "nostrud",
      "enim",
      "consectetur in aute laboris voluptate",
      "do dolore nulla non laborum",
      "dolore culpa sint reprehenderit non"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ipsumb58": ["enim fugiat sed minim labore"],
    "ut_f53": ["ad culpa aliqua", "sunt et Lorem"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "enim_1": [
      "velit occaecat ut anim",
      "aliquip pariatur",
      "Excepteur commodo ipsum minim",
      "sit"
    ],
    "velit_d": [
      "dolor",
      "esse",
      "esse exercitation non aliqua do",
      "dolor fugiat"
    ]
  },
  "voltage": "5V"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "ut mollit sed pariatur reprehenderit",
  "supplier_part_numbers": {
    "nostrud_f": [
      "adipisicing officia aliqua qui aute",
      "culpa irure pariatur sit non",
      "reprehenderit"
    ],
    "non_a": [
      "occaecat",
...
```json
{
  ...
  "connected_source_port_ids": [
    "sed",
    "amet proident eu ullamco adipisicing",
    "enim eiusmod elit anim dolor",
    "et dolor est",
    "pariatur mollit in Duis sit"
  ],
  "connected_source_net_ids": [
    "occaecat cillum enim magna",
    "ea",
    "dolor anim ut amet et"
  ]
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "incididunt in Lorem non nostrud"
}
```
...
```json
{
  ...
  "message": "veniam tempor sint aliquip ut"
}
```
...
```json
{
  ...
  "message": "Excepteur id consectetur",
...
```json
{
  ...
  "radius_x": "nulla aliquip voluptate exercitation Ut",
  "radius_y": "nulla occaecat",
  "layer": "top"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "anim47": [
      ...
      "exercitation sint id cillum do",
      "dolore sint Duis est amet",
      "magna elit dolor tempor",
      "velit ullamco"
    ],
    "laboris19": ["in", "velit sunt reprehenderit dolore"],
    "deserunt_336": ["veniam labore exercitation", "laborum dolor quis aute"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "dolor aliquip nisi minim deserunt"
  },
  "footprinter_string": "commodo voluptate Duis amet cillum",
  "model_obj_url": "Ut",
  "model_stl_url": "mollit non",
  "model_3mf_url": "dolore eu",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "eu reprehenderit Duis laborum"
}
```
...
{
  "enim0c_": {
    "top_margin": 92262715.1069437,
    "bottom_margin": 24593277.468877733
  }
}
```
