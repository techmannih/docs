...
```json
{
  ...
  "name": "D1",
  "manufacturer_part_number": "veniam non cillum esse",
  "supplier_part_numbers": {
    "incididunt_441": [
      "proident aliquip aliqua eiusmod",
      "incididunt laboris enim"
    ],
    "nisi_3": [
      "deserunt aliquip consectetur nostrud ut",
      "cillum magna sed tempor"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "non_": [
      "officia consequat anim aute laboris",
      "laboris id veniam pariatur anim"
    ],
    "sit__": [
      "aliqua non adipisicing fugiat id",
      "Lorem mollit anim",
      "culpa deserunt labore laborum",
      "Duis esse ea minim exercitation",
      "id"
    ]
  }
}
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["non laboris minim quis"],
  "is_power": false,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": -58124604.08580185
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "in occaecat dolore ad ex",
  "supplier_part_numbers": {
    "irure_02": ["culpa laboris fugiat"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "incididunt est sit nostrud magna",
  "supplier_part_numbers": {
    "consectetur2": ["sunt", "ad"],
    "dolore_7e6": ["non incididunt quis", "ipsum Lorem"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "quis tempor nostrud Lorem dolor"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "pariatur magna dolore sit",
  "supplier_part_numbers": {
    "sunt__5e": [
      "et",
      "Excepteur amet dolore ut non",
      "in officia laborum",
      "veniam consequat Ut nisi non",
      "aliquip eiusmod in enim culpa"
    ],
    "incididunt_0": ["eu velit"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "pariatur id",
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["aliqua", "et Ut sed nisi", "ea pariatur"],
  "connected_source_net_ids": [
    "Duis non consequat tempor",
    "cupidatat incididunt proident sed",
    "nisi Ut exercitation et",
    "nisi irure aute eu enim"
  ]
}
```
...
```json
{
  ...
  "radius_x": "quis est anim magna elit",
  "radius_y": -47329368.95621935,
  "layer": "top"
}
```
...
```json
{
  ...
  "type": "schematic_error",
  "error_type": "schematic_port_not_found",
  "message": "non officia ex voluptate sunt"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "doloree4": ["ullamco qui veniam fugiat"],
    "est8": ["culpa", "minim ex non consequat", "minim aliqua aliquip laboris"],
    "et_95b": [
      "sint aute velit proident",
      "ut reprehenderit eiusmod ex dolor",
      "reprehenderit",
      "sint enim eiusmod",
      "labore magna in dolore"
    ],
    "nisi05b": ["consectetur et mollit", "et nisi non eiusmod"],
    "nostrud6": [
      "pariatur dolore non",
      "culpa veniam",
      "nostrud",
      "proident Excepteur ullamco fugiat magna"
    ]
  }
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 83996794.32099015,
  "outer_height": -92852752.10069263,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "non anim officia dolor nulla"
}
```
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": -12118039.270911485
}
```
...
{
  "aliqua_2": {
    "left_margin": "dolore commodo qui",
    "right_margin": -11131550.493416846,
    "top_margin": "non pariatur enim magna",
    "bottom_margin": "sit sed minim in"
  },
  "ipsum_5b": {
    "left_margin": -32640680.92877488,
    "bottom_margin": -70040398.68787801
  }
}
```
