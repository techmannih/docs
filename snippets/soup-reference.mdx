...
```json
{
  ...
  "name": "C1",
  "manufacturer_part_number": "quis exercitation",
  "supplier_part_numbers": {
    "nisi_e4d": ["magna non ut", "est incididunt occaecat"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "dolore laboris minim",
  "supplier_part_numbers": {
    "inbf": [
      "incididunt aliqua nostrud",
      "elit velit",
      "incididunt",
      "mollit incididunt nisi enim reprehenderit",
      "dolor velit minim proident"
    ],
    "ad_13": ["ad cillum voluptate", "esse", "ad tempor ut in in"],
    "eu_1a": [
      "id voluptate anim dolor",
      "quis est veniam aliquip",
      "officia ipsum sed nulla enim",
      "consectetur laboris et sed eiusmod"
    ]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "sunt dolore Ut elit ut",
    "laboris ad deserunt veniam",
    "aute laboris Lorem",
    "est veniam irure anim eu",
    "dolor officia culpa"
  ],
  "is_power": false,
  "is_ground": false,
  "trace_width": -57193201.037257865
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "cillum proident aliquip sed enim",
  "supplier_part_numbers": {
    "sint0": ["proident consequat aute incididunt in"],
    "aliquip_4b": [
      "ea ullamco",
      "qui dolore in occaecat nulla",
      "do ad exercitation consectetur eiusmod",
      "labore Duis fugiat reprehenderit"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ad labore",
  "supplier_part_numbers": {
    "aute4": ["ut enim officia nisi", "ullamco minim"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "id in",
  "supplier_part_numbers": {
    "nisi_4ca": [
      "minim sed fugiat cupidatat",
      "esse in ipsum aliquip",
      "ea dolore"
    ],
    "velita": [
      "proident sint sunt ut esse",
      "quis",
      "reprehenderit laboris commodo in",
      "commodo",
      "id dolor"
    ],
    "Duis_04": [
      "velit id in enim",
      "sed culpa nisi aliqua",
      "do",
      "id occaecat dolor amet sint",
      "pariatur"
    ],
    "consequat02f": [
      "non aliquip dolore incididunt fugiat",
      "elit dolore ullamco esse cillum",
      "irure in reprehenderit amet",
      "culpa",
...
```json
{
  ...
  "name": "D1",
  "supplier_part_numbers": {
    "esse_d": ["consectetur cillum", "exercitation", "officia id"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "Excepteur dolore velit",
  "supplier_part_numbers": {
    "laborum_2_9": ["Lorem", "do Lorem ad commodo"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "cillum sint eu enim",
  "supplier_part_numbers": {
    "ipsum_a": [
      "dolor mollit in",
      "labore irure dolore",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "ex mollit elit",
  "supplier_part_numbers": {
    "eiusmod716": [
      "nulla ut",
      "Ut culpa ullamco dolore",
      "nisi elit in",
      "ut minim ex elit reprehenderit",
      "est sunt dolore reprehenderit id"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "commodo amet dolore aliquip Duis",
    "culpa",
    "incididunt in"
  ],
  "connected_source_net_ids": ["dolore nulla", "ex nulla"]
}
```
...
```json
{
  ...
  "message": "ullamco culpa proident"
}
```
...
```json
{
  ...
  "radius_x": "amet quis irure eiusmod",
  "radius_y": 39331737.29494473,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "consectetur deserunt quis veniam ipsum",
  "supplier_part_numbers": {
    "Lorem_02": ["non Ut"],
    "proident37": ["exercitation ea amet consectetur"],
    "ea0": ["dolore reprehenderit", "minim ut"],
    "aliquip9": [
      "anim",
      "adipisicing commodo nostrud Duis",
      "voluptate",
      "voluptate laboris"
    ]
  }
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "veniam do voluptate ut adipisicing"
  },
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": -13215772.823104382
  },
  "footprinter_string": "in commodo exercitation quis id",
  "model_obj_url": "id elit Lorem ipsum sint",
  "model_stl_url": "enim sunt exercitation"
}
```
...
```json
{
  ...
  "layer": "top",
  "description": "sint sed dolor ut nostrud",
  "shape": "circle",
  "center": {
    "x": "3mm",
    "y": "1mm"
