...
```json
{
  ...
  "ftype": "ullamco sunt Excepteur magna ex",
  "source_component_id": "source_component_1",
  "name": "U1",
  "supplier_part_numbers": {
    "culpa_6b": ["reprehenderit minim nostrud", "deserunt Lorem", "ut", "culpa"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "culpa mollit esse ipsum laborum",
    "aliquip sint ut"
  ],
  "is_power": false,
  "is_ground": true,
...
```json
{
  ...
  "supplier_part_numbers": {
    "pariatur__8": [
      "qui",
      "ipsum amet fugiat ut anim",
      "sit non eu exercitation est",
      "dolore occaecat",
      "in sint"
    ],
    "tempor__": ["sit", "sed dolor", "aliqua ad", "et"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "fugiat2": [
      ...
      "aliqua ut minim ut laboris",
      "minim ullamco",
      "quis amet commodo deserunt"
    ],
    "dolore0": [
      "elit mollit proident Lorem",
      "deserunt amet",
      "proident qui et fugiat",
      "proident dolore consectetur eiusmod",
      "esse sint elit Duis"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "supplier_part_numbers": {
    "exca9": [
      "ipsum",
      "adipisicing labore ullamco minim",
      "adipisicing commodo aliquip non",
      "officia aliquip laborum deserunt"
    ]
  }
}
```
...
```json
{
  ...
  "name": "G1",
  "supplier_part_numbers": {
    "aute_9": ["velit id", "dolor esse est Lorem", "ipsum ullamco Lorem"],
    "amet_278": ["esse ullamco officia", "non", "Excepteur est cupidatat"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "tempore": [
      "dolore nisi enim tempor mollit",
      "deserunt id minim",
      "ipsum incididunt in culpa consequat"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "connected_source_port_ids": ["officia velit aliqua deserunt"],
  "connected_source_net_ids": [
    "enim sed dolore",
    "pariatur veniam culpa laborum dolore",
    "et eu ullamco ut"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -89808382.874235,
  "box_width": "irure non fugiat incididunt in",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "message": "dolore deserunt cillum quis"
}
```
...
```json
{
  ...
  "message": "et ad deserunt quis consectetur",
...
```json
{
  ...
  "radius_x": "proident deserunt amet ad",
  "radius_y": -71047423.24648306,
  "layer": "top"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "nisi_5e": [
      "commodo sint Ut",
      "dolore tempor voluptate nostrud sunt",
      "est deserunt velit in",
      "in enim cupidatat nostrud"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "eu in proident quis"
  },
  "layer": "top",
  "model_stl_url": "Duis cupidatat laboris ea",
  "model_3mf_url": "ea minim ad"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 8604053.261924475,
  "outer_height": 98352531.60533237,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
