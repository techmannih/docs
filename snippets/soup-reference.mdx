...
```json
{
  ...
  "supplier_part_numbers": {
    "aliquip_f": [
      "sint occaecat id",
      "veniam ex reprehenderit do enim",
      "sunt ex"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "est aliqua magna Excepteur",
  "supplier_part_numbers": {
    "ut_9": ["elit labore"]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "est consectetur Lorem nulla",
  "supplier_part_numbers": {
    "nisi_9": ["elit ea in culpa", "adipisicing ullamco dolor velit"],
    "mollit_bc3": ["ex incididunt", "ipsum et laboris"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "sed fugiat",
  "supplier_part_numbers": {
    "eu_4": [
      "eiusmod",
      "anim minim culpa quis",
      "laboris elit commodo",
      "elit cillum ut",
      "ad aliqua ex sunt culpa"
    ],
    "Excepteurf8": ["tempor sed ad ea"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "tempor ex commodo amet Excepteur",
  "supplier_part_numbers": {
    "Duis_0": ["consequat aliquip", "est minim elit"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "nulla dolor"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "nisi eu ullamco",
  "supplier_part_numbers": {
    "mollit775": ["culpa cupidatat"],
    "in_8": ["in reprehenderit", "nostrud aliquip"],
    "cillum_a55": [
      "exercitation Lorem enim pariatur",
      "anim eiusmod laboris minim tempor",
      "Lorem aliqua officia ipsum sint"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "incididunt elit sit",
  "supplier_part_numbers": {
    "velitbf": ["in dolore ea", "tempor officia"],
    "magna_1b": [
      "ea adipisicing dolore sunt nulla",
      "sint sit magna sed",
      "sit exercitation",
      "in Excepteur magna"
    ],
    "in8": ["aliqua anim minim"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "labore laborum sed ipsum cupidatat",
  "supplier_part_numbers": {
    "in_f": [
      "velit cillum",
      "mollit tempor sed",
...
```json
{
  ...
  "connected_source_port_ids": ["dolor incididunt Ut", "ea exercitation"],
  "connected_source_net_ids": ["in velit et fugiat"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -31827161.81376794,
  "box_width": "voluptate dolore laborum",
  "symbol_name": "ipsum irure aliquip in consequat",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "ullamco laboris deserunt ad exercitation",
...
```json
{
  ...
  "radius_x": 43903699.87240419,
  "radius_y": 50661795.5974164,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "in fugiat reprehenderit labore",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "Excepteur fugiat",
  "model_obj_url": "ut",
  "model_stl_url": "in in veniam",
  "model_3mf_url": "ut dolore do",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layer": "top",
  "description": "nulla esse ut pariatur",
  "shape": "rect",
  "x": "3mm",
  "y": "1mm",
  "width": "5mm",
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -93476437.62648983,
  "outer_height": 79480950.01621631,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
