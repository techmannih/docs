...
```json
{
  ...
  "supplier_part_numbers": {
    "Duisad": [
      "adipisicing consectetur consequat",
      "tempor ullamco consectetur mollit sit",
      "sit eu magna commodo",
      "cupidatat ipsum ea magna"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "amet14": [
      "dolore veniam",
      "veniam ut non",
      "ex veniam adipisicing est",
      "est magna fugiat esse enim"
    ]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["aute cillum"],
  "is_power": false,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": 36365126.54925576
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "voluptate proident nisi qui",
  "supplier_part_numbers": {
    "officiae0_": ["deserunt magna", "exercitation labore aliquip"],
    "labore_80_": ["sed do mollit", "id pariatur ad", "labore aute"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "culpa ad dolore incididunt irure",
  "supplier_part_numbers": {
    "proident3": [
      "sunt id",
      "qui",
      "voluptate sunt Lorem magna",
      "incididunt amet ea veniam reprehenderit",
      "eiusmod aliquip Ut"
    ],
    "sunt0": ["quis laboris magna", "ut id", "deserunt elit veniam"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "cillum__": [
      ...
      "in aliqua nulla magna"
    ],
    "magna_2": ["sint ex", "eiusmod do quis", "eiusmod"],
    "exercitationf": [
      "consequat aute in occaecat ut",
      "adipisicing elit",
      "dolore non irure",
      "dolore consectetur sit laborum adipisicing",
      "laborum do"
    ],
    "cillum_8": [
      "laboris veniam",
      "ea et enim quis dolore",
      "sit enim nisi Excepteur esse",
      "veniam sed sunt",
      "incididunt reprehenderit culpa tempor enim"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "Excepteur_01": [
      "irure pariatur",
      "et magna officia ex",
      "aliquip cupidatat pariatur voluptate mollit",
      "do occaecat cupidatat commodo",
      "laborum culpa fugiat"
    ],
    "aliquae": [
      "amet veniam mollit voluptate",
      "nostrud",
      "ullamco voluptate",
      "Lorem",
      "nulla"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "commodo veniam dolore",
  "supplier_part_numbers": {
    "est_": ["sunt dolor non ullamco in"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    ...
    "culpa qui aliqua nostrud",
    "fugiat velit officia nostrud"
  ],
  "connected_source_net_ids": ["adipisicing enim eu ipsum"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 4222126.349501252,
  "pin_styles": {},
  "symbol_name": "ut anim mollit amet",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "text": "Hello, World!",
  "layer": "top",
  "color": "amet aliqua proident fugiat mollit"
}
```
...
```json
{
  ...
  "radius_x": -87565686.19262634,
  "radius_y": "non aliquip quis occaecat ullamco",
  "layer": "top"
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "dolore sed do reprehenderit"
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": 61870572.364281386
  },
  "layer": "top",
  "footprinter_string": "aliqua ad occaecat",
  "model_obj_url": "dolor proident esse",
  "model_stl_url": "enim",
  "model_3mf_url": "dolor ea",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "enim adipisicing labore veniam"
}
```
...
{
  "est_f6": {
    "left_margin": 9391293.020227298,
    "right_margin": "laborum dolor deserunt",
    "top_margin": -24635318.495079428,
    "bottom_margin": "Lorem"
  },
  "mollit_6": {
    "left_margin": "dolore est nostrud",
    "right_margin": 1019736.7391206622
  }
}
```
