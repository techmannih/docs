...
```json
{
  ...
  "supplier_part_numbers": {
    "ullamco_2b": [
      "consectetur magna nulla in mollit",
      "labore dolor nostrud fugiat"
    ],
    "cupidatat75": [
      "id voluptate dolore",
      "in exercitation consequat magna voluptate"
    ],
    "consequat_c60": [
      "voluptate ipsum",
...
```json
{
  ...
  "member_source_group_ids": [
    "eu cillum",
    "sint",
    "mollit labore fugiat",
    "dolore nostrud",
    "ea fugiat reprehenderit dolore consequat"
  ],
  "is_power": false,
  "is_ground": true,
...
```json
{
  ...
  "supplier_part_numbers": {
    "sintc": [
      "dolore sunt reprehenderit ipsum mollit",
      "aliquip veniam dolore laborum"
    ]
  }
}
```
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "dob4": ["dolor id cillum minim ut"],
    "in2_": [
      "culpa",
      "sunt",
      "aliqua elit",
      "nostrud adipisicing ullamco",
      "sit aliquip in et veniam"
    ],
    "ut96": ["quis esse sed officia id", "dolor amet"],
    "esse_08": [
      "fugiat esse ex enim",
      "sint",
      "cillum eiusmod nisi",
      "velit ut ullamco dolore",
      "dolor dolor eu veniam"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "name": "D1",
  "supplier_part_numbers": {
    "minim4d2": ["amet", "enim", "dolore", "eu commodo aute id"],
    "eu33": [
      "nulla dolore cupidatat Lorem",
      "amet do sint consectetur esse",
      "officia cupidatat"
    ],
    "tempor_8": [
      "aute Duis incididunt culpa",
      "laborum veniam irure fugiat",
      "in exercitation et consectetur amet"
    ]
  }
}
```
...
```json
{
  ...
  "name": "G1",
  "supplier_part_numbers": {
    "ullamco_713": ["ea", "Excepteur deserunt exercitation sint in"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "cillum68d": [
      "velit ad laborum incididunt ullamco",
      "deserunt",
      "fugiat cupidatat incididunt irure"
    ],
    "non_a": ["cillum"],
    "aliqua2_8": [
      "aliqua reprehenderit proident minim",
      "dolor consequat commodo",
      "nisi veniam"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": [
    "occaecat dolor",
    "tempor Ut ea minim voluptate",
    "nisi Duis",
    "Excepteur culpa in officia magna",
    "aliquip quis"
  ],
  "connected_source_net_ids": [
    "cillum Lorem ut mollit adipisicing",
    "eiusmod eu"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "ad laboris",
  "box_width": "eiusmod ullamco minim",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "message": "mollit in nisi est laboris",
...
```json
{
  ...
  "name": "R1",
  "supplier_part_numbers": {
    "elitc": ["dolore ullamco sint dolor elit", "in", "velit"],
    "exercitation2": ["sint id", "ad enim sint est incididunt"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "deserunt",
  "model_obj_url": "et sint sit Ut",
  "model_stl_url": "sit Duis sed",
  "model_3mf_url": "Ut est enim",
  "model_jscad": []
}
```
