...
```json
{
  ...
  "ftype": "sunt quis mollit",
  "source_component_id": "source_component_1",
  "name": "S1",
  "manufacturer_part_number": "ad",
  "supplier_part_numbers": {
    "fugiat_ef2": [
      "reprehenderit mollit in",
      "quis minim culpa in esse",
      "eu",
      "consectetur adipisicing ut sint laborum",
      "sit ad esse laborum id"
    ],
    "sed061": [
      "culpa Ut aute ex",
      "deserunt adipisicing nisi cupidatat magna",
      "eiusmod"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "inf": [
      ...
      "cupidatat id ex",
      "ex aute",
      "sit aliquip quis sunt veniam",
      "aliqua sint aliquip"
    ],
    "ullamcob4": [
      "Excepteur mollit tempor cillum occaecat",
      "ex voluptate dolore irure"
    ],
    "dolor7fe": ["Ut irure", "labore deserunt id anim elit"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "dolor elit",
  "supplier_part_numbers": {
    "cillum_d4c": [
      "do irure consequat consectetur pariatur",
      "minim proident",
      "dolor fugiat cillum et",
      "labore non",
      "exercitation"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "consequat nulla",
  "supplier_part_numbers": {
    "sint_b": ["officia id consectetur", "in cillum nulla"],
    "non6": ["voluptate officia ad", "sed voluptate dolore sunt ut"],
    "Lorem_5": ["in consequat ut adipisicing aute"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "nisi eu reprehenderit",
  "supplier_part_numbers": {
    "exercitation_aef": [
      "deserunt sit enim",
      "in magna nulla Lorem",
      "esse nostrud pariatur",
      "anim Lorem esse dolor labore",
      "adipisicing aute"
    ],
    "anim_9f9": ["Duis", "tempor", "elit fugiat"],
    "officia_2": ["Excepteur", "Lorem qui", "nulla"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "sint__": ["sit dolor aute deserunt aliqua", "sit"],
    "aliquip_b": ["culpa", "voluptate amet"],
    "enim9_": ["voluptate"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "irure ut amet aliquip",
  "supplier_part_numbers": {
    "reprehenderit_274": ["ut proident occaecat", "Excepteur in"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "sint fugiat incididunt Excepteur",
  "supplier_part_numbers": {
    "cillum_6": ["tempor voluptate nostrud", "labore", "sunt sint"],
    "id49": ["nisi deserunt", "fugiat reprehenderit aliquip"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "minim enim nulla",
    "in labore pariatur voluptate",
    "exercitation incididunt dolore reprehenderit qui"
  ],
  "connected_source_net_ids": [
    "eu dolor nisi mollit dolor",
    "dolore",
    "amet nulla incididunt",
    "dolore sit est incididunt"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 27207121.91270116,
  "box_width": "sunt amet dolor nulla",
  "symbol_name": "ea est",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "message": "dolor non eiusmod tempor"
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "culpa pariatur officia nulla"
}
```
...
```json
{
  ...
  "radius_x": "tempor laboris non",
  "radius_y": "labore enim eu qui culpa",
  "layer": "top"
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": -8247385.2118432075
  },
  "model_obj_url": "eu culpa laborum ex ad",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "proident sed reprehenderit ea cillum"
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "nostrud adipisicing cupidatat aliquip deserunt"
}
```
...
{
  "id_d": {
    "right_margin": "occaecat Ut et dolore laborum"
  }
}
```
