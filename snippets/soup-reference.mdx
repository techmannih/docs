...
```json
{
  ...
  "supplier_part_numbers": {
    "in47": ["non et", "anim nulla Excepteur", "aliqua non dolor sed"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "ipsum nostrud",
  "supplier_part_numbers": {
    "quis_43": []
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "officia_ee": [
      "Excepteur do voluptate commodo",
      "qui dolor magna do ut",
      "eiusmod velit"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "officia do",
  "supplier_part_numbers": {
    "Excepteure5": [
      "eiusmod",
      ...
      "do amet cillum",
      "laboris ullamco",
      "mollit officia ea veniam ut"
    ],
    "nostrud_2": ["Excepteur minim ea"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "exercitation",
  "supplier_part_numbers": {
    "culpa_9": [],
    "irure4": [
      "labore dolor dolor ea",
      "aliqua dolor",
      "ex Ut anim veniam dolor"
    ],
    "eu_1f": ["tempor quis do", "fugiat", "ut nostrud", "in dolore"],
    "Ut_d": ["laboris culpa laborum", "qui"],
    "non3": [
      "eiusmod consequat Excepteur",
      "voluptate esse",
      "tempor aliqua sed fugiat",
      "eu aliquip esse in ut"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "cillum24a": [
      "fugiat Excepteur",
      "deserunt culpa veniam ipsum occaecat",
      "sed cupidatat veniam laborum"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "qui_0": [
      "occaecat labore eu",
      "mollit nulla qui ipsum",
      "enim pariatur nisi consequat Excepteur",
      "aute et adipisicing Lorem sunt",
      "Lorem Ut irure"
    ],
    "in88": [
      "deserunt sint incididunt ad",
      "incididunt minim cillum",
      "officia sed quis Duis pariatur"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "elit_2_1": [
      ...
      "ipsum non tempor",
      "amet reprehenderit",
      "cupidatat reprehenderit nisi ad ex"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "minim laborum deserunt Lorem incididunt",
    "ex",
    "Excepteur",
    "sint officia Duis occaecat ipsum",
    "est"
  ],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "consequat anim",
  "pin_styles": {},
  "box_width": -80043232.30265436,
  "symbol_name": "eiusmod ut consectetur quis",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "mollit pariatur sed cupidatat qui"
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "occaecat pariatur cillum magna"
}
```
...
```json
{
  ...
  "message": "sit magna amet ex reprehenderit"
}
```
...
```json
{
  ...
  "message": "aliquip in voluptate sit",
...
```json
{
  ...
  "radius_x": "sint exercitation",
  "radius_y": 76745748.4341003,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "ut consectetur minim exercitation",
  "supplier_part_numbers": {
    "cillum_864": ["est anim labore sed dolore", "mollit", "non reprehenderit"],
    "voluptatebe1": ["mollit"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "cupidatat do deserunt",
  "supplier_part_numbers": {
    "in_a": [],
    "sed_7c3": [
      "Lorem",
      "anim dolore nulla velit veniam",
      "aliqua enim",
      "labore do ipsum magna velit"
    ],
    "magnade": ["ea et ex"]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "dolore dolore eu non in"
  },
  "model_stl_url": "in",
  "model_3mf_url": "reprehenderit",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": "aliqua id quis sed deserunt"
}
```
...
{
  "occaecat5a": {
    "left_margin": "laboris aliqua",
    "right_margin": "tempor ad dolor laboris mollit",
    "top_margin": "adipisicing",
    "bottom_margin": 47973573.70483068
  },
  "et_bca": {
    "left_margin": -76139687.9935908,
    "right_margin": "cillum ipsum",
    "top_margin": "non aliquip cillum ea ex",
    "bottom_margin": "proident eiusmod irure velit occaecat"
  },
  "aliquipc3": {
    "left_margin": "Duis",
    "right_margin": -65296960.410238825,
    "top_margin": "quis eu laboris"
  },
  "amet0": {
    "right_margin": "enim non dolore mollit",
    "top_margin": 56003600.51955363
  }
}
```
