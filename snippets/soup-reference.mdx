...
```json
{
  ...
  "ftype": "quis proident ullamco ut",
  "source_component_id": "source_component_1",
  "name": "Q1",
  "manufacturer_part_number": "laborum adipisicing dolor ea fugiat",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "ipsum minim consequat",
  "supplier_part_numbers": {
    "et703": [
      "est elit minim eu enim",
      "sint mollit esse do consequat",
      "fugiat in occaecat irure reprehenderit",
      "amet pariatur"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "mollit_3": [
      "Ut elit",
      "adipisicing dolore aute exercitation veniam",
      "magna in consequat laboris nisi",
      "occaecat",
      "velit deserunt irure veniam cillum"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "et elit",
  "supplier_part_numbers": {
    "quise70": ["Excepteur dolore Ut irure nulla", "do incididunt nisi"],
    "ipsum_b": ["velit esse consectetur occaecat", "nisi"],
    "exercitation93": [],
    "ipsum_": ["mollit et cupidatat", "labore in"],
    "proident_d": [
      "est minim",
      "proident",
      "incididunt labore",
      "veniam in nulla proident quis"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "qui laboris proident",
  "supplier_part_numbers": {
    "Ut6": ["ullamco Lorem sed laborum", "exercitation"],
    "inb": ["qui Lorem ad"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "commodo sit culpa minim"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "ut sunt sit",
  "supplier_part_numbers": {
    "ullamco7": [
      "laboris labore Ut Duis",
      "aliqua amet anim est pariatur",
      "non"
    ],
    "aliqua_0f_": ["aliqua", "et dolor in officia occaecat", "in", "deserunt"],
    "magnaac": ["fugiat incididunt laborum", "Ut elit", "aute minim Ut"],
    "sint_b": [
      "in qui Lorem eu",
      "id adipisicing ut",
      "laborum",
      "Ut esse consectetur voluptate proident",
      "laborum aliquip ullamco irure"
    ],
    "cillum17": [
      "culpa",
      "laboris",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "consectetur dolor dolore",
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_net_ids": ["ut aliqua"]
}
```
...
```json
{
  ...
  "message": "voluptate minim eiusmod dolore"
}
```
...
```json
{
  ...
  "color": "reprehenderit cupidatat ipsum exercitation laboris"
}
```
...
```json
{
  ...
  "message": "consectetur velit Excepteur sunt",
...
```json
{
  ...
  "radius_x": -45615535.38853462,
  "radius_y": 47976661.535701305,
  "layer": "top"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "tempor201": [
      "non in aute consequat sint",
      "est occaecat exercitation officia quis",
      "sunt anim labore esse elit"
    ]
  }
}
```
...
```json
{
  ...
  "footprinter_string": "deserunt incididunt non in"
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "Excepteur commodo nisi elit laboris"
}
```
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": "labore consectetur voluptate"
}
```
...
```json
{
  ...
  "sunt8e": {
    "left_margin": 93460141.91977265
  },
  "eu_675": {
    "left_margin": 4463620.577244893,
    "right_margin": "consectetur",
    "top_margin": "ad sit",
    "bottom_margin": 76392119.61009905
  }
}
```
