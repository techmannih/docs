...
```json
{
  ...
  "supplier_part_numbers": {
    "aliquaa": ["minim sunt nisi"],
    "ullamco4b": [
      "nostrud reprehenderit dolor et consectetur",
      "consequat",
      "eu laboris sit nostrud dolor"
    ],
    "incididunt6": [
      "ad adipisicing fugiat laborum aliqua",
      "voluptate aliquip aliqua sunt",
      "qui in sint minim",
      "aute et laborum",
      "dolor aute"
    ],
    "ut_f2": [
      "sint et aliqua reprehenderit qui",
      "ipsum dolore",
      "non aute",
      "occaecat eiusmod ut"
    ]
...
```json
{
  ...
  "name": "L1",
  "supplier_part_numbers": {
    "dolore_ff6": ["nulla", "ad voluptate ullamco", "nulla dolor in pariatur"],
    "commodo_053": [
      "fugiat sunt dolor ut",
      "dolor",
      "in reprehenderit irure ea",
      "id",
      "labore et consequat"
    ]
  }
...
```json
{
  ...
  "member_source_group_ids": [
    "Duis tempor eiusmod occaecat",
    "nostrud magna",
    "aliquip adipisicing fugiat",
    "irure consequat est voluptate mollit"
  ],
  "is_power": true,
  "is_ground": false,
...
```json
{
  ...
  "supplier_part_numbers": {
    "Utb": [
      "consectetur Lorem ipsum sed",
      "Ut Excepteur qui",
      "ad sint in in tempor",
      "ea occaecat aute",
      "do laborum"
    ]
  }
...
```json
{
  ...
  "supplier_part_numbers": {
    "laboris_e": [
      "enim aliqua non",
      "occaecat irure",
      "esse exercitation commodo sint labore",
      "non Excepteur minim"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "name": "G1",
  "supplier_part_numbers": {
    "dolore_ed": ["consectetur dolore quis Duis deserunt"],
    "officia_ff": ["Lorem dolor", "eu dolor dolore", "exercitation mollit"]
  }
}
```
...
```json
{
  ...
  "name": "P1",
  "supplier_part_numbers": {
    "commodo0": ["amet ea veniam nisi", "elit", "Lorem nisi Duis"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ullamco_a2": [
      "dolore commodo incididunt laborum",
      "ullamco pariatur minim magna"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    ...
    "in",
    "incididunt nisi ut in",
    "esse ex veniam mollit laborum"
  ],
  "connected_source_net_ids": ["nostrud fugiat deserunt", "ad qui"]
}
```
...
```json
{
  ...
  "message": "minim esse exercitation aliqua"
}
```
...
```json
{
  ...
  "name": "B1",
  "supplier_part_numbers": {
    "Duis_250": ["ipsum non", "magna laboris anim"]
  }
}
```
