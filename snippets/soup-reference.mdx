...
```json
{
  ...
  "name": "D1",
  "manufacturer_part_number": "occaecat nostrud ad adipisicing minim",
  "supplier_part_numbers": {
    "minim_c7": [
      "ad ea non nisi",
      "consectetur dolore",
      "dolor nisi eiusmod non",
      "sed incididunt fugiat dolore"
    ],
    "ut_9e": ["eiusmod consectetur Ut"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "occaecat dolore",
  "supplier_part_numbers": {
    "inc": ["exercitation commodo"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "proident laboris nostrud Duis adipisicing",
    "nostrud velit",
    "qui",
    "Lorem esse elit reprehenderit"
  ],
  "is_analog_signal": false,
  "trace_width": 33379405.76481317
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "velit id mollit eu",
  "supplier_part_numbers": {
    "exercitation5a": ["proident labore culpa sint laboris"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "pariatur cupidatat tempor enim",
  "supplier_part_numbers": {
    "exercitation47": [
    ...
    "quisca": [
      "velit deserunt",
      "incididunt commodo mollit sint",
      "amet ullamco Lorem deserunt non",
      "aliqua Excepteur sit"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "dolore dolor proident commodo in",
  "supplier_part_numbers": {
    "Lorem_164": ["adipisicing voluptate magna ut ut"],
    "ipsum_f": [
      "dolor labore in",
      "deserunt et mollit",
      "labore anim elit officia veniam"
    ],
    "officia836": ["dolore sit pariatur laborum", "Lorem"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "nulla7": [
      "sint ea Lorem quis",
      "do voluptate minim fugiat",
      "aute cupidatat Excepteur fugiat"
    ],
    "occaecat_640": [
      "quis minim ad",
    ...
    "cillum_6df": [
      "officia Lorem minim voluptate",
      "dolore voluptate dolore magna",
      "Lorem ut adipisicing veniam",
      "mollit Duis nulla",
      "reprehenderit ea in ut"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "laboris officia",
  "supplier_part_numbers": {
    "dolorc": ["voluptate amet sint", "in qui ad dolor ex", "id mollit ea Ut"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "eu voluptate veniam cillum ea",
  "supplier_part_numbers": {
    "non_5b5": [
      "incididunt non dolore dolor",
      "aliquip et laborum proident",
      "qui consectetur dolore",
      "ipsum",
      "nulla dolor commodo culpa sit"
    ],
    "cillum40": ["cupidatat", "labore", "ex pariatur"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "dolore pariatur in labore",
    "eiusmod ex in",
    "cupidatat proident Duis"
  ],
  "connected_source_net_ids": ["amet aliquip in Lorem"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "box_width": "in incididunt sunt enim est",
  "symbol_name": "dolore",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
...
```json
{
  ...
  "message": "aliquip Duis ullamco laboris"
}
```
...
```json
{
  ...
  "radius_x": 32409714.448267877,
  "radius_y": -63253154.233472265,
  "layer": "top"
}
```
  ...
  "route": [
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": 11089058.570978373
    },
    {
      "x": "3mm",
      "y": "1mm"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "in Ut exercitation",
  "supplier_part_numbers": {
    "pariatur1": [
      "in culpa",
      "nulla labore veniam",
      "nisi aute",
      "cupidatat aliqua velit",
      "ex sint officia"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "ea labore in ipsum sed"
  },
  "layer": "top",
  "footprinter_string": "ipsum laboris proident culpa",
  "model_obj_url": "mollit officia eu sint",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 346100.17050535977,
  "outer_height": 9751728.744086117,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "et9": {
    "left_margin": "labore non qui",
    "right_margin": "labore occaecat elit Lorem",
    "bottom_margin": "cillum nulla ex"
  }
}
```
