...
```json
{
  ...
  "name": "C1",
  "manufacturer_part_number": "Lorem deserunt proident",
  "supplier_part_numbers": {
    "cupidatat8c": [
      "ex elit incididunt Lorem",
      "eiusmod in magna",
      "dolore do"
    ],
    "sitdec": [
      "Lorem tempor sed",
      "enim amet",
      "dolore officia ipsum sint laborum",
      "anim"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "Lorem ullamco aliquip sint tempor",
  "supplier_part_numbers": {
    "Ut88": [
      "in sunt non do",
      "eiusmod",
      "et irure ad in Excepteur",
      "mollit culpa consequat Ut Lorem",
      "pariatur ad nisi aliquip"
    ]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "laborum officia ea",
    "laboris dolore cillum",
    "laboris commodo",
    "consectetur commodo do elit aliqua"
  ],
  "is_power": true,
  "is_ground": false,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "sint reprehenderit pariatur aute",
  "supplier_part_numbers": {
    "officiaeae": ["sunt", "amet aliqua ipsum in sunt"],
    "qui_3": [
      "commodo ad",
      "do cillum aliqua labore",
      "voluptate sed qui est",
      "enim exercitation",
      "in cillum dolore Lorem nostrud"
    ],
    "anim_57": ["cillum", "sunt Excepteur est"]
  }
}
```
...
```json
{
  ...
  "name": "G1",
  "supplier_part_numbers": {
    "sed_088": ["non ea nisi", "ut id"],
    "velit_": ["minim magna", "sed dolor aliquip consectetur minim"],
    "exercitation0": [
      "cillum",
      "nostrud nulla dolor non",
      "nulla voluptate deserunt velit exercitation"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "non_0f7": [
      "irure dolore Ut",
      "reprehenderit",
      "in exercitation ullamco deserunt aliqua",
      "consequat",
      "magna nulla ut"
    ]
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "ea consequat culpa",
  "supplier_part_numbers": {
    "laboris9e1": ["elit pariatur aute qui voluptate", "esse", "sed quis"],
    "eufd": [
      "consequat id consectetur aliqua et",
      "dolor est",
      "magna Ut laborum eu",
      "commodo laboris tempor labore"
    ],
    "exercitation_a38": [
      "Ut sint enim ut",
      "irure",
...
```json
{
  ...
  "connected_source_port_ids": ["proident", "sint est nisi dolore"],
  "connected_source_net_ids": [
    "irure reprehenderit dolor",
    "dolore sunt nulla sit"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "enim aute adipisicing",
  "box_width": "commodo et amet deserunt ut",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "radius_x": 15935521.252736166,
  "radius_y": -23522447.3422174,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "Duis consequat do"
}
```
...
```json
{
  ...
  "rotation": "90deg",
  "footprinter_string": "tempor reprehenderit et aute",
  "model_stl_url": "officia",
  "model_3mf_url": "minim dolor"
}
```
