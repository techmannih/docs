...
```json
{
  ...
  "ftype": "dolor adipisicing culpa",
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "dolore nostrud",
  "supplier_part_numbers": {
    "do6": [
      "sed aliqua cillum Ut",
      "Ut irure enim exercitation",
      "elit",
      "consequat aliqua fugiat id"
    ],
    "Excepteur_e9": [
      "velit ex",
      "dolor esse cupidatat",
      "est officia quis enim",
      "aliqua"
    ],
    "in_a3": ["do elit reprehenderit", "do ad"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "sit ullamco quis"
}
```
...
```json
{
  ...
  "trace_width": -14949178.638004974
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "sed reprehenderit in Lorem ut",
  "supplier_part_numbers": {
    "minimf3": [
      "magna sed ullamco adipisicing",
      "aliquip",
      "elit in sed esse",
      "et"
    ],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "dolore consectetur exercitation",
  "supplier_part_numbers": {
    "laboredeb": []
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "culpa occaecat ut veniam in",
  "supplier_part_numbers": {
    "eu_07": ["Duis proident ad ut ullamco"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "anim tempor dolor",
  "supplier_part_numbers": {
    "consequate": ["sint ipsum in elit sit"],
    "id_9": ["ut aliqua in", "labore est aliqua nostrud"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "consectetur dolore ut",
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "nostrud sed",
  "supplier_part_numbers": {
    "non606": [],
    "aliqua_f0e": ["ea Duis ex sunt", "deserunt nisi velit"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["sint ad et consequat culpa"],
  "connected_source_net_ids": [
    "adipisicing",
    "enim esse",
    "aliqua eu nisi aliquip",
...
```json
{
  ...
  "pin_spacing": "Lorem",
  "pin_styles": {},
  "box_width": "sed enim consequat reprehenderit",
  "symbol_name": "sed",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "message": "dolor dolore mollit cillum occaecat"
}
```
...
```json
{
  ...
  "message": "dolore labore Excepteur ut"
}
```
...
```json
{
  ...
  "radius_x": 47647687.595146775,
  "radius_y": "consectetur labore non aliquip",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "veniam sit do consectetur aliquip",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "aliquip in",
  "supplier_part_numbers": {
    "incididunt59": [
      "adipisicing nostrud",
      "incididunt ut in ut",
      "nulla",
      "commodo enim cupidatat"
    ],
    "ina44": [
      "nostrud",
      "culpa",
      "voluptate ea eiusmod dolor sit",
      "ex quis eu eiusmod in",
      "aute anim id"
    ],
    "enim__": ["adipisicing sed in ut"],
    "nostrud_e09": ["in consectetur laborum"],
    "elit_f8": []
  }
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "voluptate laborum nostrud Excepteur"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 21714596.224108502,
  "outer_height": 74103382.74159205,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "animd2": {
    "bottom_margin": 11520938.4448701
  }
}
```
