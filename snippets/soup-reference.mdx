...
```json
{
  ...
  "ftype": "deserunt mollit ut",
  "source_component_id": "source_component_1",
  "name": "D1",
  "supplier_part_numbers": {
    "cillum_c": [
      "eu Lorem non deserunt exercitation",
      "officia nulla",
      "esse ullamco"
    ],
    "Duis4": [
      "aliquip sed occaecat proident ea",
      "ut pariatur consequat in",
      "dolore sint Excepteur",
      "nisi",
      "velit nulla"
    ],
    "ea_335": ["eiusmod cupidatat dolor mollit"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "esse4": [
      "nisi",
      "adipisicing in reprehenderit aliquip",
      "est eiusmod",
      "cupidatat",
      "cupidatat velit tempor"
    ],
    "id_a9": ["ad", "amet ullamco in qui", "ut sint veniam aliqua"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["ut esse Lorem", "nostrud commodo do velit"],
  "is_power": false,
  "is_ground": true,
...
```json
{
  ...
  "name": "B1",
  "supplier_part_numbers": {
    "ut_c": ["reprehenderit incididunt", "nisi officia"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "commodo_2": [
      "tempor",
      "pariatur in",
      "aliquip voluptate irure in ut",
      "in Duis culpa ex aliquip",
      "aliquip pariatur laborum"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "irure_8b2": [
      "consectetur Lorem pariatur quis tempor",
      "labore nulla dolore",
      "non dolore",
      "adipisicing aliqua",
      "dolor et"
...
```json
{
  ...
  "name": "P1",
  "supplier_part_numbers": {
    "ut_50": ["ipsum pariatur culpa veniam irure", "dolore sunt officia"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "name": "R1",
  "supplier_part_numbers": {
    "id_b0": ["incididunt quis do"],
    "laborum2f": [
      "ipsum magna sunt exercitation",
      "in dolore aliquip reprehenderit",
      "consequat nostrud"
    ],
    "adipisicing6": ["aliqua", "pariatur"],
    "non_37": [
    ...
    "enim_c": ["aliquip eu minim tempor", "consequat culpa quis"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "incididunt qui aliqua cupidatat ex",
    "aute",
    "aliquip officia in"
  ],
  "connected_source_net_ids": [
    "magna ad ipsum culpa",
    "reprehenderit non ut sit aliquip",
    "laboris"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "nisi dolor ipsum amet",
  "box_width": "dolore in in",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
