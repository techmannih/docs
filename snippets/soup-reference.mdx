...
```json
{
  ...
  "supplier_part_numbers": {
    "quis_5": ["tempor sed in", "consectetur nisi culpa", "in aute aliqua"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "magna dolor consequat non",
    "reprehenderit tempor officia in amet",
    "nisi id ipsum magna eiusmod",
    "commodo"
  ],
  "is_power": false
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "pariaturc81": [
      "Duis in enim ea ullamco",
      "proident nostrud id",
      "occaecat commodo ut"
    ],
    "quis2": [
      "cillum in fugiat occaecat ipsum",
      "anim quis dolore elit",
      "velit ad exercitation in",
      "officia",
      "sed officia minim reprehenderit magna"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "sed386": ["do mollit laborum enim"],
    "labored4": [
      "reprehenderit aute sint consequat velit",
      "nulla aliquip nostrud",
      "dolore sint quis dolore",
      "ut dolor irure velit ad",
      "elit ut officia occaecat"
    ],
    "exercitation97e": ["ullamco", "Excepteur consequat deserunt"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "name": "D1",
  "supplier_part_numbers": {
    "sit_1": ["commodo ullamco pariatur tempor ex", "magna ut"],
    "nisi26": [
      "elit Ut commodo Lorem",
      "amet dolore labore adipisicing mollit",
      "reprehenderit"
    ],
    "non_2_6": [
      "adipisicing nisi aliqua amet et",
      "anim eu enim",
      "minim",
      "magna dolor sunt",
...
```json
{
  ...
  "name": "G1",
  "supplier_part_numbers": {
    "do877": ["dolore laborum laboris", "eu magna est ut anim"]
  }
}
```
...
```json
{
  ...
  "name": "P1",
  "supplier_part_numbers": {
    "enim6dc": ["laboris exercitation irure magna et"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["dolor aliquip", "quis"],
  "connected_source_net_ids": ["consectetur proident", "cupidatat"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "quis aliquip fugiat",
  "box_width": "irure non",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "message": "exercitation enim aliqua anim"
}
```
...
```json
{
  ...
  "message": "amet reprehenderit cillum ea elit",
  "pcb_trace_id": "pcb_trace_1",
  "source_trace_id": "source_trace_1",
  "pcb_component_ids": ["pcb_component_1"],
...
```json
{
  ...
  "supplier_part_numbers": {
    "et6": [
      "occaecat ut ut qui voluptate",
      "dolore",
      "sed enim",
      "irure Duis ea consequat deserunt",
      "deserunt consequat"
    ]
  },
  "capacitance": "1uF"
