...
```json
{
  ...
  "ftype": "in id in eu officia",
  "source_component_id": "source_component_1",
  "name": "I1",
  "supplier_part_numbers": {
    "nostrud_39": [
      "adipisicing dolore nisi fugiat irure",
      "mollit ut incididunt sint",
      "aliquip commodo in esse",
      "culpa esse ut eu mollit",
      "id dolor proident sit"
    ],
    "dolorea_8": ["id consequat incididunt dolor dolore", "eiusmod"],
    "idfb": [
      "aute",
      "minim labore tempor aliqua consequat",
      "tempor consequat Lorem Ut",
...
```json
{
  ...
  "supplier_part_numbers": {
    "esse_c18": [
      "sunt",
      "Lorem ad officia veniam nostrud",
      "in eu nostrud fugiat dolore"
    ],
    "minim_c1d": [
      "qui anim veniam culpa",
      "est enim incididunt eu",
      "nulla",
      "occaecat aute tempor nisi"
    ],
    "cupidatat_9": [
      "sed non magna ad",
      "ipsum sed pariatur reprehenderit consectetur",
      "exercitation",
      "ut esse ut"
    ],
    "do15": ["consectetur", "pariatur proident"],
    "proident0": ["veniam adipisicing Ut", "velit ut", "cillum qui magna Ut"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "consectetur95": [
      "nisi mollit velit",
      "non dolore et dolore labore",
      "Excepteur officia ut sunt amet",
      "elit dolore"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolor_85": [
      "sunt cillum ut",
      "dolor elit aliqua ad velit",
      "aliquip consequat sint tempor",
      "proident enim Duis amet"
    ],
    "cillum_7a0": [
      "veniam Duis",
      "non nostrud",
      "dolor",
      "ullamco voluptate tempor sint incididunt",
      "elit dolor Lorem consectetur sunt"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "adipisicing non occaecat",
    "amet ipsum cillum deserunt eu",
    "et",
    "Excepteur id est",
    "consequat est"
  ],
  "connected_source_net_ids": [
    "dolor nulla ad sunt exercitation",
    "adipisicing et Ut exercitation ut",
    "enim",
    "dolore"
  ]
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "occaecat culpa irure dolore dolore",
  "box_width": "exercitation dolor ut",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "radius_x": -37568674.304834016,
  "radius_y": -48549780.44987925,
  "layer": "top"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "mollit3": [
      "sunt mollit ullamco",
      "aliqua quis veniam proident velit",
    ...
    "ad_5": [
      "exercitation elit",
      "deserunt mollit ut occaecat aliqua",
      "in adipisicing cillum",
      "consequat in"
    ],
    "Excepteur_7": ["aute ea Duis"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "rotation": "90deg",
  "layer": "top",
  "model_obj_url": "deserunt officia dolore labore enim",
  "model_3mf_url": "do eiusmod quis aliquip",
  "model_jscad": []
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -41842864.36702616,
  "outer_height": -87536427.82723752,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
