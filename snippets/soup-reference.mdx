...
```json
{
  ...
  "supplier_part_numbers": {
    "ex65": [
      "esse Duis",
      "ut dolore ex do",
      "nisi elit consectetur fugiat dolor",
      "ipsum cupidatat"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "labore_7d5": [
      "id enim reprehenderit anim commodo",
      "exercitation eiusmod ut",
      "magna reprehenderit sint sed",
      "sed aliqua",
      "sunt Duis"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "dolor id aliquip nostrud",
  "supplier_part_numbers": {
    "incididunt_52": [
      "ullamco sed qui",
      "commodo officia esse",
      "deserunt culpa qui elit eu"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "consequat id deserunt mollit Duis",
  "supplier_part_numbers": {
    "suntf6e": [
      "ea irure amet magna Excepteur",
      "amet",
      "ad in dolore nulla in",
      "Lorem officia veniam"
    ],
    "non0fc": [
      "tempor minim culpa qui",
      "laborum",
      "tempor",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "consequat in eiusmod",
  "supplier_part_numbers": {
    "consequatb6f": [],
    "voluptate_9d7": [
      "veniam consequat minim eu",
      "sunt nostrud ut voluptate",
      "quis magna ipsum voluptate qui",
      "Lorem veniam"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "esse aliqua ut non",
  "supplier_part_numbers": {
    "in17": ["sunt dolore ex", "in", "cupidatat"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 99619822.40044543,
  "pin_styles": {},
  "box_width": 36796514.61036083,
  "symbol_name": "sed sunt Ut cupidatat",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "sed proident sint amet cillum",
...
```json
{
  ...
  "radius_x": "in officia in Ut",
  "radius_y": "Lorem quis exercitation aliqua",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "laborum est consectetur ut exercitation",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolor_f": [],
    "mollit_3ba": [
      "sint dolor deserunt voluptate",
      "sunt exercitation proident ad",
      "ullamco do voluptate incididunt culpa",
      "quis consequat in fugiat",
      "dolore quis consectetur ad"
    ],
    "mollita5_": ["occaecat est qui aliquip dolore"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "reprehenderit Ut irure amet ex",
  "supplier_part_numbers": {
    "tempor294": [
      "et consectetur laborum magna",
      "qui exercitation ut dolor velit"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "veniam ad Excepteur sint non"
  },
  "layer": "top",
  "model_obj_url": "Duis",
  "model_jscad": {}
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": -15349127.026617587
}
```
...
{
  "dolore9b": {
    "left_margin": -10459320.185276777,
    "top_margin": 62494241.07371464,
    "bottom_margin": 38123764.895146936
  },
  "mollit5": {
    "left_margin": "sed ex est"
  },
  "Excepteur_dd": {
    "left_margin": 6786756.373650253,
    "right_margin": "cillum irure",
    "bottom_margin": 67952323.39060125
  },
  "ex_c6_": {
    "left_margin": "aliquip dolore ad fugiat",
    "right_margin": 82370714.63941264,
    "top_margin": -12918771.98046127
  },
  "autea6a": {}
}
```
