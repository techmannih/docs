...
```json
{
  ...
  "ftype": "id ullamco quis consequat",
  "source_component_id": "source_component_1",
  "name": "I1",
  "manufacturer_part_number": "sit dolor Ut dolore do",
  "supplier_part_numbers": {
    "enim_957": [
      "nulla Ut Lorem aliqua",
      "ea",
      "dolore est labore sed consequat"
    ],
    "labore_a1d": ["ea minim"]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "ad proident"
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["sint eu aliquip dolor proident"],
  "is_power": false,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": false,
  "trace_width": 93918283.13733274
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "laborum labore",
  "supplier_part_numbers": {
    "nullaac": [
      "quis ipsum",
      "dolore culpa sint",
      "in ut minim",
      "irure est laboris ea aliquip"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "fugiat enim esse dolor",
  "supplier_part_numbers": {
    "dolor__4": [
      "in minim",
      "cupidatat ullamco reprehenderit sed Ut",
      "in aliqua ullamco sed",
      "veniam irure ipsum velit amet"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "in consectetur occaecat",
  "supplier_part_numbers": {
    "in8": ["in do ut", "quis eu mollit ut", "nostrud do"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "labore",
  "supplier_part_numbers": {
    "cillume5": [
      "ad consectetur laborum eiusmod aliquip",
      "ut sunt non Excepteur ad",
      "velit",
      "culpa dolore id"
    ],
    "nulla_49": ["Duis", "Duis", "consectetur", "ad"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "in dolor",
  "supplier_part_numbers": {
    "eu_5": [
      "minim aute culpa eiusmod",
      "mollit",
      "aliquip est ex minim",
      "in Excepteur",
      "et Lorem cillum"
    ],
    "ipsum_ab": ["magna nostrud", "ullamco", "irure et"],
    "eiusmod_f31": [
      "in sed consequat id exercitation",
      "deserunt in et dolore culpa",
      "proident",
      "Lorem"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "fugiat proident",
  "voltage": "5V"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "consequat_3": [
      "ea ipsum velit reprehenderit consequat",
      "in irure nulla",
      "ad mollit proident",
      "ea dolor ipsum nulla"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "irure",
    "in laboris dolor cillum",
    "ad nisi laboris magna"
  ],
  "connected_source_net_ids": [
    "culpa officia nostrud ex",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "pariatur qui Excepteur ipsum",
  "symbol_name": "ullamco labore magna eu",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "occaecat in Ut voluptate dolor"
}
```
...
```json
{
  ...
  "message": "exercitation laborum ut nulla proident",
...
```json
{
  ...
  "radius_x": "dolor nulla Duis",
  "radius_y": "minim officia",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "officia occaecat dolor Duis in",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "tempor magna nisi dolore",
  "supplier_part_numbers": {
    "nullae": [
      "adipisicing sed",
      "Duis incididunt aliqua consequat ut",
      "proident",
      "culpa qui incididunt tempor"
    ],
    "adipisicing7b": ["dolor voluptate elit", "voluptate", "nisi"]
  }
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "nostrud labore enim"
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "Ut Lorem Excepteur"
  },
  "layer": "top",
  "footprinter_string": "irure ex fugiat exercitation sunt",
  "model_obj_url": "aliqua",
  "model_stl_url": "officia mollit qui adipisicing anim",
  "model_3mf_url": "fugiat ullamco nostrud est exercitation",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -23526818.288941294,
  "outer_height": 49316959.925280064,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": 38162808.610144526
}
```
...
{
  "Lorem_2d": {
    "left_margin": 15730691.288254842,
    "right_margin": "in labore non proident",
    "top_margin": "id sed Duis",
    "bottom_margin": "elit laboris et"
  },
  "ex_5": {
    "right_margin": "quis",
    "top_margin": 40354154.38536179
  },
  "ea_873": {
    "left_margin": -47952657.13168342,
    "right_margin": 52312783.34858826,
    "bottom_margin": 20781505.444853827
  }
}
```
