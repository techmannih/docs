...
```json
{
  ...
  "member_source_group_ids": [
    ...
    "amet nostrud non Ut voluptate",
    "velit deserunt et ut",
    "sunt adipisicing deserunt et dolore"
  ],
  "is_power": true,
  "is_ground": true,
  "is_digital_signal": false,
  "is_analog_signal": true,
  "trace_width": 43265558.01469353
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "mollit",
  "supplier_part_numbers": {
    "ullamco_d61": [
      "pariatur velit veniam mollit",
      "nulla esse",
      "occaecat exercitation sit",
      "est commodo in"
    ],
    "Excepteur_bf2": ["ad dolor eu"],
    "Duis26f": ["laborum consectetur Ut laboris minim", "nulla labore do"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "reprehenderit dolor quis",
  "supplier_part_numbers": {
    "fugiat2": ["labore velit proident eu", "occaecat id pariatur", "Ut"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ut_04": [
      "ex esse",
      "aute",
      "commodo dolore deserunt reprehenderit officia",
      "magna sunt Lorem Ut",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "irure ullamco culpa deserunt sunt",
  "supplier_part_numbers": {
    "proident_c0d": [
      "Ut Duis sit",
      "eu incididunt Duis occaecat sed",
      "ut veniam aliqua consequat",
      "proident et velit",
      "velit reprehenderit"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "do nulla aute",
  "supplier_part_numbers": {
    "aute_31e": [
      "tempor dolor consectetur exercitation",
      "labore",
      "eu dolor in qui Lorem"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "pariatur sunt exercitation id enim",
  "supplier_part_numbers": {
    "occaecatd9": ["ut labore", "irure adipisicing"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "nulla",
    "labore elit do ex",
    "pariatur veniam consequat esse in"
  ],
  "connected_source_net_ids": [
    "Excepteur anim consectetur",
    "est aliquip Excepteur",
    "officia labore elit",
    "qui in",
    "eu sint"
  ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "deserunt Duis",
  "box_width": "pariatur",
  "symbol_name": "ex do occaecat",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "nostrud do ipsum ullamco"
}
```
...
```json
{
  ...
  "color": "irure Excepteur aute Lorem"
}
```
...
```json
{
  ...
  "message": "cillum laborum exercitation dolore"
}
```
...
```json
{
  ...
  "message": "sint in labore est elit",
  ...
  "route": [
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": "in Lorem minim cillum quis"
    },
    {
      "x": "3mm",
      "via": false,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "enim ad aliquip",
  "supplier_part_numbers": {
    "voluptate7": ["in dolore", "occaecat"],
    "esse9": ["culpa", "Duis in", "ad", "aute officia"]
  }
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "ut sed irure voluptate ea",
  "model_obj_url": "aliqua ipsum cupidatat laborum",
  "model_stl_url": "cillum",
  "model_3mf_url": "tempor aliqua adipisicing",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "dolore officia mollit"
}
```
...
{
  "nulla_d": {
    "top_margin": -86291054.06193474
  },
  "pariatur_4": {
    "left_margin": "incididunt irure laborum magna sed",
    "right_margin": "in",
    "top_margin": "consequat voluptate reprehenderit"
  },
  "nulla_0": {
    "right_margin": -39020422.69216768
  },
  "proident_b7": {
    "right_margin": "est",
    "top_margin": "cupidatat irure Ut eiusmod quis",
    "bottom_margin": "anim"
  },
  "irure_e": {
    "left_margin": "reprehenderit veniam irure tempor",
    "top_margin": 59138122.67633554
  }
}
```
