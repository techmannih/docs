...
```json
{
  ...
  "ftype": "eiusmod commodo",
  "source_component_id": "source_component_1",
  "name": "E1",
  "manufacturer_part_number": "deserunt tempor ad culpa",
  "supplier_part_numbers": {
    "inc3_": [
      "nulla minim magna",
      "velit dolore Lorem",
      "sint exercitation ad proident",
      "proident magna",
      "minim ut nostrud commodo"
    ],
    "commodo_00": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "eiusmod ut in in",
  "supplier_part_numbers": {
    "eiusmod_6": [
      "pariatur irure incididunt",
      "commodo adipisicing",
      "sed reprehenderit ipsum aute laborum"
    ]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "ullamco irure cillum occaecat qui",
    "in pariatur eu"
  ],
  "is_power": true,
  "is_ground": true,
  ...
  "trace_width": 39055108.892423004
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "nostrud enim esse dolore minim",
  "supplier_part_numbers": {
    "aute2f": [
      "enim in",
      "sit aliqua ut in ad",
      "fugiat et sunt velit minim",
      "dolore non Ut ad aute"
    ],
    "fugiat76": [
      "aliquip anim",
      "elit magna voluptate in ipsum",
      "mollit deserunt consectetur Excepteur",
      "aute"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "ullamco nisi minim eiusmod tempor",
  "supplier_part_numbers": {
    "dolor063": ["irure do", "officia", "exercitation anim", "ipsum in ea"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "culpac": ["minim ut do", "elit do ullamco veniam id", "culpa commodo"],
    "consecteturc6": [
      "aliqua dolore Excepteur fugiat aute",
      "cupidatat fugiat",
      "labore Duis ut enim ipsum"
    ]
  }
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "nostrud sit minim fugiat",
    "cupidatat tempor Ut nostrud ad",
    "ut dolor anim",
    "laborum quis ut",
...
```json
{
  ...
  "message": "mollit elit incididunt occaecat voluptate",
...
```json
{
  ...
  "radius_x": -23899541.61640136,
  "radius_y": "dolore voluptate magna laboris",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "dolor irure",
  "supplier_part_numbers": {
    "adipisicing_53": ["mollit aliqua anim sint in", "incididunt consequat"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "minim enim Excepteur magna occaecat"
  },
  "footprinter_string": "Duis id laborum",
  "model_3mf_url": "ullamco tempor cillum in et",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "ullamco enim ut nulla aliqua"
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "Lorem cillum qui esse laboris"
}
```
...
{
  "aliqua_ad": {
    "left_margin": "aliquip adipisicing tempor reprehenderit",
    "bottom_margin": "ipsum est labore voluptate minim"
  }
}
```
