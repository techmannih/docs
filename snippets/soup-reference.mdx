...
```json
{
  ...
  "supplier_part_numbers": {
    "minim4b": ["commodo quis laborum amet", "dolor exercitation in"],
    "anim_8": [
      "ullamco ipsum Ut dolore",
      "ad magna",
      "nulla",
      "ut eu proident"
    ],
    "aute10": [
      "adipisicing sunt in dolor",
      "incididunt et fugiat",
      "fugiat velit quis ut aliqua",
      "enim ad sint dolore"
    ]
  }
}
...
```json
{
  ...
  "member_source_group_ids": [
    "culpa quis",
    "deserunt enim culpa",
    "commodo ullamco enim mollit",
    "sint ex",
    "voluptate sit adipisicing dolore"
  ],
  "is_power": true
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "mollit officia esse",
  "supplier_part_numbers": {
    "nostrud_02": ["nulla", "minim", "in eiusmod", "veniam aliquip qui sed"],
    "magna_1": ["esse pariatur dolor", "ut in", "Ut sed", "et"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "sed minim",
  "supplier_part_numbers": {
    "ipsum_4": [
      "officia labore qui consequat Ut",
      "fugiat nulla amet",
      "tempor enim qui Duis laborum",
      "ad irure id consectetur"
    ],
    "dolore_d3": ["dolore in sit nostrud"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "laboris minim incididunt veniam",
  "supplier_part_numbers": {
    "labore_e": [
      "labore voluptate in ad exercitation",
      "exercitation ut est et pariatur",
      "est reprehenderit dolor qui culpa"
    ],
    "culpa_": ["non do in tempor Ut"],
    "Lorem_e3c": [
      "commodo elit amet aliqua",
      "laborum veniam ipsum",
      "ex ullamco ad ipsum est",
      "ipsum"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "nullac": ["voluptate sunt"],
    "aliqua_97": ["in Excepteur"],
    "dolorf_": ["ea", "proident", "do", "non ad mollit", "culpa"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "tempor ipsum in",
  "supplier_part_numbers": {
    "ut_bc3": ["sit laboris fugiat", "ad dolor dolore est commodo"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "quis dolor eiusmod",
  "supplier_part_numbers": {
    "esse4f": [
      "enim tempor Duis officia aliquip",
      "exercitation",
      "magna sed pariatur ullamco ipsum"
    ],
    "qui_09": [
      "non",
      ...
      "reprehenderit",
      "officia in ex et do",
      "ipsum occaecat laboris consequat"
    ],
    "in59": [
      "dolore laboris elit non",
      "eu dolor incididunt consectetur",
      "in proident",
      "deserunt",
      "in ex minim dolore"
    ]
...
```json
{
  ...
  "connected_source_port_ids": [
    "Ut sit Lorem irure",
    "mollit elit adipisicing exercitation laborum",
    "qui consectetur in incididunt",
    "fugiat",
    "ullamco ea labore quis est"
  ],
  "connected_source_net_ids": ["velit est"]
}
```
...
```json
{
  ...
  "message": "ullamco et cillum dolore ut"
}
```
...
```json
{
  ...
  "radius_x": "dolor ex irure esse Excepteur",
  "radius_y": 43346193.311982095,
  "layer": "top"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "velit9": ["ullamco in", "officia cillum non"],
    "pariatur8": ["mollit labore nulla proident in"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "ut laboris",
  "supplier_part_numbers": {
    "proident_7": ["in cupidatat sed"]
  }
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "incididunt cillum consectetur do"
  },
  "model_stl_url": "dolore cupidatat laboris"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "consequat aliqua elit id"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -78047056.18977685,
  "outer_height": 11286267.024938151,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "do anim Lorem fugiat commodo"
}
```
...
```json
{
  ...
  "via": false,
  "to_layer": "bottom",
  "trace_width": 57711283.317551225
}
```
...
{
  "sunt4": {
    "left_margin": "Lorem do sint",
    "right_margin": "Duis tempor Lorem culpa"
  }
}
```
