...
```json
{
  ...
  "ftype": "esse fugiat id aliqua sunt",
  "source_component_id": "source_component_1",
  "name": "E1",
  "manufacturer_part_number": "commodo nisi",
  "supplier_part_numbers": {
    "temporb": [
      ...
      "in",
      "in fugiat",
      "mollit do commodo elit"
    ],
    "cillume0b": [
      "irure officia non magna",
      "deserunt nulla magna consectetur proident",
      "in commodo dolor Ut",
      "mollit"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "cillum Ut exercitation est id",
  "supplier_part_numbers": {
    "aliquada8": [
      "anim pariatur quis in adipisicing",
      "dolor dolore in fugiat",
      "incididunt id aliquip tempor ut",
      "sit eu Excepteur dolor"
    ]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    ...
    "labore",
    "enim ad",
    "cupidatat elit culpa sint"
  ],
  "is_power": true,
  "is_digital_signal": false,
  "trace_width": -93598897.53799209
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "esse deserunt eiusmod eu",
  "supplier_part_numbers": {
    "irure_1a": [
      "in sunt nostrud",
      "ex qui est",
      "qui eiusmod aliquip nulla",
      "dolor ut fugiat Ut",
      "ad non"
    ],
    "aliqua__": ["id", "et irure ipsum eu", "eu minim"]
  }
}
```
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "deserunt_9a2": ["qui sit aliquip", "sed commodo eiusmod reprehenderit in"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "consequat in aute Ut",
  "supplier_part_numbers": {
    "in_e": [
      "tempor proident qui minim",
      "tempor",
      "dolor nulla cupidatat Excepteur deserunt",
      "minim qui",
      "elit tempor ipsum"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "mollit occaecat esse dolore in",
  "supplier_part_numbers": {
    "velit_49": [
      "veniam",
      "cupidatat enim anim consectetur laborum",
      "velit qui sint cupidatat",
      "incididunt deserunt ut voluptate eiusmod",
      "ullamco sint"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "in consequat",
  "supplier_part_numbers": {
    "enim_7": ["in eiusmod ea deserunt"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "ex non",
  "supplier_part_numbers": {
    "ex46a": [
      "in non",
      "sunt ex amet",
      "occaecat exercitation sint adipisicing",
      "ad enim culpa"
    ],
    "nisic4": [
      "nisi est proident",
      "culpa aliqua dolore velit ad",
      "in nostrud"
    ],
    "doloree": ["qui nostrud dolor", "consectetur ad exercitation", "id quis"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["sit mollit in"],
  "connected_source_net_ids": [
    "voluptate cillum est Excepteur",
    "amet veniam Ut elit",
    "tempor labore",
    "sunt esse non ullamco",
...
```json
{
  ...
  "pin_spacing": "dolore",
  "pin_styles": {},
  "box_width": 9996187.384095952,
  "symbol_name": "laboris mollit eiusmod qui nulla",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "exercitation laboris Excepteur"
}
```
...
```json
{
  ...
  "message": "exercitation aliqua veniam",
...
```json
{
  ...
  "radius_x": 79270409.02361017,
  "radius_y": 98250881.8001875,
  "layer": "top"
}
```
...
```json
{
  ...
  "radius_x": -60131590.617759965,
  "radius_y": "exercitation ex veniam",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "reprehenderit commodo",
  "supplier_part_numbers": {
    "laboris20b": ["dolor ipsum dolore sunt"],
    "non_2d": [
      "ad in Lorem",
      "pariatur nostrud quis",
      "in exercitation cupidatat Duis Ut"
    ]
  }
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "consectetur qui esse deserunt mollit",
  "model_obj_url": "velit",
  "model_stl_url": "esse exercitation deserunt fugiat occaecat",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 69417465.55538711,
  "outer_height": -13109025.825922057,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "via": false,
  "to_layer": "bottom",
  "trace_width": "Ut pariatur elit non"
}
```
...
{
  "et_e09": {
    "top_margin": "consectetur",
    "bottom_margin": "adipisicing aliqua aute officia"
  },
  "in563": {
    "left_margin": -90638960.51275554,
    "right_margin": "laboris proident mollit occaecat dolore",
    "top_margin": -32810773.526420698
  }
}
```
