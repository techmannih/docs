...
```json
{
  ...
  "ftype": "nostrud amet adipisicing",
...
```json
{
  ...
  "supplier_part_numbers": {
    "mollit_ef_": [
      "sed tempor dolore esse",
      "dolor qui",
      "pariatur et",
      "irure Duis"
    ],
    "elit_2": ["reprehenderit laboris aliquip"],
    "sit__c": ["occaecat", "ut aute ut"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "enim proident voluptate dolore",
    "enim minim proident Excepteur irure"
  ]
}
```
...
```json
{
  ...
  "name": "B1",
  "supplier_part_numbers": {
    "dolor_4e2": ["quis est ullamco", "culpa dolore et"],
    "consectetur3": ["sit dolor irure"],
    "enim205": [
      "quis ut velit adipisicing laboris",
      "amet cupidatat et",
      "aute sunt amet",
      "amet ipsum sit"
    ]
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "proident__": ["Ut mollit cupidatat ut"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "cupidatat1": [
      "ex veniam",
      "quis in sit amet",
      "anim labore nostrud exercitation dolor"
    ],
    "Lorem_e": [
      "dolore Duis",
      "labore",
      "sed",
      "sunt velit aute nisi incididunt",
      "ipsum qui sed"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "sint_4fb": [
      "aliquip et eu sint sit",
      "laboris",
      "dolor Duis",
      "cillum",
      "Duis eiusmod irure nostrud elit"
    ],
    "esse8": ["ex", "ut"],
    "enime": ["id eiusmod enim fugiat nisi"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "aute_f_3": [
      "commodo anim",
      "aliquip",
      "consequat Ut sint nulla elit",
      "dolor tempor consequat officia ea",
      "ad laborum id"
    ]
  },
  "voltage": "5V"
...
```json
{
  ...
  "supplier_part_numbers": {
    "laborum96": [
      "mollit ullamco enim",
      "elit",
      "esse voluptate eu magna",
      "tempor aliquip amet sint",
      "sunt minim"
    ],
    "sint_f3": [
      "veniam nisi proident",
      "consectetur cillum ut minim",
...
```json
{
  ...
  "connected_source_port_ids": ["in sunt dolore minim sit"],
  "connected_source_net_ids": [
    "consectetur aliquip Duis exercitation",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "cupidatat esse ad",
  "box_width": "irure sint officia anim do",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "non et ipsum sit adipisicing",
  "pcb_trace_id": "pcb_trace_1",
  "source_trace_id": "source_trace_1",
  "pcb_component_ids": ["pcb_component_1"],
...
```json
{
  ...
  "supplier_part_numbers": {
    "eufc": [
      "occaecat Excepteur dolore tempor",
      "eiusmod mollit occaecat minim qui"
    ],
    "ut6dc": ["commodo Ut"],
    "officia_2_": [
      "officia nostrud aliquip",
      "consectetur ut est quis",
      "id aliquip nulla",
      "sit",
      "labore amet ex"
    ]
...
```json
{
  ...
  "footprinter_string": "in anim",
  "model_obj_url": "aliqua ad"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -85801696.45218655,
  "outer_height": 15547183.404019281,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
