...
```json
{
  ...
  "ftype": "ad do occaecat",
  "source_component_id": "source_component_1",
  "name": "A1",
  "manufacturer_part_number": "qui",
  "supplier_part_numbers": {
    "consectetur6": [
      "esse fugiat qui ad ex",
      "voluptate qui",
      "occaecat",
      "laborum mollit deserunt laboris elit"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "nostrud qui sed exercitation Lorem",
  "supplier_part_numbers": {
    "pariatur92c": [
      "sint",
      "ipsum",
      "est ex consectetur anim",
      "eiusmod sed qui",
      "culpa in cillum enim"
    ],
    "ea7": [
      "eiusmod tempor",
      "ut eiusmod laborum dolor do",
      "cupidatat mollit labore"
    ],
    "quica4": [
      "ullamco cupidatat sint",
      "in sed Excepteur adipisicing",
      "nostrud ipsum nulla id proident"
    ]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["ea irure officia elit"],
  "is_power": true,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": 5821106.178873464
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "id magna do in ut",
  "supplier_part_numbers": {
    "aliqua__a": ["incididunt", "consectetur", "qui nostrud incididunt"],
    "sed1a": ["est"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ad magna enim",
  "supplier_part_numbers": {
    "aliquipd47": [
      "culpa ut occaecat",
      "tempor",
      "esse consequat eu labore",
      "culpa anim"
    ],
    "auteff": ["voluptate ullamco veniam proident dolor"],
    "in_0": ["commodo", "officia qui Duis", "ut", "nulla laborum tempor quis"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "consectetur exercitation",
  "supplier_part_numbers": {
    "elit3d9": ["ut eu ullamco elit", "irure", "sint"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "adipisicing in proident",
  "supplier_part_numbers": {
    "enim_a0": ["est"],
    "eae": [
      "amet in enim",
      "mollit dolor occaecat esse exercitation",
      "proident id et cillum",
      "veniam ut tempor"
    ],
    "quis5e3": ["laborum", "pariatur quis", "enim ea in eu irure"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "aliquip deserunt nostrud non",
  "supplier_part_numbers": {
    "laborum_2": [
      "dolor Ut in laborum",
      "ut ea eiusmod Lorem quis",
      "id exercitation consectetur sunt",
      "deserunt",
      "est mollit"
    ]
  }
...
```json
{
  ...
  "connected_source_port_ids": [
    "sit nostrud pariatur",
    "Duis deserunt in",
    "esse"
  ],
  "connected_source_net_ids": ["minim deserunt", "Ut dolor"]
}
```
...
```json
{
  ...
  "radius_x": "mollit commodo",
  "radius_y": 96885713.05581841,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "elit in ea cupidatat dolor",
  "supplier_part_numbers": {
    "cillum5": ["dolore Ut enim", "Lorem deserunt velit exercitation"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "adipisicing ipsum labore proident"
  },
  "rotation": "90deg",
  "model_stl_url": "do cupidatat",
  "model_3mf_url": "exercitation ea veniam aute in"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 29305591.296110883,
  "outer_height": 426987.81816779077,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "via": false,
  "to_layer": "bottom",
  "trace_width": "officia Lorem mollit cupidatat"
}
```
...
{
  "amet73": {
    "left_margin": "do laborum ea irure est",
    "right_margin": -94443227.62652665,
    "top_margin": 74995693.15155175
  },
  "qui_8": {
    "left_margin": "velit in exercitation commodo Duis",
    "right_margin": 88859536.93778852,
    "top_margin": "aliquip enim",
    "bottom_margin": "aliquip irure ullamco dolor Lorem"
  },
  "ullamco165": {
    "left_margin": "ipsum ea",
    "right_margin": "dolor laborum ea aliqua sit"
  },
  "laboris__": {
    "left_margin": 32460977.7520843,
    "right_margin": "veniam"
  },
  "adipisicing_5f": {
    "left_margin": "laboris consectetur do Excepteur",
    "right_margin": "ut"
  }
}
```
