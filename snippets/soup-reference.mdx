...
```json
{
  ...
  "ftype": "aliquip commodo",
  "source_component_id": "source_component_1",
  "name": "A1",
  "supplier_part_numbers": {
    "eiusmod082": [
      "eiusmod Excepteur adipisicing ut",
      "eiusmod ad",
      "cupidatat dolore elit",
      "occaecat",
      "tempor esse ut dolor labore"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ea_6a0": [
      ...
      "in dolor ea occaecat cillum"
    ],
    "nulla8": ["enim reprehenderit officia sint quis"],
    "elit_316": [
      "aliquip sit",
      "sed",
      "ex proident",
      "dolor officia ipsum pariatur sint"
    ],
    "ad_8": ["eu", "adipisicing", "reprehenderit voluptate nisi"],
    "incididunt8c8": ["in", "aute"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "consectetur_91": [
      "non ut labore",
      "Duis ad ex ut fugiat",
      "laboris in",
      "aliquip sint aute Excepteur Ut",
      "reprehenderit exercitation"
    ],
    "fugiatb": [
      "minim exercitation proident Duis officia",
      "id cupidatat proident",
      "minim",
      "quis qui pariatur aliqua aute"
    ]
  }
}
```
...
```json
{
  ...
  "name": "D1",
  "supplier_part_numbers": {
    "adipisicing63a": ["elit laboris sint pariatur dolore"],
    "occaecat99": [
      "est",
      "Excepteur veniam Lorem dolor minim",
      "deserunt officia laboris velit",
      "tempor"
    ],
    "ipsumbd1": [
      "do",
      "esse labore dolor",
      "qui reprehenderit labore non dolor",
      "pariatur ea cillum"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "laborum0bc": [
      "qui id mollit Duis nisi",
      "elit proident exercitation do cillum",
      "consectetur dolor aliquip reprehenderit"
    ],
    "eiusmod_42": ["qui", "deserunt proident"],
    "reprehenderit55": ["anim exercitation", "Ut qui voluptate"]
  }
}
```
...
```json
{
  ...
  "name": "P1",
  "supplier_part_numbers": {
    "eiusmod19a": ["culpa officia"],
    "do_a8_": ["nulla consectetur Ut fugiat", "fugiat amet"],
    "deseruntc": ["consectetur voluptate et commodo"],
    "sunt6_e": ["laboris minim"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["in ut velit", "magna Excepteur"],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -88431303.61644316,
  "box_width": 38637902.280090064,
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  }
...
```json
{
  ...
  "message": "in in ipsum labore fugiat",
...
```json
{
  ...
  "name": "R1",
  "supplier_part_numbers": {
    "do_15e": ["sit in", "in laborum aliquip sed", "enim Lorem", "Lorem"],
    "incididunt_018": [
      "ut eiusmod",
      "ex aliqua",
      "velit commodo et aliquip sint",
      "ea nulla amet labore incididunt"
    ],
    "proident_4": ["incididunt"],
    "est092": ["id elit"]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 82110377.63514888,
  "outer_height": -14178729.976653948,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
