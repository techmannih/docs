...
```json
{
  ...
  "supplier_part_numbers": {
    "labore_1c": ["culpa qui tempor sit"],
    "id_": ["Duis aute voluptate"],
    "cillum_52e": ["anim eiusmod"]
  }
}
```
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "nisi2": ["officia", "est irure do dolor"],
    "aliqua_12_": ["mollit non dolor", "esse cupidatat non ullamco"],
    "animad_": [
      "voluptate ullamco laboris non minim",
      "pariatur nostrud amet ea",
      "cillum",
      "est deserunt exercitation irure",
      "amet ut Ut Excepteur"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "name": "D1",
  "supplier_part_numbers": {
    "incididunt_a9": ["commodo", "eiusmod nisi", "nisi proident quis"],
    "sint_1": [
      "culpa magna elit dolor",
      "ex",
      "in pariatur ad labore",
      "occaecat cupidatat dolor ex"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "incididunt4b": [
      "in mollit quis occaecat tempor",
      "exercitation cillum in",
      "Lorem aliqua et"
    ]
  }
}
...
```json
{
  ...
  "name": "P1",
  "supplier_part_numbers": {
    "reprehenderit_fcc": ["esse cillum", "aute"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "name": "R1",
  "supplier_part_numbers": {
    "velit06": ["veniam qui ea", "laboris veniam"],
    "exercitation_a3": ["voluptate eu"],
    "fugiat_c": [
      "do qui ad ipsum sit",
      "officia non",
      "dolor sed eu",
...
```json
{
  ...
  "connected_source_port_ids": ["fugiat ad exercitation eiusmod reprehenderit"],
  "connected_source_net_ids": [
    "culpa amet enim sed velit",
    "do eiusmod enim magna dolor",
    "in in Excepteur elit culpa"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 8674940.520688683,
  "box_width": "non veniam"
}
```
...
```json
{
  ...
  "message": "proident laborum Duis nisi dolore"
}
```
...
```json
{
  ...
  "radius_x": -39296183.74370661,
  "radius_y": -48177397.1305798,
  "layer": "top"
}
```
...
```json
{
  ...
  "name": "D1",
  "supplier_part_numbers": {
    "minim_3c4": ["et non dolore occaecat", "voluptate sed sit sint proident"],
    "Lorem_beb": [
      "minim veniam magna esse",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "dolor laborum in officia voluptate"
}
```
