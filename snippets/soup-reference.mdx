...
```json
{
  ...
  "supplier_part_numbers": {
    "estf5": ["labore sunt officia", "dolor adipisicing nostrud ut"],
    "amet_fd": [
      "qui ut id tempor dolore",
      "quis ad sunt mollit",
      "nostrud sunt tempor ea culpa"
    ],
    "cupidatat__a0": [
      "velit ad nisi aute",
      "aliqua nulla",
...
```json
{
  ...
  "name": "L1",
  "supplier_part_numbers": {
    "nisi_5": ["enim ad culpa", "commodo cillum tempor"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "nostrud ea Ut",
    "dolor sunt",
    "est eiusmod aute dolor officia",
    "cupidatat ut"
  ],
  "is_power": false,
  "is_ground": false,
...
```json
{
  ...
  "supplier_part_numbers": {
    "amet71": [
      "do",
      "eiusmod dolor eu elit mollit",
      "do dolor ex aute aliqua",
      "laborum dolore est",
      "anim et ad mollit id"
    ],
    "sunt_1": ["aliqua sunt commodo elit"],
    "Utbd": [
      "laboris dolore consectetur nulla cupidatat",
      "aute minim aliqua tempor veniam",
      "dolore velit amet sit",
      "incididunt do",
...
```json
{
  ...
  "supplier_part_numbers": {
    "magna_1": [
      "mollit Duis sit",
      "incididunt",
      "laboris est deserunt aute",
      "deserunt in officia exercitation",
      "Lorem ullamco Excepteur"
    ],
    "anim_8b9": ["labore commodo", "in officia veniam do"],
    "elitd0a": [
...
```json
{
  ...
  "supplier_part_numbers": {
    "consectetur_96e": [
      ...
      "eiusmod commodo ut culpa pariatur",
      "ullamco Duis esse ut",
      "ea occaecat",
      "eu"
    ],
    "aliquaa7": [
      ...
      "pariatur voluptate",
      "laboris",
      "reprehenderit pariatur proident est",
      "cillum id esse"
    ],
    "Excepteur8": ["nostrud anim labore adipisicing eu"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "aliquip1f3": [
      "pariatur qui Lorem do",
      "aliquip",
      "Lorem exercitation sunt ex in",
      "nulla sed irure quis",
      "labore"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": [
    "do in",
    "anim",
    "qui dolor sint Ut reprehenderit",
    "in sit Excepteur"
  ],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 69246228.71596217,
  "box_width": 91525071.92936578,
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "message": "laboris aliquip mollit officia eu"
}
```
...
```json
{
  ...
  "message": "sint consectetur Excepteur irure esse"
}
```
...
```json
{
  ...
  "message": "ipsum nostrud sunt laborum proident",
...
```json
{
  ...
  "message": "aute adipisicing eiusmod",
  "pcb_trace_id": "pcb_trace_1",
  "source_trace_id": "source_trace_1",
  "pcb_component_ids": ["pcb_component_1"],
...
```json
{
  ...
  "name": "R1",
  "supplier_part_numbers": {
    "labore5": ["ullamco et sed", "officia", "commodo non Duis"],
    "laboris_735": [
      "sint in ullamco",
      "nisi quis",
      "elit fugiat eiusmod",
      "cillum tempor adipisicing quis fugiat",
      "quis"
    ],
    "nullaaa": ["Duis", "elit ad enim veniam", "culpa Ut ut qui"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 35404881.099766344,
  "outer_height": -2961751.742090434,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
