...
```json
{
  ...
  "name": "U1",
  "manufacturer_part_number": "tempor quis"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "uta28": [
      "amet proident dolore",
      "magna dolore sed",
      "labore in aliquip nisi"
    ]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "dolore consectetur",
    "Duis occaecat dolore do",
    "ullamco non Excepteur ea",
    "eu nulla",
    "occaecat"
  ],
  "is_power": true,
  "is_analog_signal": true,
  "trace_width": 63709592.316034645
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "enim nulla consectetur ipsum",
  "supplier_part_numbers": {
    "in__": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "dolor dolor Ut nulla",
  "supplier_part_numbers": {
    "adipisicing60": []
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "in sint",
  "supplier_part_numbers": {
    "mollit7c4": [],
    "incididunt_": ["ea nostrud amet", "est occaecat ad sint irure"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "dolore sunt",
  "supplier_part_numbers": {
    "occaecat_78": [
      "Ut proident",
      "reprehenderit fugiat mollit in",
      "occaecat nisi aliquip",
      "enim qui",
      "nulla adipisicing"
    ],
    "reprehenderit_6e": [
      "sint proident enim ut sit",
      "ut dolore Excepteur",
      "consectetur velit elit",
      "enim pariatur in ut deserunt",
      "exercitation"
    ],
    "eiusmod_48": ["fugiat Lorem pariatur sunt"],
    "qui9": [
      "veniam",
      "velit do aliquip aliqua et",
      "dolor",
      "enim eiusmod Ut minim",
      "elit do velit sunt"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "Duis minim exercitation consequat",
  "supplier_part_numbers": {
    "cupidatat858": ["ex eiusmod", "ipsum mollit", "eiusmod fugiat ex sed"],
    "adipisicing86c": ["officia veniam", "cillum in", "aliqua", "irure"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "velit laborum",
  "supplier_part_numbers": {
    "nisi_a64": ["aute", "cupidatat exercitation Ut"],
    "Excepteur_4": ["commodo est sunt in sit"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["mollit eu", "in cupidatat laborum voluptate"],
  "connected_source_net_ids": ["consequat ut cillum"]
}
```
...
```json
{
  ...
  "message": "occaecat fugiat quis Lorem",
...
```json
{
  ...
  "radius_x": -33205666.848976053,
  "radius_y": "consectetur occaecat cupidatat in",
  "layer": "top"
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "nostrud cupidatat Excepteur"
  },
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "aute consectetur commodo"
  },
  "model_jscad": {}
}
```
...
{
  "amet_9d": {
    "left_margin": "amet voluptate cillum adipisicing",
    "top_margin": "aliquip Duis minim"
  },
  "in_e": {
    "left_margin": "dolore ut nisi consectetur",
    "right_margin": 66833088.5378122,
    "top_margin": -62785719.444505215
  },
  "ut__": {}
}
```
