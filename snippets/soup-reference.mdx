...
```json
{
  ...
  "name": "A1",
  "manufacturer_part_number": "commodo minim eu do",
  "supplier_part_numbers": {
    "dolore_6": [
      "ex cillum",
      "consequat voluptate cillum qui quis",
      "voluptate",
      "consectetur ipsum elit in"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "pariatur esse ullamco ut eiusmod",
  "supplier_part_numbers": {
    "aliquipf93": [
      "aliquip tempor officia ut",
      "non enim fugiat cupidatat",
      "nisi ipsum exercitation nulla"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "Lorem ad",
  "supplier_part_numbers": {
    "ut41": ["magna", "esse adipisicing magna", "aute quis cillum et"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "aliquip consectetur",
  "supplier_part_numbers": {
    "exercitation_f": ["nisi fugiat laboris", "mollit in nisi", "in ut"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "anim",
  "supplier_part_numbers": {
    "qui_568": [
      "magna laboris commodo aute eu",
      "Excepteur",
      "nulla ipsum nisi exercitation"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "dolore sunt dolor magna",
  "supplier_part_numbers": {
    "consectetur_1b": ["enim laboris dolor"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "aliqua est",
  "supplier_part_numbers": {
    "suntb": [
      "culpa veniam reprehenderit aute",
      "ad aute",
      "quis voluptate",
      "laborum dolore ut aliquip",
      "ad sed aute veniam"
    ],
    "cillumf5": ["nisi qui", "Lorem sed", "velit", "consequat"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "sit labore amet reprehenderit dolore",
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "amet Duis in pariatur",
  "supplier_part_numbers": {
    "in_a77": [
      "laborum proident tempor",
      "veniam nulla culpa",
      "magna ad deserunt pariatur",
      "non cupidatat velit ea",
      "aliqua id deserunt dolor non"
    ],
    "laborum1": [
      "nisi velit",
      "tempor nulla culpa in Ut",
      "Lorem voluptate id aliqua",
      "laboris"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": [
    "in Duis",
    "nostrud et cupidatat officia ullamco",
    "ipsum",
    "consectetur",
    "mollit adipisicing laborum esse reprehenderit"
  ],
  "connected_source_net_ids": [
    "tempor qui mollit",
    "minim enim incididunt",
    "Excepteur fugiat dolore elit",
    "reprehenderit"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 58069260.702669114,
  "pin_styles": {},
  "box_width": "in magna",
  "symbol_name": "in dolore do est",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "ad consectetur commodo"
}
```
...
```json
{
  ...
  "message": "in nostrud cillum sunt",
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolor_8c": [
      ...
      "esse deserunt dolor do irure",
      "ut elit nulla"
    ],
    "culpa_62": ["quis", "ipsum ad labore cillum dolore", "mollit"]
  }
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "ad sint Lorem reprehenderit"
  },
  "rotation": "90deg",
  "layer": "top",
  "footprinter_string": "Duis exercitation dolore id",
  "model_3mf_url": "eiusmod laboris adipisicing"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -61761327.350925125,
  "outer_height": -15022067.054021135,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "sunt_44a": {
    "left_margin": 65214605.50466469,
    "bottom_margin": "quis"
  },
  "nulla7": {
    "right_margin": -26683573.26437208
  },
  "mollit0": {
    "right_margin": "sit"
  }
