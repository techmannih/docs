...
```json
{
  ...
  "ftype": "labore dolore tempor non in",
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "Ut commodo consequat",
  "supplier_part_numbers": {
    "cupidatat91": ["culpa adipisicing magna", "nisi commodo in"],
    "dolor942": ["consectetur nisi occaecat", "laboris tempor sed"],
    "nulla_4": ["quis", "fugiat", "nostrud enim non", "enim reprehenderit"],
    "quif": []
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "adipisicing Duis aute cupidatat dolore",
  "supplier_part_numbers": {
    "sed1c2": ["ea ex ad in aliquip"],
    "occaecat85": [
      "mollit incididunt ullamco eiusmod proident",
      "amet aliqua",
      "in",
      "dolor mollit laborum magna aliqua"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "incididunt_8": [
      "ut Duis dolor dolor sed",
      "Duis reprehenderit enim fugiat"
    ],
    "reprehenderit_ae": [
      "ut adipisicing sunt",
      "minim ex reprehenderit cillum"
    ],
    "incididunt7": ["consequat consectetur ut aute"],
    "consectetur_b5c": [
      "laboris sint",
      "culpa mollit minim",
      "sed Excepteur magna exercitation",
      "in enim",
      "ut"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "veniam dolore est",
  "supplier_part_numbers": {
    "reprehenderit8": ["Duis"],
    "adf_c": []
  },
...
```json
{
  ...
  "supplier_part_numbers": {
    "consectetur5b6": [
      "irure mollit",
      "ex tempor dolore aute cillum",
      "quis sed"
    ],
    "sed1d9": [
      "cillum consectetur Excepteur adipisicing exercitation",
      "commodo proident ut anim veniam",
      "cillum aliquip elit anim",
      "sit aliquip sunt"
    ],
    "ea1e9": [
      "laboris elit commodo cillum culpa",
      "ullamco elit consequat eiusmod",
      "deserunt ut Lorem ex sint",
      "eu cillum in",
      "ullamco Duis voluptate nulla labore"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "officia elit Lorem minim",
  "supplier_part_numbers": {
    "Excepteur_92d": [],
    "in_7c": [],
    "incididunt0a": ["dolore quis"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "non officia dolore sunt",
  "supplier_part_numbers": {
    "eiusmod_879": [
      "velit sunt tempor proident est",
      "cillum ad mollit",
      "sunt",
      "aliquip eu mollit irure officia",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "deserunt eu reprehenderit laborum",
  "supplier_part_numbers": {
    "in_603": ["amet fugiat ullamco", "dolore", "ut velit"],
    "doe": [
      "aute consequat magna culpa",
      "irure ex consectetur aliquip",
      "laboris proident cupidatat do",
      "fugiat velit in"
    ]
  },
  "voltage": "5V"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "amet sit minim ea",
  "supplier_part_numbers": {
    "adipisicinga3": ["incididunt in anim consectetur", "in", "velit"],
    "pariatur0": [
      "veniam sint officia",
      "dolore mollit aute",
      "deserunt ullamco ut laborum veniam",
      "culpa veniam aute ut reprehenderit"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": ["aute dolore nostrud"],
  "connected_source_net_ids": [
    "ea sit elit anim",
    "tempor consequat sunt mollit cillum",
    "ea commodo pariatur veniam",
    "elit dolor ad",
    "sed anim laboris sit"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "aliquip tempor eiusmod ut dolore",
  "pin_styles": {},
  "box_width": -49446599.24353249,
  "symbol_name": "eiusmod sint",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "qui ut consequat nostrud"
}
```
...
```json
{
  ...
  "message": "nisi culpa ex eu deserunt"
}
```
  ...
  "route": [
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": "ut laboris dolore officia sint"
    },
    {
      "x": "3mm",
      "y": "1mm",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "dolor ipsum",
  "supplier_part_numbers": {
    "aute18": ["cillum id sunt nulla", "ea in Ut aute", "ut proident"],
    "dolor3c": ["id", "nulla"]
  }
}
```
