...
```json
{
  ...
  "ftype": "minim esse exercitation anim eu",
  ...
  "supplier_part_numbers": {
    ...
    "ipsum_b39": ["officia commodo ut", "ex nostrud enim do veniam"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "amet aute tempor",
  "supplier_part_numbers": {
    "adipisicing_": ["anim", "in cupidatat id proident ad"],
    "ullamco24": [
      "anim ullamco",
      "esse",
      "sed",
      "in ipsum laboris magna",
      "laborum"
    ],
    "idace": ["pariatur", "dolor", "est", "pariatur aliqua", "ex Lorem ut"],
    "id2e": [
      "Ut qui proident tempor velit",
      "magna in",
      "ad sed consectetur irure esse"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "Excepteur Ut",
  "supplier_part_numbers": {
    "in_db": ["amet aliquip", "laboris ut ex consequat ut"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "amet sed sint nostrud",
  "supplier_part_numbers": {
    "ut_7d6": [
      "in quis laborum",
      "minim occaecat ullamco enim",
      "sed ex",
      "aute minim nulla ullamco"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "Ut dolor nulla minim",
  "supplier_part_numbers": {
    "sed_b44": [
      "laborum sed sunt",
      "labore qui reprehenderit dolore minim",
      "anim ut",
      "ad id est nulla",
      "dolor"
    ],
    "irure904": ["sunt eiusmod minim in", "ad"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "dolorecad": [
      "cillum et",
      "id eiusmod est proident",
      "exercitation aliquip",
      "ea aliquip cupidatat fugiat mollit"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "minim in ex tempor ut",
  "supplier_part_numbers": {
    "dolorb35": ["ex", "commodo", "mollit"],
    "qui_d5d": ["esse commodo consequat Excepteur sunt"],
    "minim_f": ["ea", "qui"],
    "cupidatat0": [
      "cillum enim non do",
      "ipsum",
      "proident ipsum eu adipisicing",
      "ut Excepteur ex esse"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    ...
    "laborum sed commodo",
    "magna tempor ex sit",
    "ea ut veniam nulla pariatur"
  ],
  "connected_source_net_ids": ["esse adipisicing ipsum sed"]
}
```
...
```json
{
  ...
  "message": "aliqua Lorem elit consectetur ex",
...
```json
{
  ...
  "radius_x": -14251055.40179436,
  "radius_y": "dolore officia",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "deserunt consequat cupidatat",
  "pcb_trace_id": "pcb_trace_1",
  "source_trace_id": "source_trace_1",
  "pcb_component_ids": ["pcb_component_1"],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "consectetur eiusmod",
  "supplier_part_numbers": {
    "ipsum7": ["fugiat non in", "sint proident culpa ea"],
    "in11": ["officia nisi consectetur aute"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "footprinter_string": "veniam amet Lorem sint cupidatat",
  "model_obj_url": "Ut dolor nisi consequat",
  "model_stl_url": "labore",
  "model_3mf_url": "non occaecat laborum nisi"
}
```
...
```json
{
  ...
  "layer": "top",
  "description": "minim ex fugiat deserunt",
  "shape": "rect",
  "x": "3mm",
  "y": "1mm",
  "width": "5mm",
...
```json
{
  ...
  "via": false,
  "to_layer": "bottom",
  "trace_width": 56309412.070679486
}
```
