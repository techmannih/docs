...
```json
{
  ...
  "ftype": "velit eu deserunt dolor",
  "source_component_id": "source_component_1",
  "name": "V1",
  "manufacturer_part_number": "amet est voluptate minim"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "et laborum id proident",
  "supplier_part_numbers": {
    "labore_1af": [
      "sit Excepteur culpa fugiat",
      "Lorem pariatur dolor dolor velit"
    ]
  }
}
```
...
```json
{
  ...
  "trace_width": -12403463.334903851
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "voluptate in ea"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "velit irure incididunt",
  "supplier_part_numbers": {
    "eu_5f8": ["consequat exercitation", "consequat Duis", "commodo"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "culpa_a21": [
      "et non officia culpa reprehenderit",
      "commodo occaecat in amet id",
      "ut officia",
      "nisi ut",
      "veniam"
    ],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "voluptate ex dolore irure labore",
  "supplier_part_numbers": {
    "dolor8": ["dolore ex culpa"],
    "dolor_": ["qui sint irure"],
    "sunt_f35": ["velit", "ipsum"],
    "culpa_852": []
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "dolor consequat magna reprehenderit",
  "supplier_part_numbers": {
    "ut_020": []
  }
}
...
```json
{
  ...
  "name": "P1",
  "supplier_part_numbers": {
    "esse182": ["ullamco laborum", "et est sint pariatur aliqua"],
    "dolore_93": ["qui", "anim fugiat", "tempor Ut"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolor_ff2": [
      "qui anim nostrud",
      "consectetur cillum in occaecat",
      "aute Excepteur ipsum eiusmod adipisicing"
    ],
    "veniam5b": [
      "officia minim ut eu",
      "pariatur quis anim",
...
```json
{
  ...
  "connected_source_port_ids": [
    "dolore dolor ullamco aute culpa",
    "qui non tempor amet",
    "sed qui adipisicing velit incididunt",
    "laborum eu",
    "officia aute eiusmod"
  ],
  "connected_source_net_ids": [
    "non Excepteur nostrud consectetur irure",
    "ut dolore",
    "dolor ad",
    "dolore id"
  ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 778104.3094607443,
  "pin_styles": {},
  "symbol_name": "incididunt quis commodo",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "fugiat in magna occaecat"
}
```
...
```json
{
  ...
  "route": [],
  "stroke_width": "0.1mm",
  "color": "adipisicing ea eu id non"
}
```
...
```json
{
  ...
  "message": "et Duis magna Lorem officia",
...
```json
{
  ...
  "radius_x": "ad ea et sed",
  "radius_y": -64665848.34178923,
  "layer": "top"
}
```
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "aliqua99": ["ut ex", "cupidatat officia eu", "irure ut amet enim sunt"],
    "irure_dc": ["exercitation ex ut pariatur occaecat"],
    "exercitation_d3": ["Duis minim cupidatat consequat culpa"]
  }
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "sunt ipsum commodo adipisicing occaecat",
  "model_obj_url": "quis",
  "model_stl_url": "magna",
  "model_3mf_url": "aute in anim quis",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "amet dolor irure eiusmod eu"
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "trace_width": -13339221.741569579
}
```
...
{
  "deserunt_46": {
    "right_margin": -8985459.550079972,
    "top_margin": -65269689.545265086
  }
}
```
