...
```json
{
  ...
  "supplier_part_numbers": {
    "adipisicingce6": ["eu elit", "amet incididunt"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    ...
    "deserunt adipisicing Lorem reprehenderit"
  ],
  "is_power": false,
  "is_ground": false,
...
```json
{
  ...
  "supplier_part_numbers": {
    "voluptate_cc": [
      "sunt aliquip ad anim",
      "incididunt proident irure esse ut"
    ]
  }
}
```
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "et_ce": ["Excepteur veniam fugiat", "in"],
    "in_": ["deserunt cupidatat"],
    "ad_344": [
      "amet",
      "deserunt aliquip nostrud",
      "labore pariatur sit elit proident",
...
```json
{
  ...
  "name": "D1",
  "supplier_part_numbers": {
    "laborumb": ["dolor ad elit occaecat deserunt", "quis consequat enim"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "aliquipc": [
      ...
      "Lorem commodo",
      "minim aliquip ex",
      "minim est ipsum voluptate mollit"
    ]
  }
}
```
...
```json
{
  ...
  "name": "P1",
  "supplier_part_numbers": {
    "ut5": ["nisi minim ipsum", "deserunt elit", "est dolore cillum Lorem"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolor_faf": [
      "commodo do tempor",
      "do incididunt labore",
      "Excepteur nostrud sed",
      "id sit mollit adipisicing",
      "exercitation veniam consectetur"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": ["proident irure cupidatat adipisicing"],
  "connected_source_net_ids": [
    "ipsum laborum minim velit",
    "exercitation irure eiusmod ea culpa",
    "cupidatat officia do cillum ut",
    "veniam do dolore sit",
...
```json
{
  ...
  "message": "qui mollit in id Lorem"
}
```
...
```json
{
  ...
  "message": "aute ipsum commodo qui enim",
...
```json
{
  ...
  "name": "G1",
  "supplier_part_numbers": {
    "culpa_": ["ut exercitation eiusmod sint", "in Ut"],
    "aliqua_7": [
      "dolor ut ut occaecat eu",
      "consequat deserunt nostrud officia dolor"
    ],
    "amet4": ["Lorem", "incididunt"],
    "Excepteur08": [
      "Excepteur",
      "est in",
      "Duis pariatur Excepteur",
      "elit reprehenderit ipsum in ut"
    ]
  }
}
```
