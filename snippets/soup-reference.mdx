...
```json
{
  ...
  "name": "I1",
  "manufacturer_part_number": "sint magna",
  "supplier_part_numbers": {
    "nulla1b": ["exercitation"],
    "Lorem_33": ["sed", "dolore", "fugiat nostrud tempor", "Ut"],
    "Utd4": ["ut cillum commodo anim irure"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    ...
    "Duis esse Ut laboris sint",
    "cillum veniam amet consequat",
    "esse elit mollit Excepteur",
    "minim"
  ],
  "is_ground": false,
  "is_digital_signal": true,
  "is_analog_signal": false,
  "trace_width": -3978811.4529803097
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "esse elit",
  "supplier_part_numbers": {
    "commodoc": ["incididunt magna"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "deserunt veniam ipsum minim",
  "supplier_part_numbers": {
    "commodoca4": [
      "amet",
      "laborum fugiat",
    ...
    "mollit_34": [
      "dolore labore velit pariatur",
      "nulla qui sint adipisicing Duis"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ut sint officia Excepteur",
  "supplier_part_numbers": {
    "aliquip_6": [
      "Lorem incididunt exercitation esse quis",
      "ut enim occaecat dolor ea",
      "ea sunt quis",
      "cupidatat irure anim",
      "sed ad pariatur exercitation"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "veniam et eu incididunt",
  "supplier_part_numbers": {
    "fugiatca5": [
      "Duis",
      "consectetur aliquip quis",
      "id ad laboris sint dolor"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "Excepteur ut quis proident commodo",
  "supplier_part_numbers": {
    "inb6": [
      "in",
      "dolore enim fugiat id",
      "elit",
      "adipisicing aute ullamco",
      "culpa magna est dolor sint"
    ],
    "eiusmod21e": ["exercitation magna non ex Duis", "magna"],
    "ut4": [
      "dolore dolor irure proident cupidatat",
      "dolor ex in",
      "in ipsum id velit",
      "aute exercitation nulla qui esse"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "nulla cillum culpa aute ipsum",
  "supplier_part_numbers": {
    "labore4": ["proident", "minim dolor dolore eu"],
    "nostrudf8": [
      "laborum fugiat ullamco veniam deserunt",
      "veniam amet dolore",
      "commodo"
    ],
    "reprehenderitce": ["consequat", "aliqua amet aliquip", "Excepteur et non"],
    "et_be": ["incididunt velit", "dolore sed cillum"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "dolore cupidatat",
    "commodo",
    "anim amet dolore in nisi",
    "mollit",
    "nostrud tempor"
  ],
  "connected_source_net_ids": ["proident", "consequat labore"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "voluptate sint dolor qui",
  "pin_styles": {},
  "box_width": "nostrud amet ut irure",
  "symbol_name": "veniam enim sed anim",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "veniam deserunt ut laboris"
}
```
...
```json
{
  ...
  "radius_x": "officia cupidatat Duis",
  "radius_y": -25461823.467638567,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "magna dolore",
  "supplier_part_numbers": {
    "consequat7": ["ipsum sint eiusmod commodo Duis"]
  }
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": -15617893.011609182
  },
  "model_obj_url": "officia",
  "model_stl_url": "labore adipisicing ea"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "ad quis reprehenderit in pariatur"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -66557457.58151217,
  "outer_height": -79163548.97702478,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "velitf0": {
    "left_margin": -98580182.04548329,
    "right_margin": -76966291.39062724,
    "top_margin": "ad cupidatat sint sed",
    "bottom_margin": "do in Duis incididunt dolor"
  },
  "eu__17": {
    "left_margin": 18932291.628581405,
    "right_margin": -36652776.595913485,
    "top_margin": "exercitation nostrud ut",
    "bottom_margin": "Ut"
  },
  "voluptate43": {
    "top_margin": 61887608.690443546,
    "bottom_margin": 57850782.24369323
  }
}
```
