...
```json
{
  ...
  "supplier_part_numbers": {
    "proident_719": ["sit", "voluptate sit ex tempor"],
    "mollit566": [
      "fugiat Excepteur adipisicing enim",
      "dolor magna aliquip fugiat aliqua",
      "voluptate sit laboris enim",
      "nisi",
      "ullamco occaecat"
    ]
  }
...
```json
{
  ...
  "member_source_group_ids": [
    "est sint incididunt",
    "anim pariatur laborum sint",
    "labore cillum est",
    "id laboris",
    "ut sit Excepteur laborum"
  ],
  "is_ground": false,
  "is_digital_signal": true,
  "trace_width": -25114686.96099572
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "quis voluptate deserunt cupidatat",
  "supplier_part_numbers": {
    "Excepteur_8_": ["Excepteur"],
    "ea_fb": ["velit commodo"],
    "pariatur6": [
      "mollit sint sit in",
      "ea laborum Duis proident irure",
      "elit in Excepteur laborum",
      "est dolore nulla reprehenderit eiusmod"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "nisi_3": ["eiusmod Duis anim in nisi", "culpa sunt et aute"],
    "elit8": [
      "quis consectetur deserunt ipsum non",
      "laboris commodo qui",
      "elit ut",
      "anim cupidatat quis Lorem voluptate"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "velit ut occaecat",
  "supplier_part_numbers": {
    "cillum_8b": ["quis irure in", "laborum consequat dolore in"],
    "aliquaeeb": [
      "laboris ut aliqua aliquip voluptate",
      "eu do aliquip",
      "incididunt veniam nostrud"
    ],
    "suntf95": ["fugiat Lorem ea aliqua", "amet non veniam reprehenderit"],
    "consequat_2": [
      "eu exercitation do voluptate sit",
      "dolore aliquip occaecat",
      "Ut voluptate sint",
      "Excepteur Lorem ex",
      "est et occaecat minim"
    ]
  }
}
```
...
```json
{
  ...
  "name": "D1",
  "supplier_part_numbers": {
    "Lorem__f9": ["adipisicing Duis", "voluptate"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "sint do consectetur dolor",
  "supplier_part_numbers": {
    "esse_76c": [
      "ea dolor fugiat incididunt pariatur",
      "consequat dolor",
      "anim nostrud do officia",
      "aliquip reprehenderit mollit"
    ],
    "irurec25": [
      "dolore",
      "cillum incididunt irure exercitation in",
      "est in",
      "incididunt veniam tempor sed"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "in dolore esse",
  "supplier_part_numbers": {
    "quisa": [
      "consectetur",
      "sunt do anim et",
      "in incididunt Ut culpa aliqua",
      "nulla",
      "pariatur deserunt qui"
    ],
    "tempor_5": ["officia voluptate"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "dolor",
    "occaecat do et",
    "Lorem eiusmod nisi proident culpa",
    "sed dolor"
  ],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "velit in adipisicing eu",
  "pin_styles": {},
  "box_width": "Lorem veniam proident eiusmod",
  "symbol_name": "culpa sint dolor voluptate Duis",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "deserunt dolor reprehenderit ad"
}
```
...
```json
{
  ...
  "message": "est adipisicing ex proident",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "radius_x": "aliqua cupidatat id eiusmod",
  "radius_y": "dolore ipsum",
  "layer": "top"
}
```
...
{
  "ut_68": {
    "left_margin": 99667561.18877363,
    "right_margin": 59717503.64165443,
    "top_margin": "exercitation enim minim sit ex",
    "bottom_margin": -81283208.2673412
  },
  "culpa28": {
    "left_margin": -29781778.276238754
  }
}
```
