...
```json
{
  ...
  "ftype": "nulla sint velit mollit",
  "source_component_id": "source_component_1",
  "name": "N1",
  "manufacturer_part_number": "cupidatat magna aliquip",
  "supplier_part_numbers": {
    "dolor25e": [],
    "exercitation3eb": ["dolor", "tempor nulla Lorem", "commodo"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "esse reprehenderit",
  "supplier_part_numbers": {
    "sunt_82": ["qui aliquip ea eu"],
    "laborum_71e": []
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    ...
    "exercitation dolore consectetur consequat pariatur"
  ],
  "is_power": false,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "esse dolore ea do",
  "supplier_part_numbers": {
    "exercitation5e7": [],
    "ut_4": [],
    "mollit8": [
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "labore dolor occaecat minim eiusmod",
  "supplier_part_numbers": {
    "Excepteur_de": [],
    "cillum672": [
      "in consequat",
      ...
      "esse",
      "enim dolore id consectetur irure"
    ],
    "adipisicing_4e": [
      "ad officia",
      "sit esse",
      "sunt fugiat cillum dolore dolor",
      "mollit exercitation"
    ],
    "deserunt_e2b": [
      "sit esse commodo sed",
      "culpa Lorem minim laboris",
      "mollit ex amet",
      "fugiat in do",
      "sunt"
    ]
...
```json
{
  ...
  "supplier_part_numbers": {
    "labored": ["fugiat nulla irure sit"],
    "reprehenderit__a": [
      "nulla adipisicing",
      "in Duis reprehenderit irure",
      "ut",
      "culpa non"
    ],
    "exercitation28d": [
      ...
      "elit consequat",
      "dolore do cillum",
      "culpa cupidatat elit ad aliqua",
      "velit exercitation incididunt ullamco nostrud"
    ],
    "esse_aca": ["velit pariatur", "eiusmod do consequat"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "est do pariatur",
  "supplier_part_numbers": {
    "ad__": ["nisi", "dolore ullamco nulla cupidatat", "in nostrud"],
    "ex_d5": [
      "et Duis irure exercitation",
      "in cillum ad",
      "quis do amet esse",
...
```json
{
  ...
  "connected_source_port_ids": ["reprehenderit", "ea ullamco nostrud"],
  "connected_source_net_ids": [
    "ex",
    "eu dolore nostrud",
    "ad velit eiusmod sed",
    "elit mollit",
    "exercitation in consequat reprehenderit"
  ]
}
```
...
```json
{
  ...
  "schematic_component_id": "schematic_component_1",
  "box_width": "in",
  "symbol_name": "aliquip sit voluptate",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "message": "non eiusmod amet dolor Excepteur"
}
```
...
```json
{
  ...
  "message": "incididunt consectetur"
}
```
...
```json
{
  ...
  "message": "Duis minim Lorem nulla",
...
```json
{
  ...
  "message": "veniam commodo et aliqua",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "Ut Duis id quis sunt",
  "supplier_part_numbers": {
    "ut21": [],
    "cupidatat_72c": [
      "ut dolor sunt",
      "in",
      "ut dolor exercitation non",
      "officia nostrud consequat in minim"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "minim in cillum",
  "supplier_part_numbers": {
    "incididuntb6b": []
  }
}
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "nisi Lorem irure velit quis",
  "model_obj_url": "consectetur in",
  "model_stl_url": "minim aliquip quis",
  "model_3mf_url": "nostrud magna dolore",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 75873957.05035642,
  "outer_height": 50847681.59996456,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": "ut adipisicing sit"
}
```
...
{
  "dolore95b": {
    "left_margin": 52735557.66917667,
    "right_margin": "nulla in",
    "top_margin": -51098499.74611924,
    "bottom_margin": 85349965.640239
  }
}
```
