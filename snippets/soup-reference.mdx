...
```json
{
  ...
  "supplier_part_numbers": {
    "quis_a": [
      "in eiusmod",
      "anim do eu",
      "est veniam pariatur cillum",
      "nulla"
    ],
    "utee6": [
      "qui",
      "velit",
      "esse consectetur Lorem incididunt in",
      "consequat",
      "Lorem"
    ]
  }
...
```json
{
  ...
  "member_source_group_ids": [
    "adipisicing do labore Lorem dolor",
    "ipsum",
    "Lorem irure ex enim ut"
  ],
  "is_power": true,
  "is_ground": false,
...
```json
{
  ...
  "supplier_part_numbers": {
    "Excepteur_3de": [
      "nisi",
      "consectetur ut",
      "qui culpa cillum enim",
      "magna tempor nulla Ut in"
    ],
    "Lorema7": [
      "eiusmod amet",
      "occaecat sint",
...
```json
{
  ...
  "supplier_part_numbers": {
    "et_b98": [
      "laborum amet quis ullamco",
      "cillum",
      "culpa",
      "consectetur anim ut incididunt in"
    ],
    "fugiatc5a": [
      "id in non amet",
      "nisi consectetur",
      "quis Excepteur in",
      "Lorem sed occaecat in ex",
      "amet"
    ],
    "cillum1f": ["anim laboris dolor non ad", "cupidatat", "minim dolor"],
    "nullaa": ["in ipsum", "nulla est minim sit esse", "cillum in"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "name": "G1",
  "supplier_part_numbers": {
    "Excepteur041": ["incididunt dolor"],
    "deserunt5": [
      "do voluptate",
      "ex sit nisi",
      "qui dolore mollit exercitation",
      "veniam"
    ],
    "ea6d": [
      "eiusmod voluptate cillum dolore deserunt",
      "est proident labore minim exercitation"
    ]
  }
}
```
...
```json
{
  ...
  "name": "R1",
  "supplier_part_numbers": {
    "dolorb09": ["eu dolor dolore", "eu adipisicing ad dolore"],
    "amet_52e": ["reprehenderit", "nisi consectetur", "in sed", "pariatur"],
    "ad_0": ["dolor dolor", "nisi Ut ea", "consequat", "exercitation ut"],
    "ex4bb": ["aliqua", "culpa aliquip", "cupidatat officia cillum"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "id Lorem",
    "commodo",
    "minim tempor amet non",
    "fugiat consequat ut",
    "enim consectetur"
  ],
  "connected_source_net_ids": [
    "occaecat non",
    "sunt nisi velit tempor consectetur"
  ]
}
```
...
```json
{
  ...
  "message": "nostrud et culpa enim adipisicing"
}
```
...
```json
{
  ...
  "message": "non Lorem anim dolore amet"
}
```
...
```json
{
  ...
  "name": "L1",
  "supplier_part_numbers": {
    "ametc47": ["qui eiusmod est", "consequat esse aute laborum", "irure do"]
  }
}
```
