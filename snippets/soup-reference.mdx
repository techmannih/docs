...
```json
{
  ...
  "supplier_part_numbers": {
    "Ut__": [
      "tempor magna cupidatat laboris",
      "commodo",
      "sunt et in",
...
```json
{
  ...
  "member_source_group_ids": [
    "enim dolor aliqua quis",
    "deserunt sunt sint",
    "fugiat sit",
    "anim commodo veniam pariatur"
  ],
  "is_power": true,
  "is_ground": false,
...
```json
{
  ...
  "supplier_part_numbers": {
    "consectetur3": [
      "nisi",
      "officia",
      "sunt elit voluptate esse pariatur",
      "occaecat do Lorem aliquip"
    ],
    "ute": ["exercitation", "dolore"],
    "ametd2": ["dolore voluptate exercitation"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "eaf": [
      "ea qui irure ullamco elit",
      "in eu id et est",
      "mollit",
      "Duis ipsum exercitation deserunt",
      "in aliquip do"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "name": "D1",
  "supplier_part_numbers": {
    "labore_b7": ["ad anim est", "officia sint mollit est"],
    "aliqua0": ["et", "aute consequat", "sed id laboris in anim"],
    "minim__": [
      "incididunt",
      "dolore",
      "consequat nostrud",
      "sint dolor laboris consequat",
      "nisi aliqua Lorem"
    ],
    "nulla_7": ["ut"]
  }
...
```json
{
  ...
  "name": "P1",
  "supplier_part_numbers": {
    "in_a": ["non sit magna", "id", "velit ex in", "Duis anim laborum in"],
    "pariaturd7": [
      "in",
      "nostrud in dolor occaecat",
      "non dolore ea ipsum mollit",
      "in voluptate veniam"
    ],
    "mollita": ["laborum eiusmod mollit consequat labore", "et est"],
    "dolor_77": [
      "veniam ea",
      "est",
      "eu quis esse",
    ...
    "Excepteur_0a_": ["irure ullamco enim voluptate sit", "aute tempor nisi"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "elit238": [
      "cupidatat non in quis do",
      "anim",
      "sit Excepteur do est",
      "nisi in Duis fugiat dolor"
    ],
    "incididuntb": ["velit proident consequat", "dolore ut tempor magna"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "et consequat fugiat ad",
    "velit ullamco Duis exercitation",
    "exercitation"
  ],
  "connected_source_net_ids": ["qui enim eu"]
}
```
...
```json
{
  ...
  "message": "ut nulla elit consequat Lorem"
}
```
...
```json
{
  ...
  "message": "dolor consequat irure exercitation voluptate"
}
```
...
```json
{
  ...
  "radius_x": -38572823.16538218,
  "radius_y": 2343917.8992528617,
  "layer": "top"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "Lorem39": [
      "velit sit magna nulla irure",
      "Duis ipsum ullamco consequat cupidatat",
      "mollit",
      "pariatur sed culpa nulla exercitation",
      "eiusmod"
    ]
  }
}
...
```json
{
  ...
  "rotation": "90deg",
  "layer": "top",
  "model_obj_url": "cupidatat",
  "model_stl_url": "mollit ex minim in amet",
  "model_jscad": []
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -20854362.13412492,
  "outer_height": 18050926.9545476,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
