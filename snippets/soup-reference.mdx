...
```json
{
  ...
  "ftype": "cupidatat Lorem aute eiusmod elit",
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "id nisi et",
  "supplier_part_numbers": {
    "commodo_4": ["id irure aute", "irure eu sit", "nulla dolor sint"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "ut consequat et adipisicing",
  "supplier_part_numbers": {
    "veniam_081": [
      "commodo et",
      "ullamco",
      "do Excepteur aliquip sit",
      "exercitation dolore"
    ],
    "Lorem_e91": ["officia sit pariatur"],
    "sed9": ["nulla Ut"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "aliqua sint labore fugiat anim",
    "dolor id nostrud",
    "consectetur ex eu exercitation in",
    "aliquip Lorem culpa consequat do"
  ],
  "is_ground": false,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": 36529389.02654627
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "consequat reprehenderit ullamco dolore commodo",
  "supplier_part_numbers": {
    "autef3": ["reprehenderit eu nostrud", "deserunt amet sit culpa"],
    "aute_5": [
      "Ut sit mollit nisi deserunt",
      "mollit velit occaecat",
      "id elit ipsum eiusmod dolore",
      "ea proident laborum quis"
    ],
    "ea___": [
      "veniam dolore",
      "in exercitation incididunt mollit labore",
      "id est esse irure",
      "Ut consequat",
      "consequat veniam"
    ],
    "est_d": ["ipsum occaecat", "deserunt pariatur"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "Ut dolor et voluptate cillum",
  "supplier_part_numbers": {
    "nostrud3b": [
      "tempor",
      "do consectetur eiusmod",
      "aliqua laborum fugiat ex"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "officia",
  "supplier_part_numbers": {
    "aute_e": [
      "culpa amet ad quis ipsum",
      "veniam consectetur sit mollit laboris",
      "culpa cupidatat",
      "adipisicing",
      "minim laborum nostrud eu"
    ],
    "fugiat_78": ["minim culpa Excepteur tempor", "tempor dolore"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "voluptate et ut mollit consectetur",
  "supplier_part_numbers": {
    "qui_34_": ["sint"]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "Lorem culpa",
  "supplier_part_numbers": {
    "deserunt2_e": ["sunt id aliqua nostrud"],
    "aliquip_f": ["Lorem", "occaecat mollit", "adipisicing non ullamco"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["esse", "incididunt nostrud"],
  "connected_source_net_ids": [
    "nulla dolor dolore eiusmod",
    "qui",
    "Excepteur aliquip Lorem irure"
  ]
}
```
...
```json
{
  ...
  "pin_styles": {
    "veniame9": {
      "left_margin": 85793705.3698245,
      "right_margin": "dolor",
      "top_margin": -3982530.9952670634,
      "bottom_margin": "dolor quis dolore elit"
    }
  },
  "box_width": 10688673.373668417,
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  }
...
```json
{
  ...
  "message": "Ut deserunt exercitation consectetur est"
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "anim",
  "model_obj_url": "enim deserunt ut occaecat",
  "model_stl_url": "labore esse ipsum ea",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -38993777.90492169,
  "outer_height": -75720751.61697543,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "laboris6e2": {
    "left_margin": "dolor reprehenderit in",
    "right_margin": -66309940.56786692,
    "top_margin": 9483181.5698746,
    "bottom_margin": -58130589.33149025
  },
  "fugiat_4cd": {
    "right_margin": -21472767.50847502,
    "bottom_margin": 21830371.01383607
  }
}
```
