...
```json
{
  ...
  "ftype": "non dolore sunt",
  "source_component_id": "source_component_1",
  "name": "N1",
  "manufacturer_part_number": "in",
  "supplier_part_numbers": {
    "laboris__f4": [
      "Ut deserunt fugiat irure in",
      "in deserunt commodo",
      "eiusmod",
      "ipsum fugiat proident in",
      "eiusmod adipisicing in consequat cillum"
    ],
    "in0": ["anim dolor fugiat nisi ipsum"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["quis adipisicing dolore sint magna"],
  "is_power": false,
  "is_ground": true,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "dolor officia reprehenderit",
  "supplier_part_numbers": {
    "ad_3": [
      "Duis elit dolore labore",
      "incididunt enim",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "aliquip Lorem consectetur in veniam",
  "supplier_part_numbers": {
    "sit_285": ["mollit adipisicing Excepteur", "sunt dolore in ullamco"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "dolore sint incididunt voluptate",
  "supplier_part_numbers": {
    "velit19_": [
      "id Ut pariatur sed",
      "labore ullamco in",
      "sunt eu et commodo",
      "id minim ad incididunt magna"
    ],
    "nisi683": [
      "consectetur proident Lorem",
      "ut",
      "id esse do",
      "consequat officia fugiat sint"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "velit id eiusmod do",
  "supplier_part_numbers": {
    "in8d2": ["ea minim culpa", "dolor enim amet ullamco"],
    "minim38": [
      "commodo Excepteur eiusmod elit",
      "mollit Excepteur",
      "et commodo",
      "incididunt Duis ullamco amet"
    ]
  }
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "quis commodo dolor",
    "in sint in Lorem est",
    "nostrud est dolor anim consectetur"
  ],
  "connected_source_net_ids": ["anim in", "nisi sed ex Lorem minim", "ut"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "culpa quis commodo",
  "box_width": "laborum",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "message": "in cupidatat commodo aliquip",
...
```json
{
  ...
  "radius_x": "voluptate exercitation amet",
  "radius_y": "quis tempor fugiat sit",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "dolor commodo",
  "supplier_part_numbers": {
    "mollit_b87": ["adipisicing mollit anim"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "laborum eu in",
  "model_obj_url": "nisi minim dolor",
  "model_stl_url": "consectetur non aliqua",
  "model_3mf_url": "aliqua amet laborum",
  "model_jscad": []
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 2297106.982728228,
  "outer_height": -55188740.01505805,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
