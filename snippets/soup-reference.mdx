...
```json
{
  ...
  "ftype": "ex adipisicing pariatur",
  "source_component_id": "source_component_1",
  "name": "E1",
  "manufacturer_part_number": "amet reprehenderit",
  "supplier_part_numbers": {
    "ut7f": [
      "Ut Duis eiusmod",
      "eu nostrud Lorem fugiat aliqua",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "commodo velit aliqua occaecat",
  "supplier_part_numbers": {
    "officia_1": ["enim est", "mollit in commodo", "id Ut Excepteur in"],
    "adipisicingc_": ["exercitation ea mollit Duis"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["tempor Lorem", "pariatur veniam", "minim"],
  "is_power": true,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "deserunt Excepteur sed quis in",
  "supplier_part_numbers": {
    "incididunt73e": [
      "incididunt amet ut dolor",
      "est quis occaecat tempor veniam",
      "eu dolor qui"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "veniam aute magna deserunt do",
  "supplier_part_numbers": {
    "euec": ["sunt consectetur exercitation do Ut"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "elit deserunt labore est",
  "supplier_part_numbers": {
    "quie": [
      "cillum nostrud deserunt eiusmod officia",
      "elit sunt occaecat mollit",
      "irure cillum tempor labore",
      "eiusmod",
      "exercitation labore dolor in cillum"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolore9": [
      "enim labore Duis",
      "minim cupidatat id",
      "magna nulla deserunt minim"
    ],
    "cupidatat_a64": [
      "est",
      "sunt dolor pariatur",
      "dolore adipisicing sit deserunt Lorem",
      "aliquip in Ut aute exercitation",
      "laboris"
    ],
    "Excepteur_e31": ["deserunt do labore enim sunt"]
  }
}
```
...
```json
{
  ...
  "name": "G1",
  "supplier_part_numbers": {
    "eu88": ["tempor quis et", "dolore id"],
    "quis_12": ["dolore", "qui labore Lorem"],
    "minim_73": [
      "laborum",
      "quis dolore et sunt",
      "ad eu enim occaecat",
      "quis minim reprehenderit deserunt nisi"
    ],
    "sed_2": [
      "cupidatat dolore qui deserunt in",
      "occaecat elit sit",
      "aliquip ex velit nisi"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "Ute": [
      ...
      "est et cupidatat",
      "enim adipisicing Excepteur minim irure"
    ],
    "dolore_a": ["commodo quis exercitation", "dolor esse"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "minim in culpa",
  "supplier_part_numbers": {
    "eu_4": ["qui aute", "dolor aute eiusmod", "tempor in laboris ipsum non"],
    "dolorab8": [
      "elit culpa",
      "proident minim est",
      "dolor dolor officia",
...
```json
{
  ...
  "connected_source_port_ids": [
    "laborum in officia nostrud deserunt",
    "cillum aute officia ex",
    "aute Ut anim"
  ],
  "connected_source_net_ids": ["commodo culpa exercitation", "reprehenderit"]
}
```
...
```json
{
  ...
  "message": "adipisicing sunt laborum"
}
```
...
```json
{
  ...
  "message": "qui elit aute labore proident"
}
```
...
```json
{
  ...
  "radius_x": -62449595.28885907,
  "radius_y": "officia labore reprehenderit",
  "layer": "top"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "exercitation sed ut in laboris"
}
```
...
{
  "elite3": {
    "left_margin": 65529500.0509457,
    "right_margin": 11179634.671943009,
    "top_margin": "adipisicing id commodo",
    "bottom_margin": "sint dolor minim in laboris"
  },
  "sitc": {
    "left_margin": "dolore culpa ea nisi incididunt",
    "right_margin": -49711713.832158335,
    "top_margin": 63586507.25467062,
    "bottom_margin": -12821853.665745258
  },
  "in_": {
    "right_margin": "velit ullamco laboris voluptate ex",
    "top_margin": -92783257.5234711,
    "bottom_margin": -56330848.940894775
  }
}
```
