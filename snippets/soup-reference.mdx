...
```json
{
  ...
  "ftype": "proident Excepteur velit incididunt",
  "source_component_id": "source_component_1",
  "name": "P1",
  "supplier_part_numbers": {
    "fugiat_5_": ["eu proident exercitation et"],
    "proident_e36": ["ut"]
  }
}
```
...
```json
{
  ...
  "name": "L1",
  "supplier_part_numbers": {
    "in_5": ["laboris mollit do", "aliqua", "Lorem voluptate tempor ut"],
    "ad16": [
      "ad",
      "reprehenderit ipsum proident irure",
      "minim ea cupidatat laborum",
      "Duis dolor dolore irure eu"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "nostrudb5a": [
      "et occaecat in",
      "anim dolore labore laborum",
      "Excepteur magna in",
      "qui Excepteur Lorem pariatur"
    ],
    "occaecat_d": ["ut exercitation commodo"],
    "auteb2": [
      "laborum deserunt ipsum sit",
      "sed cillum dolor velit",
      "ullamco",
      "culpa",
      "ut adipisicing"
    ]
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "enim___9": ["consectetur qui", "reprehenderit"],
    "officia_6": ["aliquip ex in et", "proident laborum laboris dolore"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "name": "D1",
  "supplier_part_numbers": {
    "ullamco_8": ["labore velit minim", "reprehenderit id voluptate esse"],
    "dolor_7b": ["et amet", "adipisicing Ut ut magna ullamco", "ea consectetur"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "officia__0_": [
      "ut labore proident ullamco nulla",
      "Excepteur consectetur elit",
      "elit reprehenderit veniam irure"
    ],
    "dolore": ["consequat occaecat elit voluptate"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "autee8": [
      "occaecat voluptate eiusmod aliquip",
      "eiusmod tempor quis",
      "elit",
      "occaecat"
    ],
    "nulla_6": ["nostrud", "pariatur in anim nostrud"],
    "reprehenderit_5": [
      "ullamco aute",
      "sed",
      "ex",
      "irure sunt exercitation do ut"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "in aute anim consequat esse",
    "commodo in non",
    "deserunt laborum nulla sint",
    "qui aliquip ex amet"
  ],
  "connected_source_net_ids": ["labore fugiat est"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "veniam velit anim ad non",
  "box_width": "anim ullamco aliquip amet",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "radius_x": "amet enim ea cupidatat",
  "radius_y": "dolore velit do",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "deserunt occaecat amet sint in",
  "pcb_trace_id": "pcb_trace_1",
  "source_trace_id": "source_trace_1",
  "pcb_component_ids": ["pcb_component_1"],
...
```json
{
  ...
  "supplier_part_numbers": {
    "non20": [
      "sint irure fugiat ullamco",
      "anim velit",
      "cupidatat non et",
      "exercitation amet",
      "id esse consectetur commodo"
    ]
  }
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": -12443173.913091376
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": -22064422.177102342
  },
  "layer": "top",
  "footprinter_string": "dolor",
  "model_obj_url": "enim nisi amet voluptate",
  "model_stl_url": "mollit in cillum culpa",
  "model_3mf_url": "Lorem exercitation consequat",
  "model_jscad": []
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -57768854.3864868,
  "outer_height": 41550376.20261699,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
