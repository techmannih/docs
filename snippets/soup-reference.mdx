...
```json
{
  ...
  "supplier_part_numbers": {
    "culpa_": [
      "ex qui commodo",
      "quis Excepteur occaecat cillum",
      "ad enim sint"
    ]
  }
}
...
```json
{
  ...
  "member_source_group_ids": [
    "aliquip amet nisi in velit",
    "officia consectetur",
    "in eu consectetur voluptate Ut",
    "voluptate dolor occaecat Lorem",
    "sunt"
  ],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "dolor fugiat Ut ullamco tempor",
  "supplier_part_numbers": {
    "animd8": [
      "ex",
      "laborum quis non voluptate culpa",
      "ex Excepteur consequat fugiat pariatur",
      "ipsum in cupidatat mollit commodo",
      "adipisicing laboris enim ipsum id"
    ],
    "veniam_652": [
      "qui",
      "in ipsum fugiat sit nulla",
      "exercitation pariatur Duis sunt ea"
    ],
    "utaa": ["aliquip culpa Lorem ut ut", "do qui"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "enim et in laborum nulla",
  "supplier_part_numbers": {
    "quisa": ["incididunt sed cupidatat occaecat est", "elit in ut", "ut"],
    "amet_dd": ["id ea cupidatat est et", "ut magna"],
    "elitb24": [],
    "esse_6ed": ["sunt occaecat culpa"],
    "incididunt_67": []
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "cupidatat enim",
  "supplier_part_numbers": {
    "consectetur_9": ["anim tempor ut dolore voluptate"],
    "ipsum_2c_": [
      "veniam dolor consectetur proident elit",
      "consectetur mollit et magna dolor",
      "ut"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "quis nostrud et officia ut",
  "supplier_part_numbers": {
    "consectetura": [
      "cillum anim sed tempor ea",
      "ipsum minim tempor",
      "dolor est",
      "aliqua veniam enim incididunt ea",
      "quis ex"
    ],
    "et9": ["elit cillum reprehenderit in"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "non tempor quis sint laboris",
  "supplier_part_numbers": {
    "Duis7": [
      "tempor anim Duis voluptate",
      "tempor",
      "nisi ut laboris consequat"
    ],
    "ea167": ["et enim in"]
  },
  "voltage": "5V"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "eiusmod Excepteur deserunt laboris commodo",
  "supplier_part_numbers": {
    "ete58": [
      "in tempor",
      "occaecat non",
      "do ullamco sit laborum cupidatat",
      "sint nulla esse eu",
      "cillum"
    ],
    "id_8a": [
      "sint laboris incididunt enim dolore",
      "et tempor",
      "Excepteur sint est",
      "amet ea sit"
    ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -16555728.254365623,
  "pin_styles": {},
  "box_width": "sed cillum",
  "symbol_name": "sit",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "message": "amet labore est non magna"
}
```
...
```json
{
  ...
  "message": "ut ullamco et pariatur",
...
```json
{
  ...
  "message": "do minim dolor aliquip",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "supplier_part_numbers": {
    "sint_26": [],
    "ut_90": ["est voluptate", "Duis", "voluptate nisi dolor"],
    "nostrudac_": [
      "eu magna",
      "in Duis",
      "Duis in ullamco",
      "laborum amet ut mollit"
    ],
    "auted": [
      "voluptate consectetur culpa velit eu",
      "Excepteur voluptate sit anim"
    ]
  }
}
```
...
```json
{
  ...
  "model_obj_url": "consequat amet aliqua",
  "model_stl_url": "ad nulla aliqua consequat adipisicing",
  "model_3mf_url": "anim nisi consectetur",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -616785.0663962364,
  "outer_height": 10825254.45467852,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "Excepteur dolor pariatur esse"
}
```
...
```json
{
  ...
  "via": false,
  "to_layer": "bottom",
  "trace_width": "nostrud voluptate deserunt incididunt in"
}
```
...
{
  "Loremf55": {
    "left_margin": "Lorem qui dolore veniam non",
    "right_margin": -70936897.62437832
  },
  "idcf": {
    "left_margin": -72720842.95197843,
    "right_margin": "ut Excepteur",
    "top_margin": "dolor"
  },
  "sunt355": {
    "right_margin": "cupidatat nostrud tempor fugiat aute",
    "top_margin": "dolor",
    "bottom_margin": "labore esse et"
  }
}
```
