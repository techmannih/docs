...
```json
{
  ...
  "ftype": "anim proident in voluptate",
  "source_component_id": "source_component_1",
  "name": "A1",
  "manufacturer_part_number": "sint commodo et",
  "supplier_part_numbers": {
    "cupidatat_e_4": ["ullamco", "dolore cillum"],
    "dolore1c": [
      "in voluptate aute ea cillum",
      "esse sed reprehenderit tempor dolore",
      "amet"
    ],
    "ullamco3": [
      "minim adipisicing Excepteur tempor quis",
      "nisi Lorem velit",
      "qui cillum in occaecat"
    ]
  }
}
```
...
```json
{
  ...
  "trace_width": -52405237.480416164
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "sit ex dolore magna sint",
  "supplier_part_numbers": {
    "ut0": [
      "exercitation consectetur ullamco Ut laboris",
      "ad consequat Excepteur in",
      "laboris Ut eiusmod velit anim",
      "tempor"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "ad aute",
  "supplier_part_numbers": {
    "non_c44": [
      "magna veniam in eiusmod ad",
      "in consectetur aute culpa",
      "et est aliqua"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "pariatur ad ut dolore",
  "supplier_part_numbers": {
    "non52": ["veniam mollit amet", "in veniam cupidatat", "nisi voluptate"],
    "est5": ["nostrud et qui proident aute"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "eiusmod dolor",
    "fugiat ex ut",
    "minim commodo incididunt veniam"
  ],
  "connected_source_net_ids": [
    "minim",
    "sit est ipsum eiusmod",
    "exercitation id et pariatur cillum",
    "in qui cupidatat"
  ]
}
```
...
```json
{
  ...
  "message": "dolor nostrud aliqua esse"
}
```
...
```json
{
  ...
  "message": "dolor et adipisicing in",
...
```json
{
  ...
  "radius_x": -59048053.3916979,
  "radius_y": 75779063.11158222,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "adipisicing aliqua velit",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "consectetur anim",
  "supplier_part_numbers": {
    "eu_cb": ["dolor aute in exercitation", "ipsum id"],
    "dolor_0": [
      "incididunt ut deserunt et aliquip",
      "voluptate esse",
      "nostrud et officia non",
      "in",
      "enim et ad exercitation sint"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "voluptate",
  "model_obj_url": "nostrud et consectetur dolor officia",
  "model_stl_url": "aliqua amet aute",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -42429266.25713048,
  "outer_height": 15652969.88481526,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
