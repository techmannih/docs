...
```json
{
  ...
  "name": "C1",
  "manufacturer_part_number": "dolor enim amet Ut",
  "supplier_part_numbers": {
    ...
    "culpa_a": [
      ...
      "proident",
      "Lorem",
      "Lorem proident incididunt nulla"
    ]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    ...
    "mollit commodo Ut consectetur",
    "nisi dolore irure pariatur"
  ],
  "is_power": false,
  "is_ground": false,
  "is_digital_signal": false,
  "is_analog_signal": true,
  "trace_width": -50319871.638669334
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "ex sed velit",
  "supplier_part_numbers": {
    "non69": [],
    "exf": ["voluptate reprehenderit ut", "Excepteur aliqua dolor voluptate"],
    "velit_e": [
      "anim",
    ...
    "nondd6": [
      "proident dolore aute commodo sed",
      "qui eu sunt labore",
      "velit"
    ],
    "Ut_54": ["qui", "adipisicing"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "nisi_5": ["nisi sit laboris laborum in"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "tempor eu"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "eiusmod enim exercitation sed",
  "supplier_part_numbers": {
    "consectetur_3": ["ipsum ea cupidatat", "ut ullamco", "do enim elit"],
    "qui_44": [],
    "quisb99": [
      "irure eiusmod sint minim",
      "reprehenderit occaecat ex tempor amet",
      "ipsum Ut laborum qui",
      "minim incididunt exercitation id eu",
...
```json
{
  ...
  "supplier_part_numbers": {
    "incididunt_3d": [],
    "commodo_1": ["culpa irure pariatur labore incididunt"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "tempor veniam dolor ullamco",
  "supplier_part_numbers": {
    "non_9bf": [
      "sit adipisicing occaecat non laborum",
...
```json
{
  ...
  "connected_source_net_ids": [
    "Duis eiusmod nisi exercitation mollit",
    "ex reprehenderit",
    "sint do et aliqua ea",
    "aliqua",
    "nostrud anim aute"
  ]
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "box_width": 34434632.03590369,
  "symbol_name": "quis dolore dolor",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "in officia sunt veniam"
}
```
...
```json
{
  ...
  "message": "in ut dolore in mollit"
}
```
...
```json
{
  ...
  "message": "esse ea ad amet fugiat",
...
```json
{
  ...
  "radius_x": -80563874.3403855,
  "radius_y": "aliqua et do",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "consectetur qui nostrud dolore laborum",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
  ...
  "route": [
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": "veniam consequat exercitation laboris voluptate"
    },
    {
      "x": "3mm",
      "y": "1mm",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "Lorem Ut dolore fugiat voluptate",
  "supplier_part_numbers": {
    "mollit_75": ["Ut esse"],
    "mollit2b": ["labore est proident ex ullamco", "cupidatat velit eu"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 4301541.739855304,
  "outer_height": -66330036.44104703,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "commodo_1f": {
    "left_margin": -38057958.33365777,
    "right_margin": "sint eiusmod proident",
    "bottom_margin": 75523189.10604191
  },
  "incididuntbb6": {
    "left_margin": "nulla",
    "top_margin": "proident",
    "bottom_margin": 65525869.71252096
  },
  "proident_1d": {
    "left_margin": -41332880.733258784,
    "right_margin": "id",
    "top_margin": "dolor enim Duis"
  },
  "iruree8": {
    "left_margin": "in in",
    "right_margin": "qui nisi aliquip incididunt consequat",
    "top_margin": "in non",
    "bottom_margin": 25006021.277885944
  }
}
```
