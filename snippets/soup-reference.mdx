...
```json
{
  ...
  "ftype": "enim tempor aliqua nisi consectetur",
  "source_component_id": "source_component_1",
  "name": "E1",
  "manufacturer_part_number": "nulla Duis sint",
  "supplier_part_numbers": {
    "cupidatat1": ["culpa"],
    "aute_a": [
      "nostrud do",
      "adipisicing officia Ut mollit",
      "reprehenderit velit dolore",
      "aliqua ut ea do consectetur"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolore_6d5": ["minim ut in occaecat"]
  }
}
```
...
```json
{
  ...
  "trace_width": -19085662.727221742
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "Lorem enim ullamco ea",
  "supplier_part_numbers": {
    "quis_5": ["ex tempor"]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "eu5": [
      ...
      "commodo Duis",
      "sunt nisi",
      "ipsum officia eu sit id"
    ],
    "fugiat_6bf": [
      "mollit qui consectetur aliqua amet",
      "in Excepteur ea Lorem",
      "officia occaecat qui cillum"
    ],
    "ut_": [
      "qui exercitation nostrud veniam ut",
      "in",
      "ut ut irure nostrud id",
      "exercitation",
      "et"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "nisi fugiat officia",
  "supplier_part_numbers": {
    "irure5_": [
      "in commodo ad",
      "sit labore",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "exercitation nulla deserunt ea Duis",
  "supplier_part_numbers": {
    "labore_ac": ["elit in", "amet ut"],
    "reprehenderit_214": ["id proident"],
    "aute_38": [
      "velit do",
      "dolor sed",
      "anim commodo ullamco dolore",
      "qui aliquip proident"
    ],
    "ullamcod5": [
      "fugiat dolor ut cillum",
      "enim",
      "adipisicing cupidatat nisi"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "pariaturf5": [
      "minim qui non elit",
      "sunt",
      "officia culpa sit et",
      "Duis tempor"
    ],
    "occaecat7c": [
      "sunt pariatur velit exercitation ea",
      "aliqua veniam in culpa"
    ],
    "voluptate_9": [
      "proident deserunt in occaecat",
      "cillum id laboris",
      "nostrud aute",
      "eu proident officia"
    ],
    "ea_4": [
      "dolore sit amet cupidatat",
      "proident",
      "incididunt mollit nulla"
    ],
    "proident__": ["ut officia est anim voluptate"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "et in pariatur",
  "supplier_part_numbers": {
    "velitd": ["in", "sed in consectetur ex anim"],
    "dolor2c": [
      "laboris nostrud velit elit",
      "nisi quis mollit Excepteur cupidatat",
      "nostrud sint",
      "minim mollit in",
      "aliqua est non"
    ],
    "nostrud_f65": [
      "sed",
      "in",
      "Lorem adipisicing ipsum proident",
      "cillum culpa aliqua ea"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": ["in aliquip aute dolor fugiat"],
  "connected_source_net_ids": ["ut", "ipsum qui aute officia tempor"]
}
```
...
```json
{
  ...
  "message": "sint nisi sunt occaecat exercitation"
}
```
...
```json
{
  ...
  "message": "sit Excepteur officia labore",
...
```json
{
  ...
  "radius_x": -73908256.64928392,
  "radius_y": 71415547.13059291,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "ea eiusmod aute esse consequat",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "anim consectetur",
  "supplier_part_numbers": {
    "anim_af": ["ea velit adipisicing", "aliqua culpa et cupidatat"],
    "in540": [
      "dolor aliquip nisi ut Excepteur",
      "consequat sint in dolore consectetur",
      "Ut sed laborum",
      "fugiat dolore ex"
    ],
    "mollit__": [
      "dolore amet minim quis",
      "fugiat irure",
      "ut nisi Excepteur sint"
    ]
  }
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "in ullamco non est adipisicing"
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
  ...
  "layer": "top",
  "footprinter_string": "laboris Duis sed consequat",
  "model_obj_url": "qui laborum",
  "model_stl_url": "ut in aute officia Lorem",
  "model_3mf_url": "exercitation laboris fugiat sed ullamco",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -70567916.24833733,
  "outer_height": 59457.235316082835,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "nostrud_0f4": {
    "left_margin": -64865013.591631636,
    "right_margin": -30953460.496139497,
    "top_margin": "commodo veniam",
    "bottom_margin": "dolore"
  },
  "in_e0b": {
    "left_margin": -19949354.888979524,
    "right_margin": "veniam in",
    "top_margin": -30936226.29482153,
    "bottom_margin": -9424102.036424741
  },
  "occaecat835": {
    "left_margin": 84851057.10026294,
    "right_margin": 75151628.13010341,
    "top_margin": "voluptate magna velit aliqua dolore",
    "bottom_margin": 88629814.57272038
  },
  "sed_b": {
    "left_margin": 62130474.80971637,
    "right_margin": "sed"
  }
}
```
