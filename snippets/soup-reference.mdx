...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "voluptate consectetur aute",
  "supplier_part_numbers": {
    "mollit12": [
      "aliquip",
      "sed fugiat",
      "ut aute ipsum",
      "Lorem sint dolore laboris"
    ],
    "cillum_a79": [
      "proident est Duis eu",
      "dolore",
      "quis eiusmod",
      "consequat Ut dolore"
    ],
    "do_ae6": [
      "nostrud",
      "ipsum ut minim laboris",
      "id nisi velit qui",
      "laboris veniam adipisicing exercitation do",
      "velit ex Excepteur"
    ]
  }
}
...
```json
{
  ...
  "member_source_group_ids": [
    "Excepteur dolor nisi nulla dolore",
    "tempor adipisicing ullamco sunt",
    "non id"
  ],
  "is_ground": true,
  "is_digital_signal": true,
  "trace_width": 78394119.71587467
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "sint aliqua",
  "supplier_part_numbers": {
    "sunt47": [
      "nulla dolor non",
      "sint culpa adipisicing eiusmod aute",
      "ullamco occaecat",
      "nisi id",
      "id quis ut labore"
    ],
    "temporcfc": [
      "adipisicing tempor dolor sed minim",
      "dolor consectetur",
      "ad irure pariatur",
      "reprehenderit amet",
      "non veniam"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "ullamco qui non elit",
  "supplier_part_numbers": {
    "proident5a": [
      "officia dolore",
      "Duis tempor proident nulla",
      "incididunt",
      "in"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "do veniam nisi eiusmod",
  "supplier_part_numbers": {
    "voluptate4": [
      "ad quis sunt dolor Excepteur",
      "in",
      "reprehenderit ea dolor dolore occaecat"
    ]
  }
}
```
...
```json
{
  ...
  "name": "P1",
  "supplier_part_numbers": {
    "quis9d": ["anim ad deserunt"],
    "irure9": [
      "eu reprehenderit Excepteur velit qui",
      "fugiat minim dolor dolor"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "cupidatat aliquip Duis eu",
  "supplier_part_numbers": {
    "id_c8": ["Excepteur", "ad irure", "eiusmod est"],
    "nisia": ["ea sed", "id consectetur ullamco in"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["in pariatur velit", "ea Duis non et quis"],
  "connected_source_net_ids": ["id fugiat", "id exercitation"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -57618481.59880176,
  "box_width": 37088760.17571464,
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "Excepteur consequat amet",
...
```json
{
  ...
  "radius_x": -72867030.29176293,
  "radius_y": -29101254.45909317,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "officia mollit id dolore cupidatat",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "trace_width": 58272532.486999124
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "qui voluptate",
  "supplier_part_numbers": {
    "mollit3_": [
      "cillum in veniam ex",
      "esse",
      "consequat irure dolor enim veniam"
    ],
    "et_c41": [
      "est veniam cillum Duis dolor",
      "mollit minim amet eiusmod aliquip",
      "nulla",
      "nulla reprehenderit dolore"
    ],
    "commodo7d": ["deserunt et est", "dolore tempor"],
    "Duis23": ["nisi ut ex", "laboris"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 94148131.2153742,
  "outer_height": 20909034.47781898,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "aliqua incididunt mollit proident"
}
```
