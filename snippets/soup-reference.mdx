...
```json
{
  ...
  "supplier_part_numbers": {
    "aliquip05": [
      "sunt dolore",
      "do laboris nulla",
      "eiusmod proident sit deserunt magna"
    ]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["cillum"],
  "is_power": true,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": 58830607.845810205
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "sed laboris mollit",
  "supplier_part_numbers": {
    "nulla_64b": ["consequat Ut"],
    "aliquip_8": [
      "id velit",
      "sed labore mollit",
      "Duis ipsum mollit adipisicing",
      "laboris dolore ad deserunt",
      "in"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "amet in dolore eiusmod Duis",
  "supplier_part_numbers": {
    "exercitation_39": ["laborum"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "name": "D1",
  "supplier_part_numbers": {
    "dof": ["amet ullamco cillum", "dolor sunt adipisicing irure"],
    "dolore_94": [
      "Lorem mollit deserunt Excepteur",
      "aliqua magna anim dolor ut",
      "et sed nostrud aliquip",
      "ea aliqua"
    ],
    "velit2b": ["in consequat"],
    "sit_ed_": [
      "ut ut",
      "veniam sunt dolor ipsum",
      "fugiat",
      "deserunt ut ea qui ipsum"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "sed minim et",
  "supplier_part_numbers": {
    "essefb": ["eiusmod tempor culpa"],
    "ut_8cb": [
      "esse qui",
      "elit dolore do cillum aute",
      "magna nisi",
      "commodo deserunt",
      "Lorem"
    ],
    "elit_3_": ["deserunt dolor laborum", "mollit est", "nostrud do irure"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "irure veniam",
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "ipsum cupidatat pariatur cillum",
  "supplier_part_numbers": {
    "in_5eb": ["ut ullamco", "in voluptate fugiat qui"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "ut occaecat dolor",
    "eiusmod ea ut in",
    "dolore dolore ea tempor esse",
    "quis cillum"
  ],
  "connected_source_net_ids": ["magna culpa cillum in consectetur"]
}
```
...
```json
{
  ...
  "pin_spacing": "ex",
  "pin_styles": {},
  "box_width": -30013917.830367327,
  "symbol_name": "sed dolore eu",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "et Duis cupidatat voluptate laborum"
}
```
...
```json
{
  ...
  "radius_x": 48542971.75715491,
  "radius_y": -40845576.728650056,
  "layer": "top"
}
```
  ...
  "route": [
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": "adipisicing culpa enim"
    }
  ]
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "do ullamco nulla pariatur laborum",
  "model_obj_url": "Lorem in ullamco",
  "model_stl_url": "irure in aliquip",
  "model_3mf_url": "mollit aliqua sint labore ullamco",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "Duis ad do laboris proident"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -58234627.923774384,
  "outer_height": 77049176.57639667,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "velit9": {
    "left_margin": "amet sint qui",
    "right_margin": 30163328.455379456,
    "top_margin": "pariatur qui minim dolore",
    "bottom_margin": 5172676.157474816
  }
}
```
