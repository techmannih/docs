...
```json
{
  ...
  "name": "N1",
  "manufacturer_part_number": "consequat dolore enim cillum reprehenderit",
  "supplier_part_numbers": {
    "in_c": [
      "elit dolor consectetur ut irure",
      "dolore sit consectetur sed labore",
      "enim exercitation tempor culpa",
      "consequat incididunt sunt"
    ]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    ...
    "deserunt dolor non",
    "enim fugiat",
    "quis enim Lorem veniam est",
    "ea commodo in qui tempor"
  ],
  "is_power": false,
  "is_ground": false,
  "is_analog_signal": true,
  "trace_width": 23024512.44123675
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "proident6": [
      ...
      "dolor sunt",
      "Ut in amet fugiat",
      "amet laboris esse in"
    ],
    "aliqua_505": ["dolore Excepteur consequat"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "Excepteur id ut nostrud",
  "supplier_part_numbers": {
    "ex_4d9": ["in veniam ex", "in labore officia eu sit", "sed"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "laboris do in",
  "supplier_part_numbers": {
    "fugiatf3": [
      "nulla enim fugiat et",
      "nisi",
      "aliquip voluptate",
      "laboris velit commodo ut",
      "proident velit Lorem"
    ],
    "officia703": ["ullamco"],
    "officia_b": ["labore officia cillum", "amet do non"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "deserunt sed sunt nisi",
  "supplier_part_numbers": {
    "qui286": [
      "officia mollit",
      "magna ad",
      "ullamco fugiat laboris",
      "in Duis"
    ],
    "incididunt6": [
      ...
      "occaecat fugiat",
      "cillum",
      "nulla occaecat nisi incididunt culpa"
    ],
    "infb": ["Ut", "sunt cillum in nisi ullamco"],
    "eu_e": ["proident", "et", "in laborum amet", "quis"],
    "etd": ["cillum consectetur"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ipsumdbd": [
      "sit ea irure tempor laboris",
      "in veniam exercitation eiusmod"
    ],
    "nisi60": [
      "Duis sint",
      "adipisicing",
      "non occaecat",
      "quis adipisicing Ut eu",
      "sed esse adipisicing aute nostrud"
    ],
    "voluptate56e": [
      "mollit Duis ut consequat",
      "aliquip aliqua labore",
      "cillum",
      "exercitation",
      "anim in sunt"
    ],
    "ipsum92d": ["eiusmod proident dolor nostrud"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "incididunt4": [
      "culpa non consequat incididunt",
      "consequat elit",
    ...
    "Loremf9": [
      "mollit do eu anim",
      "nulla ullamco dolor velit officia",
      "culpa"
    ]
  },
  "voltage": "5V"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "in dolore aute ea",
  "supplier_part_numbers": {
    "Duis4b8": ["in exercitation pariatur", "cillum"],
    "officia_f": [
      "occaecat mollit est",
      "adipisicing ullamco do ad",
      "qui esse",
      "labore nisi qui",
      "ipsum amet dolore sit aliquip"
    ],
    "occaecat_5e": [
      "veniam ipsum",
      "commodo Excepteur velit nulla",
      "ea occaecat incididunt consequat",
      "Ut ea do",
      "sint do"
    ]
  },
...
```json
{
  ...
  "connected_source_port_ids": ["enim eu laborum", "eu irure nisi"],
  "connected_source_net_ids": [
    "laboris occaecat",
    "ullamco ut ex anim",
    "nostrud laborum minim quis ipsum"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "velit aliqua",
  "pin_styles": {},
  "box_width": -54967674.69497565,
  "symbol_name": "minim incididunt est",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "Ut aliqua do voluptate"
}
```
...
```json
{
  ...
  "message": "dolore id sint pariatur",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "deserunt irure fugiat voluptate commodo",
  "supplier_part_numbers": {
    "in74e": [
      "et",
      "irure Excepteur elit aliqua nostrud",
      "dolore quis sunt pariatur laboris",
      "et Lorem"
    ],
    "magna_b1": ["aute", "ad voluptate ipsum aliquip Duis"],
    "occaecate41": [
      "consectetur voluptate nisi ut",
      "magna dolore",
      "Lorem cillum"
    ]
  }
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "pariatur incididunt anim",
  "model_obj_url": "nulla sunt officia dolore ipsum",
  "model_stl_url": "incididunt",
  "model_3mf_url": "consequat nostrud",
  "model_jscad": {}
}
```
...
{
  "quis_6f": {
    "left_margin": -86873353.23272279,
    "top_margin": -9691773.403111354
  },
  "reprehenderit3_": {
    "right_margin": "consequat",
    "bottom_margin": "laboris"
  }
}
```
