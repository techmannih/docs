...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "Duisa6": [
      "sed officia enim sint reprehenderit",
      "aliqua nisi sed aute velit",
      "tempor quis"
    ],
    "aliquip_09": [
      "ut adipisicing irure esse",
      "incididunt dolore",
      "mollit non sit tempor"
    ],
    "cupidatat__81": ["Duis", "dolore voluptate in"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "et ipsum labore",
  "supplier_part_numbers": {
    "deserunt835": ["dolore ea labore commodo", "aliquip minim", "magna"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "sunt ea ullamco enim nostrud",
    "eu",
    "dolor sunt aliqua deserunt"
  ],
  "is_power": true,
  "is_ground": false,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": -30283298.620690465
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolor_a": [
      "ea officia eiusmod in",
      "in cillum et veniam reprehenderit",
      "cillum exercitation ipsum aliquip Lorem",
      "exercitation reprehenderit"
    ],
    "deserunt_d4": ["elit nulla", "occaecat magna ut esse dolore"],
    "nulla_6a": [
      "in pariatur tempor nulla",
      "magna ad reprehenderit",
      "quis non ex fugiat",
      "eu",
      "fugiat laborum sunt tempor minim"
    ],
    "veniam_0": [
      "ad",
      "aliqua",
      "nisi anim in",
      "ullamco nisi dolor dolore",
      "consequat"
    ],
    "sunt_76": ["Ut laboris officia", "deserunt proident ut"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "irure aliquip proident nostrud ullamco",
  "supplier_part_numbers": {
    "essea": [
      "non consectetur ullamco",
      "officia sit",
      "Excepteur",
      "est aute dolore deserunt"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ullamco in",
  "supplier_part_numbers": {
    "aliquip_e": [
      "incididunt proident",
      "laborum cupidatat fugiat exercitation pariatur",
      "enim dolor"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "mollit magna",
  "supplier_part_numbers": {
    "Uta83": [
      "sit culpa anim aute",
      "consequat ea incididunt cupidatat",
      "labore est tempor"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "veniam Excepteur aliqua",
  "supplier_part_numbers": {
    "incididunt_03_": [
      "Excepteur dolore laborum id Lorem",
      "in",
      "tempor",
      "sed Ut"
    ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "consequat proident nostrud ut",
  "supplier_part_numbers": {
    "incididuntff": [
      "laboris aliquip ad",
      "amet cillum Ut",
      "in occaecat labore sunt",
      "ad nostrud Ut aliqua"
    ],
    "etc0": [
      "ipsum voluptate qui",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "in Excepteur",
  "supplier_part_numbers": {
    "id_80a": [
      "dolor dolore",
      "ex ut",
      "dolor consectetur",
      "veniam ut eu officia ullamco"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "veniam ipsum quis mollit",
    "Duis aliqua nulla",
    "consectetur consequat id veniam"
  ],
  "connected_source_net_ids": [
    "in nisi eiusmod ipsum ex",
    "ullamco amet",
    "minim",
    "sed aliqua commodo aliquip",
    "enim sed"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "pariatur consequat sed magna in",
  "pin_styles": {},
  "box_width": 43014698.57832515,
  "symbol_name": "aute minim occaecat",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "reprehenderit consequat enim mollit et",
...
```json
{
  ...
  "route": [
    ...
    },
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": -11437125.317297786
    },
    {
      "x": "3mm",
      "via": true,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "proident",
  "supplier_part_numbers": {
    "reprehenderit_d1e": ["nulla aliqua", "enim", "ad", "aliqua", "non ad"],
    "sit2ec": [
      "id Excepteur",
      "consequat in ullamco Duis in",
      "ea elit fugiat in ad"
    ],
    "Ut_81a": ["consectetur"]
  }
}
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "ad nulla",
  "model_obj_url": "ipsum veniam sunt officia",
  "model_stl_url": "aliqua et cupidatat nostrud",
  "model_3mf_url": "aute do",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 72285838.80334464,
  "outer_height": -60025465.35771938,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "via": false,
  "to_layer": "bottom",
  "trace_width": "Duis elit commodo Excepteur"
}
```
...
```json
{
  "reprehenderit_d8": {
    "left_margin": "anim",
    "right_margin": -78567370.64013486
  }
}
```
