...
```json
{
  ...
  "ftype": "mollit id elit",
  "source_component_id": "source_component_1",
  "name": "M1",
  "manufacturer_part_number": "do reprehenderit ut tempor",
  "supplier_part_numbers": {
    "pariatur3c_": ["est officia anim dolore pariatur"],
    "sunte6": []
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "qui elit anim veniam",
  "supplier_part_numbers": {
    "ex_a": [
      "proident magna adipisicing aliqua nostrud",
      "sint anim ex",
      "eu",
      "tempor cillum sint",
      "occaecat dolore eiusmod enim"
    ],
    "magnae": ["dolor do", "nostrud anim culpa dolor", "ex dolor nostrud"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "amet laboris laborum sint aute",
    "mollit aliqua consequat",
    "aliqua amet labore dolore qui",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "culpa minim reprehenderit",
  "supplier_part_numbers": {
    "in6d": ["labore ea ut qui elit", "in ad dolore", "tempor minim"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "Excepteur irure veniam eu deserunt",
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "nulla_6_1": [
      "ipsum commodo est cillum laboris",
      "exercitation",
      "esse",
      "exercitation magna nostrud eu in"
    ],
    "occaecat_3": [
      "aliqua commodo",
      "amet proident consectetur aliquip",
      "sed",
      "non dolor",
      "elit dolor officia"
    ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "incididunt ut ut aliquip",
  "supplier_part_numbers": {
    "in41": ["pariatur irure quis veniam"],
    "mollit8b8": [
      "eu fugiat dolore incididunt",
      "fugiat mollit proident",
      "adipisicing ut reprehenderit tempor qui",
      "minim dolore deserunt",
      "et"
    ]
  }
}
...
```json
{
  ...
  "name": "G1",
  "supplier_part_numbers": {
    "officia7c": ["in sunt", "et", "nostrud Duis commodo ad", "et anim qui"],
    "ullamco_603": [
      "nisi culpa enim ea",
      "amet ullamco pariatur reprehenderit cillum",
      "dolor commodo culpa fugiat"
    ],
    "sint_8_2": ["velit aliquip consequat"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "quis ex elit dolor",
  "supplier_part_numbers": {
    "ut_e79": [
      "dolore consectetur ullamco cupidatat",
      "enim",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "minim do amet culpa",
  "supplier_part_numbers": {
    "euf8": [
      "ipsum ut",
      "minim dolore ad eu",
    ...
    "dolor_ca_": ["Duis est ea"],
    "fugiat43": ["anim proident ut", "deserunt quis esse minim anim"],
    "magna9b": [
      "ipsum ullamco pariatur elit amet",
      "in enim do",
      "in do laborum"
    ]
  },
...
```json
{
  ...
  "connected_source_port_ids": ["tempor", "aute", "minim in"],
  "connected_source_net_ids": [
    "consectetur cillum fugiat eiusmod in",
    "sit ex occaecat consequat",
    "esse",
    "esse",
    "Duis incididunt eiusmod in veniam"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "box_width": -17085709.256313384,
  "symbol_name": "qui nostrud Ut non",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "Excepteur nisi consectetur"
}
```
...
```json
{
  ...
  "radius_x": "aliqua dolore ut qui et",
  "radius_y": "culpa labore laboris aliqua",
  "layer": "top"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "elita": [
      "proident laboris pariatur non Lorem",
      "sit elit et ullamco",
      "est ut velit commodo"
    ],
    "in_6c": [
      "commodo laboris mollit",
      "sunt ut magna Excepteur adipisicing",
      "reprehenderit Lorem Ut id",
      "magna"
    ],
    "aliqua7": ["elit laborum", "nulla dolore sint ex cupidatat"],
    "occaecatb": ["adipisicing ut", "amet", "nostrud"]
  }
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "ullamco consequat eu"
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "cupidatat consequat consectetur exercitation"
  },
  "layer": "top",
  "footprinter_string": "commodo consectetur pariatur quis labore",
  "model_obj_url": "do officia minim",
  "model_stl_url": "esse sunt commodo cupidatat",
  "model_3mf_url": "anim velit nisi in",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "ut Ut mollit sit irure"
}
```
...
{
  "in_0fd": {
    "left_margin": -78162701.48281395,
    "right_margin": "dolore nulla dolor",
    "top_margin": 43219584.25866982,
    "bottom_margin": "Ut dolore et fugiat in"
  },
  "labore77": {
    "left_margin": "id",
    "right_margin": "ullamco ea tempor et veniam",
    "top_margin": "reprehenderit ut"
  },
  "voluptatefbd": {
    "left_margin": 21554575.50542006
  },
  "culpa_0": {
    "left_margin": -6301329.446721703,
    "right_margin": -64433009.26384232,
    "bottom_margin": 35713481.915637136
  }
}
```
