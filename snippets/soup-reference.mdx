...
```json
{
  ...
  "ftype": "nostrud adipisicing exercitation quis occaecat",
  "source_component_id": "source_component_1",
  "name": "N1",
  "manufacturer_part_number": "id occaecat qui",
  "supplier_part_numbers": {
    "aute75_": ["in nostrud reprehenderit", "ut occaecat", "aliqua"],
    "ea_1c2": ["qui", "ipsum ad officia velit", "sint non", "Ut"],
    "Duis8": ["sit", "do deserunt occaecat"],
    "commodo_6": ["ut et", "ad ipsum Excepteur dolor fugiat"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    ...
    "elit ad",
    "commodo non sunt",
    "consectetur ullamco do id Duis"
  ],
  "is_power": true,
  "is_ground": true,
  "is_digital_signal": false,
  "is_analog_signal": true,
  "trace_width": -14346852.452547759
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "sint veniam sit pariatur",
  "supplier_part_numbers": {
    "dolorb": []
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolor70": [
      ...
      "voluptate Ut Duis labore",
      "occaecat velit amet elit",
      "qui est quis"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "esse id culpa sunt",
  "supplier_part_numbers": {
    "nostrud_": ["sed culpa esse", "elit velit pariatur sit"],
    "dolore_8": [],
    "mollit_": ["dolor minim voluptate"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "ad Duis ipsum sit",
  "supplier_part_numbers": {
    "voluptate_c4": []
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": ["aliquip", "consectetur Duis"],
  "connected_source_net_ids": [
    "sunt amet exercitation ut",
    "eiusmod proident dolor culpa",
    "aliquip dolore"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "sint non sunt",
  "pin_styles": {},
  "box_width": "velit",
  "symbol_name": "ut qui aliqua Duis",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "commodo dolor dolore eu",
  ...
  "route": [
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": "reprehenderit sed Lorem magna"
    },
    {
      "x": "3mm",
      "via": false,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "anim voluptate aliquip non",
  "supplier_part_numbers": {
    "consequat_5": [],
    "in4": [
      "ea",
      "velit mollit nulla laboris dolore",
      "occaecat mollit non sunt deserunt",
      "ex id fugiat nisi"
    ]
  }
}
...
```json
{
  ...
  "rotation": "90deg",
  "footprinter_string": "ea qui dolor est",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "dolore aliqua quis"
}
```
