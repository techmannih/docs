...
```json
{
  ...
  "ftype": "eiusmod consectetur",
  "source_component_id": "source_component_1",
  "name": "E1",
  "manufacturer_part_number": "cillum dolor sit in dolore",
  "supplier_part_numbers": {
    "nisi530": ["aliqua nostrud in eu", "aliqua", "Excepteur"],
    "non6d": ["adipisicing anim amet eu in", "sunt cupidatat"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "velitc": ["esse laborum eiusmod"],
    "in_973": [
      "proident ut ea est aute",
      "ut ad",
      "dolor cillum irure veniam non",
      "consectetur qui cillum",
      "velit labore ea aliquip Duis"
    ],
    "commodo_e86": [
      "proident et",
      "deserunt Lorem nulla quis",
...
```json
{
  ...
  "member_source_group_ids": [
    "magna exercitation",
    "eu Lorem Duis",
    "sit sed nulla sint irure"
  ],
  "is_power": false,
  "trace_width": 4912422.497141436
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "aliquip eiusmod",
  "supplier_part_numbers": {
    "ad_b5": ["aliquip est sint Ut"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "Lorem8": ["esse", "aliquip"],
    "ut8fa": ["aute cillum mollit eu", "pariatur amet"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "voluptate_be4": ["officia cupidatat"],
    "ut_a1f": ["cupidatat"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "adipisicing id aliqua",
  "supplier_part_numbers": {
    "sunt5": [
      "eiusmod esse irure aliquip voluptate",
      "amet ut commodo enim",
      "est",
      "amet ad nisi"
    ],
    "sit5_": ["deserunt exercitation", "ut aute"],
    "sunt_6": [
      "qui magna",
      "quis est nostrud exercitation reprehenderit",
      "labore enim sed",
      "dolore aliqua minim"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "elit Ut eiusmod dolor velit"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "et ipsum amet anim mollit",
  "supplier_part_numbers": {
    "est5": ["dolor ut sit sed consectetur", "Excepteur"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "et Lorem",
  "supplier_part_numbers": {
    "exa4": ["reprehenderit labore laboris laborum", "laborum non esse"],
    "do6": ["tempor Lorem quis", "Lorem", "Duis dolor laboris sed"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "quis",
    "aliqua voluptate occaecat ipsum et",
    "quis nulla sed elit"
  ],
  "connected_source_net_ids": [
    "et proident amet Ut",
    "cillum",
    "reprehenderit labore sed"
  ]
}
```
...
```json
{
  ...
  "schematic_component_id": "schematic_component_1",
  "pin_styles": {},
  "box_width": "et dolore ut",
  "symbol_name": "incididunt",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "message": "incididunt exercitation eu dolor sit"
}
```
...
```json
{
  ...
  "message": "Duis deserunt reprehenderit cupidatat",
...
```json
{
  ...
  "radius_x": "minim incididunt do veniam nisi",
  "radius_y": "nostrud mollit",
  "layer": "top"
}
```
  ...
  "route": [
    {
      ...
      "y": "1mm",
      "to_layer": "bottom",
      "trace_width": "quis irure voluptate"
    },
    {
      "x": "3mm",
      "via": false,
...
```json
{
  ...
  "supplier_part_numbers": {
    "sed__3": ["Duis anim culpa quis eu"]
  }
}
```
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": -42043486.558281496
  },
  "footprinter_string": "pariatur ullamco sunt",
  "model_obj_url": "sint ipsum ullamco culpa",
  "model_stl_url": "eu",
  "model_3mf_url": "ad id sed",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "quis sed minim amet ad"
}
```
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": "in ex exercitation sint"
}
```
...
{
  "consequat_d": {
    "left_margin": "ut dolor dolore in anim"
  },
  "dolore_b": {
    "left_margin": "incididunt qui exercitation deserunt Excepteur",
    "right_margin": "sed in non elit reprehenderit"
  },
  "mollit_c": {
    "left_margin": 78500340.95722184,
    "right_margin": "ad adipisicing",
    "top_margin": "nisi quis Ut esse",
    "bottom_margin": "in adipisicing ut Excepteur"
  },
  "magna32": {
    "left_margin": "incididunt",
    "right_margin": "incididunt culpa in irure consectetur"
  }
}
```
