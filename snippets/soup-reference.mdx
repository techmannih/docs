...
```json
{
  ...
  "ftype": "laboris dolor dolor do aliqua",
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "Lorem non quis"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "Lorem dolor dolore cupidatat",
  "supplier_part_numbers": {
    "occaecat1_": [
      "sint proident",
      "officia nulla",
      "minim ad",
      "Excepteur aliqua magna ut proident"
    ],
    "non_8_6": [
      "adipisicing enim culpa veniam sed",
      "dolore est",
      "irure sint occaecat cupidatat sed"
    ],
    "ipsum_6": ["incididunt ipsum", "Excepteur laboris ex"],
    "adipisicing_76": [
      "Excepteur reprehenderit dolor deserunt pariatur",
      "aute nisi reprehenderit laborum",
      "in ea"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "aute_b3": [
      "proident in elit commodo reprehenderit",
      "irure",
      "minim ex Lorem incididunt nisi",
      "irure sed ad",
      "irure do aute adipisicing"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "aute dolor ut consectetur cupidatat",
  "supplier_part_numbers": {
    "Ut0": [],
    "voluptate_3fc": [
      "id tempor consequat labore magna",
      "ad proident eu nisi ipsum"
    ],
    "do_9": [
      "in eiusmod dolore amet",
      "enim in",
      "fugiat ut pariatur",
      "Lorem fugiat laboris esse"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "ea ipsum quis nisi aliqua",
  "supplier_part_numbers": {
    "enim0": [],
    "laborisd": [
      "ut",
      ...
      "est qui consectetur pariatur"
    ],
    "id_2fb": ["nisi", "tempor elit exercitation"],
    "elit502": []
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "irure ut labore",
  "supplier_part_numbers": {
    "culpab0": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "officia aliquip elit cillum",
  "supplier_part_numbers": {
    "veniam_3": [],
    "proident_f1": [
      ...
      "aliquip Ut",
      "dolor",
      "proident et minim fugiat mollit"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "Duis73": ["do irure"],
    "ea_7a6": ["do labore anim sit aute"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "radius_x": "reprehenderit",
  "radius_y": 14423442.115046382,
  "layer": "top"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "utd9": [
      "Excepteur",
      "ut sint nisi dolor deserunt",
      "consequat ex pariatur",
      "Duis minim"
    ],
    "Excepteur_4d9": [
      "ea",
      "sunt exercitation eu consequat",
      "sint",
      "tempor aute veniam quis ut"
    ],
    "sit3dc": []
  }
}
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "nisi eu mollit cupidatat",
  "model_obj_url": "Ut aliqua ut",
  "model_stl_url": "pariatur est aute voluptate",
  "model_3mf_url": "sunt tempor anim reprehenderit",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -44285549.05537019,
  "outer_height": 97766067.72964108,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "reprehenderit_22_": {
    "left_margin": -723572.8836748451,
    "right_margin": -8994914.971090749,
    "bottom_margin": "ad"
  },
  "exercitation83": {}
}
