...
```json
{
  ...
  "ftype": "labore sit incididunt",
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "magna",
  "supplier_part_numbers": {
    "pariatura9": ["non ad", "Ut quis", "anim in eu labore", "pariatur"],
    "labore_fad": [
      "tempor",
      "est cupidatat eu",
      "sed labore amet consequat sunt",
      "aliquip ea Duis exercitation ut"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "ullamco elit esse",
  "supplier_part_numbers": {
    "ut_bc": [
      "Duis",
      "sit velit in",
...
```json
{
  ...
  "member_source_group_ids": [
    "labore exercitation aute consequat",
    "Lorem dolore aliqua",
    "consectetur id fugiat incididunt"
  ],
  "is_power": false,
  "is_ground": false,
  "is_digital_signal": true,
  "is_analog_signal": false,
  "trace_width": 97125935.85359931
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "dolore voluptate"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "commodo nostrud id",
  "supplier_part_numbers": {
    "officia_a": [
      "dolor qui in dolore incididunt",
      "veniam in dolore tempor",
      "do quis culpa",
      "anim eiusmod magna",
      "consequat dolore"
    ],
    "commodo_5": ["in minim ut et", "cupidatat"],
    "tempor_b": ["commodo in dolor", "ullamco adipisicing aliqua voluptate"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "aliqua__8_": [
      "et consequat dolor ex",
      "velit adipisicing id cupidatat",
      "ipsum velit aliqua"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "adipisicing dolore proident deserunt nulla",
  "supplier_part_numbers": {
    "nisia": [
      "eu veniam aliquip cupidatat Duis",
      "esse enim in Ut",
      "Lorem reprehenderit incididunt elit",
      "non tempor"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "Excepteur mollit Ut",
  "supplier_part_numbers": {
    "adipisicing_2a": ["aliquip Ut"],
    "eiusmod_ee": [
      "consectetur veniam cillum",
      "ullamco mollit culpa",
      "labore elit enim",
      "in"
    ]
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "Excepteur consequat irure ea",
  "supplier_part_numbers": {
    "fugiat_2f": [
      "et eu quis ad ut",
      "est ipsum esse",
      "cillum fugiat amet ut qui"
    ],
    "ullamco1b": ["qui est tempor ad"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["quis pariatur"],
  "connected_source_net_ids": ["cillum velit elit aute", "et"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "magna dolor consectetur",
  "pin_styles": {},
  "box_width": -97744.50560185313,
  "symbol_name": "culpa",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "message": "proident fugiat Lorem est veniam"
}
```
...
```json
{
  ...
  "radius_x": -21468666.980923995,
  "radius_y": 81217391.04776803,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "sit dolore dolor officia",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "quis ex veniam"
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "eu qui magna Excepteur aliqua"
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
  ...
  "layer": "top",
  "footprinter_string": "eu",
  "model_obj_url": "nostrud",
  "model_stl_url": "ut Duis",
  "model_3mf_url": "ullamco aliqua commodo",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "veniam Excepteur aliquip cillum officia"
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "fugiat veniam eiusmod voluptate"
}
```
...
{
  "nulla3": {
    "left_margin": 29328056.21098514,
    "top_margin": "sit"
  },
  "aute_6eb": {
    "left_margin": 68580126.2031978,
    "right_margin": 91551258.99455518,
    "top_margin": -56272404.278340235,
    "bottom_margin": "consequat cupidatat pariatur"
  },
  "magnac": {
    "left_margin": "tempor ut",
    "right_margin": -90363808.97748981,
    "top_margin": "incididunt commodo exercitation quis Duis",
    "bottom_margin": 14470250.007097095
  },
  "inae": {
    "left_margin": -27116525.86167705,
    "right_margin": 27868201.369982734,
    "top_margin": "non proident tempor ea mollit",
    "bottom_margin": -51655266.248269886
  },
  "do1b": {
    "left_margin": 47895566.99751243,
    "right_margin": "do est",
    "top_margin": "sed",
    "bottom_margin": -89872828.58636826
  }
}
```
