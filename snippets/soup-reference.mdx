...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "in non",
  "supplier_part_numbers": {
    "occaecat_424": [
      "ad laboris id occaecat",
      "laboris cillum",
      "magna",
      "in",
      "elit"
...
```json
{
  ...
  "member_source_group_ids": [
    "sunt ipsum ullamco est proident",
    "in ipsum veniam ut enim",
    "officia magna deserunt mollit voluptate",
    "deserunt"
  ],
  "is_power": true,
  "is_ground": true,
  ...
  "trace_width": -44379207.255556665
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "cupidatat in reprehenderit sit",
  "supplier_part_numbers": {
    "consectetur89": ["dolor veniam Excepteur", "eiusmod do", "quis Duis"],
    "deseruntc": ["irure id"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "consequat28": [
      "irure amet laborum culpa",
      "nulla",
      "deserunt ut sed in laborum"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ipsum esse id anim dolore",
  "supplier_part_numbers": {
    "non_b": [
      "Excepteur est occaecat deserunt",
      "tempor",
      "amet voluptate",
      "irure eiusmod"
    ],
    "quis_e": [
      "aliqua cillum adipisicing fugiat id",
      "eu sed",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "velit amet dolore dolor cillum",
  "supplier_part_numbers": {
    "nulla2": [
      "Duis dolore reprehenderit dolor magna",
      "proident labore enim qui sit",
      "anim deserunt amet",
      "ipsum in irure id",
      "dolor proident non labore fugiat"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "eu dolor pariatur mollit",
  "supplier_part_numbers": {
    "inb1": ["cillum enim", "sit sunt magna"],
    "do_e": ["magna quis ex", "dolor"],
    "nulla0": ["incididunt deserunt"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "ipsum nisi aute",
  "supplier_part_numbers": {
    "dolor267": [
      "Lorem consequat",
      "fugiat ut ullamco",
      "incididunt eu adipisicing mollit",
      "irure Ut anim Duis",
      "aliqua sunt"
    ]
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "ullamco ipsum magna Lorem culpa",
  "supplier_part_numbers": {
    "qui_b64": [
      "exercitation esse culpa qui",
      "Lorem amet",
      "laboris enim",
      "ipsum",
      "magna cillum"
    ],
    "laboris844": ["ipsum reprehenderit Duis aute"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    ...
    "enim ut nostrud",
    "Excepteur velit",
    "commodo do proident esse amet"
  ],
  "connected_source_net_ids": [
    "consequat ea",
    "id",
    "enim aute",
    "id incididunt dolore velit fugiat",
    "amet Excepteur in ullamco quis"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -4371669.189760223,
  "pin_styles": {},
  "box_width": -63583692.56999578,
  "symbol_name": "reprehenderit minim incididunt commodo",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "proident enim aliquip ea"
}
```
...
```json
{
  ...
  "color": "consectetur anim sunt in reprehenderit"
}
```
...
```json
{
  ...
  "message": "laborum fugiat voluptate amet",
...
```json
{
  ...
  "radius_x": -15006174.954361066,
  "radius_y": 3016075.05367136,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "velit anim sed fugiat",
  "supplier_part_numbers": {
    "ead2": [
      "aliquip ex velit",
      "cupidatat esse ut occaecat tempor",
      "nisi",
      "nisi"
    ]
  }
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "in",
  "model_obj_url": "dolore sit",
  "model_stl_url": "ex ullamco",
  "model_3mf_url": "exercitation dolore est minim dolore",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "ad et sit Lorem non"
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "dolore Excepteur elit consectetur veniam"
}
```
...
{
  "consecteture_c": {
    "left_margin": -81336107.83889589,
    "right_margin": "eu cupidatat laborum deserunt elit",
    "top_margin": "labore in commodo ex",
    "bottom_margin": -90183593.47968338
  },
  "nisib": {
    "left_margin": "eu adipisicing elit officia",
    "right_margin": 74886832.06083673,
    "top_margin": 487837.4709496945
  },
  "officia_714": {
    "right_margin": "elit qui anim do"
  },
  "aliquip86d": {
    "left_margin": 66071505.31228399,
    "right_margin": "aliqua aliquip veniam",
    "top_margin": "ut sed adipisicing"
  },
  "ina8": {
    "right_margin": 89760900.792986,
    "top_margin": 27505701.602925375,
    "bottom_margin": "dolor in mollit labore"
  }
}
```
