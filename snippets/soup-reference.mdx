...
```json
{
  ...
  "ftype": "ut minim enim elit",
  "source_component_id": "source_component_1",
  "name": "U1",
  "manufacturer_part_number": "qui aute proident",
  "supplier_part_numbers": {
    ...
    "velit_5": [
      ...
      "sed consectetur",
      "laboris",
      "eiusmod anim reprehenderit aliquip"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "labore50b": ["officia ipsum", "proident"],
    "Excepteur9": [
      "sint",
      "in sint",
      "labore",
      "in sint",
      "et sit eiusmod proident"
    ]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "quis in dolor Excepteur ullamco",
    "eiusmod dolor cillum incididunt nostrud",
    "occaecat"
  ],
  "is_power": true,
  "is_analog_signal": true,
  "trace_width": -49112768.15607662
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "incididunt Lorem nulla cillum ea",
  "supplier_part_numbers": {
    "minim_5": [],
    "elit_e8": ["commodo sed aute cillum"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "nostrud in aute irure",
  "supplier_part_numbers": {
    "proident30f": ["cupidatat et cillum minim"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "Lorem voluptate enim",
  "supplier_part_numbers": {
    "commodo4": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "Ut in Duis",
  "supplier_part_numbers": {
    "in011": ["Ut", "Excepteur ea ad in"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "proidentbc": [
      "ea consequat",
      "ea cillum et",
      "voluptate dolor commodo eiusmod est"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": ["non"],
  "connected_source_net_ids": ["culpa nisi elit"]
}
```
...
```json
{
  ...
  "message": "elit laboris qui nostrud nisi",
...
```json
{
  ...
  "radius_x": -995405.9363404363,
  "radius_y": 84853343.3134394,
  "layer": "top"
}
```
...
```json
{
  ...
  "route": [
    ...
    },
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": 10855482.546206608
    }
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "tempor occaecat",
  "supplier_part_numbers": {
    "incididuntb20": [
      "in esse deserunt enim cillum",
      "Ut fugiat pariatur occaecat",
      "pariatur Excepteur non nostrud",
      "aliqua id"
    ]
  }
}
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "sit ullamco ut nulla",
  "model_stl_url": "non eiusmod et officia tempor",
  "model_jscad": {}
}
```
...
{
  "ade": {
    "left_margin": -16455017.97141935,
    "right_margin": "tempor",
    "top_margin": "eu dolore aute Lorem Excepteur",
    "bottom_margin": "deserunt ullamco quis voluptate commodo"
  },
  "eiusmod_": {
    "top_margin": "est incididunt adipisicing",
    "bottom_margin": "aliqua in"
  },
  "voluptate39": {
    "left_margin": "eiusmod",
    "right_margin": -20631735.04409015
  },
  "ad_5": {
    "left_margin": "elit magna ut",
    "right_margin": "mollit exercitation laborum",
    "top_margin": "nulla"
  },
  "Ut07b": {
    "left_margin": 79298939.58033675,
    "right_margin": 82649293.98233661,
    "top_margin": 53110332.66420257
  }
}
```
