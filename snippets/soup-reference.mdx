...
```json
{
  ...
  "ftype": "nisi Excepteur minim",
  "source_component_id": "source_component_1",
  "name": "N1",
  "manufacturer_part_number": "magna dolore eu velit minim",
  "supplier_part_numbers": {
    "cillum_9": ["in dolore elit"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "qui_0c5": ["incididunt eiusmod aute cillum consectetur"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "laboris anim officia sint",
    "tempor dolor",
    "labore in",
    "cupidatat in",
    "incididunt laborum qui"
  ],
  "is_power": true,
  "is_ground": true,
...
```json
{
  ...
  "supplier_part_numbers": {
    "qui_5ac": [
      "non",
      "ipsum exercitation Ut",
      "anim sit adipisicing velit",
      "sint dolor consectetur ad et",
      "in dolor adipisicing et"
    ],
    "ex_e38": ["in aute non amet"],
    "labore_03": ["aliquip culpa laboris"],
    "nullab": [
      "voluptate",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "veniam minim eu",
  "supplier_part_numbers": {
    "Duis8": ["sunt sint ad in"],
    "esse_8": ["exercitation et dolor est ea", "ipsum reprehenderit aute"],
    "in39f": [
      "labore elit",
...
```json
{
  ...
  "supplier_part_numbers": {
    "culpa_a": [
      ...
      "aliqua",
      "magna anim sint id reprehenderit"
    ],
    "elit___e": [
      "nisi Excepteur ullamco laboris",
      "consequat laborum esse amet pariatur",
      "est aliquip Duis"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "laborum ut nulla enim"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "velit_9": ["dolor laboris magna", "irure Duis"],
    "non_817": ["ullamco", "aliqua minim", "aute nisi officia culpa"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["commodo sit"],
  "connected_source_net_ids": ["in", "qui", "velit dolor sed aliqua"]
}
```
...
```json
{
  ...
  "message": "id nisi magna ut nostrud"
}
```
...
```json
{
  ...
  "radius_x": -27487799.722691536,
  "radius_y": "dolore sed in reprehenderit",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "dolore in",
  "supplier_part_numbers": {
    "id_975": ["reprehenderit"]
  }
}
```
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": -21133515.746027067
  },
  "model_stl_url": "ut elit labore veniam"
}
```
