...
```json
{
  ...
  "supplier_part_numbers": {
    "amet4": ["Ut sed ex", "anim sed nostrud", "Ut ad", "deserunt", "sit"],
    "ullamco79": [
      "sunt dolore",
      "ex quis",
      "culpa cillum Duis quis in",
      "sunt aute ad voluptate",
      "incididunt esse veniam elit quis"
    ],
    "aute00": [
      "Lorem ad sit sunt do",
      "in Lorem commodo velit",
      "pariatur sed",
      "nulla nostrud sunt ea"
    ],
    "fugiat80": [
      "officia",
      "do",
      "exercitation do dolor esse",
      "sed",
      "non nisi aute deserunt veniam"
    ],
    "non_": ["culpa ut amet veniam"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["velit eu quis in"],
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolord": [
      "exercitation enim Lorem magna cillum",
      "Ut dolor proident deserunt magna",
      "dolore",
      "sint"
    ],
    "minim_ac": ["dolore", "ipsum labore sunt qui consequat"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "name": "D1",
  "supplier_part_numbers": {
    "deserunt_e": ["ullamco irure minim proident in"]
  }
}
```
...
```json
{
  ...
  "name": "G1",
  "supplier_part_numbers": {
    "quis_09": ["incididunt proident sed"],
    "in_38a": [
      "irure non ipsum in",
      "ad",
      "enim fugiat aute laboris",
      "do ex veniam minim"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "fugiat_882": [
      "consequat incididunt deserunt est ullamco",
      "ex commodo officia",
      "tempor"
    ]
  },
...
```json
{
  ...
  "name": "R1",
  "supplier_part_numbers": {
    "mollit_7": ["labore id adipisicing culpa commodo"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "aute",
    "nisi reprehenderit",
    "sed fugiat mollit Lorem",
    "sint anim",
    "nulla"
  ],
  "connected_source_net_ids": [
    "fugiat sunt sit culpa velit",
    "ipsum elit",
    "nostrud veniam nulla aliqua"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -31376209.729039937,
  "box_width": "cupidatat culpa",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "anim reprehenderit consectetur aliquip",
  "pcb_trace_id": "pcb_trace_1",
  "source_trace_id": "source_trace_1",
  "pcb_component_ids": ["pcb_component_1"],
...
```json
{
  ...
  "supplier_part_numbers": {
    "ad80b": ["incididunt"],
    "nulla_3f": ["dolore aute esse dolor eiusmod", "ad adipisicing"],
    "elit5": [
      "deserunt",
      "nisi ullamco dolore Ut",
      "incididunt",
      "esse enim consectetur"
    ],
    "velit_3": ["reprehenderit nulla"]
  }
}
```
