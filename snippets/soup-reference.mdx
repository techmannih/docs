...
```json
{
  ...
  "name": "E1",
  "manufacturer_part_number": "ut aute",
  "supplier_part_numbers": {
    "irurecf": ["ex eu", "proident dolor", "deserunt laborum ea laboris"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["dolore nisi sed exercitation elit"],
  "is_ground": true,
  "is_analog_signal": true,
  "trace_width": 10763872.79943885
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ipsum sit in ea",
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "dolor occaecat sint ut et",
  "supplier_part_numbers": {
    "eiusmod_5b": [
      "in velit labore elit pariatur",
      "Ut sunt",
      "mollit adipisicing qui minim"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "et ut in",
  "supplier_part_numbers": {
    "aliquip__": [
      "ullamco qui",
      "id occaecat cupidatat ullamco",
      "elit minim deserunt dolore",
      "voluptate et commodo quis",
      "tempor aute eu dolor"
    ],
    "culpa_3": ["officia", "deserunt nulla", "aliqua exercitation minim"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "ea sed reprehenderit laborum sunt",
  "supplier_part_numbers": {
    "aliquae": [
      "officia dolor ut laborum qui",
      "nulla dolore sit",
      "eiusmod sit id Lorem"
    ],
    "exercitationc5_": ["qui et do sed tempor", "veniam Duis sunt sed tempor"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["culpa ut commodo velit et"],
  "connected_source_net_ids": [
    "sunt pariatur ut in",
    "voluptate sint",
    "ipsum adipisicing commodo",
    "enim officia dolor dolore"
  ]
}
```
...
```json
{
  ...
  "radius_x": 81684704.05215365,
  "radius_y": -39943708.5889788,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "non proident adipisicing dolor esse",
  "supplier_part_numbers": {
    "cillum_c83": ["commodo", "sunt", "in consequat labore velit"],
    "Duisd5": [
      "tempor",
      "amet laboris",
      "pariatur incididunt adipisicing dolore commodo",
      "fugiat ea exercitation enim culpa",
      "in"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "occaecat commodo voluptate ut Excepteur",
  "model_obj_url": "id",
  "model_stl_url": "Ut proident cupidatat laborum",
  "model_3mf_url": "aute",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -34400681.05949456,
  "outer_height": 56209970.31252065,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
