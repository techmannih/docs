...
```json
{
  ...
  "supplier_part_numbers": {
    "nullac": ["reprehenderit ullamco", "nisi non minim fugiat"],
    "ex_8": [
      "Ut sunt labore aute nulla",
      "eu",
      "id eiusmod",
      "eiusmod laborum Excepteur amet",
      "do fugiat proident Excepteur"
    ]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["irure enim nulla veniam aliqua", "exercitation"],
  "is_power": true,
  "is_ground": true,
  "is_digital_signal": false,
  "is_analog_signal": true,
  "trace_width": 22675395.016125947
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "officia ut minim proident ut",
  "supplier_part_numbers": {
    "qui_515": ["minim laboris", "ad anim cupidatat"],
    "in_988": [
      "minim qui amet anim",
      "ad sint nisi Excepteur ut",
      "cillum sit elit laboris",
      "fugiat elit in in exercitation"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "enim amet sed",
  "supplier_part_numbers": {
    "ex2a7": ["sed", "deserunt velit", "reprehenderit"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "quis exercitation dolor enim",
  "supplier_part_numbers": {
    "eiusmod_1": [
      "velit Duis magna",
      "dolore non ea quis exercitation",
      "culpa laborum tempor ut dolore"
    ],
    "sint_c": [
      "occaecat aliquip Excepteur",
      "quis aliquip in veniam tempor",
      "dolore adipisicing",
      "ad",
      "Ut"
    ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "ex eu",
  "supplier_part_numbers": {
    "non9": ["amet aute do est exercitation"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "consectetur id in cillum irure",
  "supplier_part_numbers": {
    "proident3": ["magna fugiat", "Excepteur ea"],
    "consequat73": [
      "sint velit",
      "laboris anim",
      "enim eu",
    ...
    "pariatur_d": [
      "velit",
      "commodo",
      "occaecat aliqua enim aute sunt",
      "nisi"
    ],
    "in6": ["cillum nulla veniam anim consectetur"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["in culpa id aliquip", "anim ut"],
  "connected_source_net_ids": [
    "exercitation sunt",
    "sit consequat in commodo",
    "eu pariatur officia aliqua",
    "exercitation dolor"
  ]
}
```
...
```json
{
  ...
  "message": "aliquip aliqua dolore eu"
}
```
...
```json
{
  ...
  "message": "reprehenderit dolor consectetur exercitation",
...
```json
{
  ...
  "radius_x": 92285502.68575582,
  "radius_y": "eiusmod sunt",
  "layer": "top"
}
```
  ...
  "route": [
    {
      ...
      "y": "1mm",
      "to_layer": "bottom",
      "trace_width": "laborum cillum amet nisi enim"
    },
    {
      "x": "3mm",
      "y": "1mm",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "dolore exercitation ullamco",
  "supplier_part_numbers": {
    "consectetur2": [
      "dolor sit sunt Ut",
      "ipsum sit dolore quis",
      "velit et officia",
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "minim non Lorem aliqua nisi"
  },
  "layer": "top",
  "model_obj_url": "nostrud adipisicing Excepteur qui",
  "model_3mf_url": "in Lorem tempor",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "consequat reprehenderit est Duis amet"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -87364443.96288623,
  "outer_height": 37376318.768417746,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "magna commodo consequat cillum"
}
```
...
{
  "irurefb3": {
    "left_margin": -33078127.969857186,
    "right_margin": 40300421.32470596,
    "top_margin": -36060751.552088454
  },
  "labore_5a0": {
    "top_margin": 47864661.64716229
  },
  "ex_d": {
    "left_margin": "et mollit commodo"
  },
  "proident2": {
    "left_margin": 3923555.5522949547,
    "right_margin": "Lorem pariatur proident mollit dolor",
    "top_margin": "proident laboris Duis officia"
  }
}
```
