...
```json
{
  ...
  "name": "C1",
  "manufacturer_part_number": "ex exercitation irure est minim"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "consequat_a": [
      "amet",
      "ipsum cillum dolor aute ex",
      "cillum nulla dolore in",
      "officia ut"
    ]
  }
}
...
```json
{
  ...
  "trace_width": 14434321.028835654
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "consequat_94": [
      "dolore laborum nostrud qui",
      "mollit amet ullamco ex",
      "sit amet pariatur Lorem consequat",
      "cillum quis adipisicing minim commodo",
      "mollit incididunt"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "Duis deserunt proident",
  "supplier_part_numbers": {
    "est_53e": ["dolor in officia ex", "ut aliquip"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "cupidatat sint magna proident velit",
  "supplier_part_numbers": {
    "sit_1": ["do"],
    "laborum_3d": [
      "quis fugiat nostrud elit do",
      "dolor",
      "exercitation elit culpa laborum"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "Duis consectetur",
  "supplier_part_numbers": {
    "deserunt_70": [
      "officia laborum in amet est",
      "cillum labore veniam enim",
      "eu dolor voluptate esse pariatur"
    ],
    "aliqua_80": [
      "adipisicing sit tempor non",
      "irure Duis",
      "dolor",
      "Excepteur sed veniam adipisicing sunt"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "Duisd": ["Excepteur et Lorem sit"],
    "labore5": ["elit sed laborum consequat"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "minim3a": [
      "laborum sunt mollit enim",
      "in",
      "non elit ad in anim",
      "elit sint reprehenderit voluptate",
      "velit"
    ],
    "ad_0": ["Lorem", "nisi est", "Excepteur", "et"],
    "elitc": [
      "laboris nisi esse Ut ex",
      "anim dolore in sit",
      "Excepteur cillum voluptate ad amet",
      "consequat",
      "anim"
    ],
    "dolore7": ["fugiat nostrud"],
    "consequat_f27": []
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "nostrud amet consectetur",
  "supplier_part_numbers": {
    "pariatur_00e": ["esse aute sed non quis"],
    "eiusmod_": [
      "aliquip",
      "ut esse pariatur",
      "et voluptate elit quis",
      "veniam deserunt cupidatat occaecat fugiat",
      "non"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": [
    "voluptate occaecat tempor",
    "non Excepteur Ut",
    "laboris amet nulla in labore",
    "mollit"
  ],
  "connected_source_net_ids": [
    "dolore Ut quis sunt",
    "ad magna ut commodo mollit"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "do mollit velit adipisicing",
  "pin_styles": {},
  "box_width": 52641251.161336124,
  "symbol_name": "sed Ut ullamco",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "officia ad laborum labore"
}
```
...
```json
{
  ...
  "message": "ullamco adipisicing non"
}
```
...
```json
{
  ...
  "route": [
    ...
    },
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": "nisi sunt adipisicing"
    }
  ]
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ex_a2_": [
      "laboris",
      "amet deserunt magna",
      "officia culpa veniam qui sed",
      "exercitation ut voluptate eiusmod"
    ],
    "incididunt7e": [],
    "ex3e": ["in", "amet enim dolor ad eiusmod", "incididunt"],
    "utdd": ["sit", "est velit irure", "adipisicing", "proident", "aute ad"]
  }
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "incididunt in dolor non fugiat"
}
```
...
```json
{
  "eiusmod6": {
    "left_margin": "eiusmod",
    "right_margin": 34605446.022807,
    "top_margin": -13394401.646641135,
    "bottom_margin": "in velit aute"
  },
  "consequataf": {
    "left_margin": -78697638.08166277,
    "right_margin": 65871624.780151755,
    "top_margin": -31957662.251293063
  },
  "dolore_496": {
    "left_margin": 42849849.28035346,
    "right_margin": -837338.6507557184,
    "top_margin": "quis eu exercitation laborum mollit"
  },
  "in_80": {
    "left_margin": -348718.5112106353,
    "right_margin": "qui",
    "top_margin": -57128691.8242174,
    "bottom_margin": "nulla"
  }
}
```
