...
```json
{
  ...
  "supplier_part_numbers": {
    "ide_a": ["ad consequat", "id esse eiusmod ut"],
    "deserunt__": ["ea id", "id exercitation dolor incididunt laboris"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["reprehenderit aute fugiat commodo amet"],
  "is_ground": false,
  "is_digital_signal": false,
  "is_analog_signal": false,
  "trace_width": 14827340.142550185
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "mollit commodo tempor fugiat officia",
  "supplier_part_numbers": {
    "adea": ["sunt", "exercitation dolore id eu", "minim sint dolore", "nisi"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolor3_": [
      "ut deserunt nostrud dolore ea",
      "exercitation in",
      "ea laborum enim id adipisicing",
      "sed aliquip nostrud id"
    ],
    "occaecat_9b": [
      "nulla enim",
      "ad tempor culpa",
      "dolor in quis Lorem deserunt",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "enim voluptate sint quis",
  "supplier_part_numbers": {
    "reprehenderit_c5": [
      "aliqua sunt",
      "aliqua",
      "reprehenderit adipisicing laborum consequat"
    ],
    "in_c": ["do sed in quis exercitation", "velit Duis"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "veniam aliquip dolor et",
  "supplier_part_numbers": {
    "minima7_": [
      "non dolor sit",
      "sed labore magna sit culpa",
      "velit",
      "in ullamco"
    ]
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "adipisicing ut nostrud consequat et",
  "supplier_part_numbers": {
    "mollit35": [
      "minim elit incididunt proident",
      "cupidatat aliqua irure esse",
      "dolore",
      "reprehenderit sunt esse",
      "quis cillum"
    ],
    "dolorea": ["dolore", "aliquip in est do"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_net_ids": ["dolore"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "incididunt",
  "pin_styles": {},
  "box_width": "aute dolore consectetur dolore",
  "symbol_name": "in",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "message": "sed minim sit proident"
}
```
...
```json
{
  ...
  "radius_x": "sed dolor elit commodo",
  "radius_y": "anim dolore officia aute",
  "layer": "top"
}
```
  ...
  "route": [
    {
      ...
      "y": "1mm",
      "to_layer": "bottom",
      "trace_width": "sit anim amet reprehenderit"
    }
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "magna in nulla est",
  "supplier_part_numbers": {
    "exercitationbde": [
      "Lorem laborum nostrud eu ea",
      "velit voluptate",
      "aliqua voluptate",
      "tempor Duis culpa ad esse",
      "eu quis occaecat"
    ]
  }
}
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "occaecat Duis dolor"
  },
  "layer": "top",
  "footprinter_string": "adipisicing",
  "model_obj_url": "culpa",
  "model_stl_url": "ex qui dolore",
  "model_3mf_url": "dolor occaecat",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 74378702.73087963,
  "outer_height": -81504313.25347562,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "Excepteur consequat incididunt cupidatat"
}
```
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": -30180659.594171375
}
```
...
{
  "incididunt_401": {
    "top_margin": "dolor aute",
    "bottom_margin": "anim sit consequat laborum sint"
  }
}
```
