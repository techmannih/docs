...
```json
{
  ...
  "ftype": "do cillum eu elit magna",
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "velit ut Lorem minim dolore",
  "supplier_part_numbers": {
    "officia_4a4": [],
    "ind": ["consequat sunt ipsum sint esse", "eu dolor ex nisi"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "consectetur cupidatat"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "elit reprehenderit sint deserunt ut",
  "supplier_part_numbers": {
    "Lorema73": ["laboris"],
    "eiusmod_7d6": [
      "commodo est nostrud id reprehenderit",
      "ullamco eu irure",
      "et fugiat qui consequat",
      "mollit in"
    ],
    "ex8a": ["do in mollit minim"],
    "dolorc8": [
      "ad mollit ut",
      "Duis tempor dolor",
      "elit reprehenderit dolor laboris consequat"
    ],
    "dolore_2b": [
      "magna ut minim",
      "irure veniam",
      "Duis ipsum Excepteur labore"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ea_f38": [
      "do",
      "amet aliqua pariatur qui nostrud",
      "consectetur",
      "ullamco incididunt"
    ],
    "do_6": [
      "culpa laboris dolore deserunt",
      "aliqua",
      "magna in elit sed aliquip",
      "ex aliquip"
    ],
    "ex_a": ["est"]
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "minim in esse",
  "supplier_part_numbers": {
    "eab2": [
      "adipisicing dolor non labore velit",
      "cupidatat ullamco Excepteur culpa",
      "proident reprehenderit est nostrud",
      "Lorem"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "deserunt Lorem Ut dolore"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "est mollit Lorem ex",
  "supplier_part_numbers": {
    "aliquip_1_2": ["ea"],
    "deserunt8": []
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "irure dolor dolore",
  "supplier_part_numbers": {
    "exercitation_05": []
  },
  "voltage": "5V"
...
```json
{
  ...
  "supplier_part_numbers": {
    "ut_6": [
      "nulla ut veniam exercitation",
      "sunt ut laborum aliquip id",
      "incididunt ex in"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": [
    "ex",
    "Ut",
    "occaecat quis labore reprehenderit",
    "dolore"
  ],
  "connected_source_net_ids": ["irure"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 84901771.60847262,
  "pin_styles": {},
  "box_width": "sunt nisi quis aliqua",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "velit nulla laborum deserunt"
}
```
...
```json
{
  ...
  "message": "id in deserunt exercitation ullamco"
}
```
...
```json
{
  ...
  "radius_x": "non commodo quis",
  "radius_y": "adipisicing",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "in do",
  "supplier_part_numbers": {
    "ea_ca": ["non", "dolore incididunt veniam", "quis deserunt"]
  }
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -71723070.44635326,
  "outer_height": -27325950.099265084,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "laboris id velit dolore commodo"
}
```
...
{
  "dolore_ac": {
    "left_margin": 9407953.356694639,
    "right_margin": -59424683.309643015,
    "top_margin": -58452734.12095287,
    "bottom_margin": 444605.56858690083
  }
}
```
