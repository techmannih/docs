...
```json
{
  ...
  "name": "P1",
  "manufacturer_part_number": "incididunt",
  "supplier_part_numbers": {
    "suntf": [
      "ipsum qui quis minim in",
      "quis sed fugiat ex esse",
      "irure sed incididunt ut",
      "velit",
      "sit commodo pariatur"
    ],
    "amet_8": [
      "eiusmod dolore aliquip eu consectetur",
      "tempor est aliqua nisi",
      "Excepteur ut ex consequat",
      "velit in occaecat ea"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "amet et ad laborum",
  "supplier_part_numbers": {
    "do_8b4": [
      "quis sed elit laboris consectetur",
      "in Ut",
      "eiusmod incididunt",
      "cillum sit amet id ut",
      "amet Duis"
    ],
    "qui6c6": ["dolor", "reprehenderit aute Excepteur sit"],
    "laborumb": ["aliquip sed sint", "amet sunt tempor"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "quis ut mollit",
    "amet incididunt est sit consequat",
    "nulla cillum quis",
    "incididunt ex veniam ut",
    "incididunt dolore commodo mollit"
  ],
  "is_power": false,
...
```json
{
  ...
  "supplier_part_numbers": {
    "aliqua7": ["enim irure occaecat laborum et", "aliqua"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ut reprehenderit aliqua",
  "supplier_part_numbers": {
    "mollit38": [
      "cillum irure laborum",
      "consequat ut officia",
      "dolor nisi commodo fugiat proident"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "est eiusmod dolor occaecat Excepteur",
  "supplier_part_numbers": {
    "ina1": [
      "officia occaecat ipsum",
      "Ut deserunt culpa laborum",
      "incididunt ad in dolore cillum",
      "esse sunt in eu"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "esse ut ea",
  "supplier_part_numbers": {
    "pariatur_a8d": ["cillum"],
    "site09": ["ad", "ut cupidatat"],
    "deseruntace": ["ullamco dolor non cillum anim", "est", "mollit", "dolore"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "sunt in et",
    "quis commodo ut mollit Duis",
    "sit aliquip veniam esse"
  ],
  "connected_source_net_ids": [
    "occaecat et",
    "in Ut sunt deserunt est",
    "nisi",
    "deserunt fugiat ullamco Duis",
    "enim in magna"
  ]
}
```
...
```json
{
  ...
  "pin_spacing": "commodo",
  "pin_styles": {},
  "symbol_name": "esse sunt consequat enim cillum",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "message": "cillum deserunt non veniam Ut",
...
```json
{
  ...
  "radius_x": 13340070.749428675,
  "radius_y": 83428398.43698767,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "elit nostrud proident amet cillum",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "sed sunt",
  "supplier_part_numbers": {
    "exercitation__": ["deserunt", "proident"],
    "in_72": [
      "ut sed nostrud exercitation",
      "elit in",
      "pariatur deserunt laboris cupidatat"
    ]
  }
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "et nisi minim eu officia",
  "model_obj_url": "cupidatat Excepteur eu irure",
  "model_stl_url": "est Ut commodo laborum amet",
  "model_3mf_url": "aliqua Ut sunt",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "culpa fugiat laborum"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 15507544.621952936,
  "outer_height": -99965947.18938603,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "reprehenderitfbb": {
    "right_margin": -28017961.661130816,
    "top_margin": "aliquip esse occaecat",
    "bottom_margin": "pariatur"
  },
  "officia7": {
    "left_margin": -22805389.210957512,
    "bottom_margin": 56259737.425359815
  }
}
```
