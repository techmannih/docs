...
```json
{
  ...
  "supplier_part_numbers": {
    "uta52": ["in velit veniam aliquip", "esse cillum"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "aliquaf3_": [
      "cillum sint magna ex",
      "id tempor deserunt magna in",
      "minim",
      "magna Lorem ex",
      "tempor voluptate ex nulla"
    ]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "eu laboris nostrud aliquip id",
    "nisi sint tempor in",
    "ea exercitation nulla amet",
    "velit laborum nulla laboris in",
    "anim laborum nostrud eiusmod aliquip"
  ],
  "is_power": true,
  "is_ground": false,
  "is_digital_signal": false,
  "is_analog_signal": true,
  "trace_width": 85784563.77989179
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "incd4": [
      "laborum",
      "minim",
      "reprehenderit non irure pariatur",
      "aute dolor ex"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "in_5": ["laboris elit esse consectetur ipsum", "tempor", "cupidatat amet"],
    "eu_6": ["magna enim"]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "proident occaecat sed",
  "supplier_part_numbers": {
    "eiusmod_": ["ullamco in laborum non qui", "eu aliqua id non proident"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "nulla tempor",
  "supplier_part_numbers": {
    "deserunt_9": [
      "qui",
      "proident nisi minim",
      "amet voluptate occaecat sint"
    ],
    "adipisicing26": [
      "dolor in labore eiusmod",
      "occaecat nulla aute dolor",
      "ullamco minim labore in Excepteur",
      "fugiat",
      "eu aute quis"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "ex nulla adipisicing",
  "supplier_part_numbers": {
    "voluptateb41": ["dolore Ut Excepteur", "veniam commodo ut dolor"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "Ut officia",
  "supplier_part_numbers": {
    "ad3d": [
      "culpa",
      "aliquip sunt nulla laboris",
      "sunt",
      "consectetur",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "esse ea adipisicing do occaecat",
  "supplier_part_numbers": {
    "in_00e": [
      "ut",
      "ad ex occaecat in",
      "ut occaecat laboris in do",
      "cillum pariatur ex dolore",
      "minim exercitation"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": [
    ...
    "anim",
    "consequat consectetur voluptate dolor"
  ],
  "connected_source_net_ids": ["cillum minim sunt laborum", "aute"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 81329183.14641261,
  "box_width": 17983617.276851088,
  "symbol_name": "sunt",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
...
```json
{
  ...
  "radius_x": "culpa magna deserunt sunt",
  "radius_y": "dolore nisi",
  "layer": "top"
}
```
...
```json
{
  ...
  "name": "L1",
  "supplier_part_numbers": {
    "reprehenderit2a": ["est et Duis aute eu"],
    "in_4b6": [
      "exercitation est nisi",
      "reprehenderit Lorem ex",
      "veniam mollit ullamco in incididunt",
      "eiusmod",
      "qui"
    ],
    "esta": [
    ...
    "ea6": [
      "consectetur laboris exercitation incididunt",
      "nulla irure",
      "irure",
      "commodo eu ullamco voluptate in"
    ]
  }
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "consequat consectetur ea aliqua",
  "model_obj_url": "occaecat laboris ad in cupidatat",
  "model_stl_url": "eiusmod commodo dolor",
  "model_3mf_url": "mollit labore cillum",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layer": "top",
  "description": "non incididunt tempor est dolore",
  "shape": "rect",
  "x": "3mm",
  "y": "1mm",
  "width": "5mm",
