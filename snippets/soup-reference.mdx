...
```json
{
  ...
  "supplier_part_numbers": {
    "proident368": [
      "laborum occaecat",
      "consectetur exercitation nostrud laborum aliquip"
    ]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "deserunt consequat ea id proident",
    "ut",
    "ullamco fugiat",
    "velit",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "in reprehenderit et",
  "supplier_part_numbers": {
    "in_405": ["ut", "culpa quis", "occaecat Duis", "ad proident ex in amet"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "deserunt cillum ut velit Excepteur",
  "supplier_part_numbers": {
    "consequat_ca4": [
      "anim ullamco consectetur dolor",
      "ad eu velit",
      "cupidatat ea minim pariatur",
      "exercitation ut Duis amet"
    ],
    "occaecat509": [
      "pariatur ullamco elit",
      "aute",
      "anim laborum cillum ut magna"
    ],
    "elit_5": [
      "reprehenderit Excepteur sed et",
      "tempor",
      "sint labore",
      "irure",
      "minim mollit tempor enim ex"
    ],
    "labore_3a": ["sunt deserunt", "culpa eiusmod exercitation", "dolor in ut"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "consectetur laborum proident elit in",
  "supplier_part_numbers": {
    "do_a": [
      "aliquip ea laborum",
      "culpa consequat minim dolore exercitation",
      "Ut et officia do ad"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "cupidatat nisi esse Excepteur",
  "supplier_part_numbers": {
    "Lorem1": [
      "nulla do minim nisi eu",
      "sunt ut voluptate",
      "adipisicing magna laborum",
      "veniam aliquip voluptate quis incididunt"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "nisi enim tempor amet dolore",
  "supplier_part_numbers": {
    "dolor_8a": ["enim reprehenderit cillum tempor"],
    "aliqua__09": [
      "amet incididunt eu in",
...
```json
{
  ...
  "connected_source_port_ids": [
    "ea exercitation enim laborum",
    "minim ea",
    "velit adipisicing amet eu veniam",
    "commodo quis sed",
    "minim Ut laborum"
  ],
  "connected_source_net_ids": [
    "non sed in nostrud nulla",
    "dolor cupidatat occaecat labore"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 34928626.95907077,
  "box_width": -1334562.049084559,
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  }
...
```json
{
  ...
  "message": "proident Lorem exercitation in amet"
}
```
...
```json
{
  ...
  "radius_x": "reprehenderit proident irure",
  "radius_y": -76251676.42683116,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "enim incididunt voluptate",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "dolore eiusmod Excepteur",
  "supplier_part_numbers": {
    "nulla_5": ["laboris sed", "in", "minim id consequat quis"],
    "laborisb7": ["dolor ad in pariatur nulla"]
  }
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "incididunt deserunt et",
  "model_obj_url": "dolore",
  "model_stl_url": "anim non proident consectetur",
  "model_3mf_url": "incididunt",
  "model_jscad": []
}
```
