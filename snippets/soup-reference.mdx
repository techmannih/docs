...
```json
{
  ...
  "ftype": "officia ullamco nisi velit",
  "source_component_id": "source_component_1",
  "name": "O1",
  "manufacturer_part_number": "elit",
  "supplier_part_numbers": {
    "dolor9d": ["sint minim ut adipisicing velit", "dolore"],
    "consequat6": ["labore", "fugiat", "incididunt Ut"],
    "esse8d": ["eiusmod esse"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "enim",
    "mollit nisi velit consequat",
    "consequat dolore officia anim Ut",
    "sit"
  ],
  "is_power": true,
  "is_ground": false,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "est occaecat nulla sint",
  "supplier_part_numbers": {
    "cillum_9": [
      "Duis aute",
      "nostrud irure",
    ...
    "do6ff": [
      ...
      "elit nostrud non",
      "eu est",
      "occaecat dolore aliqua laboris",
      "ipsum consectetur"
    ],
    "fugiat_34": [
      "officia ut exercitation",
      "anim minim consectetur sunt",
      "dolor deserunt",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "sit ullamco dolore sed cupidatat",
  "supplier_part_numbers": {
    "dolor_ec6": ["dolor enim qui", "in eu dolore commodo cupidatat"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "tempor culpa Excepteur in",
  "supplier_part_numbers": {
    "aute0f": [
      "dolor ut",
      "sed laborum sunt sint",
      "mollit officia dolor nulla",
      "incididunt sunt commodo non"
    ],
    "eu_a": [
      "velit dolore",
      "officia laborum eiusmod sunt",
      "Ut anim sit ipsum",
      "eu"
    ]
  }
...
```json
{
  ...
  "supplier_part_numbers": {
    "nostrud___": ["Lorem ut voluptate ea ut", "reprehenderit culpa aute id"],
    "non765": ["in occaecat"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "ex ut nulla",
  "supplier_part_numbers": {
    "cupidatat21d": ["quis nostrud", "qui", "pariatur", "magna ut eiusmod"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "minim do dolor",
  "supplier_part_numbers": {
    "qui_76": ["ut nulla id ullamco", "irure occaecat cillum ut quis"],
    "culpa_0__": ["ut cupidatat commodo"],
    "velit_40": ["adipisicing"],
    "Duisd8": ["sunt Ut incididunt ut ipsum", "in"],
    "quis932": ["aute culpa nisi", "qui amet tempor pariatur eu", "quis Lorem"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "tempor incididunt est",
  "resistance": "1k"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "Duis incididunt",
  "pin_styles": {},
  "box_width": -6108269.185753599,
  "symbol_name": "ut Lorem tempor laborum culpa",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "radius_x": "veniam dolore labore incididunt elit",
  "radius_y": -55685546.68728436,
  "layer": "top"
}
```
...
```json
{
  ...
  "route": [
    ...
    },
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": "occaecat exercitation et Ut velit"
    }
  ]
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "tempor2": ["veniam aliquip nisi", "nisi"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -79507554.10100521,
  "outer_height": -42028951.82980866,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": "sint Duis minim deserunt nulla"
}
```
...
{
  "enim_271": {
    "left_margin": "ipsum elit",
    "top_margin": 60042460.21107194,
    "bottom_margin": 13084574.875217348
  }
}
```
