...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["consequat", "eiusmod elit ullamco ad dolore"],
  "is_power": false,
  "is_ground": false,
...
```json
{
  ...
  "supplier_part_numbers": {
    "magna_2": [
      "sed Excepteur sunt",
      "qui Ut mollit sint",
      "dolor ullamco qui magna"
    ],
    "in_1_1": ["aliquip minim", "non"],
    "ametb": ["est", "nisi elit do", "anim nostrud consectetur nulla"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "consectetur ex et mollit aute",
  "supplier_part_numbers": {
    "commodoe6b": [
      "ipsum consectetur proident",
      "cillum sed",
      "ea ex",
      "sunt culpa in consequat amet",
      "incididunt ex"
    ],
    "commodoc": ["reprehenderit", "laboris Ut dolore eu"],
    "nulla_56": ["et dolor", "tempor officia"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "pariatur sunt reprehenderit est",
  "supplier_part_numbers": {
    "aliquip9": [
      "velit reprehenderit dolore mollit",
      "nostrud",
      "velit ipsum quis",
      "fugiat",
      "ut"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "do ullamco dolor id",
  "supplier_part_numbers": {
    "Lorem_8": ["exercitation reprehenderit nisi in"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "officia anim",
  "supplier_part_numbers": {
    "consequat741": ["Lorem in", "nisi voluptate"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "reprehenderit consectetur ullamco dolor",
  "supplier_part_numbers": {
    "doloree": [
      "in Duis",
      "fugiat incididunt amet non tempor",
      "est veniam in Lorem",
      "commodo proident nulla est esse"
    ],
    "in_6e": ["sed", "aliquip"],
    "anim_b": [
      "aliqua sunt",
      "consectetur",
      "dolor reprehenderit laboris anim sint",
      "Lorem",
      "deserunt"
    ],
    "veniam_5": [
      "dolor",
      "dolore irure sunt veniam",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "eiusmod adipisicing",
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["aliquip ut"],
  "connected_source_net_ids": [
    "consequat",
    "mollit dolore",
    "quis fugiat amet reprehenderit dolore",
    "ut nostrud id"
  ]
}
```
...
```json
{
  ...
  "message": "ad velit adipisicing nisi"
}
```
...
```json
{
  ...
  "color": "ullamco exercitation Lorem eiusmod pariatur"
}
```
...
```json
{
  ...
  "message": "anim laboris reprehenderit nulla pariatur",
...
```json
{
  ...
  "message": "in sed aliqua mollit id",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
  ...
  "route": [
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": "labore dolore dolor id ut"
    },
    {
      "x": "3mm",
      "y": "1mm",
...
```json
{
  ...
  "rotation": "90deg",
  "layer": "top",
  "footprinter_string": "dolor nostrud Excepteur",
  "model_3mf_url": "aliqua eiusmod",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "veniam consequat Lorem do eu"
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "dolore anim laborum Ut culpa"
}
```
...
```json
{
  ...
  "via": false,
  "to_layer": "bottom",
  "trace_width": "tempor aute pariatur"
}
```
...
{
  "nostrud2d": {
    "top_margin": -20486762.105152458,
    "bottom_margin": 53169683.78631523
  },
  "enim_e": {
    "left_margin": "consequat elit commodo in",
    "right_margin": "ad pariatur nostrud",
    "top_margin": -60996872.651797764,
    "bottom_margin": 25132395.00104852
  }
}
```
