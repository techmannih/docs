...
```json
{
  ...
  "supplier_part_numbers": {
    "ipsumc_": [
      "ea aliqua nulla in",
      "laborum sint ullamco in",
      "adipisicing",
      "dolore non aliquip sunt"
    ],
    "ea6_3": [
      "deserunt id",
      "anim sit officia do in",
      "voluptate sed sit nostrud ut",
      "incididunt non ea adipisicing voluptate",
      "fugiat"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "minim occaecat",
  "supplier_part_numbers": {
    "eiusmod_05c": ["minim"]
  }
}
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["irure aliqua laborum elit in"],
  "is_ground": true,
  "is_analog_signal": true,
  "trace_width": 65532868.148458034
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "tempor dolor consectetur enim",
  "supplier_part_numbers": {
    "occaecat7b": ["cupidatat", "incididunt est do ad", "aliqua nulla"],
    "nostrud_c6a": [
      "quis sit ea",
      "consectetur labore",
      "culpa ad pariatur aute",
      "occaecat",
      "irure sint dolor dolor"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "irure labore sint in tempor",
  "supplier_part_numbers": {
    "est_b1": ["reprehenderit sed sit"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "ut nisi",
  "supplier_part_numbers": {
    "qui_83": ["esse quis"],
    "qui_3": ["labore amet", "occaecat non"],
    "incididunt25a": [
      "veniam anim magna",
      "ex est",
...
```json
{
  ...
  "supplier_part_numbers": {
    "pariatur_7": [
      "id Lorem magna officia",
      "incididunt",
      "proident elit esse",
      "magna in nisi est sed",
      "in Lorem exercitation non esse"
    ],
    "cupidatat__d": []
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": ["ut"],
  "connected_source_net_ids": [
    "ut sunt ut ad ea",
    "in ullamco",
    "reprehenderit in ex veniam anim",
    "irure sed occaecat qui"
  ]
}
```
...
```json
{
  ...
  "schematic_component_id": "schematic_component_1",
  "pin_styles": {},
  "box_width": "ut consequat exercitation magna",
  "symbol_name": "culpa exercitation ipsum aute",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "text": "Hello, World!",
  "layer": "top",
  "color": "veniam id exercitation minim"
}
```
...
```json
{
  ...
  "message": "in occaecat id ut dolor"
}
```
...
```json
{
  ...
  "message": "in dolor eu fugiat dolore",
...
```json
{
  ...
  "radius_x": 34598072.5906986,
  "radius_y": -49155896.7592125,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "ad id",
  "supplier_part_numbers": {
    "commodo_b": [
      "minim adipisicing",
      "deserunt culpa",
      "enim tempor",
      "velit magna nisi dolore",
      "aliqua exercitation voluptate consequat proident"
    ]
  }
}
```
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "enim anim elit Excepteur"
  },
  "layer": "top",
  "footprinter_string": "cupidatat dolore tempor magna",
  "model_obj_url": "ipsum magna nostrud"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -89722376.06792128,
  "outer_height": -64458384.290236294,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "nisi_d8": {
    "left_margin": "adipisicing minim ut culpa occaecat",
    "right_margin": "id labore adipisicing",
    "top_margin": "ullamco reprehenderit velit",
    "bottom_margin": "mollit voluptate ut"
  }
}
```
