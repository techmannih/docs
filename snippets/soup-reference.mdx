...
```json
{
  ...
  "ftype": "incididunt enim",
  "source_component_id": "source_component_1",
  "name": "I1",
  "supplier_part_numbers": {
    "enimfd": ["nisi amet ullamco eiusmod ut"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "sint_b0": [
      "in esse",
      "laboris",
      "eiusmod nisi officia adipisicing sit",
      "ea esse Excepteur aliqua",
      "sed voluptate Excepteur aliqua"
    ],
    "ute_1": [
      "fugiat sint ex id irure",
      "amet aute",
...
```json
{
  ...
  "member_source_group_ids": [
    "fugiat",
    "mollit veniam consequat fugiat nisi",
    "culpa incididunt"
  ],
  "is_power": false,
...
```json
{
  ...
  "supplier_part_numbers": {
    "ex28": ["elit laborum"],
    "nostrud6_": [
      "eu deserunt ullamco dolor occaecat",
      "occaecat commodo",
      "pariatur ipsum fugiat veniam",
      "aute dolor exercitation Duis",
      "laborum minim nisi amet"
    ],
    "dolor76": ["minim velit sed"],
    "ad93": [
      "ut",
      "ea",
      "pariatur ullamco tempor culpa in",
      "commodo reprehenderit Lorem eiusmod",
...
```json
{
  ...
  "supplier_part_numbers": {
    "veniam_24d": [
      ...
      "nostrud",
      "ut voluptate adipisicing est proident",
      "deserunt irure ut",
      "ut"
    ],
    "reprehenderite7d": ["velit veniam", "irure Ut ad"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "name": "D1",
  "supplier_part_numbers": {
    "culpa1ac": ["Excepteur Duis laborum in exercitation", "est esse aliquip"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "voluptate_111": [
      "sed et",
      "irure",
      "tempor exercitation labore voluptate",
      "id velit nulla reprehenderit",
...
```json
{
  ...
  "supplier_part_numbers": {
    "in11": [
      "Duis anim",
      "minim non sunt elit",
      "voluptate ut amet tempor commodo"
    ],
    "culpa_a7": ["in exercitation cillum aliquip"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "et_80": [
      "est cupidatat velit culpa",
      "laborum eu",
      "sit nulla sunt fugiat est",
      "ea Excepteur nisi sunt",
      "aliqua"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": [
    "anim",
    "nostrud",
    "ut deserunt dolor incididunt dolore",
    "officia dolor"
  ],
  "connected_source_net_ids": ["proident Excepteur consectetur"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "aute in dolore",
  "box_width": "consectetur ullamco exercitation do",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "consequat sunt adipisicing proident",
...
```json
{
  ...
  "supplier_part_numbers": {
    "mollit_c_": [
      "aliquip ex",
      "cupidatat in id aliqua",
      "laboris Duis cillum sit labore",
      "consequat dolor in"
    ],
    "in_80": ["laborum consequat", "ad sint cillum proident"],
    "nisi4": ["voluptate ea veniam commodo esse", "incididunt elit ut"]
  }
}
```
...
```json
{
  ...
  "footprinter_string": "ut amet",
  "model_stl_url": "anim Lorem in aliquip aliqua"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 81551997.19231004,
  "outer_height": 4494251.928205222,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "exercitation pariatur in nostrud dolor"
}
```
