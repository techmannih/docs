...
```json
{
  ...
  "ftype": "eu veniam dolor aute",
  "source_component_id": "source_component_1",
  "name": "E1",
  "manufacturer_part_number": "voluptate amet elit in",
  "supplier_part_numbers": {
    "cillum6": [
      "reprehenderit",
      "sint dolore",
      "minim dolor",
      "magna reprehenderit nostrud Duis voluptate",
      "est"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "esse culpa do tempor labore",
  "supplier_part_numbers": {
    "elitd": [
      "id in consequat labore",
      "veniam cillum magna amet",
      "sunt ad",
      "sed elit",
      "eu dolor laboris sit qui"
    ],
    "aliquip_b": ["reprehenderit exercitation esse", "sunt id"],
    "eu_2c2": ["non nulla magna", "nostrud laboris non anim sint"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "laboris non do",
  "supplier_part_numbers": {
    "enima4": [
      "velit culpa do sunt ea",
      "reprehenderit ex est ad eu",
      "anim id",
      "laboris Duis in",
      "ut commodo consectetur laboris ipsum"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolore3a_": ["ad Lorem reprehenderit", "aliquip est amet magna aliqua"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "tempor_ac": [
      "cillum consectetur adipisicing reprehenderit deserunt",
      "non mollit proident"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "voluptate elit proident do",
  "supplier_part_numbers": {
    "eiusmod_a": ["cillum mollit sint", "eu sunt"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "ipsum occaecat laboris cupidatat elit",
  "supplier_part_numbers": {
    "in_92": ["exercitation ullamco", "dolore sit"],
    "qui_925": [
      "fugiat Duis aute voluptate",
      "commodo ut Ut",
      "laboris ad elit ullamco ut"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "dolor mollit nostrud in",
  "supplier_part_numbers": {
    "amet_24c": [
      "sed occaecat voluptate",
      "sit",
      "dolor adipisicing eiusmod",
      "cillum incididunt mollit",
      "reprehenderit culpa dolore velit"
    ],
    "anim_b6": ["ad Duis consequat", "do laboris in elit anim"],
    "et00": ["cillum veniam incididunt"],
    "magna_0c": ["proident laborum"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "consequat Ut proident ullamco",
    "minim ut consequat laboris fugiat",
    "quis",
    "mollit",
    "reprehenderit esse culpa amet ut"
  ],
  "connected_source_net_ids": ["velit"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -11385808.213224232,
  "pin_styles": {},
  "box_width": "velit est eu",
  "symbol_name": "anim elit incididunt dolore",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "consequat qui commodo nisi"
}
```
...
```json
{
  ...
  "radius_x": "laborum in voluptate dolor adipisicing",
  "radius_y": 38538631.478493065,
  "layer": "top"
}
```
...
```json
{
  ...
  "route": [
    ...
    },
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": "non officia dolor aliquip eu"
    },
    {
      "x": "3mm",
      "via": false
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "et laboris dolore ex"
  },
  "layer": "top",
  "footprinter_string": "voluptate sint",
  "model_stl_url": "cillum sunt eu in Duis",
  "model_3mf_url": "eu nisi laboris Lorem"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -97052928.9680476,
  "outer_height": 73473597.66693819,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "pariatur90a": {
    "right_margin": "deserunt",
    "bottom_margin": 73176995.66048789
  },
  "minim22": {
    "right_margin": -92298902.7637767,
    "top_margin": "elit",
    "bottom_margin": -41140999.87885225
  },
  "ex_0_": {
    "left_margin": "occaecat commodo ea culpa nisi"
  },
  "deserunt_8c": {
    "left_margin": "amet qui anim",
    "top_margin": "aliqua ullamco"
  }
}
```
