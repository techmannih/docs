...
```json
{
  ...
  "supplier_part_numbers": {
    "enim2f3": ["cupidatat Excepteur magna voluptate"]
  }
}
```
...
```json
{
  ...
  "trace_width": -2292477.3361742795
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "adipisicing ad",
  "supplier_part_numbers": {
    "consectetur_3_d": [
      "et",
      "ut pariatur magna",
...
```json
{
  ...
  "supplier_part_numbers": {
    "ullamco_a9": ["elit exercitation ullamco"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "incididunt_81f": [
      "aliqua mollit ut veniam reprehenderit",
      "eiusmod minim cillum quis ut",
      "non ut",
      "ullamco dolor sint",
      "voluptate cupidatat"
    ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "aliqua Ut in labore"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "elit ullamco nulla",
  "supplier_part_numbers": {
    "pariatur1c": ["laboris in"],
    "esse_1": ["aliqua"],
    "reprehenderit38": ["elit", "irure minim dolor esse"],
    "aliquip_f": ["ad dolor fugiat sed"],
    "amet_49": ["dolore aliquip nostrud"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "Duis50": [
      "consequat ea",
      "Lorem ullamco sit ex pariatur",
      "ut",
      "dolor ex"
    ],
    "aliqua_8f": [
      "dolor elit cupidatat sit nulla",
      "magna cillum commodo officia veniam",
      "anim exercitation dolore",
      "aute consequat in elit"
    ],
    "non16": [
      "consequat in ullamco incididunt proident",
      "commodo eiusmod anim fugiat",
      "sint tempor Duis"
    ],
    "consectetur_f5e": [
      "nostrud eiusmod dolor",
      "non cupidatat sed",
      "aute ut est aliquip incididunt",
      "magna et labore esse sit",
      "velit voluptate"
    ],
    "et_e": ["nisi nostrud proident", "adipisicing tempor dolore", "magna"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_net_ids": ["velit eiusmod labore dolor"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "cillum labore tempor proident",
  "box_width": 21353772.44216214,
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "message": "dolor velit culpa cillum"
}
```
...
```json
{
  ...
  "radius_x": "labore tempor laboris est",
  "radius_y": "tempor cillum",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "tempor eiusmod sunt exercitation ullamco",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "cupidatat sit nulla",
  "supplier_part_numbers": {
    "qui2": ["labore magna"],
    "nisi4_5": ["commodo proident velit non dolor", "dolor ipsum aliqua"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "tempor in adipisicing sit"
  },
  "layer": "top",
  "model_obj_url": "cillum ut",
  "model_stl_url": "nisi qui"
}
```
