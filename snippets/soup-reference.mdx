...
```json
{
  ...
  "supplier_part_numbers": {
    "elit_a": ["reprehenderit proident et veniam", "Lorem exercitation sit"]
  }
}
```
...
```json
{
  ...
  "name": "L1",
  "supplier_part_numbers": {
    "ea_d3": ["nisi esse irure aliqua", "voluptate do eu"],
    "id_da": ["irure velit", "amet Duis elit", "cillum qui mollit et nisi"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "occaecat veniam in",
  "supplier_part_numbers": {
    "laborume6": ["aute sed dolor fugiat ad"],
    "dolore10": [
      "ut anim",
      "anim est",
      "ullamco",
      "eu dolor voluptate esse proident"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "magna ex"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "officia esse culpa",
  "supplier_part_numbers": {
    "id27": [
      "nisi adipisicing minim irure aliquip",
      "nulla Lorem ut in",
      "Duis consectetur incididunt officia dolore"
    ],
    "consecteture": [
...
```json
{
  ...
  "supplier_part_numbers": {
    "ex_332": ["reprehenderit", "dolor laborum occaecat aute sunt"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "veniam sunt",
    "sit ipsum",
    "esse eu Lorem laboris",
    "occaecat",
    "dolore cupidatat"
  ],
  "connected_source_net_ids": ["elit deserunt", "ex"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "voluptate sint in",
  "pin_styles": {},
  "box_width": -36073264.538539715,
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "in reprehenderit adipisicing nulla eiusmod"
}
```
...
```json
{
  ...
  "message": "irure qui in exercitation amet"
}
```
...
```json
{
  ...
  "message": "in cillum consequat amet",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "mollit exercitation Duis fugiat",
  "supplier_part_numbers": {
    "mollit_82_": ["mollit", "consectetur commodo aliqua", "cupidatat"],
    "suntb_5": [
      "ex nulla in",
      "do enim minim",
      "adipisicing",
      "sed dolor anim do",
      "Lorem eiusmod sint amet"
    ],
    "mollite": ["ex", "ut ea elit enim", "consequat nisi ea dolor eiusmod"]
  }
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "commodo Lorem et consectetur laboris"
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
  ...
  "layer": "top",
  "footprinter_string": "dolor aliquip voluptate",
  "model_obj_url": "deserunt anim",
  "model_stl_url": "est quis id",
  "model_3mf_url": "nisi",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "mollit sunt id nostrud magna"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -23821694.799141154,
  "outer_height": -52405590.77720492,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "dolor_6bc": {
    "left_margin": 82834730.29187456,
    "bottom_margin": 44743718.06434968
  },
  "velit_655": {}
}
```
