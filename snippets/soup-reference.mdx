...
```json
{
  ...
  "name": "U1",
  "manufacturer_part_number": "deserunt cupidatat occaecat",
  "supplier_part_numbers": {
    "ullamco_33": ["reprehenderit Duis Lorem", "in Duis ad", "fugiat"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "nostrud non fugiat aliquip",
  "supplier_part_numbers": {
    "qui_32": [
      "et cillum dolore adipisicing aute",
      "et",
      "dolor quis in consectetur",
      "esse nisi sunt in",
      "anim labore Lorem"
    ],
    "veniam68": [
      "proident pariatur mollit velit",
      "consectetur non",
      "laborum proident do dolor",
      "labore qui Ut",
      "nisi dolore fugiat adipisicing ut"
    ]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["occaecat aliqua in"],
  "is_power": true,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": -74849622.4860284
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "esse dolor",
  "supplier_part_numbers": {
    "cillum_b3": ["dolor", "dolor nulla", "id ut quis est"],
    "in99c": ["ipsum sunt cillum"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "irure occaecat",
  "supplier_part_numbers": {
    "id3f": ["enim nisi ipsum sunt", "officia laboris ullamco sunt", "sunt"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "aliqua esse fugiat in"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "tempor ut et",
  "supplier_part_numbers": {
    "sit_b7": ["laborum"]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "magna7": ["cillum enim aute non", "reprehenderit anim Excepteur"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "veniam culpa aliquip",
  "supplier_part_numbers": {
    "est_4": [
      "incididunt aliqua dolor",
      "adipisicing",
      "ea sunt incididunt aute ut",
      "reprehenderit",
      "aute nisi"
    ],
    "pariatur_4b": [
      "ad nisi pariatur veniam in",
      "ex laborum in",
      "sed Duis consequat do",
      "dolor ad pariatur Excepteur"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "et mollit",
    "dolore amet culpa",
    "elit sint quis mollit"
  ],
  "connected_source_net_ids": ["do adipisicing dolor eiusmod aute"]
}
```
...
```json
{
  ...
  "color": "incididunt anim mollit velit ullamco"
}
```
...
```json
{
  ...
  "radius_x": -47960676.13594062,
  "radius_y": -63029723.7502822,
  "layer": "top"
}
```
  ...
  "route": [
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": 34545187.877527684
    },
    {
      "x": "3mm",
      "via": true,
...
```json
{
  ...
  "supplier_part_numbers": {
    "id61c": [
      "aute eiusmod cillum",
      "commodo in incididunt ipsum",
      "non proident deserunt sunt occaecat",
      "Excepteur do culpa"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "velit laboris minim aute"
  },
  "layer": "top",
  "footprinter_string": "non incididunt",
  "model_obj_url": "commodo consectetur",
  "model_stl_url": "minim Ut",
  "model_3mf_url": "ea nisi reprehenderit",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "cupidatat cillum dolor ea tempor"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -41362433.79608367,
  "outer_height": 7085957.343558207,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "dolore_eb": {
    "left_margin": "anim sit incididunt et",
    "right_margin": "cupidatat exercitation aliqua",
    "top_margin": -94549833.99790238
  },
  "Ut_a40": {
    "left_margin": "magna ut deserunt ullamco",
    "right_margin": "ea amet Excepteur Duis",
    "top_margin": "Excepteur aliquip commodo"
  }
}
```
