...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "dolore irure est mollit",
  "supplier_part_numbers": {
    "non_4": ["aliquip irure eiusmod dolor", "quis deserunt eiusmod laborum"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "laborum elit labore nisi pariatur",
    "ad ea reprehenderit exercitation laboris",
    "sed est"
  ],
  "is_ground": false,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "voluptate adipisicing"
}
```
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "cillum94": ["adipisicing occaecat", "consequat cillum Duis nostrud sunt"],
    "iruref": ["Ut mollit Duis", "non"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "magna_ef": [
      "commodo tempor minim voluptate laboris",
      "ut commodo reprehenderit",
      "dolor",
      "in dolor ea",
      "reprehenderit exercitation non officia nostrud"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "eu1c": [
      "Ut nostrud cupidatat elit non",
      "dolor",
      "ullamco in",
      "nulla dolore"
    ],
    "proident_5": ["Duis Ut"],
    "dolore458": ["nulla dolor"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "culpa sit",
  "supplier_part_numbers": {
    "ut7a4": [
      "incididunt voluptate",
      "aliqua exercitation adipisicing dolor minim",
      "adipisicing anim nulla in"
    ],
    "proident_2b": [
      "exercitation et eiusmod",
      "in adipisicing ex",
      "non labore cupidatat ipsum",
      "enim ullamco incididunt et cupidatat"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": ["reprehenderit"],
  "connected_source_net_ids": [
    "ex ad incididunt dolor in",
    "fugiat dolore",
    "velit Ut laborum aliqua ut",
    "quis ut et ullamco",
    "adipisicing"
  ]
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "Ut sed non aliquip eiusmod",
  "pin_styles": {},
  "box_width": "esse cupidatat Excepteur aliqua",
  "symbol_name": "Excepteur ullamco cupidatat enim",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "ut reprehenderit officia commodo nisi"
}
```
...
```json
{
  ...
  "color": "fugiat aliqua voluptate magna"
}
```
...
```json
{
  ...
  "radius_x": -87980376.29151976,
  "radius_y": "nisi Ut fugiat do qui",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "irure enim labore et aliquip",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "supplier_part_numbers": {
    "culpa_e5": ["officia occaecat Excepteur magna"]
  }
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "consectetur nostrud amet consequat eu",
  "model_obj_url": "veniam id",
  "model_stl_url": "tempor laboris Lorem",
  "model_3mf_url": "veniam proident",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "nulla consectetur reprehenderit sit"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -97029106.99699539,
  "outer_height": 38343599.69871616,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "officia in Excepteur in eiusmod"
}
```
...
{
  "incididunt96": {
    "left_margin": 44567310.17365256,
    "right_margin": 71258900.97959244,
    "top_margin": "velit",
    "bottom_margin": "enim deserunt dolore"
  }
}
```
