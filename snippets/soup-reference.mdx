...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "adipisicing cillum consectetur"
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["incididunt"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "exercitation nulla",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ipsum commodo magna Lorem",
  "supplier_part_numbers": {
    "consecteturf9f": ["esse proident dolor", "aute", "ut"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "eu deserunt id nisi",
  "supplier_part_numbers": {
    "do92": ["id", "commodo aliqua", "commodo anim tempor sed"],
    "sunta": [
      "Ut Lorem qui exercitation anim",
      "fugiat dolore veniam in",
      "ea pariatur",
      "eu"
    ],
    "consequat8": ["in ad nisi"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "aliquip incididunt",
  "supplier_part_numbers": {
    "ipsum54": [
      "Ut exercitation adipisicing",
      "pariatur",
      "elit deserunt est sed nisi",
      "aliquip pariatur in"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "in_6d": [
      "velit et in",
      "cupidatat sed occaecat esse nulla",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "Duis id",
  "supplier_part_numbers": {
    "ullamco6": [
      "ad aute non sed",
      "enim",
      "qui dolore",
      "laboris adipisicing ipsum Excepteur nisi",
      "nulla anim id"
    ],
    "in_f": [
      "id et",
      "Excepteur et anim officia nisi",
      "minim cillum Lorem sint occaecat",
      "Excepteur dolore non ut culpa",
      "magna"
    ],
    "exc": ["deserunt", "laboris", "et", "aliqua", "adipisicing nulla"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "consectetur magna commodo sed reprehenderit",
    "tempor ad adipisicing in",
    "irure",
    "in occaecat Lorem",
    "aliquip"
  ],
  "connected_source_net_ids": ["aute"]
}
```
...
```json
{
  ...
  "radius_x": -22025467.485347733,
  "radius_y": "Lorem ut adipisicing cillum",
  "layer": "top"
}
```
  ...
  "route": [
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": "nisi aliquip sed Excepteur in"
    },
    {
      "x": "3mm",
      "y": "1mm",
...
```json
{
  ...
  "supplier_part_numbers": {
    "inda": [
      "veniam consequat id pariatur velit",
      "Lorem exercitation",
      "proident anim"
    ]
  },
...
```json
{
  ...
  "rotation": "90deg",
  "layer": "top",
  "model_obj_url": "aliquip sed mollit",
  "model_stl_url": "sint labore amet ut in",
  "model_3mf_url": "irure dolor aute culpa pariatur",
  "model_jscad": {}
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "trace_width": -41982585.949313834
}
```
...
```json
{
  "dolor2": {
    "left_margin": "sit",
    "right_margin": "ipsum do occaecat labore consectetur",
    "top_margin": 74770114.39643714,
    "bottom_margin": 73532172.2747612
  }
}
```
