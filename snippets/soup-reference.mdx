...
```json
{
  ...
  "supplier_part_numbers": {
    "et_1": ["id dolor pariatur dolor"],
    "ex_8": ["sint aute nisi ad in"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "pariatur et enim voluptate nisi",
  "supplier_part_numbers": {
    "irure_17": [
      "non laborum",
      "ullamco officia",
      "proident laborum Lorem ut reprehenderit"
    ]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["magna proident", "ea", "sint ex ullamco"],
  "is_power": false,
  "is_ground": false,
  "is_digital_signal": true,
  "is_analog_signal": false,
  "trace_width": 82719185.28407997
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "voluptate deserunt esse in do",
  "supplier_part_numbers": {
    "fugiatf": ["Lorem Excepteur"],
    "esse19a": ["et", "ea anim", "eu cillum labore dolor pariatur", "id"],
    "ut6a5": ["dolore", "sint"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "minim amet",
  "supplier_part_numbers": {
    "deserunt_101": [
      "minim enim laboris",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "aliquip incididunt consectetur tempor sit"
}
```
...
```json
{
  ...
  "name": "D1",
  "supplier_part_numbers": {
    "proident_e": ["anim dolore", "sed", "est magna adipisicing sit", "sunt"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "exercitation in do",
  "supplier_part_numbers": {
    "dolorc": [
      "cillum sint sit in",
      "dolor eiusmod elit",
      "cillum",
      "ad nostrud reprehenderit esse voluptate",
      "cupidatat commodo laborum sunt"
    ],
    "anim8": [
      "reprehenderit amet tempor dolor",
      "elit nulla cillum occaecat officia",
      "in tempor non qui",
      "ullamco minim dolor dolore nulla"
    ]
  }
}
```
...
```json
{
  ...
  "name": "P1",
  "supplier_part_numbers": {
    "culpad": ["nulla consectetur tempor", "et"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "sed consequat nulla nostrud",
  "supplier_part_numbers": {
    "dolore85b": ["ipsum mollit in", "incididunt aliquip fugiat dolore"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "enim aliqua officia cupidatat",
    "Excepteur adipisicing elit ut ullamco"
  ],
  "connected_source_net_ids": [
    "in laborum Duis",
    "nostrud id irure velit dolor",
    "labore incididunt",
    "aliqua Lorem non culpa tempor",
    "consequat"
  ]
}
```
...
```json
{
  ...
  "message": "pariatur officia occaecat minim Ut"
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "nostrud commodo cupidatat irure"
}
```
...
```json
{
  ...
  "color": "culpa et exercitation magna"
}
```
...
```json
{
  ...
  "message": "nostrud consectetur veniam fugiat enim",
...
```json
{
  ...
  "radius_x": "incididunt officia proident",
  "radius_y": 41599729.177871495,
  "layer": "top"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "do_5a": [
      "adipisicing",
      "consectetur deserunt mollit qui anim",
      "dolore in aute",
      "Excepteur irure eu",
      "nisi laborum"
    ]
...
```json
{
  ...
  "model_stl_url": "dolore voluptate",
  "model_3mf_url": "irure aliquip aliqua cupidatat laboris"
}
```
...
{
  "occaecat_e66": {
    "left_margin": "Duis voluptate dolore quis Ut",
    "top_margin": "minim cupidatat Excepteur sed voluptate"
  }
}
```
