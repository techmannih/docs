...
```json
{
  ...
  "name": "A1",
  "manufacturer_part_number": "ut sint",
  "supplier_part_numbers": {
    "nisic": [
      "velit",
      "non",
      "fugiat incididunt in aute",
      "proident officia Excepteur amet voluptate",
      "ex Lorem occaecat laboris officia"
    ],
    "Duise": ["Lorem ut ex"]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "Lorem consequat laborum",
  "supplier_part_numbers": {
    "magna_89_": [
      "magna commodo amet exercitation",
      "nisi exercitation",
      "quis in dolor"
    ],
    "cillum_": ["esse officia laboris", "proident ipsum"],
    "fugiat_141": ["Lorem", "fugiat", "in non dolor adipisicing aliqua"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    ...
    "sunt in laborum",
    "laboris id enim",
    "dolor id in commodo amet"
  ],
  "is_power": false,
  "is_ground": true,
  "is_digital_signal": false,
  "is_analog_signal": true,
  "trace_width": -22983360.693444237
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "enim incididunt",
  "supplier_part_numbers": {
    "proident_c_": [
      "commodo sed adipisicing amet",
      "sunt sint mollit commodo nulla",
      "amet reprehenderit do elit non",
      "Excepteur ullamco sed cupidatat ut"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "Excepteur consequat dolor",
  "supplier_part_numbers": {
    "irure_2ec": [
      "nulla fugiat minim dolore",
      "in incididunt labore",
      "est laboris",
      "eu adipisicing reprehenderit ut"
    ],
    "eaec": ["officia ad ex dolore", "Excepteur Duis labore"],
    "irure22": [
      "magna",
      "voluptate",
      "ullamco quis sed nulla consectetur",
      "do Ut nisi pariatur"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "incididunt fugiat velit"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "non laborum consectetur qui"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "voluptate dolore",
  "supplier_part_numbers": {
    "tempor905": ["officia", "esse culpa cupidatat", "labore aute eu"],
    "ea_c": [
      "tempor",
      "proident Lorem labore laborum in",
      "non labore nisi cillum",
      "laborum",
      "ad et id anim"
    ]
  }
...
```json
{
  ...
  "connected_source_port_ids": ["cupidatat aliqua eiusmod adipisicing do"],
  "connected_source_net_ids": ["proident anim quis", "culpa"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "box_width": "aute Excepteur",
  "symbol_name": "eiusmod est",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "in irure nulla dolor officia"
}
```
...
```json
{
  ...
  "radius_x": 12572547.751137093,
  "radius_y": "dolore Duis veniam commodo",
  "layer": "top"
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "velit adipisicing consectetur deserunt"
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
  ...
  "layer": "top",
  "footprinter_string": "magna ea",
  "model_obj_url": "laboris consequat",
  "model_stl_url": "dolore",
  "model_3mf_url": "Excepteur mollit laboris",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": 21638093.304524466
}
```
...
```json
{
  "esse_9": {
    ...
    "right_margin": -82859377.18123284,
    "top_margin": "sint non Excepteur quis",
    "bottom_margin": "esse id amet officia"
  },
  "in_a5": {
    "left_margin": 62889559.70552471,
    "right_margin": -35918207.861691,
    "top_margin": 58239778.655444056,
    "bottom_margin": -76366033.03902528
  }
}
```
