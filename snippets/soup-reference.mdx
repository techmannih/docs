...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "adipisicing Ut minim",
  "supplier_part_numbers": {
    "occaecat3": [
      "officia",
      "do",
      "proident nulla deserunt esse",
      "in Excepteur et",
      "eu"
    ]
  }
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["Ut", "nisi", "culpa"],
  "is_power": false,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": 67203557.78769603
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "esse nisi in",
  "supplier_part_numbers": {
    "elit_69e": ["Duis velit adipisicing", "nisi"],
    "aute_12a": [
      "id Ut est minim",
      "pariatur Duis incididunt",
      "aliquip minim et"
    ],
    "et4": [
      "ut laboris sunt Excepteur officia",
      "officia consequat",
      "amet qui deserunt dolore",
      "dolore in do ad pariatur"
    ],
    "incididunt_ba": [
      "laborum magna culpa in",
      "voluptate",
      "veniam irure",
      "cillum sint in eiusmod",
      "cillum consectetur sunt adipisicing"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ut124": ["ut tempor deserunt non", "anim Ut"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "enim nulla",
  "supplier_part_numbers": {
    "Duis9c": ["amet deserunt tempor", "nisi mollit ipsum laborum"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "fugiat eu commodo exercitation",
  "supplier_part_numbers": {
    "sint_412": ["labore"],
    "ut_3": [
      "in esse culpa in id",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "do Lorem laboris consequat",
  "supplier_part_numbers": {
    "Lorem41": [
      "dolor sint ex Lorem",
      "ut esse dolore",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "pariatur ex",
  "supplier_part_numbers": {
    "ut_03c": [
      "consectetur incididunt ut elit",
      "dolore nostrud in cupidatat labore",
      "reprehenderit Lorem Ut consectetur dolor"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": ["eiusmod consectetur culpa in", "do"],
  "connected_source_net_ids": ["Ut", "labore eu sint"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "eu non et cupidatat",
  "pin_styles": {
    "veniam_f4": {
      "left_margin": -44364912.129618265
    }
  },
  "symbol_name": "in in exercitation sed"
}
```
...
```json
{
  ...
  "radius_x": "elit do pariatur aute nostrud",
  "radius_y": "sunt",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "dolore aliqua",
  "supplier_part_numbers": {
    "occaecat09": [
      "veniam minim ea occaecat voluptate",
      "ex",
      "ex do sed Duis dolor",
      "id exercitation consectetur occaecat minim",
      "minim adipisicing"
    ]
  },
  "voltage": "5V"
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "sint",
  "model_obj_url": "velit aliquip laboris et",
  "model_stl_url": "in",
  "model_3mf_url": "laboris deserunt",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 42762696.388883024,
  "outer_height": -17952767.77963215,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "ipsum9": {},
  "in06": {
    "left_margin": "et sed ex",
    "right_margin": -18057252.038355514
  },
  "laboris1b": {
    "left_margin": -79033199.99384837,
    "right_margin": -26579556.63267702,
    "top_margin": "qui Excepteur ullamco cillum"
  }
}
```
