...
```json
{
  ...
  "supplier_part_numbers": {
    "elit_5c8": ["quis ut consequat ipsum sint", "officia sunt"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "amet nostrud dolore incididunt",
  "supplier_part_numbers": {
    "incididunt47": [
      "laborum ad non dolore",
      "sunt ipsum",
      "deserunt officia eiusmod",
      "laborum",
      "enim culpa est Duis ut"
    ],
    "aliqua_a": ["cillum sunt", "consectetur voluptate", "ut elit Lorem"],
    "proident1": ["ex"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    ...
    "anim cillum exercitation reprehenderit ex"
  ],
  "is_power": true,
  "is_ground": false,
  "is_digital_signal": true,
  "is_analog_signal": false,
  "trace_width": 71849469.7223886
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "in_bf": [
      "sint pariatur aliquip et ad",
      "culpa commodo minim nisi",
      "non nisi cupidatat ea sed",
      "ullamco",
      "nostrud"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "sed consequat anim veniam",
  "supplier_part_numbers": {
    "cupidatat_13": [
      "sint dolore et",
      "adipisicing eu",
      "qui",
      "ipsum Duis nostrud eu Excepteur",
      "in ullamco aute officia"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "aliquip velit cupidatat non adipisicing",
  "supplier_part_numbers": {
    "ullamco24a": ["sunt cupidatat consequat ut"],
    "esse00b": ["Duis officia", "ex adipisicing", "aliqua cillum sunt"],
    "quis_f8": ["in mollit"],
    "reprehenderit_36": [
      "dolor",
      "dolor labore",
      "cupidatat dolor",
      "elit ad dolore qui laborum",
      "labore incididunt aliqua"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "dolor ullamco",
  "supplier_part_numbers": {
    "ea_1": ["aliquip exercitation", "dolore sint laborum minim sunt"],
    "sint__a": ["exercitation in irure ut"]
  }
}
```
...
```json
{
  ...
  "name": "G1",
  "supplier_part_numbers": {
    "commodo_e": ["do consectetur cupidatat eu", "cillum", "elit eiusmod eu"],
    "esse_9a": [
      "anim",
      "nostrud Ut adipisicing mollit veniam",
      "proident elit aliqua anim"
    ],
    "reprehenderit_71": [
      "qui ullamco ut in",
      "Excepteur incididunt ipsum laboris",
      "tempor nostrud sunt deserunt sed",
      "exercitation reprehenderit irure ut aliquip"
    ],
    "mollit6e": ["magna eu aliquip laborum sint", "aliquip dolore"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "Ut incididunt voluptate officia",
  "supplier_part_numbers": {
    "dolor_3d": [
      "mollit ullamco cillum magna do",
      "sed fugiat aliqua ipsum",
      "velit consectetur do ullamco"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "velit id",
  "supplier_part_numbers": {
    "dolor_a6": [
      "sint incididunt",
      "aute reprehenderit incididunt",
      "anim aute dolore amet consequat",
      "magna pariatur proident"
    ],
    "magna_cab": [
      "magna proident dolore quis",
      "enim dolor elit",
      "non",
      "aute dolor velit aliqua dolore"
    ],
    "anim_3f": ["laborum cupidatat"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_net_ids": [
    "et Duis in tempor in",
    "aute reprehenderit adipisicing consequat"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "aliquip consequat et laboris quis",
  "box_width": -64345006.23022554,
  "symbol_name": "ad sunt in",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  }
...
```json
{
  ...
  "message": "eiusmod Excepteur pariatur aliqua"
}
```
...
```json
{
  ...
  "radius_x": "Excepteur eiusmod incididunt",
  "radius_y": "labore magna Ut dolore voluptate",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "consectetur dolore et nostrud voluptate",
  "supplier_part_numbers": {
    "sed_4": [
      "consectetur laboris sint amet",
      "sint sit fugiat Lorem do",
      "voluptate",
      "proident nisi reprehenderit Ut sint"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 39752915.66744837,
  "outer_height": -64899367.00903809,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": -51476703.631275326
}
```
...
{
  "reprehenderit33": {
    "left_margin": -30594735.267968163,
    "right_margin": -29760985.270844832,
    "top_margin": "do pariatur sint consequat in",
    "bottom_margin": -40264537.02114403
  }
}
```
