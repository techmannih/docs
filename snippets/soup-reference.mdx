...
```json
{
  ...
  "ftype": "nostrud incididunt deserunt",
  "source_component_id": "source_component_1",
  "name": "N1",
  "manufacturer_part_number": "elit deserunt ut voluptate amet",
...
```json
{
  ...
  "member_source_group_ids": [
    "ex id deserunt ullamco",
    "in ut aliqua",
    "cupidatat eu reprehenderit Excepteur"
  ],
  "is_power": false,
  "is_ground": false,
  "is_digital_signal": false,
  "is_analog_signal": false,
  "trace_width": -85626192.31475241
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolorebb": [
      "incididunt consectetur labore tempor",
      "ut sint incididunt",
      "do tempor voluptate aliquip eiusmod"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "cillum_135": ["aliqua consequat", "minim"],
    "sed__a": [
      "qui nulla",
      "incididunt esse velit adipisicing",
      "amet ut aute consequat",
      "exercitation quis eiusmod ut Ut"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "elit ex Duis dolor",
  "supplier_part_numbers": {
    "cillumf": ["ad voluptate aute veniam esse"],
    "aliquipaa": ["ullamco ex laborum sit quis"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "non exercitation sint qui",
  "supplier_part_numbers": {
    "adipisicing79": ["Lorem"],
    "autee13": [
      "Ut occaecat",
      "pariatur ullamco aute",
      "labore dolore eu consequat"
    ],
    "irured9": ["ipsum labore minim consequat Duis"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "officia Ut",
  "supplier_part_numbers": {
    "mollit_b": [
      "id mollit anim in",
      "eu",
      "veniam pariatur exercitation aliquip consectetur",
      "irure",
      "non sint dolor"
    ],
    "aliquae0f": ["ex adipisicing"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "reprehenderit_f3": [
      "Ut voluptate",
      "consequat nostrud Ut sunt",
      "pariatur eiusmod dolor magna",
      "mollit minim aute Lorem adipisicing",
      "labore dolor"
    ],
    "nostrud_48f": [
      "dolor eu",
      "aliquip sunt officia in",
      "cillum ut aliqua ullamco",
      "ullamco in officia Lorem dolor"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "name": "R1",
  "supplier_part_numbers": {
    "consectetur77c": ["deserunt sint pariatur", "irure"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "mollit velit officia",
    "laborum quis",
    "ullamco nostrud voluptate",
    "reprehenderit deserunt eiusmod aliquip esse",
    "commodo sit dolore ut"
  ],
  "connected_source_net_ids": ["sint eiusmod", "cillum ad", "deserunt esse"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "cupidatat qui",
  "box_width": "ipsum sit eu",
  "symbol_name": "cupidatat occaecat sunt aliqua",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "radius_x": -80854264.56214222,
  "radius_y": "labore eiusmod commodo ut exercitation",
  "layer": "top"
}
```
  ...
  "route": [
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": -10405797.493416727
    },
    {
      "x": "3mm",
      "via": false,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "nostrud id",
  "supplier_part_numbers": {
    "eiusmodb7a": ["Excepteur", "sunt", "tempor"],
    "Excepteur_2": ["reprehenderit proident id do", "anim in ipsum"],
    "do_b": [
      "est nostrud aliquip amet",
      "ad officia voluptate proident",
      "magna cillum sint cupidatat ut",
      "nostrud commodo anim velit"
    ],
    "in6": ["id", "nulla amet minim"]
  }
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "id veniam sit laborum"
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "adipisicing voluptate est id"
  },
  "layer": "top",
  "footprinter_string": "sint Excepteur sed",
  "model_obj_url": "qui",
  "model_stl_url": "consectetur",
  "model_3mf_url": "Ut ea et",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -18467731.38544497,
  "outer_height": -58318252.02735939,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
