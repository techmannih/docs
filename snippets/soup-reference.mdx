...
```json
{
  ...
  "ftype": "magna labore ea ad voluptate",
  "source_component_id": "source_component_1",
  "name": "M1",
  "manufacturer_part_number": "laborum",
  "supplier_part_numbers": {
    "aliquipb4": [
      "sit laboris quis eiusmod",
      "tempor adipisicing labore sunt culpa",
      "ipsum",
      "nostrud Ut irure laborum esse"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "id dolor"
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    ...
    "consectetur Excepteur enim non",
    "id eiusmod dolor"
  ],
  "is_ground": true,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "labore incididunt",
  "supplier_part_numbers": {
    "ipsume": [
      "Ut anim",
      "ex ad",
      "qui",
      "sed elit magna reprehenderit deserunt"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "cillum voluptate",
  "supplier_part_numbers": {
    "qui_0": ["ut esse", "aliqua laborum", "aliqua"],
    "quis_58": [
      "aliqua aute",
      "irure velit reprehenderit nostrud exercitation",
      "fugiat nulla",
      "ea sed enim fugiat deserunt",
      "Lorem Duis commodo dolore"
    ],
    "eu_d1": ["sunt Duis do eiusmod", "quis Ut"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "commodo et in",
  "supplier_part_numbers": {
    "veniam_5": [
      "fugiat et officia velit",
      "irure deserunt adipisicing occaecat"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "voluptate tempor Lorem",
  "supplier_part_numbers": {
    "in_ab": [
      "occaecat quis",
      "aliquip et eiusmod Ut",
      "nisi qui laborum tempor Duis",
      "do enim",
      "irure in"
    ],
    "consectetur57": ["in ut ipsum"],
    "exercitation_26": [
      "eu officia deserunt mollit",
      "ex exercitation",
      "occaecat quis voluptate",
      "ut cillum dolor laboris"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "proident_a": ["sed et"],
    "mollit36": ["velit in ut Duis", "aute irure anim", "ad ut anim est"],
    "doa": [
      "aute ea labore aliqua",
      "in tempor quis",
      "qui",
      "eiusmod nisi Duis aliqua",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "aliqua cillum veniam nostrud commodo",
  "supplier_part_numbers": {
    "Loremb9": [
      "officia dolore adipisicing cillum irure",
      "aute mollit",
      "ullamco dolore nulla qui",
      "eiusmod"
    ],
    "laborume": [
      "velit magna fugiat sint voluptate",
      "do eu qui Ut amet",
      "voluptate aliqua ut elit Excepteur",
      "Ut"
    ],
    "ad_7d6": [
      "in sunt",
      "qui in non Duis id",
      "amet cillum commodo",
      "qui ullamco pariatur Lorem cupidatat",
      "proident"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": ["Duis amet in", "exercitation sint"],
  "connected_source_net_ids": [
    "dolor consectetur commodo Duis dolore",
    "aliqua ad commodo in",
    "sunt"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "ipsum deserunt amet nulla incididunt",
  "box_width": 90393908.8807891,
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "radius_x": -73235312.32429348,
  "radius_y": -56544791.04297687,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "dolor laboris enim ipsum incididunt",
  "supplier_part_numbers": {
    "incididuntc": ["aute qui sunt consectetur"],
    "commodoebf": ["magna", "dolor non nostrud"],
    "eiusmod_a7": ["officia irure", "esse et", "qui in enim", "Ut", "dolore"]
  }
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "in nulla aliqua in"
  },
  "layer": "top",
  "footprinter_string": "occaecat proident"
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "cupidatat commodo Duis Ut elit"
}
```
