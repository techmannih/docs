...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "nostrud",
  "supplier_part_numbers": {
    "sunt16": ["dolore non", "ut", "in dolor anim in", "ad ea", "est"],
    "Duis_8e1": [
      "ullamco nostrud elit",
      "irure aute consequat",
      "mollit laboris ea quis",
      "elit",
      "laborum amet voluptate"
    ],
    "nostrud_5": [],
    "aliquip3fb": [
      "dolore cillum ullamco mollit",
      "nulla nostrud labore deserunt ipsum",
      "Excepteur ut in",
      "Duis"
    ]
  }
...
```json
{
  ...
  "supplier_part_numbers": {
    "occaecat_38": ["sunt nisi irure", "velit ut irure Excepteur"],
    "eiusmod_23": ["nostrud in laborum", "enim"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "cillumc1": ["nulla enim consectetur amet"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ut828": [
      ...
      "exercitation",
      "sit",
      "culpa commodo sint enim"
    ],
    "consectetur_674": ["deserunt cillum"]
  }
}
```
...
```json
{
  ...
  "name": "G1",
  "supplier_part_numbers": {
    "dolor_b8d": ["eiusmod sed reprehenderit sint consequat"],
    "aliqua_a": [],
    "veniam423": ["do in cupidatat", "pariatur magna quis cillum"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "velit4_3": [
      "nisi ad cupidatat aliqua Ut",
      "minim",
      "elit",
      "veniam aute culpa ut"
    ],
    "Ut6a9": [],
    "aute_4d": ["deserunt ad"]
  },
...
```json
{
  ...
  "connected_source_port_ids": [
    "proident fugiat voluptate aliqua",
    "sed incididunt aute proident aliquip",
    "adipisicing",
    "in reprehenderit aute"
  ],
  "connected_source_net_ids": ["adipisicing et aliqua", "laboris occaecat"]
}
```
...
```json
{
  ...
  "message": "elit proident Excepteur cupidatat id"
}
```
...
```json
{
  ...
  "message": "ut commodo consectetur irure sit"
}
```
...
```json
{
  ...
  "radius_x": -36581063.72870948,
  "radius_y": "veniam labore",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "do consequat velit aliqua in",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "supplier_part_numbers": {
    "Lorem_42": [
      "sit veniam consequat",
      "sint irure",
      "nulla incididunt sunt",
      "sed minim laboris nostrud",
      "tempor do labore"
    ],
    "proident_9_": [
      "sit in mollit aliqua",
      "non reprehenderit ea tempor",
      "consequat proident et occaecat",
      "do dolore elit esse"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": -31217531.248201743
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "consequat cillum incididunt"
  },
  "layer": "top",
  "footprinter_string": "amet",
  "model_obj_url": "eu dolore",
  "model_stl_url": "aliquip ea dolore",
  "model_3mf_url": "do dolor velit deserunt pariatur",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "do dolor reprehenderit"
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "laborum magna non nostrud aliquip"
}
```
...
{
  "sed07": {
    "left_margin": -11836096.875426129,
    "right_margin": "id quis",
    "bottom_margin": "et nostrud est"
  },
  "id_b1f": {}
}
```
