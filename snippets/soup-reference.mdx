...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "cillum eiusmod",
...
```json
{
  ...
  "member_source_group_ids": [
    "ex officia nisi proident",
    "nostrud reprehenderit"
  ],
  "trace_width": 19696262.357751235
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "enim_18": [
      ...
      "pariatur in incididunt"
    ],
    "fugiat__": ["enim tempor nulla et eu", "reprehenderit"],
    "exercitationd1": [
      "voluptate eiusmod id tempor nostrud",
      "mollit",
      "Lorem irure ut laboris enim",
      "quis",
      "tempor nulla in"
    ],
    "exercitation429": ["culpa deserunt", "cillum", "sunt minim"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "veniam pariatur mollit",
  "supplier_part_numbers": {
    "quis_e": ["incididunt", "sit ea commodo consequat magna"],
    "aliquip0": [
      "non eiusmod",
      "pariatur eu sunt",
      "Lorem Ut laboris",
      "officia ea",
      "dolor ut occaecat non minim"
    ],
    "irure7": [
      "fugiat nulla irure",
      "deserunt qui mollit",
    ...
    "aliquip_2db": [
      "nisi ad cupidatat sunt nostrud",
      "ipsum et consequat",
      "aliqua",
      "nisi"
    ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "amet est enim",
  "supplier_part_numbers": {
    "ut_7": ["proident Ut ex in anim", "qui ipsum"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "labore irure voluptate eu",
  "supplier_part_numbers": {
    "aute_": [
      "occaecat",
      "sint officia elit veniam nostrud",
      "id labore",
      "voluptate nisi deserunt est",
      "ex et irure eu"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "minimf_": ["ipsum adipisicing eiusmod velit"]
  }
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["sed", "ullamco consectetur magna do"],
  "connected_source_net_ids": [
    "in irure mollit est",
    "ut ipsum",
    "velit exercitation",
    "ea reprehenderit labore id",
    "Duis adipisicing"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "dolore eu aliqua in elit",
  "pin_styles": {},
  "box_width": -81964059.40258776,
  "symbol_name": "sunt",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "message": "consequat reprehenderit"
}
```
...
```json
{
  ...
  "message": "est officia qui eu commodo"
}
```
...
```json
{
  ...
  "radius_x": 97606551.67802534,
  "radius_y": 66307913.03492564,
  "layer": "top"
}
```
...
```json
{
  ...
  "name": "A1",
  "member_source_group_ids": [
    "magna consectetur ea ex dolor",
    "adipisicing deserunt ex",
    "sint irure ad dolore"
  ],
  "is_power": false,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": -65724797.83379696
}
```
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "occaecat aliqua commodo sint"
  },
  "layer": "top",
  "footprinter_string": "fugiat ea",
  "model_obj_url": "cillum quis",
  "model_stl_url": "sit",
  "model_3mf_url": "nisi officia",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "nulla reprehenderit"
}
```
...
```json
{
  "Ut_632": {
    "left_margin": "mollit",
    "right_margin": "ad est incididunt",
    "top_margin": "mollit pariatur sed",
    "bottom_margin": "aute ullamco veniam sunt"
  },
  "nisi538": {
    "left_margin": "dolor nostrud ipsum ex commodo",
    "right_margin": 72935898.77213603,
    "top_margin": "Lorem dolore"
  },
  "Lorem0ad": {
    "left_margin": "labore velit officia Lorem",
    "right_margin": -49569206.836131394
  },
  "officia_9": {
    "left_margin": 78983397.20491192,
    "right_margin": "laborum proident veniam consequat sed",
    "top_margin": -74831090.67074731,
    "bottom_margin": 2395279.6164958775
  },
  "exercitation03": {
    "left_margin": "Duis reprehenderit eu"
  }
}
```
