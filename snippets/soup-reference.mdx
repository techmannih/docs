...
```json
{
  ...
  "ftype": "exercitation in",
  "source_component_id": "source_component_1",
  "name": "E1",
  "manufacturer_part_number": "nostrud laboris commodo occaecat",
  "supplier_part_numbers": {
    "deseruntb0e": [
      "laboris Excepteur commodo ut ad",
      "quis enim eu",
      "ad commodo mollit"
    ],
    "ullamco44": [
      ...
      "in nisi",
      "magna velit cupidatat elit Lorem",
      "ullamco",
      "in"
    ]
  }
...
```json
{
  ...
  "supplier_part_numbers": {
    "proidentb55": [
      "qui consectetur dolor irure magna",
      "dolor consequat nulla dolore"
    ],
    "et_c3": [
      "do fugiat",
      "eiusmod qui",
      "dolore proident ea in",
      "dolor non labore aliqua",
      "non ut Duis cillum"
    ]
  }
}
...
```json
{
  ...
  "member_source_group_ids": [
    "dolor ipsum voluptate nisi",
    "dolore nisi do",
    "aute sit et reprehenderit",
    "ex et labore"
  ],
  "is_power": true,
  "is_ground": true,
...
```json
{
  ...
  "supplier_part_numbers": {
    "magna2b": ["adipisicing velit", "ipsum eu in", "officia commodo et"],
    "aliquip_d": [
      "eu sed culpa",
      "non est consectetur elit pariatur",
      "dolore labore ipsum in fugiat"
    ],
    "ad_88": ["aute ullamco pariatur"],
    "anim68": [
      "elit",
      "fugiat",
      "dolor commodo elit mollit",
      "ullamco qui id irure et"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ut sint Duis sed quis",
  "supplier_part_numbers": {
    "aliquip_a0": [
      "ut aliqua",
      "ut consectetur",
      "minim sed enim dolor et",
      "laborum qui cillum labore ea"
    ],
    "culpa_": ["deserunt minim mollit dolor"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "laboris occaecat nostrud",
  "supplier_part_numbers": {
    "ut_dd1": ["id", "proident culpa", "in Lorem deserunt eiusmod cupidatat"],
    "aliquip_d": [
      "incididunt aliquip veniam ea sed",
      "cillum",
      "exercitation velit et nostrud nisi",
      "in ut anim deserunt eiusmod",
      "dolor sed laboris irure Lorem"
    ],
    "labore451": ["sint dolore aliqua ipsum", "esse"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "cillum dolore laboris officia ea",
  "supplier_part_numbers": {
    "officia_cd": ["esse qui ut in", "est id"],
    "Lorem_19d": ["aute in nostrud quis"],
    "ut7": [
      "Excepteur veniam nulla amet id",
      "occaecat ea",
      "nisi Duis aliqua ea enim",
      "dolore"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "do laboris incididunt",
  "supplier_part_numbers": {
    "consectetur0f": [
      "Excepteur consequat laborum nulla culpa",
      "do proident ipsum ea anim"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "minim nostrud cillum dolor",
  "supplier_part_numbers": {
    "quis_5": ["amet anim veniam sunt", "sed magna adipisicing reprehenderit"],
    "sit_2b": [
      "dolore",
      "id ut",
      "Lorem",
      "Ut dolor reprehenderit et",
      "sunt in velit consequat consectetur"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    ...
    "sint exercitation nisi adipisicing",
    "Excepteur"
  ],
  "connected_source_net_ids": [
    "laborum reprehenderit ut ut anim",
    "ullamco",
    "ex reprehenderit esse irure nisi",
    "eiusmod aliqua",
    "dolore aliqua sint"
  ]
}
...
```json
{
  ...
  "message": "in adipisicing elit occaecat proident"
}
```
...
```json
{
  ...
  "radius_x": "sed aute sit labore",
  "radius_y": 72887069.84758386,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "aute consequat reprehenderit",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "elit",
  "model_obj_url": "sint dolore laboris",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -606053.1544135511,
  "outer_height": -98243391.4451783,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "amet_3": {
    "left_margin": -78303383.72431841,
    "right_margin": 64673885.185923785,
    "top_margin": "id officia",
    "bottom_margin": "Excepteur"
  },
  "sede": {
    "left_margin": "laboris mollit id aute ipsum"
  }
}
```
