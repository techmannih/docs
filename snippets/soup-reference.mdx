...
```json
{
  ...
  "supplier_part_numbers": {
    "eiusmodd6": ["mollit velit eu nostrud"],
    "sed_d70": [
      "eiusmod ut esse ipsum",
      "tempor minim mollit adipisicing sunt",
      "minim nisi",
      "eu laborum aliqua dolor dolor"
    ],
    "elit758": ["Duis consectetur adipisicing", "eu minim velit"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "incididunt Lorem",
    "elit nostrud mollit est",
    "fugiat ullamco ut",
    "labore in non",
    "cillum dolor Lorem esse"
  ],
  "is_power": false,
  "is_ground": true,
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "ex_2": [
      "elit nisi ex deserunt",
      "cillum",
      "commodo ullamco esse",
      "dolore anim labore commodo",
...
```json
{
  ...
  "supplier_part_numbers": {
    "reprehenderit_cf": [
      "qui ut sit do",
      "sed laboris consequat",
      "qui ut exercitation commodo"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "pariatur_3": [
      "voluptate",
      "officia in deserunt est minim",
      "deserunt fugiat aliqua id nisi",
      "Ut laboris quis"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": [
    "veniam eiusmod dolore qui minim",
    "fugiat Duis sit elit",
    "magna consequat Duis consectetur"
  ],
  "connected_source_net_ids": [
    "quis ea in",
    "consequat veniam dolore voluptate",
    "Lorem in elit"
  ]
}
```
...
```json
{
  ...
  "message": "Ut culpa ullamco labore aute"
}
```
...
```json
{
  ...
  "radius_x": 55350906.26350719,
  "radius_y": 49404110.04306418,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "ut aliqua Excepteur Ut",
  "pcb_trace_id": "pcb_trace_1",
  "source_trace_id": "source_trace_1",
  "pcb_component_ids": ["pcb_component_1"],
...
```json
{
  ...
  "name": "B1",
  "supplier_part_numbers": {
    "doloreec": ["voluptate sit dolor aliquip"]
  }
}
```
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": 11205534.200716853
  },
  "layer": "top",
  "footprinter_string": "commodo Ut ut deserunt dolore",
  "model_obj_url": "ipsum",
  "model_stl_url": "dolore eu irure",
  "model_3mf_url": "sint",
  "model_jscad": []
}
```
