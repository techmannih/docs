...
```json
{
  ...
  "name": "C1",
  "manufacturer_part_number": "veniam in quis voluptate",
  "supplier_part_numbers": {
    "Ut_964": ["in eu ea", "ex ipsum"],
    "nostrud_2a": [
      "ipsum ut reprehenderit incididunt",
      "anim nulla Lorem",
      "Excepteur",
      "Ut"
    ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "veniam consequat nostrud in laborum",
  "supplier_part_numbers": {
    "sit8_": ["in aute velit", "nisi"],
    "pariatur9cc": ["eu est veniam tempor velit"],
    "proident_e": ["fugiat ad", "ullamco nostrud", "tempor"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "laborum id ipsum voluptate in",
    "nulla eu deserunt",
    "quis incididunt cillum",
    "eiusmod adipisicing magna aliquip",
    "ipsum culpa sint proident consequat"
  ],
  "is_power": true,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": 83181562.2417706
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "sunt reprehenderit",
  "supplier_part_numbers": {
    "aliquipbd": ["Ut nostrud quis adipisicing"],
    "aliquip5": ["proident quis adipisicing dolore do", "consequat"],
    "sinta5": [
      "adipisicing sunt consequat nisi qui",
      "dolor irure",
      "nisi",
      "in laboris ad irure magna",
      "dolore ut est et"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "et",
  "supplier_part_numbers": {
    "et_1": [
      "id",
      "in in tempor id dolor",
      "pariatur ullamco proident magna ex",
      "aute voluptate est magna",
      "dolore mollit"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "officia Lorem veniam",
  "supplier_part_numbers": {
    "Duis_b_": [
      "do exercitation ea",
      "occaecat eiusmod veniam fugiat reprehenderit",
      "ut labore velit",
      "laborum aute officia irure qui",
      "deserunt"
    ],
    "in_0": [
      "consectetur quis in officia",
      "Excepteur",
      "ut",
      "nostrud",
      "nisi aliquip sunt in"
    ],
    "ut5c": ["in"]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "officia8": [
      "sed",
      "non cillum adipisicing voluptate",
      "aliqua velit id pariatur nisi",
      "et incididunt velit laborum"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "aliqua370": ["ea consectetur labore dolore ipsum"],
    "ea_7_c": ["in", "sit consectetur", "ex dolore aute magna"],
    "aute_9e": ["esse aliqua ut et Duis"],
    "dolore72": ["nisi ea"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "veniam ex fugiat",
  "supplier_part_numbers": {
    "estf9": ["occaecat veniam", "nostrud et sed ut in"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "nulla ut dolor voluptate",
  "supplier_part_numbers": {
    "sed_efb": [
      "consequat ullamco Lorem enim mollit",
      "mollit culpa Excepteur officia",
      "aliqua magna"
    ],
    "voluptate_d8e": [
      "id laboris magna",
      "voluptate veniam Duis laboris culpa"
    ],
    "irure_0": [
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "magna occaecat nisi deserunt sit",
  "pin_styles": {},
  "box_width": -13068040.48803109,
  "symbol_name": "sit quis anim",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "enim ut adipisicing in"
}
```
...
```json
{
  ...
  "color": "mollit aute occaecat elit"
}
```
...
```json
{
  ...
  "radius_x": -58065411.670545466,
  "radius_y": 27334390.581633985,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "minim est voluptate veniam",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "ipsum mollit",
  "supplier_part_numbers": {
    "ina09": [
      "deserunt nisi",
      "sit sint amet aliqua",
      "sed aliquip reprehenderit aliqua dolor",
      "consequat fugiat quis id pariatur"
    ],
    "Duis85": ["in ut culpa", "officia cillum"],
    "nostrud_5": [
      "veniam cillum dolor ut",
      "commodo Duis ipsum consequat",
      "officia occaecat et",
      "elit"
    ],
    "consequat_7": [
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 93127564.92337883,
  "outer_height": -33878484.19167607,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "minim_ae": {},
  "enim7af": {
    "left_margin": "velit enim",
    "top_margin": "sed id Duis esse non",
    "bottom_margin": -88044866.2490311
  },
  "enimf0": {
    "left_margin": "cillum aliqua est labore in",
    "right_margin": 83321553.68123811
  },
  "sed__": {
    "left_margin": 17119300.813476413,
    "right_margin": "enim sed dolor nulla voluptate",
    "top_margin": "nostrud mollit et ut consectetur"
  },
  "culpa80": {
    "bottom_margin": "qui mollit amet nulla"
  }
}
```
