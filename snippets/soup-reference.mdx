...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "nisi est do dolor",
  "supplier_part_numbers": {
    "velit_8": [
      "ipsum dolore",
      "mollit qui Excepteur ea",
      "dolore Lorem dolor sit enim",
      "adipisicing et Lorem consectetur quis",
      "ex deserunt nulla"
    ],
    "proident_e3": [
      "quis",
      ...
      "aute veniam ex",
      "aute quis laborum velit nulla"
    ],
    "laboris03a": ["ut mollit sint aliqua reprehenderit"],
    "qui_4": ["occaecat aliqua sint"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "ex irure aliquip sunt",
    "laborum nulla est ad consequat",
    "pariatur"
  ],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "est sunt ad ipsum",
  "supplier_part_numbers": {
    "Ute": ["et laborum"],
    "dolorc_": ["consectetur"],
    "est243": ["ipsum ut dolore et", "veniam ut", "anim"],
    "quic": [
      "ipsum adipisicing officia voluptate laborum",
      "reprehenderit",
      "deserunt elit"
    ],
    "culpa8b3": ["deserunt non id nulla ut", "deserunt"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "aute sit elit voluptate",
  "supplier_part_numbers": {
    "tempor_82": ["consequat dolor", "ea aliquip ex"],
    "dolore53": ["nulla commodo sed"],
    "enim0": [
      "ipsum non",
      "Duis eiusmod",
      "consectetur minim dolore cillum consequat"
    ],
    "exercitation5_5": [
      "non",
      "culpa est fugiat",
      "cupidatat",
      "in irure ullamco Lorem proident"
    ],
    "adipisicingc2": [
      "aliqua",
      "do voluptate",
      "nostrud",
      "et Ut minim aliquip officia",
      "sunt incididunt"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ea exercitation",
  "supplier_part_numbers": {
    "anim__a7": ["in occaecat non deserunt", "est", "reprehenderit ut"],
    "irureb": [
      "tempor magna dolor",
      "et mollit",
      "qui nisi esse",
    ...
    "proident943": [
      "aliquip consectetur eu sed sunt",
      "enim",
      "sit adipisicing laborum",
      "pariatur amet dolor sint sed"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "in dolor aliquip ea magna",
  "supplier_part_numbers": {
    "eu_8": ["Ut Lorem Excepteur consequat", "proident incididunt"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "cupidatat1f": [
      "Lorem",
      "in adipisicing",
      "anim est ipsum reprehenderit nisi",
      "laborum esse consequat cillum"
    ],
    "nostrud_4cb": [
      "irure",
      "nulla nostrud incididunt tempor ipsum",
      "id",
      "occaecat dolore"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "cillum dolor officia ut non",
  "supplier_part_numbers": {
    "ut_e1": ["eiusmod laboris"],
    "ad67": ["in enim labore in", "mollit enim", "laborum irure id"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "incididunt deserunt culpa",
  "supplier_part_numbers": {
    "non_e": [
      "dolore nostrud commodo reprehenderit enim",
      "id sint do in",
      "exercitation enim sed laborum veniam",
      "et consequat quis nisi anim"
    ],
    "ine": [
      "esse non quis",
      "ullamco Excepteur Duis ex irure",
      "ea proident eu ullamco reprehenderit",
      "culpa fugiat eiusmod occaecat deserunt"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "nisi deserunt aliqua Lorem",
    "Ut est minim quis",
    "exercitation"
  ],
  "connected_source_net_ids": [
    "ullamco reprehenderit id pariatur sed",
    "nulla irure",
    "non ut"
  ]
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "deserunt sed Lorem eiusmod et",
  "pin_styles": {},
  "box_width": 99154988.76775035,
  "symbol_name": "cupidatat adipisicing cillum",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "exercitation aliquip enim non"
}
```
...
```json
{
  ...
  "radius_x": "eu ex et ullamco proident",
  "radius_y": "aliquip enim",
  "layer": "top"
}
```
...
```json
{
  ...
  "route": [
    ...
    },
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": 38149766.716208786
    },
    {
      "x": "3mm",
      "y": "1mm"
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "ea qui pariatur nulla"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -86134347.56092145,
  "outer_height": 90168451.03036699,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": "magna sit aute dolore"
}
```
...
{
  "enim_8": {
    "left_margin": "dolore Ut",
    "right_margin": 5032692.307036608,
    "top_margin": 17968839.958566815,
    "bottom_margin": "laborum eiusmod proident"
  }
}
```
