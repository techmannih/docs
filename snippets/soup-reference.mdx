...
```json
{
  ...
  "ftype": "sunt exercitation adipisicing in esse",
...
```json
{
  ...
  "supplier_part_numbers": {
    "ametd": [
      "ea exercitation sint Lorem dolor",
      "aute",
      "est",
      "cupidatat in veniam officia voluptate"
    ]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "deserunt pariatur dolor et",
    "sint ad cillum deserunt commodo",
    "ea",
    "in consequat"
  ],
  "is_power": true,
...
```json
{
  ...
  "supplier_part_numbers": {
    "qui_523": [
      "eiusmod commodo nisi aute esse",
      "dolore incididunt consequat ex Duis"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "consectetur_d66": [
      "labore",
      "eiusmod magna in irure sed",
      "mollit non Duis eu culpa"
    ],
    "Duis_b2": ["commodo", "amet Ut"],
    "adipisicing2b5": ["magna", "sit pariatur", "elit anim voluptate dolore"],
    "ea5_": ["enim voluptate occaecat id"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "laboris__d": [
      "quis labore exercitation in deserunt",
      "aliquip Ut",
      "anim",
      "dolor labore sed eu"
    ]
...
```json
{
  ...
  "supplier_part_numbers": {
    "eiusmod9": [
      "pariatur",
      "irure",
      "in quis mollit ipsum",
      "occaecat ut proident reprehenderit labore"
    ],
    "occaecat11": ["commodo", "sed minim sunt Excepteur"]
  }
}
```
...
```json
{
  ...
  "name": "P1",
  "supplier_part_numbers": {
    "in_32e": ["pariatur irure magna fugiat proident", "minim"],
    "dolor0c": [
      "exercitation ex",
      "in exercitation",
      "qui dolor dolor irure",
      "ex proident eiusmod commodo"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "doloref1_": [
      "do esse irure ut",
      "eu in ea consectetur elit",
      "ullamco voluptate fugiat officia cupidatat",
      "et cupidatat adipisicing",
      "sunt amet Duis"
    ],
    "eiusmod_a6": [
      "aliqua Duis dolore minim dolor",
      "eiusmod fugiat Lorem et deserunt",
      "ut aliqua commodo",
      "magna commodo",
      "voluptate sint"
    ]
...
```json
{
  ...
  "connected_source_port_ids": ["velit anim proident nulla"],
  "connected_source_net_ids": [
    "sint eiusmod",
    "Duis sit",
    "incididunt dolor do",
    "dolore nulla labore id",
    "ex dolor commodo aliqua est"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "reprehenderit",
  "box_width": 98687804.31960413
}
```
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "culpa1a5": ["cupidatat Excepteur", "sunt reprehenderit"]
  },
  "capacitance": "1uF"
}
```
