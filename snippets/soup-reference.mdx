...
```json
{
  ...
  "name": "E1",
  "manufacturer_part_number": "id occaecat ullamco",
  "supplier_part_numbers": {
    "irure__": ["ut laboris", "ex aute irure esse", "quis sed"],
    "dolorff": ["Excepteur"],
    "magna__": ["adipisicing"],
    "labore_986": ["dolore non ut laboris Ut", "laboris laborum id"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "aliquip_bd": ["ut esse", "irure aute", "id", "magna", "Duis veniam"],
    "fugiat_fd": [
      "do fugiat Duis consequat",
      "in",
      "ullamco",
      "veniam ad sit",
      "exercitation do"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "ea Lorem et",
  "supplier_part_numbers": {
    "ipsumae": ["minim labore eiusmod"],
    "in7f7": [
      "nostrud ipsum voluptate laborum commodo",
      "laborum",
      "velit Lorem in",
      "sed deserunt sit et esse",
      "laborum"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "eu laboris id aliquip tempor",
  "supplier_part_numbers": {
    "sit_d": ["ut anim tempor sint"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "velit_52": ["cillum in velit laboris"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "laborum dolor",
  "supplier_part_numbers": {
    "quis007": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "pariatur id Lorem in",
  "supplier_part_numbers": {
    "laboris_e6": [],
    "exb_d": ["elit"],
    "ex8d": ["et fugiat sed magna", "non velit"],
    "aliquip3_2": ["irure fugiat", "voluptate irure aliquip Ut sunt", "elit"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "occaecat labore nulla sunt laborum",
  "supplier_part_numbers": {
    "eiusmode": ["adipisicing anim"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "ullamco adipisicing",
  "supplier_part_numbers": {
    "nulla7": [
      "magna consequat minim occaecat veniam",
      "adipisicing proident do ipsum"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "minim cillum adipisicing cupidatat",
    "esse adipisicing sint",
    "nisi qui"
  ],
  "connected_source_net_ids": ["anim quis", "incididunt in velit eu"]
}
```
...
```json
{
  ...
  "message": "quis exercitation et in"
}
```
...
```json
{
  ...
  "color": "quis pariatur adipisicing"
}
```
...
```json
{
  ...
  "radius_x": "in et mollit est",
  "radius_y": -19675907.89606732,
  "layer": "top"
}
```
  ...
  "route": [
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": -28850633.360833913
    },
    {
      "x": "3mm",
      "y": "1mm",
      "trace_width": 56063228.136568576
    }
  ]
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "consectetur_8": ["proident enim", "fugiat eiusmod elit ea"]
  }
}
```
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "adipisicing ullamco in magna"
  },
  "layer": "top",
  "footprinter_string": "consectetur",
  "model_stl_url": "sint"
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "trace_width": "voluptate Lorem in"
}
```
...
{
  "eae86": {
    "right_margin": "qui eiusmod magna dolore in",
    "top_margin": -13984086.86567682
  }
}
```
