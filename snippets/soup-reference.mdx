...
```json
{
  ...
  "name": "C1",
  "manufacturer_part_number": "incididunt exercitation consectetur fugiat"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "proident magna ea consectetur in",
  "supplier_part_numbers": {
    "enim_ca": [
      "fugiat deserunt",
      "exercitation occaecat Duis",
      "laboris",
      "sunt ut tempor eiusmod sint"
    ],
    "deserunt__4": ["anim eu labore"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["ut deserunt in amet", "in laborum", "Lorem"],
  "is_power": true,
  "is_ground": false,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": -92663563.15499844
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "magna deserunt",
  "supplier_part_numbers": {
    "magnafd": [],
    "ipsumf5": ["cillum aliquip", "tempor ipsum mollit esse elit"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ipsumc0": ["id"],
    "labore_60": [
      "exercitation ipsum minim irure culpa",
      "fugiat quis laborum"
    ],
    "laborum_0": [
      "exercitation Duis nisi",
      "laboris et in Excepteur cupidatat",
      "nisi dolor",
      "mollit sint ut non",
      "id incididunt Excepteur voluptate"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "minim consectetur in ad enim",
  "supplier_part_numbers": {
    "ipsum_bc_": [
      "eiusmod laborum voluptate anim in",
      "dolor",
      "sunt nostrud cillum commodo",
      "sunt veniam"
    ],
    "aliqua20a": ["minim fugiat dolor in occaecat"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "enima50": [
      "Ut irure in eu",
      "cupidatat anim",
      "est aute sit reprehenderit",
      "velit deserunt quis ad"
    ],
    "dolorec": ["ut Duis proident"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "proident officia ea qui",
  "supplier_part_numbers": {
    "irure8": ["irure mollit sunt"],
    "adipisicingd": ["dolor", "anim irure labore", "enim est", "fugiat labore"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "ut dolor",
  "voltage": "5V"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "nisi_9_b": [
      ...
      "Excepteur",
      "est ex cupidatat velit aliquip"
    ],
    "sed__": ["tempor sint cupidatat nisi"],
    "nulla56_": ["adipisicing", "enim", "veniam"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["sunt Duis", "ut incididunt"],
  "connected_source_net_ids": [
    "culpa aute Excepteur sit",
    "nostrud culpa id dolor"
  ]
}
```
...
```json
{
  ...
  "message": "ullamco sunt cupidatat",
...
```json
{
  ...
  "radius_x": 52928801.85552949,
  "radius_y": 9599893.208487049,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "qui exercitation commodo magna",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "supplier_part_numbers": {
    "voluptate_85": [
      ...
      "Lorem id sint",
      "dolor Duis adipisicing amet"
    ],
    "nostrud_c19": ["consequat dolore"],
    "quise": ["in nisi", "non ad nisi elit esse", "sit culpa"],
    "culpa_0f": ["deserunt adipisicing", "do quis culpa"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "veniam aliquip mollit anim"
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "occaecat consequat velit laboris"
}
```
...
```json
{
  ...
  "via": false,
  "to_layer": "bottom",
  "trace_width": "labore nostrud Duis"
}
```
...
{
  "dolor_baf": {
    "left_margin": -15058152.613616511,
    "top_margin": -16308980.445990518,
    "bottom_margin": "culpa mollit fugiat"
  },
  "culpa56": {
    "right_margin": "Ut dolore in elit",
    "top_margin": "officia reprehenderit id aute deserunt"
  },
  "esse7": {
    "left_margin": -63316414.47151277,
    "right_margin": "elit id dolor velit",
    "top_margin": "tempor nulla"
  },
  "cupidatat7": {
    "left_margin": 76478943.88319796,
    "right_margin": "elit",
    "top_margin": "eu",
    "bottom_margin": 58788032.33814463
  }
}
```
