...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["occaecat ipsum consequat Excepteur enim"],
  "is_power": true,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ullamco ut enim esse fugiat",
  "supplier_part_numbers": {
    "quis6aa": ["mollit", "ex quis est nostrud ut", "sit", "eiusmod"],
    "magnae": [
      "Lorem non",
      "reprehenderit sit laboris voluptate",
      "magna ipsum culpa",
      "ut velit nulla"
    ],
    "dolore6f6": ["et", "minim", "esse aliquip tempor aute"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "laborum minim Lorem",
  "supplier_part_numbers": {
    "dolor81": ["proident enim aute"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "exercitation ea enim",
  "supplier_part_numbers": {
    "voluptate__0": [
      "pariatur tempor",
      "veniam Excepteur deserunt",
      "qui",
      "ullamco sed voluptate eu non"
    ],
    "laborum_1d": [
      "ipsum aliquip nisi",
      "do Duis et consequat Excepteur",
      "nisi ipsum enim",
      "Excepteur"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "dolore mollit",
  "supplier_part_numbers": {
    "dolore_c3b": ["dolor dolor amet", "cupidatat consectetur dolore", "in do"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "ut minim anim Lorem",
    "occaecat ad anim magna sunt",
    "eu adipisicing ad"
  ],
  "connected_source_net_ids": [
    "minim cupidatat et",
    "dolor",
    "sunt minim dolor aliquip mollit"
  ]
}
```
...
```json
{
  ...
  "radius_x": "ipsum Lorem incididunt",
  "radius_y": "quis do reprehenderit",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "officia laboris cillum",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "irure enim incididunt veniam",
  "supplier_part_numbers": {
    "sint98d": [
      "in nostrud",
      "ad",
      "Lorem adipisicing sint",
      "eu in tempor dolore ex"
    ],
    "incididunt_2": [
      "fugiat consectetur nostrud",
      "sint fugiat commodo ea esse",
      "aliquip do anim voluptate ipsum"
    ]
  }
}
```
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "laboris mollit nisi"
  },
  "layer": "top",
  "footprinter_string": "exercitation labore deserunt ipsum ullamco",
  "model_obj_url": "eiusmod pariatur culpa veniam occaecat",
  "model_3mf_url": "nostrud irure cillum incididunt ea",
  "model_jscad": {}
}
```
