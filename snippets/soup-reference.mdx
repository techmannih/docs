...
```json
{
  ...
  "ftype": "laborum amet dolore tempor id",
...
```json
{
  ...
  "name": "L1",
  "supplier_part_numbers": {
    "incididuntc": ["cupidatat dolor mollit tempor"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "in cillum pariatur",
    "aliquip elit minim",
    "Duis dolore elit sed in",
    "proident",
    "tempor labore"
  ],
  "is_power": false,
  "is_ground": false,
  "trace_width": 14860814.369185299
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "reprehenderit fugiat in Excepteur cupidatat",
  "supplier_part_numbers": {
    "voluptate_1": [],
    "pariatur940": [
      "nostrud",
      "ad reprehenderit labore",
      "magna irure consectetur minim est",
      "ad",
      "elit ex voluptate"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "Duis sit veniam",
  "supplier_part_numbers": {
    "Ut2": [],
    "occaecat_43": [
      "in incididunt do consequat in",
      "occaecat Ut amet dolor",
      "cillum laboris",
      "ea",
      "eiusmod dolor anim"
    ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "dolore ex dolor tempor",
  "supplier_part_numbers": {
    "elit__2b": []
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolore_c38": [
      ...
      "est veniam sint",
      "minim adipisicing Duis est deserunt"
    ],
    "incididunt__7b": [
      "incididunt Excepteur ut occaecat",
      "aute sit",
      "exercitation anim est",
      "veniam Excepteur ut pariatur ullamco",
      "minim"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolorb08": [
      "ex Lorem magna mollit sed",
      "dolor",
      "Duis do dolor exercitation cillum",
      "adipisicing quis enim",
      "ipsum"
    ]
  },
  "voltage": "5V"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "voluptate ullamco consectetur",
  "resistance": "1k"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 96214332.37869832,
  "pin_styles": {},
  "box_width": "consectetur adipisicing in",
  "symbol_name": "velit aliquip sint incididunt",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "adipisicing aliquip minim id ullamco"
}
```
...
```json
{
  ...
  "message": "exercitation voluptate proident dolor",
...
```json
{
  ...
  "radius_x": "sit ex Lorem officia occaecat",
  "radius_y": "voluptate eiusmod exercitation ex",
  "layer": "top"
}
```
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": -50384818.882593006
  },
  "layer": "top",
  "footprinter_string": "sed Duis laboris dolor",
  "model_stl_url": "ullamco",
  "model_3mf_url": "deserunt ut",
  "model_jscad": {}
}
```
...
{
  "adipisicing86": {
    "left_margin": 69794119.86094326,
    "right_margin": "incididunt",
    "top_margin": "magna cillum consequat id",
    "bottom_margin": "in"
  }
}
```
