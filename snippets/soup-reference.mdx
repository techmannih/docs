...
```json
{
  ...
  "name": "C1",
  "manufacturer_part_number": "in enim do consectetur nulla",
  "supplier_part_numbers": {
    "pariatura5": ["elit aliqua", "consectetur"],
    "elitab": [
      "adipisicing ex incididunt",
      "nostrud",
      "eu dolore proident",
      "deserunt amet mollit enim",
      "adipisicing tempor esse veniam"
    ],
    "magna5": [
      "non sed dolor",
      "adipisicing nostrud",
      "magna nisi Duis deserunt",
      "ex officia et ea fugiat",
      "do sunt eu"
    ],
    "tempor5ca": ["est", "deserunt enim ad"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "in aliqua culpa incididunt",
  "supplier_part_numbers": {
    "sunt_9fd": [
      "consequat",
      "consequat",
      "nostrud magna in",
      "velit adipisicing sit ullamco"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "adipisicing sunt",
  "supplier_part_numbers": {
    "occaecat_d99": ["Duis non veniam", "Ut aliqua tempor est"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolorea4": ["laboris dolore ullamco"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "est eu deserunt occaecat laboris",
  "supplier_part_numbers": {
    "voluptate9eb": [
      "est",
      "tempor qui",
      "incididunt et Excepteur esse",
      "dolore"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "culpa3": ["sint est do", "id consequat"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "cupidatat_b": [
      "pariatur laboris quis consectetur Excepteur",
      "in",
      "ipsum dolore Duis ad commodo"
    ],
    "dolore_a": ["minim enim", "minim exercitation aliqua"],
    "proident_8": ["ullamco", "velit", "id", "elit ut consequat ad veniam"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "sunt dolore officia",
    "ad aute dolor pariatur",
    "dolor commodo cupidatat anim dolor",
    "et",
    "qui"
  ],
  "connected_source_net_ids": ["incididunt sunt"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -44789058.474023856
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "culpa ipsum adipisicing Excepteur"
}
```
...
```json
{
  ...
  "radius_x": "Lorem aliqua amet",
  "radius_y": 93076163.02838922,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "cupidatat est id nulla cillum",
  "supplier_part_numbers": {
    "cillumddb": [
      "quis",
      "et",
      "aliqua ut laborum sit eiusmod",
      "proident esse"
    ],
    "laboris_80": ["eu laborum do proident dolor"],
    "amet7ce": ["ex"],
    "non142": [
      "culpa consequat officia id",
      "sunt Excepteur voluptate in",
      "do sit irure laboris reprehenderit",
      "veniam elit ipsum exercitation",
      "amet ipsum proident esse"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "ad commodo reprehenderit",
  "model_obj_url": "ullamco nulla non consequat",
  "model_stl_url": "Lorem veniam amet ut nostrud",
  "model_3mf_url": "nisi anim",
  "model_jscad": {}
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "pariatur velit commodo consequat fugiat"
}
```
...
{
  "do8": {
    "left_margin": 79682270.09585366,
    "right_margin": "consectetur commodo proident reprehenderit"
  },
  "consequat_218": {
    "left_margin": "culpa",
    "right_margin": "commodo ullamco qui",
    "top_margin": "ea eu dolor ut aliquip"
  }
}
```
