...
```json
{
  ...
  "supplier_part_numbers": {
    "officia_69": ["ut et", "quis enim dolor", "incididunt amet velit"],
    "doloreec6": ["eiusmod labore amet", "consequat esse"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "Lorem ullamco irure ex",
  "supplier_part_numbers": {
    "ad_04d": [
      "deserunt eiusmod ut in voluptate",
      "magna aliquip adipisicing",
      "magna eiusmod ullamco occaecat",
      "ad incididunt est",
      "exercitation ipsum dolor"
    ],
    "anim89": ["pariatur Duis", "occaecat", "esse aute", "fugiat", "eiusmod"],
    "labore8b": ["cillum dolor fugiat", "velit"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "voluptate1e7": [
      "velit do",
      "quis veniam non dolor nulla",
      "veniam",
      "consequat Lorem aute ullamco nulla",
      "cillum dolor"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "cillum_b": [
      "quis",
      "adipisicing enim Ut esse dolor",
      "voluptate qui",
      "ut ea"
    ],
    "ullamcod01": ["sunt", "officia"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "incididunt cupidatat fugiat deserunt",
  "supplier_part_numbers": {
    "irure1_b": [
      "tempor in cupidatat irure",
      "reprehenderit mollit",
      "id sit",
      "do ullamco in adipisicing"
    ],
    "dolor99d": [
      "ex nulla commodo sed anim",
      "sint",
      "ad ea adipisicing exercitation",
      "Excepteur",
      "ad"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "minim enim",
  "supplier_part_numbers": {
    "laboris__": [
      "ad fugiat sed incididunt sunt",
      "proident ut in incididunt velit",
      "pariatur mollit"
    ]
  }
}
...
```json
{
  ...
  "name": "G1",
  "supplier_part_numbers": {
    "labore_e7": ["minim aliquip commodo ipsum"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "velit nisi ad minim laborum",
  "supplier_part_numbers": {
    "eafb": ["adipisicing", "elit minim"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "nulla079": [
      "tempor Duis deserunt eiusmod occaecat",
      "cillum",
      "esse",
      "minim"
    ]
...
```json
{
  ...
  "connected_source_port_ids": [
    "qui tempor cupidatat dolor",
    "ut",
    "reprehenderit cillum enim amet"
  ],
  "connected_source_net_ids": [
    "cillum mollit fugiat in",
    "qui",
    "anim proident"
  ]
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 46351879.21059632,
  "box_width": 54864109.94274858,
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "ut eiusmod proident ut veniam"
}
```
...
```json
{
  ...
  "message": "ullamco id sit tempor et"
}
```
...
```json
{
  ...
  "message": "fugiat cupidatat laboris culpa voluptate",
...
```json
{
  ...
  "radius_x": "exercitation adipisicing",
  "radius_y": -33540528.370363235,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "sed Excepteur esse consectetur Duis",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "nulla sunt",
  "supplier_part_numbers": {
    "adipisicing3": [
      "Lorem sed",
    ...
    "consecteturd_": [
      "ipsum Ut occaecat irure",
      "nostrud ea",
      "fugiat minim",
      "dolor in nisi do ex",
      "nisi eiusmod reprehenderit qui"
    ],
    "elit8": ["nisi"]
  },
  "resistance": "1k"
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "ad id ullamco in pariatur"
  },
  "layer": "top",
  "footprinter_string": "ullamco eu",
  "model_obj_url": "velit",
  "model_stl_url": "culpa veniam",
  "model_3mf_url": "dolor irure",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -85721798.26831064,
  "outer_height": -11497106.48247759,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
