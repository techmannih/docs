...
```json
{
  ...
  "ftype": "ipsum amet aliqua",
  "source_component_id": "source_component_1",
  "name": "I1",
  "manufacturer_part_number": "magna qui eu cillum",
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["nulla ullamco"],
  "is_power": false
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "et enim qui sint sed",
  "supplier_part_numbers": {
    "pariatur388": ["consectetur fugiat"],
    "Duis_cfe": ["non sed laborum"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "laborum culpa ut",
  "supplier_part_numbers": {
    "dolor96": ["pariatur cupidatat anim"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "cupidatat laborum ad incididunt",
  "supplier_part_numbers": {
    "eu9": ["consequat eiusmod do veniam ad"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "do",
  "supplier_part_numbers": {
    "consequat2": [
      "sunt enim ipsum amet",
      "eiusmod magna cupidatat",
      "esse aute tempor ea non",
      "ex occaecat voluptate irure"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "Excepteur sit ex incididunt",
  "supplier_part_numbers": {
    "aliquip_46": ["laboris sed consequat esse", "anim eiusmod", "cillum"],
    "in_f": [
      "qui commodo",
      "Lorem",
      "proident magna quis dolor",
      "labore in minim pariatur"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "sint cupidatat do aliquip",
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "sed cillum minim",
  "supplier_part_numbers": {
    "sit_0": [
      "esse nostrud qui dolor laborum",
      "in non",
      "occaecat consequat anim sit",
      "ullamco sit laborum sed",
      "sunt do aliqua"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": [
    ...
    "labore",
    "ullamco Ut",
    "veniam cupidatat quis Duis"
  ],
  "connected_source_net_ids": ["sint ea ut sunt", "officia ipsum"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "et deserunt consequat",
  "pin_styles": {},
  "box_width": "do",
  "symbol_name": "deserunt anim cillum amet",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "consequat laborum occaecat sunt"
}
```
...
```json
{
  ...
  "message": "id fugiat magna veniam"
}
```
...
```json
{
  ...
  "radius_x": 53328324.30886847,
  "radius_y": "exercitation",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "fugiat labore aute do consequat",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "tempor enim",
  "supplier_part_numbers": {
    "adipisicing5": [
      "mollit deserunt nostrud et",
      "voluptate Ut culpa",
      "in laboris",
      "eu cupidatat et"
    ]
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "exercitation nulla adipisicing ut labore"
}
```
...
{
  "magnac": {
    "left_margin": "laborum enim",
    "right_margin": -78691367.59120186,
    "top_margin": -92132524.9493064,
    "bottom_margin": -18853507.30335866
  }
}
```
