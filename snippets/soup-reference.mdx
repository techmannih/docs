...
```json
{
  ...
  "supplier_part_numbers": {
    "sint94e": [
      "ex dolor",
      "occaecat veniam consequat enim",
      "sit nisi sed Excepteur et",
      "qui commodo",
      "elit in"
    ],
    "elit97": ["culpa", "Duis ut sed Excepteur"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "aliqua irure",
  "supplier_part_numbers": {
    "eiusmod_f3": [
      "occaecat ut ad",
      "tempor in",
      "occaecat deserunt dolor aliquip"
    ],
    "aute_01e": [
      "non laborum sunt ipsum amet",
      "aliqua",
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["id commodo dolore qui labore"],
  "is_ground": true,
  "is_analog_signal": false,
  "trace_width": -93536505.49876429
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "ipsum adipisicing anim aliqua qui",
  "supplier_part_numbers": {
    "mollit2c1": ["adipisicing ut", "aliquip eu", "est Ut consectetur minim"],
    "dolor_1": [
      "occaecat in ut commodo sed",
      "labore",
      "qui",
      "Lorem laboris",
      "do laboris et minim"
    ],
    "irure_f": ["commodo culpa", "irure do sunt cupidatat Duis", "aute"],
    "fugiat6": [
      "laboris in irure cillum",
      "mollit magna est voluptate amet",
      "mollit proident",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "commodo ullamco labore veniam",
  "supplier_part_numbers": {
    "ipsum_63_": [
      "eu",
      "qui cupidatat pariatur est Lorem",
      "pariatur",
      "do cupidatat proident dolore",
      "cillum"
    ],
    "fugiat_0": ["ut qui ipsum"],
    "eu_259": [
      "enim",
      "velit reprehenderit occaecat qui",
      "nisi amet culpa Excepteur",
      "aliqua",
      "in in ex Lorem laboris"
    ],
    "ea0a4": ["elit culpa"]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "in exercitation reprehenderit",
  "supplier_part_numbers": {
    "ipsum535": ["sit Lorem aliquip proident reprehenderit"],
    "occaecatc1": ["Ut", "culpa voluptate"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "Lorem occaecat anim deserunt",
  "supplier_part_numbers": {
    "voluptate924": [
      "reprehenderit esse in occaecat non",
      "ad",
      "consequat magna ea in"
    ],
    "aliqua_08": ["nulla ipsum Ut", "magna proident nulla ut dolore"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "labore ex"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "non in fugiat qui consectetur",
  "supplier_part_numbers": {
    "adipisicing_3": ["aute magna dolor"],
    "sint8": ["eu sunt nostrud consequat"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["ut culpa", "labore", "irure"],
  "connected_source_net_ids": ["ut ex ipsum", "quis", "minim in"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 4729657.549321294,
  "pin_styles": {},
  "box_width": "ullamco reprehenderit",
  "symbol_name": "laboris anim nisi aute",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "color": "ea nisi Excepteur fugiat aliqua"
}
```
...
```json
{
  ...
  "radius_x": -69175239.28218117,
  "radius_y": 28387904.46397175,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "exercitation in amet qui nostrud",
  "supplier_part_numbers": {
    "Duis0e5": [
      "mollit consectetur consequat",
      "consequat exercitation sint",
      "quis aliqua commodo consectetur",
      "do nostrud eiusmod ex in"
    ]
  }
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -54828397.3295165,
  "outer_height": -62736333.113472484,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": -27506472.708545357
}
```
...
{
  "officia7a4": {
    "left_margin": 63690642.01253417,
    "right_margin": -47896016.89513216
  }
}
```
