...
```json
{
  ...
  "supplier_part_numbers": {
    "commodo45": ["incididunt eu Ut"],
    "cupidatat_390": [
      "est cupidatat id dolor ex",
      "aliquip reprehenderit in aliqua",
      "est qui Lorem fugiat ut"
    ],
    "proident_0": ["ea", "consequat ut"],
    "est_b3": [
      "tempor eu",
      "pariatur",
      "esse officia ad nulla",
      "ex in velit Duis nisi",
      "ad"
    ]
  }
}
...
```json
{
  ...
  "name": "L1",
  "supplier_part_numbers": {
    "ad_d": ["dolore cillum Excepteur eu"],
    "labored": [
      "tempor velit",
      "non officia proident dolor consequat",
      "amet velit",
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["aliqua ullamco nostrud"]
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "fugiatcfd": ["occaecat"],
    "magna_": ["qui consequat cillum anim tempor"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ad3": [
      "irure proident ut",
      "qui dolor sunt voluptate",
      "cupidatat Excepteur",
      "nostrud",
      "proident mollit id tempor"
    ],
    "eiusmod915": ["cillum qui Ut", "ad nisi"]
  }
}
```
...
```json
{
  ...
  "name": "G1",
  "supplier_part_numbers": {
    "dolor01a": ["sed dolor incididunt in cillum", "mollit commodo esse in"],
    "sit_a3c": ["cillum nulla"],
    "elit7d2": [
      "voluptate in in esse",
      "Excepteur cillum consequat",
      "cillum elit non anim",
      "veniam aliquip",
      "commodo in"
    ]
  }
...
```json
{
  ...
  "name": "P1",
  "supplier_part_numbers": {
    "ullamcoa4": ["labore consequat", "Duis quis laboris"],
    "ea_0": ["est aute", "sit", "laborum nisi commodo", "aliqua eiusmod amet"],
    "dolor__a": ["sint ut reprehenderit ex"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "deserunt_056": [
      "in nisi aliqua irure",
      "aliquip deserunt nisi",
      "ad est quis in",
      "ad"
    ],
    "fugiat_": ["in enim", "mollit eu adipisicing sunt", "in deserunt magna"],
    "ipsum4b": [
      "veniam elit consequat incididunt",
      "mollit dolore",
      "dolor in veniam aute",
      "officia anim cupidatat tempor mollit",
      "nostrud aute aliquip in"
    ],
    "sit_69": ["aliquip ut do cillum aliqua"],
    "deseruntbc9": ["proident qui", "aute culpa quis consectetur"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "occaecat ut exercitation id",
    "incididunt est culpa ut",
    "ut non do elit"
  ],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -10070715.934880912,
  "box_width": -2449474.155876577
}
```
...
```json
{
  ...
  "message": "aliqua quis laborum et mollit",
...
```json
{
  ...
  "radius_x": -49423579.98192306,
  "radius_y": -20805193.47993195,
  "layer": "top"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "pariatur92c": [
      "ut id officia labore",
      "dolore Excepteur labore",
      "in",
      "eiusmod amet ex Ut consectetur",
      "et"
    ],
    "consequat_e": ["id anim deserunt cupidatat fugiat", "tempor"],
    "voluptate03": [
      "esse aliquip",
      "Lorem sed sit dolore",
      "dolore",
      "proident laborum consequat ex"
    ],
    "ut_a": [
      "ut sint est commodo incididunt",
      "non exercitation Excepteur fugiat",
      "id",
      "sint dolore Duis mollit ut",
      "Excepteur officia ea"
    ],
    "dolore_0": ["sed amet", "tempor"]
  }
}
```
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": 40182670.524470985
  },
  "layer": "top",
  "footprinter_string": "Duis",
  "model_obj_url": "sunt velit laborum",
  "model_stl_url": "sunt dolore nostrud veniam",
  "model_3mf_url": "exercitation Duis fugiat non",
  "model_jscad": []
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -52072597.3070963,
  "outer_height": -77930591.80588813,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "voluptate commodo nostrud magna et"
}
```
