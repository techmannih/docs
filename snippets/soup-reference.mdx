...
```json
{
  ...
  "ftype": "laborum consequat minim Duis quis",
  ...
  "supplier_part_numbers": {
    "incididunt8": [
      "velit in sint",
      "in nostrud reprehenderit dolor do",
      "dolore nulla cupidatat minim fugiat"
    ],
    "officiab": ["eu amet sit Duis", "laboris magna ad cillum et"],
    "pariaturb": [
      "aliqua",
      "fugiat labore qui",
      "culpa quis sint",
      "in laboris et dolore",
      "culpa exercitation amet reprehenderit"
    ],
    "qui_8c": [
      "sed nisi",
      "cupidatat",
      "velit dolore",
      "ut dolore ad exercitation"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "esse do ullamco in Duis",
  "supplier_part_numbers": {
    "exercitation__48": [
      "do commodo elit proident",
      "aliquip",
      "non quis Lorem",
      "ut consequat Duis ut"
    ],
    "labored_d": ["ipsum ad", "ea Lorem voluptate in"],
    "suntc95": ["velit", "irure sint dolor", "dolor et Lorem"],
    "dolor_b1": [
      "irure dolor occaecat dolore",
      "cillum voluptate tempor proident dolor"
    ]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "amet labore veniam voluptate",
    "fugiat nisi",
    "sit magna esse labore",
    "nulla fugiat tempor",
    "id deserunt ipsum ex voluptate"
  ],
  "is_power": false,
  "is_ground": true,
  "is_digital_signal": false,
  "is_analog_signal": true,
  "trace_width": 44045599.31412241
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "officia cupidatat",
  "supplier_part_numbers": {
    "esse68": ["mollit aliqua"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "consequat Ut aliqua ad do",
  "supplier_part_numbers": {
    "do_6": ["laborum", "proident enim sit"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "laboris id elit voluptate",
  "supplier_part_numbers": {
    "in_32f": [
      "velit dolore adipisicing anim Excepteur",
      "deserunt amet in et",
      "Excepteur Duis"
    ],
    "do_80": [
      "aliquip reprehenderit deserunt Ut velit",
      "nulla",
      "elit magna ex in quis",
      "sed ad veniam"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "et minim exercitation quis tempor",
  "supplier_part_numbers": {
    "dolore_4": ["enim amet", "ea enim"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "ex irure non incididunt",
  "supplier_part_numbers": {
    "ullamco96": ["pariatur incididunt", "dolor aute sit est enim"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "sed enim do anim",
  "voltage": "5V"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "aliquip et nisi laboris irure",
    "proident",
    "sint fugiat ipsum"
  ],
  "connected_source_net_ids": [
    "cillum Duis consectetur",
    "nulla nisi est reprehenderit nostrud",
    "culpa eu ad mollit laboris",
    "et cupidatat",
    "id est consequat culpa officia"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "non id ut aliquip",
  "pin_styles": {},
  "box_width": 60588787.11626959,
  "symbol_name": "exercitation aliquip",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  }
...
```json
{
  ...
  "message": "et mollit esse officia"
}
```
...
```json
{
  ...
  "radius_x": "quis irure et ex esse",
  "radius_y": -29498737.942932025,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "consequat commodo cillum voluptate",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "ea veniam Excepteur sed ut",
  "supplier_part_numbers": {
    "laborum_2": ["officia deserunt nulla dolore", "reprehenderit esse est"],
    "nisieca": ["reprehenderit adipisicing sit minim dolore"],
    "Loremf_4": [
      "dolore ut",
      "magna fugiat aute Lorem ipsum",
      "quis",
      "Excepteur est",
      "ad fugiat"
    ]
...
```json
{
  ...
  "footprinter_string": "ex exercitation reprehenderit pariatur irure",
  "model_obj_url": "cupidatat exercitation",
  "model_stl_url": "proident nulla commodo",
  "model_3mf_url": "sint",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "via": false,
  "to_layer": "bottom",
  "trace_width": "occaecat Lorem Duis mollit nostrud"
}
```
...
{
  "eu_e_5": {
    "left_margin": "magna eu mollit",
    "right_margin": 27823582.54138057,
    "top_margin": "dolor est",
    "bottom_margin": -2554327.4609247595
  },
  "ex_9c4": {
    "left_margin": 98900665.60829851,
    "right_margin": "sit labore cupidatat id laborum",
    "top_margin": -25275987.84339413
  },
  "minim_81": {
    "left_margin": 64848264.56295586,
    "bottom_margin": -55546973.44327897
  }
}
```
