...
```json
{
  ...
  "ftype": "cillum sint minim",
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "nulla eu",
  "supplier_part_numbers": {
    "aliqua_68": [
      "laboris sit sunt dolor aliquip",
      "reprehenderit",
      "mollit enim laboris nostrud",
      "id dolor nisi eiusmod"
    ],
    "commodo_8": ["ad adipisicing in Ut esse"],
    "ex_16e": [
      "velit nisi incididunt",
      "ut sit pariatur culpa voluptate",
      "proident eu"
    ]
  }
}
...
```json
{
  ...
  "name": "L1",
  "supplier_part_numbers": {
    "voluptate69d": ["pariatur eu", "magna in", "sit non est veniam irure"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "et ipsum cupidatat sint labore",
    "eiusmod dolor mollit veniam incididunt"
  ],
  "is_power": true,
  "is_ground": true,
  "is_digital_signal": true,
  "trace_width": 3022335.1514342874
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "qui_6": ["aute", "commodo"],
    "Excepteur3": ["in", "exercitation ipsum sit ad"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "Ut_b56": [
      ...
      "tempor sint dolore ut",
      "reprehenderit in magna",
      "exercitation in",
      "aute dolor anim Lorem mollit"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "ullamco ex velit magna"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "esse pariatur Duis enim aute",
  "supplier_part_numbers": {
    "quisce": [
      "veniam nostrud et occaecat eu",
      "dolor culpa nulla irure tempor",
      "labore laboris culpa magna et",
      "deserunt Ut nisi elit aute"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "est dolor fugiat sunt magna",
  "supplier_part_numbers": {
    "eiusmod68": [
      "incididunt",
      "consectetur sed eu",
      "eu adipisicing qui consequat"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "commodo voluptate eiusmod consectetur",
    "quis sint do amet non",
    "veniam irure ad",
    "dolore aliquip enim mollit",
    "anim aliqua"
  ],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 25190140.76310797,
  "box_width": "sunt minim enim",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "ad Lorem nisi pariatur consequat"
}
```
...
```json
{
  ...
  "message": "dolore nisi pariatur Lorem dolor",
...
```json
{
  ...
  "radius_x": "sunt reprehenderit nulla consequat laboris",
  "radius_y": -85023393.12497082,
  "layer": "top"
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "dolore anim fugiat nostrud",
  "model_obj_url": "eiusmod qui mollit Duis proident",
  "model_stl_url": "proident magna ut aliquip anim",
  "model_3mf_url": "incididunt mollit id in officia"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 55633981.99173969,
  "outer_height": 77325071.76695651,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
