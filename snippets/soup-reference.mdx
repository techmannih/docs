...
```json
{
  ...
  "ftype": "occaecat minim sit tempor",
  "source_component_id": "source_component_1",
  "name": "O1",
  "supplier_part_numbers": {
    "inbd": ["Duis eiusmod", "est id magna velit"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "labore pariatur dolor incididunt"
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["sint proident", "Duis labore"],
  "is_power": false,
  "is_ground": false,
  "is_digital_signal": false,
  "is_analog_signal": false,
  "trace_width": 92976396.8567121
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "proident Lorem",
  "supplier_part_numbers": {
    "in_9_": [
      "est occaecat dolor",
      "pariatur consequat sint",
      "aliqua proident officia aute Ut",
      "ex mollit"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "do voluptate incididunt laborum",
  "supplier_part_numbers": {
    "esse9bf": [
      "voluptate ullamco labore est",
      "veniam consectetur pariatur aute",
      "est velit sit ad deserunt",
      "cupidatat",
      "anim"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "in dolor id",
  "supplier_part_numbers": {
    "esse6bf": [
      "deserunt tempor in",
      "in aliquip velit elit quis",
      "veniam aute fugiat"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "in anim veniam fugiat",
  "supplier_part_numbers": {
    "nullaac": ["sunt sint proident", "deserunt", "sunt sit in"],
    "irure40f": ["Ut", "commodo non", "ut ullamco", "tempor"],
    "eiusmod_633": ["fugiat incididunt ut", "eu"],
    "sint_cb5": [
      "ut",
      "ut exercitation do aliqua",
      "in",
      "occaecat in ipsum ut sed",
      "et in"
    ],
    "dolorc58": [
      "fugiat est exercitation adipisicing non",
      "nulla eiusmod cupidatat",
      "ut",
      "Lorem dolore sunt irure"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "reprehenderit sit culpa elit pariatur",
  "supplier_part_numbers": {
    "et_7": ["cillum reprehenderit amet elit aliquip"],
    "non_c": ["cillum Duis", "ad Excepteur", "voluptate qui", "anim"],
    "laborume": [
      "commodo",
      "nisi ut laborum officia tempor",
      "ullamco",
      "minim elit"
    ],
    "Ut_9fa": ["nulla labore mollit"],
    "minim_75": [
      "ea enim tempor culpa mollit",
      "aliquip aute Excepteur cupidatat sint"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": ["commodo adipisicing esse", "amet dolore Ut"],
  "connected_source_net_ids": [
    "deserunt incididunt Ut",
    "exercitation anim",
    "Lorem eiusmod",
    "laboris",
    "Ut sit exercitation ex dolor"
  ]
}
```
...
```json
{
  ...
  "radius_x": -54575323.45924947,
  "radius_y": "cupidatat dolor Duis eu",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "culpa sint labore pariatur",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "Duis sed non eiusmod pariatur",
  "supplier_part_numbers": {
    "etb": [
      "fugiat dolore sit ex",
      "exercitation aliqua tempor minim",
      "incididunt ullamco eiusmod ad"
    ],
    "consectetur__": ["id", "Lorem id fugiat"],
    "fugiat018": ["fugiat in consequat ipsum cillum", "Duis"],
    "quif": ["tempor", "qui", "elit", "veniam Excepteur deserunt"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "elit Excepteur proident in tempor"
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": -21162009.089125007
  },
  "layer": "top",
  "footprinter_string": "amet laboris",
  "model_obj_url": "eiusmod deserunt irure dolore laborum",
  "model_stl_url": "qui veniam exercitation",
  "model_3mf_url": "consectetur",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 55666197.293697625,
  "outer_height": 2853756.0157001317,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "eta5f": {
    "left_margin": -65217514.013441846,
    "right_margin": 67758041.5793333,
    "top_margin": -90391443.55603614,
    "bottom_margin": 23970632.924392104
  }
}
```
