...
```json
{
  ...
  "ftype": "nulla aliquip anim nisi",
  "source_component_id": "source_component_1",
  "name": "N1",
  "manufacturer_part_number": "nostrud magna amet",
  "supplier_part_numbers": {
    "incididunt_4a9": [
      "cillum consectetur labore",
      "occaecat laborum do fugiat voluptate",
      "aliqua quis proident amet",
      "mollit",
      "ut aliquip"
    ],
    "fugiat_e": [
    ...
    "irure99": ["sed ullamco consectetur non veniam", "dolor ad ea est amet"],
    "consequat3_2": [],
    "dolorebcf": []
  }
}
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["amet consequat irure ad"],
  "is_power": true,
  "is_ground": true,
  "is_digital_signal": false,
  "is_analog_signal": true,
  "trace_width": -57395029.708804704
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "pariatur_3": [
      "veniam dolore esse adipisicing",
      "Excepteur",
      "aliqua",
      "est Lorem",
      "elit Duis commodo deserunt"
    ],
    "mollit_ce": ["in aliqua anim elit"],
    "Excepteur_0b": [
      "Excepteur amet",
      "anim mollit ad",
      "ea in esse",
      "ex magna officia reprehenderit"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "dolor ea labore",
  "supplier_part_numbers": {
    "laboris9b": [
      "sint sit",
      "sit in magna dolore Lorem",
      "ut do proident adipisicing Ut"
    ],
    "sed21": [],
    "aliquip_b2": []
  }
...
```json
{
  ...
  "supplier_part_numbers": {
    "amet8f": [
      "sint reprehenderit et id ipsum",
      "ad ex reprehenderit sed",
      "ut deserunt veniam",
      "esse",
      "labore dolor"
    ],
    "laborum_967": [
      ...
      "qui elit sunt cillum officia",
      "adipisicing aliquip veniam voluptate",
      "fugiat",
      "ut Lorem"
    ]
  }
...
```json
{
  ...
  "supplier_part_numbers": {
    "in_3": [
      ...
      "sunt enim Duis mollit est",
      "adipisicing ad enim commodo aliqua",
      "veniam proident"
    ]
  },
  "voltage": "5V"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "culpa magna in",
  "supplier_part_numbers": {
    "incididunte1": ["laborum in cillum in velit", "et elit sed cupidatat"],
    "laborum_6": [
      "deserunt",
      "nostrud mollit laborum velit",
      "ut ea nostrud",
      "ut dolor",
      "magna aute Duis nulla consectetur"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "ut",
    "tempor quis est dolore aliqua",
    "ad dolore eiusmod",
    "in proident veniam aute",
    "Lorem"
  ],
  "connected_source_net_ids": ["occaecat culpa"]
}
```
...
```json
{
  ...
  "color": "in dolore sint eiusmod sit"
}
```
...
```json
{
  ...
  "message": "sed nisi adipisicing esse"
}
```
...
```json
{
  ...
  "radius_x": -79401581.62821227,
  "radius_y": "deserunt adipisicing aliquip laborum",
  "layer": "top"
}
```
...
```json
{
  ...
  "model_obj_url": "tempor minim",
  "model_stl_url": "nisi sunt aliqua laboris fugiat",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "name": "R1",
  "supplier_part_numbers": {
    "dolore_": ["in", "ad", "ullamco do", "dolor", "eiusmod"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": -13693427.125489458
  },
  "layer": "top",
  "footprinter_string": "Excepteur ullamco",
  "model_obj_url": "in",
  "model_stl_url": "nisi veniam",
  "model_3mf_url": "dolore incididunt do officia",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "dolore Excepteur sunt"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -2865959.945043087,
  "outer_height": 41492559.06707236,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "in in pariatur quis consectetur"
}
```
...
{
  "incididunt5f_": {
    "left_margin": 72432807.54200253,
    "right_margin": -70079697.64717221,
    "top_margin": "sunt id",
    "bottom_margin": -20360934.813412964
  }
}
```
