...
```json
{
  ...
  "member_source_group_ids": [
    "ut incididunt deserunt enim",
    "incididunt aliquip",
    "consectetur aliquip et",
    "adipisicing ex commodo Excepteur",
    "officia"
  ],
  "is_power": false,
  "is_ground": true,
  "is_analog_signal": false,
  "trace_width": 48970277.92874277
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "cillum_fb0": [
      "ullamco ipsum enim quis occaecat",
      "in qui reprehenderit",
      "dolore sit in do",
      "Lorem aute eiusmod",
      "exercitation ullamco dolore sunt consectetur"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "irure elit sit anim",
  "supplier_part_numbers": {
    "aliquaf": [
      "enim et mollit",
      "consectetur dolor",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "exercitation in Lorem",
  "supplier_part_numbers": {
    "incididunteb": [
      "officia eu veniam",
      "eu deserunt dolore",
      "sunt deserunt quis cupidatat labore",
      "esse tempor non dolore"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "proident_14c": [
      "irure ullamco sed laboris dolore",
      "sunt dolor",
      "ullamco nostrud enim aliqua cillum",
      "nulla magna Duis et"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "commodo culpa",
  "supplier_part_numbers": {
    "sit_441": ["Duis dolor", "in", "velit adipisicing", "esse", "in est ad"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "in laboris deserunt ut quis",
  "supplier_part_numbers": {
    "mollit_9a1": [
      "do et occaecat sint est",
      "amet occaecat",
      "eiusmod labore",
      "anim nisi occaecat quis",
      "veniam consequat minim Duis id"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "aute dolor sed ullamco",
    "do deserunt dolore",
    "consectetur ex",
    "eiusmod est aliqua officia enim",
    "laborum dolor aliquip"
  ],
  "connected_source_net_ids": [
    "in",
    "magna quis minim aute",
    "occaecat",
    "nostrud amet ut ipsum",
    "fugiat consequat"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -88279108.23787838,
  "box_width": -80573640.99717818,
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "labore dolor dolore ut adipisicing"
}
```
...
```json
{
  ...
  "radius_x": 90552569.50181308,
  "radius_y": "nisi pariatur",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "sit Excepteur anim nulla culpa",
  "supplier_part_numbers": {
    "nisie_7": ["nisi sit quis commodo fugiat", "officia labore nulla dolor"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "Duis deserunt magna",
  "model_3mf_url": "consequat nisi",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -22715933.027753904,
  "outer_height": -65934143.49752171,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
