...
```json
{
  ...
  "ftype": "nisi exercitation in ut",
  "source_component_id": "source_component_1",
  "name": "N1",
  "manufacturer_part_number": "ut eu ipsum ea elit",
  "supplier_part_numbers": {
    ...
    "in_70": [
      "culpa tempor Duis qui",
      "ad do",
      "ut sunt",
      "in occaecat Lorem aute ut"
    ]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "cupidatat et voluptate aute minim",
    "dolore",
    "sit occaecat dolore mollit tempor",
    "sunt"
  ],
  "is_power": false,
  "is_ground": true,
  "is_analog_signal": false,
  "trace_width": 82194904.50095797
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "nostrud eu fugiat sint sit",
  "supplier_part_numbers": {
    "quic58": ["Ut mollit culpa velit", "ut sint"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "eu irure labore dolor",
  "supplier_part_numbers": {
    "in032": ["labore amet"]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "deserunt26f": [
      "veniam aliquip ea dolore",
      "minim reprehenderit est ut in",
      "ex Duis",
      "laboris enim consequat"
    ],
    "eu_27a": [
      "est culpa quis",
      "dolor commodo esse anim occaecat",
      "laboris irure qui consectetur"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "ut veniam magna adipisicing id"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "laboris Excepteur amet velit et",
  "supplier_part_numbers": {
    "dolorea": ["dolor", "culpa in"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "laboris488": ["deserunt"],
    "reprehenderite": [
      "esse ea adipisicing nisi",
      "Excepteur nisi tempor do eu",
      "in proident",
      "id deserunt"
    ],
    "pariatur_92": ["incididunt nulla nostrud commodo", "mollit in in qui"],
    "id_d_7": ["id", "Duis anim Ut culpa", "irure in"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["dolor", "aliqua", "consectetur", "aute Lorem"],
  "connected_source_net_ids": [
    "cillum laboris in sit sunt",
    "consequat laboris est sed"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -54844567.32275324,
  "pin_styles": {},
  "box_width": 57362382.3554641,
  "symbol_name": "ullamco",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "message": "nulla consequat sit velit labore"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "nostrude9": [
      "ullamco consectetur Ut",
      "amet ut irure sed enim",
      "Duis",
      "esse enim",
      "consectetur ex exercitation ea"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "fugiat ex sunt",
  "supplier_part_numbers": {
    "minim_02": ["nulla velit nisi"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "laborum in elit",
  "model_obj_url": "quis aliquip eiusmod proident in",
  "model_stl_url": "deserunt",
  "model_3mf_url": "ut anim amet cillum est",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -77680668.7928103,
  "outer_height": -40011544.740085945,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "adipisicing sed nulla sit Lorem"
}
```
...
{
  "incididunt_e9": {
    "right_margin": 33439035.47325246,
    "top_margin": "dolor minim proident mollit labore",
    "bottom_margin": "qui"
  }
}
```
