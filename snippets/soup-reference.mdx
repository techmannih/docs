...
```json
{
  ...
  "supplier_part_numbers": {
    "in_ee8": ["dolor dolor anim id"],
    "fugiat_3": [
      "do Duis elit incididunt",
      "eu amet voluptate ipsum",
      "consectetur laboris Excepteur reprehenderit"
    ],
    "in__7": [
      "sint",
      "tempor do quis",
      "in in sint irure nostrud",
      "anim magna",
      "proident et qui irure do"
    ],
    "quisa69": [
      "laborum do",
      "aute nulla enim dolore laboris",
      "magna",
      "eu veniam aute in",
      "non dolor aliquip"
    ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "in dolore amet occaecat eu"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "labore94_": ["irure mollit", "minim veniam ullamco"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "aute officia Duis irure",
  "supplier_part_numbers": {
    "quis9": ["voluptate officia laborum amet Ut", "ipsum", "sed Ut"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "occaecat Excepteur",
  "supplier_part_numbers": {
    "consequat_d": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "aliquip pariatur mollit officia sunt",
  "supplier_part_numbers": {
    "do1c": ["ut", "pariatur non", "officia eiusmod", "magna"],
    "nisi9": ["adipisicing amet laborum"],
    "elit0c": ["adipisicing occaecat elit", "reprehenderit"],
    "nostrud_2ed": [
      "fugiat in minim voluptate qui",
      "irure in mollit minim",
      "sed Lorem amet mollit sit",
      "anim quis Excepteur"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "exercitation0": [
      "mollit labore",
      "consectetur veniam proident in incididunt",
      "do mollit ad"
    ]
  },
  "voltage": "5V"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -6461926.967146918,
  "pin_styles": {},
  "symbol_name": "sed Duis tempor",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "message": "sed Lorem incididunt ipsum reprehenderit"
}
```
  ...
  "route": [
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": "sed cupidatat velit est dolore"
    },
    {
      "x": "3mm"
    }
...
```json
{
  ...
  "name": "P1",
  "supplier_part_numbers": {
    "cupidatat7b_": ["dolor", "id veniam"],
    "laborum_58": [
      "mollit nulla dolor",
      "quis enim ipsum in",
      "labore dolore ullamco et eu",
      "laborum"
    ],
    "ea0e": ["deserunt id minim", "commodo", "nisi qui"],
    "dolore52": []
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "incididunt irure do laboris"
  },
  "layer": "top",
  "footprinter_string": "sit occaecat",
  "model_obj_url": "deserunt reprehenderit",
  "model_stl_url": "consequat tempor officia commodo dolore",
  "model_3mf_url": "cupidatat anim",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "in in laborum dolore Lorem"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 30694779.786531433,
  "outer_height": 96380462.04101989,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "via": false,
  "to_layer": "bottom",
  "trace_width": "reprehenderit quis sit ex"
}
```
...
{
  "elit_bd": {
    "left_margin": 79406061.69824228,
    "right_margin": "sunt non irure velit",
    "top_margin": -73724799.22232835,
    "bottom_margin": "commodo qui proident cupidatat"
  }
}
```
