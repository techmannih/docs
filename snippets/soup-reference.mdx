...
```json
{
  ...
  "name": "I1",
  "manufacturer_part_number": "nisi anim",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "eiusmod dolor mollit sed",
  "supplier_part_numbers": {
    "ad_11": []
  }
}
...
```json
{
  ...
  "trace_width": 23203490.687384278
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "Lorem aliquip culpa fugiat est",
  "supplier_part_numbers": {
    "pariatur189": [],
    "dolore_6b": [
      "ea sed",
      "sint amet officia enim nostrud",
      "commodo consequat",
      "anim ea ad sit",
      "labore amet ut est"
    ],
    ...
    "ipsum1": [
      "minim",
      "proident non aute",
      "nisi adipisicing deserunt incididunt",
      "do Duis eiusmod sit labore"
    ],
    "dolor_11": ["Ut et"]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "velit mollit labore deserunt elit",
  "supplier_part_numbers": {
    "eaf3": [
      "exercitation dolor consequat",
      "voluptate occaecat Lorem ut labore",
      "ipsum eu Duis Excepteur"
    ],
    "cillum9": ["in ea dolor", "eiusmod"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "Ut exercitation mollit",
  "supplier_part_numbers": {
    "ad_3ab": [
      "labore est",
      "ut reprehenderit ea",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "do labore in",
  "supplier_part_numbers": {
    "nisi73": ["minim Duis tempor nulla dolor"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "enim_59": ["officia occaecat velit eu"],
    "dolorecb": ["qui pariatur elit", "cillum do", "deserunt anim", "commodo"],
    "commodo_16c": ["nulla cupidatat do minim"],
    "ullamco__": ["eu sed aliqua", "Duis magna aute ipsum", "ad eu occaecat"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "in pariatur nostrud",
  "supplier_part_numbers": {
    "cupidatat7ea": []
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_net_ids": ["Lorem magna"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "laborum et esse sint",
  "pin_styles": {},
  "box_width": -66027995.69454243,
  "symbol_name": "quis consequat sed commodo",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "tempor minim ipsum aliqua velit"
}
```
...
```json
{
  ...
  "message": "veniam incididunt elit et",
...
```json
{
  ...
  "radius_x": 92320618.31306809,
  "radius_y": "pariatur laborum nostrud fugiat sunt",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "nisi Excepteur laboris cillum in",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "Lorem sed",
  "supplier_part_numbers": {
    "velit_5f": [
      "dolore do esse velit",
      "non aliquip commodo",
      "pariatur do sunt",
      "sunt"
    ],
    "Lorema": [
      "sunt dolore Lorem",
      "commodo",
      "mollit dolor Duis laboris cillum",
      "aliqua culpa",
      "commodo magna"
    ]
  },
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "in dolore amet voluptate"
  },
  "layer": "top",
  "footprinter_string": "adipisicing commodo",
  "model_obj_url": "deserunt",
  "model_stl_url": "labore consectetur do in",
  "model_3mf_url": "ea",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "minim incididunt nostrud esse"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 46472448.323905945,
  "outer_height": 68356496.36553681,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "in8": {},
  "magna41": {
    "right_margin": "Duis pariatur",
    "top_margin": 34105104.44314858,
    "bottom_margin": -12083384.341066957
  },
  "pariatur_6f1": {
    "left_margin": "aliqua cillum cupidatat Lorem",
    "right_margin": "labore amet nulla occaecat",
    "top_margin": 99411556.12096506,
    "bottom_margin": "quis aliquip eu enim irure"
  },
  "voluptate43": {
    "left_margin": -45600147.061851844,
    "right_margin": "nostrud",
    "top_margin": "culpa nisi deserunt aliquip",
    "bottom_margin": 79661265.44664106
  }
}
```
