...
```json
{
  ...
  "ftype": "aliquip non eiusmod",
  "source_component_id": "source_component_1",
  "name": "A1",
  "manufacturer_part_number": "officia amet proident deserunt dolor",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "adipisicing non tempor officia"
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["aliquip"],
  "is_power": true,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": false,
  "trace_width": -18477655.460154057
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolor_d20": [
      "elit incididunt Lorem occaecat nostrud",
      "occaecat ut in dolor",
      "aliquip nulla incididunt"
    ],
    "minim_00e": ["sit ut magna", "veniam reprehenderit voluptate sunt qui"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "in aliqua",
  "supplier_part_numbers": {
    "voluptate_be": [
      "laborum ex dolor quis ad",
      "culpa",
      "aliquip proident consequat sit officia",
      "reprehenderit commodo in sunt"
    ],
    "deseruntea4": [
      "sed aliquip proident ea reprehenderit",
      "velit in minim",
      "ut nisi aliquip ex",
      "laboris nisi ad commodo",
      "fugiat voluptate adipisicing reprehenderit id"
    ],
    "irure1f": ["pariatur nisi", "veniam dolore aute reprehenderit", "in aute"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "fugiat Duis sed",
  "supplier_part_numbers": {
    "cillum_68e": [
      "ut laborum ipsum quis",
      "ex sit cupidatat velit enim",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "pariatur occaecat eu ut",
  "supplier_part_numbers": {
    "eiusmod_bf": [
      "ipsum eiusmod cillum",
      "labore",
      "aute laboris elit eiusmod",
      "ex",
      "commodo incididunt"
    ],
    "adipisicing_2": [
      "dolor voluptate in id deserunt",
      "sint proident",
      "nisi dolore",
      "do id cillum qui",
      "nulla nisi consequat ad"
    ],
    "voluptate12": ["nostrud", "eiusmod Lorem"],
    "veniam3": [
      "tempor Lorem",
      "do",
      "deserunt proident",
...
```json
{
  ...
  "connected_source_port_ids": [
    "veniam Excepteur cillum ullamco in",
    "consequat ea mollit sit",
    "ullamco tempor sint qui magna"
  ],
  "connected_source_net_ids": [
    "ex eu nisi irure",
    "enim sit exercitation",
    "exercitation id Lorem proident"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 26155629.442669332,
  "box_width": -75888888.53313462,
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "radius_x": "cupidatat",
  "radius_y": "et nisi mollit aliquip",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "minim in ad sed",
  "supplier_part_numbers": {
    "consectetur_1ce": ["id deserunt laboris dolor"],
    "proident_821": [
      "sit ullamco",
      "ex reprehenderit deserunt",
      "voluptate minim dolore",
      "in consectetur"
    ],
    "officia_c": ["enim elit exercitation sit", "cupidatat", "et mollit nulla"],
    "consequat_a_2": [
      "est",
      "consequat velit proident aute commodo",
      "cupidatat in ea labore adipisicing"
    ]
  },
  "capacitance": "1uF"
}
