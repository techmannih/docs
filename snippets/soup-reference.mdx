...
```json
{
  ...
  "ftype": "commodo aliquip sed",
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "aliquip",
  "supplier_part_numbers": {
    "minim3": ["mollit ea", "laborum fugiat Excepteur consectetur eu"],
    "consectetur_fd": ["tempor ut officia enim", "est culpa", "ipsum id"],
    "aliqua_c": ["ullamco ex"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "et quis dolor anim",
  "supplier_part_numbers": {
    "dolore_10": [
      "amet esse et est",
      "exercitation ut commodo consequat",
      "et in cupidatat",
      "ut eiusmod dolor quis proident"
    ],
    "et_": [
      "id velit",
      "ut commodo est adipisicing officia",
      "amet laborum et cupidatat",
      "aliqua et pariatur",
      "irure eu in incididunt"
    ],
    "elit_e_5": ["sit nulla ex dolor"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "labore eiusmod id",
    "voluptate ipsum",
    "minim adipisicing sint consequat amet",
    "cupidatat magna dolore in officia"
  ],
  "is_power": false,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": -30566089.528251305
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "adipisicing est cupidatat deserunt",
  "supplier_part_numbers": {
    "inc": [
      "eiusmod quis dolor officia Ut",
      "eu ea",
      "ut",
      "velit est ut aute id"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "dolor dolore dolor amet commodo",
  "supplier_part_numbers": {
    "essea": [
      "sunt deserunt dolor magna",
      "est dolor cillum voluptate",
      "aliqua"
    ],
    "proident4b6": ["aliquip dolore", "proident", "consequat commodo ex", "in"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "labore dolore",
  "supplier_part_numbers": {
    "dolore_cf": [
      "dolor laborum deserunt",
      "nulla elit",
      "deserunt",
      "nostrud ut culpa minim amet",
      "incididunt quis"
    ],
    "velit_7": [
      "cupidatat culpa ad nostrud",
      "cupidatat irure mollit ad ullamco",
      "ad mollit in aliqua"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "occaecat labore in in ut",
  "supplier_part_numbers": {
    "dolore_": ["sit id est", "do deserunt consequat aliquip", "irure", "anim"],
    "eiusmod_2": ["dolore", "dolore qui"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "incididunt deserunt esse eiusmod",
  "supplier_part_numbers": {
    "ipsum9e9": ["enim in", "qui ut"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "cillum deserunt dolor ut",
  "supplier_part_numbers": {
    "Ut_42": ["exercitation velit"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["dolor in"],
  "connected_source_net_ids": [
    "enim",
    "fugiat veniam nostrud amet",
    "consectetur tempor eu Excepteur in"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "et sint est tempor dolor",
  "pin_styles": {},
  "box_width": "amet ad cupidatat laborum eu",
  "symbol_name": "qui quis ut",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "color": "incididunt cupidatat magna sit sunt"
}
```
...
```json
{
  ...
  "radius_x": "ut aliquip cupidatat",
  "radius_y": -93760229.99328226,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "ipsum nostrud officia enim velit"
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "in voluptate reprehenderit"
  },
  "rotation": "90deg",
  "layer": "top",
  "footprinter_string": "in cupidatat",
  "model_obj_url": "nostrud",
  "model_3mf_url": "labore aliqua cupidatat dolor enim"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "dolor adipisicing elit Excepteur consectetur"
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "deserunt ut exercitation non"
}
```
...
{
  "do_5": {
    "left_margin": "occaecat deserunt minim irure",
    "right_margin": 85996862.75090095,
    "top_margin": "culpa id velit ex officia",
    "bottom_margin": "do aute fugiat eu sed"
  }
}
```
