...
```json
{
  ...
  "name": "N1",
  "manufacturer_part_number": "occaecat irure sunt id"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "commodo_1": ["non sunt mollit exercitation id"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    ...
    "ullamco minim esse officia",
    "labore quis laborum sit veniam"
  ],
  "is_power": false,
  "is_ground": true,
  "is_digital_signal": false,
  "is_analog_signal": false,
  "trace_width": 32236164.617253408
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "Excepteur qui magna",
  "supplier_part_numbers": {
    "sit_2": ["reprehenderit magna incididunt sint eu"],
    "voluptate_313": ["id consectetur sit"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "adipisicing eu ad",
  "supplier_part_numbers": {
    "laboris_85": [
      "Duis",
      "sit dolor sint culpa mollit",
      "voluptate",
      "nisi commodo dolore minim irure",
      "sunt"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "aliquip enim Ut",
  "supplier_part_numbers": {
    "elit_16a": [
      "ex sint adipisicing",
      "Lorem ut culpa reprehenderit",
      "est deserunt nisi esse aliqua",
      "nostrud est voluptate ipsum",
      "cupidatat exercitation do dolor"
    ],
    "sint729": ["labore voluptate", "mollit enim"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "eiusmod deserunt proident fugiat in",
  "supplier_part_numbers": {
    "dolor8": [
      "tempor sunt aliquip mollit",
      "aliqua occaecat reprehenderit est",
      "cupidatat proident",
      "deserunt ullamco",
      "quis ea eu incididunt dolor"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "ullamco laboris cillum aute",
  "supplier_part_numbers": {
    "deserunt_474": [
      "proident nisi consectetur fugiat eu",
      "in commodo et",
      "cupidatat dolore nisi",
      "in dolore laboris",
      "voluptate Lorem"
    ],
    "Ut23": [
      "Lorem veniam sit officia velit",
      "fugiat sit magna consectetur ex"
    ],
    "aute1": [
      "laboris Excepteur consequat reprehenderit",
      "cupidatat consequat dolore officia",
      "laboris non",
      "eu aute nostrud occaecat non"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "sed",
    "elit",
    "dolor in deserunt dolore",
    "deserunt sed veniam dolor",
    "reprehenderit"
  ],
  "connected_source_net_ids": ["cillum", "qui irure", "nulla"]
}
```
...
```json
{
  ...
  "message": "exercitation reprehenderit do ipsum"
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "elit veniam incididunt eu"
}
```
...
```json
{
  ...
  "color": "Lorem est sed dolor pariatur"
}
```
...
```json
{
  ...
  "message": "in laborum et dolore nisi",
...
```json
{
  ...
  "radius_x": -66630228.33060808,
  "radius_y": "in et deserunt dolor pariatur",
  "layer": "top"
}
```
...
```json
{
  ...
  "name": "R1",
  "supplier_part_numbers": {
    "pariatur320": ["commodo", "reprehenderit occaecat"],
    "cillum503": [
      "nisi ullamco sint voluptate",
      "id culpa",
      "tempor veniam sed dolor irure",
      "consequat"
    ],
    "proident_7": ["ut enim cupidatat ea"],
    "laborum_3f": ["sunt enim pariatur sed", "occaecat laboris velit"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "ut amet aliquip id"
  },
  "layer": "top",
  "footprinter_string": "dolor incididunt Ut irure fugiat",
  "model_obj_url": "nulla ipsum anim cupidatat laborum",
  "model_stl_url": "ipsum Ut deserunt magna",
  "model_3mf_url": "deserunt",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "ipsum_0": {
    "left_margin": "sint tempor sunt nisi proident",
    "right_margin": 63196529.993539095
  }
}
```
