...
```json
{
  ...
  "name": "C1",
  "manufacturer_part_number": "laborum voluptate Lorem sit"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "in est enim in nostrud",
  "supplier_part_numbers": {
    "sedd": [
      "eiusmod ad exercitation",
      "voluptate velit esse",
      "dolore ex ullamco et eiusmod",
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["et Duis nostrud", "cillum eiusmod"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "culpa sed",
  "supplier_part_numbers": {
    "non_7": ["enim culpa ut", "eu Ut amet consectetur nisi"],
    "laboris__": [
      "Duis ea cupidatat",
      "dolor exercitation aliqua dolore dolor",
      "non anim consequat est",
      "nisi officia"
    ],
    "dofa": ["elit minim nulla", "reprehenderit nisi ipsum", "nostrud"],
    "in129": ["irure fugiat aliquip incididunt sint", "aliqua sint"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "culpa_9bb": ["ea aute", "aute", "ad adipisicing amet"],
    "laboris_2e": ["officia dolore anim nostrud deserunt"],
    "cupidatat_deb": [
      "enim ea magna",
      "non dolore minim sunt",
      "Ut sit velit consectetur aliquip",
      "laboris tempor Lorem ea et"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "magna tempor laborum dolor"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "ut sit incididunt amet esse",
  "supplier_part_numbers": {
    "mollit_d": [
      "fugiat occaecat irure nulla",
      "fugiat in officia pariatur in",
      "Duis sint exercitation ullamco est",
      "nisi eu ipsum pariatur",
      "cillum occaecat est ullamco"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "pariatur sit in non dolor",
  "pin_styles": {},
  "box_width": -70325434.3170276,
  "symbol_name": "cupidatat id non proident",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "aliquip Ut deserunt ut"
}
```
...
```json
{
  ...
  "radius_x": "quis elit aliqua eu do",
  "radius_y": -50822413.45648994,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "adipisicing dolor sint",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
  ...
  "route": [
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": 12104259.379576117
    }
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "in ex ut",
  "supplier_part_numbers": {
    "est4": ["aliquip incididunt consequat sint", "nostrud est minim ipsum"],
    "minim7": ["qui ut"]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "pariatur voluptate ut",
  "model_obj_url": "ut adipisicing",
  "model_stl_url": "veniam consequat",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layer": "top",
  "description": "officia est cillum",
  "shape": "circle",
  "center": {
    "x": "3mm",
    "y": "1mm"
...
```json
{
  ...
  "y": "1mm",
  "to_layer": "bottom",
  "trace_width": "exercitation id do"
}
```
...
{
  "deserunte": {
    "left_margin": -62999253.69460526,
    "bottom_margin": "veniam deserunt enim"
  },
  "culpa_0d0": {
    "top_margin": "enim sunt"
  }
}
```
