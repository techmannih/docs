...
```json
{
  ...
  "name": "D1",
  "manufacturer_part_number": "pariatur veniam anim ea ipsum",
  "supplier_part_numbers": {
    ...
    "aute__7": ["eu Lorem amet in", "reprehenderit magna eu proident"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "nostrud elit in",
  "supplier_part_numbers": {
    "in83": ["aliquip", "qui labore"],
    "labore_4d": [
      "qui ex consequat aliqua",
      "sint deserunt aliquip Excepteur",
      "Ut aliqua dolor in"
    ]
  }
}
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["in"],
  "is_power": true,
  "is_ground": true,
  "is_digital_signal": false,
  "is_analog_signal": false,
  "trace_width": -20329304.890870064
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "in nostrud",
  "supplier_part_numbers": {
    "dolor7d": ["in id consequat pariatur", "enim aute deserunt", "ad dolore"],
    "adipisicingdb1": ["esse"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "eiusmod_1f": [
      "esse elit ex fugiat",
      "amet commodo elit consectetur",
      "magna pariatur",
      "ullamco esse Ut Lorem",
      "in"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "dolore ut est nulla ea",
  "supplier_part_numbers": {
    "adipisicingf": ["in non nulla", "enim qui"],
    "exercitation6": [
      "dolore aute amet",
      "adipisicing Duis do cillum",
      "sit amet pariatur"
    ],
    "in_c": [
      "pariatur eu nulla velit ad",
    ...
    "in_f": [
      "cupidatat",
      "veniam in velit",
      "dolor in amet ullamco",
      "reprehenderit sed enim qui",
      "aliquip et magna ut"
    ],
    "mollitd": [
      "incididunt laborum sint do eu",
      "esse mollit est nulla",
      "et consectetur",
      "mollit",
      "irure nulla deserunt nisi"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "Lorem mollit sed Excepteur commodo",
  "supplier_part_numbers": {
    "dolor_70": ["pariatur qui enim do", "do", "occaecat", "in commodo officia"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "aliqua esse",
  "supplier_part_numbers": {
    "aliquad7f": ["eu sit nisi dolore", "ut ipsum"],
    "laboris2db": ["in nostrud", "occaecat do Excepteur", "Ut laborum"],
    "adipisicing_79a": ["dolor", "aliquip"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    ...
    "ea",
    "ullamco cillum eiusmod dolor laborum"
  ],
  "connected_source_net_ids": [
    "ad incididunt commodo nulla ullamco",
    "incididunt"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 10569353.362236276,
  "pin_styles": {}
}
```
...
```json
{
  ...
  "color": "exercitation adipisicing ullamco"
}
```
...
```json
{
  ...
  "message": "officia aute sed ut in"
}
```
...
```json
{
  ...
  "message": "et minim deserunt qui magna",
...
```json
{
  ...
  "supplier_part_numbers": {
    "ullamco_e3a": ["nostrud adipisicing culpa anim ut"],
    "nulla_f": ["commodo nulla magna", "aliqua elit quis dolore dolor"],
    "est36f": ["sint minim", "culpa dolore non", "ad aliquip nulla"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "sit ut enim Ut cillum",
  "supplier_part_numbers": {
    "occaecat_77c": [
      "dolor commodo",
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "reprehenderit cillum minim"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -88349993.39352567,
  "outer_height": -70265614.00580502,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "ullamco_3": {
    "left_margin": -80557782.9948061,
    "right_margin": "deserunt sed occaecat velit nostrud",
    "top_margin": -52631877.82891401,
    "bottom_margin": -90399194.26106122
  }
}
```
