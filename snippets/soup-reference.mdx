...
```json
{
  ...
  "ftype": "deserunt nostrud ullamco ipsum",
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "Excepteur proident",
  "supplier_part_numbers": {
    "anim6": [
      "magna deserunt consequat est",
      "sint exercitation eiusmod",
      "ullamco id ea sunt quis"
    ],
    "sint_0b4": ["dolore proident nulla ex voluptate"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "fugiat minim elit",
  "supplier_part_numbers": {
    "enim_76e": ["ipsum Lorem tempor", "in incididunt dolor do", "voluptate"],
    "in_6": ["dolor deserunt ex Duis sunt"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "qui velit commodo ullamco id"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "aliqua consectetur",
  "supplier_part_numbers": {
    "sunt_9": ["laborum", "dolor et", "est reprehenderit proident"],
    "proidente6": []
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "quisc": [
      "in",
      "reprehenderit occaecat adipisicing tempor",
      "et enim eu",
      "id",
      "quis"
    ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "cupidatat proident enim voluptate minim",
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "velit consectetur",
  "supplier_part_numbers": {
    "proident__": ["est mollit do", "deserunt dolore quis dolor laboris"],
    "non4": [],
    "in79": ["nulla est eu ut"],
    "officia_6": [
      "fugiat aute officia tempor",
      "sed pariatur ipsum irure officia",
      "enim esse cillum in"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": [
    "ipsum eiusmod sunt quis",
    "et Ut dolore veniam",
    "amet laboris commodo",
    "ipsum Excepteur esse labore veniam"
  ],
  "connected_source_net_ids": [
    "elit",
    "sit veniam",
    "tempor officia consequat ipsum",
    "ut elit sed"
  ]
}
```
...
```json
{
  ...
  "pin_styles": {
    "quis75": {
      "left_margin": "Ut ipsum aliqua irure",
      "right_margin": "ullamco esse reprehenderit fugiat ea",
      "top_margin": 23897002.589708686
    }
  },
  "port_arrangement": {
    "left_size": 3,
...
```json
{
  ...
  "message": "dolore irure cupidatat nisi"
}
```
...
```json
{
  ...
  "radius_x": "eu voluptate esse ut",
  "radius_y": "nostrud in nisi",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "ut laborum pariatur exercitation dolor",
  "supplier_part_numbers": {
    "elit6c": [
      "sunt adipisicing",
      "amet culpa",
    ...
    "Duis294": [
      ...
      "dolore occaecat ad",
      "occaecat cupidatat",
      "nisi occaecat in consectetur Excepteur"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "aute dolor irure",
  "supplier_part_numbers": {
    "sitb": ["ea consequat officia"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "consequat deserunt commodo",
  "model_obj_url": "id in",
  "model_stl_url": "occaecat",
  "model_3mf_url": "do",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "ut nisi in officia ex"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 40830609.36625618,
  "outer_height": 28210707.640590638,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "y": "1mm",
  "to_layer": "bottom",
  "trace_width": "voluptate exercitation"
}
```
...
{
  "laboris_bde": {
    "left_margin": -39748783.16932204,
    "right_margin": "non ea nisi voluptate irure"
  },
  "culpa_0": {
    "left_margin": 77711531.24021608,
    "right_margin": "dolore cillum ut pariatur",
    "top_margin": "laborum aliquip ipsum",
    "bottom_margin": -24374421.516553506
  },
  "Ut9": {
    "left_margin": "sunt",
    "right_margin": "velit sed",
    "top_margin": -45122523.94453773
  },
  "commodo__": {
    "left_margin": "dolore exercitation ullamco in",
    "right_margin": -97906963.3284523,
    "top_margin": -62194119.964568004
  }
}
```
