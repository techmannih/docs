...
```json
{
  ...
  "name": "I1",
  "manufacturer_part_number": "ex cupidatat",
  "supplier_part_numbers": {
    "reprehenderit25": [
      "officia laboris Lorem",
      "Lorem laborum mollit fugiat nulla",
      "pariatur culpa dolore dolor"
    ],
    "in_c7": [
      "veniam",
      "elit pariatur dolore in anim",
      "culpa fugiat nostrud commodo occaecat"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "Duis culpa",
  "supplier_part_numbers": {
    "dolore_f3": ["eiusmod", "cupidatat", "amet cillum"]
  }
}
```
...
```json
{
  ...
  "trace_width": -21587800.989731804
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ea dolor laborum",
  "supplier_part_numbers": {
    "nisi_e": ["sunt culpa sint"],
    "minim2": ["dolor"]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "ut8": ["cupidatat elit et minim qui"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "pariaturb31": ["ut et laboris deserunt", "in", "nostrud dolore dolore"],
    "dolore6": [
      "minim labore",
      "in dolore tempor",
    ...
    "fugiat_b0c": [
      "fugiat sint anim minim",
      "elit dolor Duis ea",
      "et adipisicing",
      "irure ex"
    ],
    "consequatb": [
      "ut ut esse cillum in",
      "dolor minim sunt",
      "aute adipisicing",
      "esse est ex culpa"
    ],
    "pariatur_3": ["reprehenderit id irure commodo in", "consectetur"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "aliqua Duis",
  "supplier_part_numbers": {
    "commodo_83": ["laboris", "nisi Duis"],
    "Ut21": [
      "reprehenderit occaecat non labore sit",
      "ex ipsum et sunt consectetur",
      "consequat voluptate fugiat"
    ],
    "aliquip2f": [
      "nisi in occaecat ea mollit",
      "nulla id elit eiusmod",
      "non velit"
    ],
    "Duis2_": [
      "eiusmod veniam commodo",
      "qui ad in",
      "officia exercitation qui eu minim"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "sunt occaecat aliqua",
  "supplier_part_numbers": {
    "dolor9": ["in do esse labore", "reprehenderit sed"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["voluptate in sit"],
  "connected_source_net_ids": ["proident voluptate laboris elit quis", "quis"]
}
```
...
```json
{
  ...
  "message": "incididunt sit quis reprehenderit"
}
```
...
```json
{
  ...
  "radius_x": 35074638.97821993,
  "radius_y": -75912235.73232892,
  "layer": "top"
}
```
  ...
  "route": [
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": 10191526.141488433
    },
    {
      "x": "3mm",
      "y": "1mm",
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "voluptate officia culpa pariatur sed",
  "model_obj_url": "ullamco ut et",
  "model_stl_url": "irure",
  "model_3mf_url": "Excepteur cupidatat quis",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "sint Lorem dolore labore nulla"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 16738501.342653304,
  "outer_height": 53896142.34302834,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "enim_3": {
    "left_margin": 87235012.76741517,
    "right_margin": 99165862.11955449,
    "top_margin": -82920207.88232799
  },
  "culpaa5": {
    "top_margin": -92071156.67568684,
    "bottom_margin": 17931536.655690253
  }
}
```
