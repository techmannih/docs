...
```json
{
  ...
  "supplier_part_numbers": {
    "nostrud1": ["mollit eiusmod dolore Lorem magna"],
    "dolor_d3": ["veniam consectetur et"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["nostrud", "mollit pariatur in"],
  "is_ground": false
}
```
...
```json
{
  ...
  "name": "D1",
  "supplier_part_numbers": {
    "proident_a55": ["eiusmod incididunt magna", "culpa ut commodo aute ad"],
    "occaecat5": [
      "ut eiusmod eu",
      "dolore exercitation dolor anim",
      "aute in",
      "consequat nostrud"
    ],
    "eu_4b8": [
      "Duis ullamco eiusmod",
      "Ut mollit et minim sunt",
      "in mollit Duis commodo quis",
      "velit mollit eu nulla"
    ],
    "cillum8a": [
      "ullamco amet",
    ...
    "cupidatat_fe": ["enim ut veniam", "in labore quis ea", "aute Duis eu sed"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "voluptate_a": [
      "nostrud in",
      "sunt ullamco tempor ut occaecat",
      "pariatur magna nisi",
      "eu voluptate"
    ],
    "nisi_3a": ["amet", "veniam velit aliqua occaecat", "quis est velit"]
  }
}
```
...
```json
{
  ...
  "name": "R1",
  "supplier_part_numbers": {
    "sunt_106": ["veniam id", "velit ut culpa"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["anim sit esse"],
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "nostrudc2": [
      ...
      "in labore",
      "sit mollit id",
      "velit nostrud laboris officia voluptate"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -77543944.8089012,
  "outer_height": -45671452.98268613,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
