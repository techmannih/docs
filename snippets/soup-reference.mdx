...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "elit mollit sed culpa sunt",
  "supplier_part_numbers": {
    "in_473": [
      "tempor nostrud pariatur Excepteur",
      "quis labore in in",
      "proident ipsum"
    ]
  }
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["aliqua"],
  "is_power": true,
  "is_ground": false,
  "is_digital_signal": false,
  "is_analog_signal": false,
  "trace_width": 66501998.20451656
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "eu Duis adipisicing ullamco dolore",
  "supplier_part_numbers": {
    "dolore_4": [
      "esse mollit pariatur",
      "eu reprehenderit nisi sunt",
      "ullamco deserunt eu",
      "adipisicing sed enim"
    ],
    "do_6d3": [
      "sint officia laborum mollit Excepteur",
      "commodo",
      "enim dolore sed est",
      "officia mollit ea"
    ],
    "veniam160": [
      "ex dolore id",
      "nulla elit sint Ut nisi",
      "aliquip voluptate fugiat adipisicing mollit",
      "nisi irure cillum"
    ],
    "commodo3": ["non", "quis laborum", "Duis cillum anim aliqua"],
    "consectetur1": [
      "in ipsum ullamco",
      "quis magna sed amet Excepteur",
      "anim",
      "elit ut anim culpa Lorem",
      "cupidatat Ut deserunt laborum"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "irure13b": ["do dolore", "in culpa eiusmod veniam", "labore cupidatat"],
    "in_0": [
      "ut mollit eu ea veniam",
      "elit aute",
      "adipisicing esse velit culpa",
      "velit"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "dolor ea amet",
  "supplier_part_numbers": {
    "doa5": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "tempor aute ipsum",
  "supplier_part_numbers": {
    "eab1c": []
  },
  "voltage": "5V"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "magna Lorem sunt",
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    ...
    "consequat veniam",
    "tempor cupidatat",
    "officia ut cupidatat ex"
  ],
  "connected_source_net_ids": ["amet commodo"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 2133000.334694028,
  "pin_styles": {},
  "box_width": -73123059.98588768,
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "message": "dolore nostrud reprehenderit"
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "exercitation tempor est in"
}
```
...
```json
{
  ...
  "message": "enim occaecat laborum ut tempor"
}
```
...
```json
{
  ...
  "radius_x": "exercitation minim",
  "radius_y": "culpa anim incididunt",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "elit tempor in exercitation aliquip",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
  ...
  "route": [
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": "ipsum in irure eu et"
    },
    {
      "x": "3mm",
      "y": "1mm",
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "sed non nisi laborum"
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "incididunt ut consequat in dolore"
  },
  "layer": "top",
  "footprinter_string": "consequat aliquip voluptate eu ex",
  "model_obj_url": "dolor consectetur",
  "model_stl_url": "sit magna",
  "model_3mf_url": "dolor anim cillum",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -53373222.627599135,
  "outer_height": -66452424.534216896,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "et15": {
    "left_margin": -9914081.708748817,
    "right_margin": "ut in exercitation fugiat",
    "bottom_margin": "irure et ut"
  }
}
```
