...
```json
{
  ...
  "name": "E1",
  "manufacturer_part_number": "dolor velit",
  "supplier_part_numbers": {
    "reprehenderit2": ["adipisicing", "ad mollit quis est"],
    "velit_7db": [
      "irure nostrud est",
      "irure",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "elit sed",
  "supplier_part_numbers": {
    "est9": ["aliquip do", "reprehenderit id", "sed do culpa nulla"],
    "officia_34d": [
      "laborum",
      "Lorem officia sit",
      "exercitation voluptate",
      "sunt aute cillum exercitation Duis"
    ],
    "reprehenderit95": ["quis aliqua amet do", "amet aliqua"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["esse dolor", "mollit officia nisi"],
  "trace_width": 20055755.98969589
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "laborum consequat laboris adipisicing",
  "supplier_part_numbers": {
    "dolor_f9": [
      "et consectetur",
      "eiusmod",
      "do mollit ipsum",
      "veniam incididunt magna velit"
    ],
    "ex47": ["qui sit labore"]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "Excepteur incididunt ad culpa Lorem",
  "supplier_part_numbers": {
    "sed1": [
      "Duis culpa veniam ex minim",
      "magna veniam",
      "id voluptate commodo dolor fugiat"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "cupidatat ullamco sunt Lorem laborum",
  "supplier_part_numbers": {
    "ipsum634": [
      "velit",
      "mollit proident eiusmod dolore",
      "ullamco id proident dolor",
      "laboris sed sunt",
      "voluptate"
    ],
    "cupidatat__73": [
      "aliquip ut reprehenderit commodo",
      "pariatur nulla",
      "elit incididunt",
      "culpa qui adipisicing enim voluptate"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "Excepteur non est quis"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "eiusmod_8": [
      "ea amet nisi in",
      "veniam magna ea dolor",
      "sit minim",
      "nisi consectetur"
    ],
    "incididunt4": [
      "id culpa",
      "minim Duis dolor dolor in",
      "occaecat velit ullamco dolor",
      "ad dolor eu",
      "consequat elit qui"
    ]
  },
...
```json
{
  ...
  "connected_source_port_ids": [
    "dolor nulla Excepteur velit occaecat",
    "minim aute ad veniam dolore",
    "nulla laboris",
    "irure eiusmod Excepteur culpa"
  ],
  "connected_source_net_ids": ["pariatur Excepteur Duis et"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "box_width": "laborum deserunt non qui elit",
  "symbol_name": "et magna id",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  }
...
```json
{
  ...
  "message": "enim laborum tempor nostrud"
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "sit enim reprehenderit anim"
}
```
...
```json
{
  ...
  "radius_x": "qui",
  "radius_y": "culpa eiusmod commodo",
  "layer": "top"
}
```
  ...
  "route": [
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": "Ut non labore eiusmod in"
    },
    {
      "x": "3mm",
      "y": "1mm",
      "via": false,
      "to_layer": "bottom",
      "trace_width": -62317592.818635784
    },
    {
      "x": "3mm",
      "y": "1mm",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "voluptate aute nisi sit",
  "supplier_part_numbers": {
    "dolorea": [
      "deserunt eu",
      "esse",
      "Excepteur non ullamco ut",
      "et id sint eiusmod"
    ]
  }
}
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "nisi aute ad dolor",
  "model_obj_url": "nisi",
  "model_stl_url": "aliquip",
  "model_3mf_url": "nulla ipsum exercitation",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "officia irure dolore amet"
}
```
...
{
  "nisi_8": {
    "left_margin": "aute consequat",
    "right_margin": -12716551.559987545,
    "top_margin": -22694098.301273376
  }
}
```
