...
```json
{
  ...
  "supplier_part_numbers": {
    "magna__": ["cupidatat incididunt"],
    "sed_1": ["sunt consequat dolor irure", "et"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["et reprehenderit voluptate"],
  "is_power": true,
  "is_ground": false,
...
```json
{
  ...
  "supplier_part_numbers": {
    "reprehenderit_4_a": [
      "dolor id veniam",
      "consectetur nisi dolore reprehenderit dolor",
      "dolor ipsum"
    ],
    "et32": ["aliquip dolor"],
    "culpad": [
      "voluptate Excepteur est sint",
      "laborum",
      "aliqua cillum id",
      "qui nisi labore est elit"
    ],
    "minim_5b": ["dolore quis culpa", "et", "Ut"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "dolor do",
  "supplier_part_numbers": {
    "anim6": [
      "ut adipisicing proident reprehenderit tempor",
    ...
    "dolore_e3f": [
      "in irure",
      "non minim irure nulla",
      "anim in dolore laboris sit",
      "Ut"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "aliquip adipisicing ut ipsum dolor",
  "supplier_part_numbers": {
    "laboris_5": ["dolor ullamco", "ipsum"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "eu laboris nisi minim in",
  "supplier_part_numbers": {
    "et_": [
      "veniam",
      "quis cillum enim officia",
      "dolor velit mollit Lorem sint",
      "Excepteur"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "fugiat sed laborum Lorem",
  "supplier_part_numbers": {
    "sit_": ["dolore elit est nulla"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "quis ullamco do",
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["fugiat", "sunt esse magna in"],
  "connected_source_net_ids": [
    "id sint eu",
    "ullamco qui aliqua enim eu",
    "occaecat eu pariatur cupidatat",
    "qui veniam",
...
```json
{
  ...
  "radius_x": "sint sunt in",
  "radius_y": 98513161.60080835,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "ea in occaecat velit veniam",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": -1259847.9815526605
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "in qui do cillum tempor"
  },
  "layer": "top",
  "footprinter_string": "magna elit et",
  "model_obj_url": "proident esse cupidatat ut culpa",
  "model_stl_url": "eiusmod esse",
  "model_3mf_url": "consequat est cillum",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 57877024.21859738,
  "outer_height": -77783848.04950495,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
