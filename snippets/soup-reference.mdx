...
```json
{
  ...
  "ftype": "aliqua Ut nostrud deserunt",
  "source_component_id": "source_component_1",
  "name": "A1",
  "supplier_part_numbers": {
    "adipisicinge8": ["labore veniam", "aute", "commodo", "Excepteur", "anim"]
  }
}
```
...
```json
{
  ...
  "name": "L1",
  "supplier_part_numbers": {
    "voluptate_1": ["nostrud nulla labore non"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["sit", "sunt"],
  "is_power": true,
  "is_ground": true,
...
```json
{
  ...
  "supplier_part_numbers": {
    "Lorema99": [
      "reprehenderit adipisicing aliquip",
      "cupidatat amet ullamco aliquip",
      "fugiat nostrud mollit veniam",
      "amet occaecat commodo ex"
    ],
    "minimbc4": [
      "do dolor ex culpa",
      "sed sit dolore",
      "officia Excepteur",
      "dolore aliquip",
      "nulla dolore ipsum deserunt fugiat"
    ]
  }
}
```
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "occaecat_2a4": ["dolor esse mollit non et", "laborum"],
    "proident_6_": [
      "aute enim ad elit",
      "dolor minim voluptate",
      "eu Lorem labore"
    ],
    "eiusmod_3": ["sed", "velit dolore irure reprehenderit esse"],
    "nostrudf": ["minim"]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "name": "D1",
  "supplier_part_numbers": {
    "exercitation7b9": ["irure Ut", "aliqua"],
    "id7": ["enim in in"],
    "aliquipfbb": ["fugiat dolor ex", "cillum ullamco ea"],
    "laborum_1f2": ["mollit id irure"]
  }
}
```
...
```json
{
  ...
  "name": "P1",
  "supplier_part_numbers": {
    "dolor89": ["et ex voluptate qui"],
    "mollit2": ["sit et", "cillum", "ut culpa reprehenderit"],
    "dolorb": ["Ut in eu sint labore", "nulla anim do et consectetur"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "pariatur elit commodo amet",
    "pariatur dolore tempor Ut laborum"
  ],
  "connected_source_net_ids": ["enim ex voluptate nisi", "consectetur occaecat"]
}
```
...
```json
{
  ...
  "message": "aliquip anim esse ullamco"
}
```
...
```json
{
  ...
  "message": "cupidatat proident dolore eu",
...
```json
{
  ...
  "radius_x": 87043291.99445143,
  "radius_y": -27597087.1906396,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "eu occaecat voluptate mollit et",
  "pcb_trace_id": "pcb_trace_1",
  "source_trace_id": "source_trace_1",
  "pcb_component_ids": ["pcb_component_1"],
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "sint ad",
  "model_obj_url": "ut commodo ad in",
  "model_stl_url": "reprehenderit labore ipsum",
  "model_3mf_url": "Ut aliquip sint velit quis",
  "model_jscad": []
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -60135779.214227855,
  "outer_height": 42734587.35128638,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
