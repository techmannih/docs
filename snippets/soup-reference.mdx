...
```json
{
  ...
  "supplier_part_numbers": {
    "reprehenderit40": [
      ...
      "cillum id deserunt aliqua ipsum",
      "proident"
    ],
    "cupidatat3": [
      "aute",
      "nisi tempor proident elit culpa",
      "nisi deserunt Excepteur irure",
      "minim ex irure"
    ],
    "et_78": ["do Duis"],
    "ut1f": [
      "cillum incididunt Duis",
      "eiusmod veniam",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "et dolor",
  "supplier_part_numbers": {
    "elit_091": ["magna officia in", "eiusmod", "non in"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "aliqua pariatur minim",
  "supplier_part_numbers": {
    "dolore_d9": [
      "Ut laboris enim anim deserunt",
      "et sint reprehenderit in",
      "fugiat exercitation consequat nulla eu"
    ]
  }
}
```
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "ametdb": ["veniam nostrud Ut", "tempor consectetur anim sunt"],
    "Utb": ["dolore ullamco", "est cupidatat incididunt tempor", "qui"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "occaecat in nostrud labore dolor",
  "supplier_part_numbers": {
    "sunt_104": ["amet enim tempor", "ex officia aute", "aliqua Ut do in ut"],
    "quis_e": ["sint ipsum ex", "magna eu elit amet fugiat"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "et reprehenderit in ad in",
  "supplier_part_numbers": {
    "irure_6c": ["esse amet", "aute voluptate culpa ut id"],
    "sunt_47": [
      "ea sunt ipsum",
      "in",
      "ipsum",
...
```json
{
  ...
  "supplier_part_numbers": {
    "sedd": [
      "cillum exercitation dolore ipsum",
      "commodo Excepteur elit velit proident",
      "labore commodo",
      "qui id in"
    ],
    "aute_e6": ["voluptate Duis deserunt enim ea"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "fugiat id Excepteur et Lorem",
    "pariatur aute",
    "ea"
  ],
  "connected_source_net_ids": ["adipisicing sed Duis ex", "ut"]
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "deserunt eiusmod cillum mollit"
}
```
...
```json
{
  ...
  "message": "dolore nulla do anim dolor",
...
```json
{
  ...
  "radius_x": -36631627.106317535,
  "radius_y": "nisi non cillum",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "proident consectetur commodo esse laborum",
  "pin_styles": {},
  "box_width": "consequat",
  "symbol_name": "labore deserunt sed do sit",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "labore consequat sunt enim"
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "laboris pariatur irure commodo"
  },
  "layer": "top",
  "model_obj_url": "laboris tempor nulla sint",
  "model_stl_url": "dolore culpa sed elit",
  "model_3mf_url": "nostrud occaecat culpa",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "aliquip Excepteur culpa veniam"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -4388445.1787239015,
  "outer_height": -38592098.1785052,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": "commodo reprehenderit"
}
```
...
{
  "incididunt_23": {
    "left_margin": 41064771.5829494,
    "right_margin": "id labore Ut",
    "top_margin": 52318933.43126255
  },
  "Duis2d": {
    "left_margin": "anim eu",
    "right_margin": "fugiat adipisicing est proident enim",
    "top_margin": 72106254.38358077,
    "bottom_margin": -34526938.33803515
  },
  "sint_4": {
    "left_margin": -66356408.417353615
  },
  "nostrud_2": {
    "left_margin": "aliqua",
    "right_margin": -68929913.59906335,
    "top_margin": -52237869.69316024,
    "bottom_margin": "dolor"
  },
  "eiusmod932": {
    "right_margin": "nisi sint",
    "bottom_margin": "consectetur Duis exercitation dolor"
  }
}
```
