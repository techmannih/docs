...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["voluptate ut", "ex"],
  "is_power": true,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": -19974366.782139793
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "in_0": [
      "mollit laborum dolore quis nisi",
      "culpa dolor incididunt aute sed",
      "fugiat deserunt laboris Lorem labore"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "aute commodo quis do",
  "supplier_part_numbers": {
    "aliquacf3": ["sint", "Ut", "mollit officia pariatur cupidatat"],
    "eiusmod5": [
      "in sunt",
      "Ut",
      "ad",
      "nisi laboris sed reprehenderit",
      "laborum sit"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "nisi cillum",
  "supplier_part_numbers": {
    "dolor_7": ["dolor labore incididunt minim quis", "veniam aliquip"],
    "veniam_7_": [
      "in",
      "nostrud in",
      "in nisi",
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "tempor06f": [
      ...
      "cupidatat qui et",
      "sunt qui consequat",
      "reprehenderit veniam enim commodo"
    ],
    "ad_5": [
      "dolor",
      "dolor anim ea consequat qui",
      "veniam",
      "dolor mollit Excepteur est"
    ],
    "voluptate_b5": ["cillum Duis aliquip sunt dolore", "ipsum"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "pariatur_9": ["ea mollit", "nulla commodo dolore"],
    "aliquae6": ["ullamco", "ipsum ad"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["sit dolore", "exercitation proident"],
  "connected_source_net_ids": [
    "magna commodo dolor elit nulla",
    "dolor aute",
    "aliqua anim laborum elit ex",
    "culpa ut",
    "aliquip minim in nisi eu"
  ]
}
```
...
```json
{
  ...
  "message": "ea fugiat labore eiusmod commodo"
}
```
...
```json
{
  ...
  "radius_x": 55696316.77324018,
  "radius_y": "culpa cupidatat Excepteur",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "sed fugiat cupidatat Lorem",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "supplier_part_numbers": {
    "irure4c7": [
      ...
      "irure do elit dolore",
      "aliqua Duis amet",
      "qui dolor id anim"
    ],
    "officia__0": ["et"],
    "non_e": ["reprehenderit proident incididunt"],
    "exercitation_cfb": [
      "deserunt in nostrud voluptate labore",
      "qui",
      "cillum labore sit Lorem",
      "eu dolor sint Lorem elit"
    ]
  }
}
```
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": -58903928.292424545
  },
  "layer": "top",
  "footprinter_string": "pariatur tempor incididunt dolore",
  "model_obj_url": "fugiat sint consequat ullamco",
  "model_stl_url": "cillum sit ex Lorem",
  "model_3mf_url": "voluptate",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "do occaecat quis Ut deserunt"
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "aliqua dolore aliquip irure laboris"
}
```
