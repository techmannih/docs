...
```json
{
  ...
  "name": "A1",
  "manufacturer_part_number": "voluptate non laborum",
  "supplier_part_numbers": {
    "elit_a0": ["sit nostrud"],
    "Excepteur_f": ["velit eiusmod fugiat Duis et"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "id fugiat",
  "supplier_part_numbers": {
    "enim0d": ["officia est proident magna velit", "occaecat ea quis"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["non ipsum id in minim", "ipsum aute commodo"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "dolor nisi non",
  "supplier_part_numbers": {
    "qui_ef_": ["tempor in"],
    "eiusmod_c5c": [
      "Ut exercitation in sint",
      "irure in",
      "dolor in velit consequat quis",
      "enim mollit sit",
      "sed Excepteur"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "eiusmod anim elit sunt exercitation",
  "supplier_part_numbers": {
    "id_d": ["reprehenderit dolore", "dolor nostrud proident"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "mollit adipisicing incididunt esse"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "in sed anim quis"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "ea sint",
  "supplier_part_numbers": {
    "magna_1": ["aliqua consequat Ut cupidatat", "Ut", "qui ipsum adipisicing"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "elit enim culpa quis",
  "supplier_part_numbers": {
    "in1": ["dolor exercitation"],
    "cillum_4b": [
      "enim do sed in",
      "laboris id quis",
      "fugiat mollit adipisicing",
      "consectetur veniam sint ea"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    ...
    "elit",
    "Lorem",
    "pariatur ad occaecat Excepteur officia"
  ],
  "connected_source_net_ids": ["proident ad ex", "sint est Ut"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -58201443.58683077,
  "pin_styles": {},
  "box_width": "irure Lorem ullamco aute",
  "symbol_name": "nulla",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "color": "velit dolor exercitation non sit"
}
```
...
```json
{
  ...
  "message": "laborum ipsum cillum sit mollit"
}
```
...
```json
{
  ...
  "message": "occaecat consequat proident ipsum",
...
```json
{
  ...
  "route": [
    ...
    },
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": "qui veniam cupidatat"
    }
  ]
}
```
...
```json
{
  ...
  "radius_x": -74926999.25773518,
  "radius_y": "nisi aliqua laborum est dolor",
  "layer": "top"
}
```
...
{
  "ipsum_7": {
    "left_margin": "nisi voluptate",
    "top_margin": 35934138.75277397
  }
}
```
