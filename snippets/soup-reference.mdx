...
```json
{
  ...
  "ftype": "exercitation sint eu eiusmod",
  "source_component_id": "source_component_1",
  "name": "E1",
  "manufacturer_part_number": "labore nostrud velit ex in",
  "supplier_part_numbers": {
    "esse_f": [
      "ea nulla",
      "elit ut Excepteur exercitation",
      "occaecat ex in do",
      "eu esse culpa",
      "sit Excepteur aute"
    ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "Lorem mollit ea consequat",
  "supplier_part_numbers": {
    "id_b52": ["ullamco dolor ut", "qui cupidatat", "commodo"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "nulla fugiat incididunt exercitation ut",
  "supplier_part_numbers": {
    "in_2": [
      "reprehenderit commodo veniam est",
      "deserunt",
      "eiusmod sunt velit ex enim"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "in laborum",
  "supplier_part_numbers": {
    "ullamco_27": ["laboris", "officia Duis eu reprehenderit elit"],
    "sit_2": [
      "do id ullamco sed voluptate",
      "dolor elit laboris",
      "labore in",
      "ad deserunt est commodo",
      "voluptate"
    ],
    "sint4": [
      "nulla pariatur",
      "deserunt in nulla",
      "sed occaecat in proident veniam"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "minim nulla proident nostrud consectetur",
  "supplier_part_numbers": {
    "Lorem0d4": ["eu in Duis do"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "laborum magna",
  "supplier_part_numbers": {
    "estfb": ["adipisicing eu cupidatat", "dolor", "velit mollit aute"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "consectetur aliqua mollit",
  "supplier_part_numbers": {
    "incididunt_3": [
      "sed Excepteur",
      "dolore in dolore eiusmod",
      "pariatur amet",
      "elit sed dolore velit",
      "culpa laboris"
    ],
    "proident_93": ["laboris", "ullamco Ut ex eu consectetur"],
    "in_cbf": ["proident adipisicing"],
    "consectetur_24e": [
      "est pariatur in Ut",
      "pariatur",
...
```json
{
  ...
  "connected_source_port_ids": ["do consequat minim nisi in"],
  "connected_source_net_ids": ["ad Ut quis"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -20337.410636410117
}
```
...
```json
{
  ...
  "message": "sunt dolor deserunt cillum"
}
```
...
```json
{
  ...
  "radius_x": "qui velit",
  "radius_y": "amet cupidatat incididunt consequat irure",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "esse quis laboris",
  "supplier_part_numbers": {
    "magna0": [
      "aliquip velit nulla occaecat Duis",
      "nisi commodo occaecat minim dolore"
    ]
  }
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "labore aliqua enim aute",
  "model_obj_url": "veniam Excepteur Lorem",
  "model_stl_url": "Duis",
  "model_3mf_url": "nostrud qui",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layer": "top",
  "description": "labore qui sunt consectetur proident",
  "shape": "circle",
  "center": {
    "x": "3mm",
    "y": "1mm"
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "labore est enim sunt Excepteur"
}
```
...
```json
{
  ...
  "via": false,
  "to_layer": "bottom",
  "trace_width": -18389107.907846197
}
```
