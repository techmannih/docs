...
```json
{
  ...
  "ftype": "amet officia tempor nostrud",
  "source_component_id": "source_component_1",
  "name": "A1",
  "manufacturer_part_number": "Lorem nostrud exercitation",
  "supplier_part_numbers": {
    "do_60c": [
      "tempor exercitation culpa",
      "ut in",
      "ex adipisicing voluptate occaecat",
      "nostrud ad aliquip",
      "commodo"
    ],
    "Ut_0": [
      "ullamco ut labore minim",
      "pariatur",
      "enim aute",
      "consectetur in",
      "officia adipisicing aliquip dolor"
    ],
    "proident05": ["pariatur dolor"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "veniam velit nulla",
  "supplier_part_numbers": {
    "Lorem_b1": [],
    "esse_9_": [
      "ullamco ex ut culpa",
      "aute voluptate consequat",
      "magna consequat pariatur officia"
    ],
    "proidentb": ["nulla Lorem dolore anim Excepteur"],
    "fugiat_2a": []
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "nostrud sint reprehenderit",
  "supplier_part_numbers": {
    "labore_4": ["aliqua ipsum in enim commodo"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "elit aute enim sed ullamco",
  "supplier_part_numbers": {
    "sint_29": ["minim Duis"]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "et irure sunt",
  "supplier_part_numbers": {
    "ute": ["sit ut nisi culpa in"],
    "minim_74f": [
      "elit mollit culpa aliqua",
      "proident deserunt Duis sint exercitation",
      "aliquip quis adipisicing",
      "esse",
      "sed mollit quis aliquip aute"
    ],
    "consectetur4_": [
      "ad dolore",
      "do laboris incididunt est amet",
      "quis velit commodo voluptate in"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "sed et",
  "supplier_part_numbers": {
    "sint_5": ["veniam incididunt anim voluptate elit", "incididunt"],
    "ut_8": [
      "anim cupidatat consequat aliqua ullamco",
      "cupidatat ea",
      "fugiat",
      "deserunt",
      "Duis voluptate sed ut"
    ],
    "ea_a8": [
      "exercitation dolore",
      "irure officia dolor",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "reprehenderit in",
  "supplier_part_numbers": {
    "anim80": ["cupidatat", "dolore Duis occaecat", "fugiat"],
    "sunte": [
      "labore mollit in",
      "adipisicing sunt Excepteur deserunt",
      "est ipsum aute amet voluptate",
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "ullamco3": [
      "voluptate",
      "aute laborum ipsum",
      "sed anim fugiat irure",
      "Lorem esse aute in quis",
      "esse do"
    ]
  },
  "voltage": "5V"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "in voluptate",
  "supplier_part_numbers": {
    "auteea": ["labore ut ad Duis sunt", "fugiat", "dolore"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_net_ids": ["ut ut in eiusmod"]
}
```
...
```json
{
  ...
  "message": "ullamco cillum exercitation laboris cupidatat"
}
```
...
```json
{
  ...
  "radius_x": 85732282.02637747,
  "radius_y": -12157002.332537293,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "incididunt non proident in sed",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "nisi dolor",
  "supplier_part_numbers": {
    "officia79": [
      "do proident id",
      "fugiat veniam enim in ut",
      "in labore proident ad",
      "ex Lorem in veniam",
      "ipsum elit eiusmod tempor"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "tempor_200": ["in nulla sed id ea", "id", "deserunt eiusmod"],
    "ullamcofb": ["commodo", "magna"]
  }
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "incididunt exercitation"
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": -59459447.640861906
  },
  "layer": "top",
  "footprinter_string": "in esse",
  "model_obj_url": "ex laborum mollit dolor dolor",
  "model_stl_url": "cillum",
  "model_3mf_url": "aliqua ut dolor Duis dolore",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "enim voluptate mollit sit"
}
```
...
{
  "commodo662": {
    "right_margin": 45529202.972485095
  }
}
```
