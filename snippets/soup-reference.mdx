...
```json
{
  ...
  "ftype": "anim labore adipisicing non elit",
  "source_component_id": "source_component_1",
  "name": "A1",
  "supplier_part_numbers": {
    "labore_0": ["sint tempor exercitation non", "Ut"],
    "ut8c": [
      "exercitation Lorem minim ut amet",
      "culpa",
      "ut nulla mollit et tempor",
      "culpa in cupidatat consequat"
    ],
    "dolorad": [],
    "nisic70": ["dolore reprehenderit aliqua et"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "et aliquip in"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "do sint",
  "supplier_part_numbers": {
    "proident3f1": []
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "exercitation ex aliqua sunt sit",
  "supplier_part_numbers": {
    "quise2": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "nulla quis sit",
  "supplier_part_numbers": {
    "suntdd": [
      "cupidatat deserunt",
      "magna nulla",
      "in cillum",
      "elit adipisicing occaecat in"
    ],
    "nulla2": [],
    "qui_65": [
      "consequat Lorem irure commodo cupidatat",
      "aute in",
      "laboris irure qui",
      "laboris tempor labore eu sint",
      "pariatur dolore elit reprehenderit quis"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "laboris4": [
      "cupidatat qui in esse",
      "aute",
      "ut Lorem est",
      "ullamco pariatur nostrud in"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "Ut esse do et",
  "supplier_part_numbers": {
    "in_b": [
      "quis incididunt officia",
      "ex ullamco ad occaecat",
      "sint do sed Duis"
    ],
    "aliquipf": ["voluptate magna amet aliqua"],
    "proident_0": ["exercitation", "fugiat ut aliquip consectetur"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "adipisicing magna pariatur proident et",
    "in do Duis sunt deserunt"
  ],
  "connected_source_net_ids": [
    "qui ullamco eu culpa",
    "sunt",
    "veniam ea sed deserunt consequat"
  ]
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "anim Lorem enim nostrud dolore"
}
```
  ...
  "route": [
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": 16552690.809240863
    },
    {
      "x": "3mm",
      "via": false,
...
```json
{
  ...
  "supplier_part_numbers": {
    "proident_8d": ["amet irure", "nostrud minim"]
  }
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": -23960742.836601987
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "reprehenderit quis"
  },
  "layer": "top",
  "footprinter_string": "commodo proident et non",
  "model_obj_url": "fugiat consequat consectetur labore aliqua",
  "model_stl_url": "ullamco Lorem"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 5314416.0582461655,
  "outer_height": 65692222.475865334,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "tempor ipsum in culpa dolore"
}
```
...
{
  "dolore05": {
    "left_margin": 54971683.48832506,
    "right_margin": "esse",
    "top_margin": -49955133.9521751,
    "bottom_margin": "Ut irure consequat Lorem"
  },
  "labore_8": {
    "top_margin": -37887012.25003046
  },
  "fugiat_9e": {
    "left_margin": "quis fugiat aliquip",
    "right_margin": "cillum est",
    "top_margin": "laborum reprehenderit cillum non",
    "bottom_margin": -22610385.63148135
  }
}
```
