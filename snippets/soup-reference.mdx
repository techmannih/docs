...
```json
{
  ...
  "name": "C1",
  "manufacturer_part_number": "officia nostrud"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "dolore sunt irure non"
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["ut cillum"],
  "is_power": false,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": -37798665.82765621
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "elit92": ["in", "labore do nulla", "elit deserunt labore", "non"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "proident velit consectetur nulla laboris",
  "supplier_part_numbers": {
    "ad_161": ["aliqua", "est quis"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "non eu",
  "supplier_part_numbers": {
    "laboris__": [
      "eiusmod pariatur adipisicing anim fugiat",
      "consectetur reprehenderit sint nulla",
      "nostrud voluptate",
    ...
    "irure_0": [
      "qui",
      "nostrud consequat incididunt ullamco qui",
      "adipisicing ea",
      "aute id in",
      "Lorem ad id labore voluptate"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "velit dolor occaecat",
  "supplier_part_numbers": {
    "pariatur76": ["in"]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "sed consequat incididunt qui",
  "supplier_part_numbers": {
    "utc": [
      "aliqua Ut ullamco labore in",
      "id voluptate Excepteur labore",
      "laborum irure aliquip consectetur nulla",
      "in minim cillum",
      "et minim velit sint"
    ],
    "labore2": [
    ...
    "Excepteure1d": [
      "dolore nostrud",
      "cillum dolor",
      "laborum ullamco non irure Lorem"
    ],
    "ullamco_244": [
      "laborum nostrud aliquip",
      "ullamco",
      "consectetur ex ut qui"
    ],
    "sit_d7": ["nulla ullamco fugiat magna ut", "est anim ullamco dolore"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "magna proident voluptate mollit ex",
  "supplier_part_numbers": {
    "ullamco_4": [
      "ipsum anim deserunt ad",
      "dolore velit non",
      "laboris velit ut incididunt Lorem",
      "aliqua",
      "tempor cupidatat voluptate adipisicing"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "proident elit",
    "do",
    "in esse est consectetur"
  ],
  "connected_source_net_ids": ["irure dolore exercitation amet ad"]
}
```
...
```json
{
  ...
  "message": "tempor aliqua reprehenderit commodo"
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "ad incididunt dolor dolore culpa"
}
```
...
```json
{
  ...
  "color": "adipisicing Ut fugiat incididunt pariatur"
}
```
  ...
  "route": [
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": "proident laborum in eiusmod enim"
    }
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "veniam aliqua",
  "supplier_part_numbers": {
    "minim4": ["et amet aute laboris", "aute eiusmod"],
    "cillum_02": ["quis occaecat officia amet"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "deserunt adipisicing nisi tempor"
  },
  "layer": "top",
  "footprinter_string": "consequat occaecat aute sit adipisicing",
  "model_obj_url": "nulla anim",
  "model_stl_url": "dolor consectetur ullamco",
  "model_3mf_url": "velit",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "deserunt qui cillum enim"
}
```
...
```json
{
  ...
  "via": false,
  "to_layer": "bottom",
  "trace_width": "elit ad et reprehenderit Ut"
}
```
...
{
  "fugiat5": {
    "left_margin": 15157134.738824591
  },
  "laboris_6": {},
  "veniam_f4": {
    "left_margin": -21779072.632187277,
    "bottom_margin": -62087876.55972503
  },
  "nona": {
    "right_margin": 69536672.45678902,
    "bottom_margin": "labore sunt amet Excepteur"
  },
  "exercitatione": {
    "left_margin": -64846448.84464874,
    "right_margin": -27927383.156192094,
    "top_margin": "tempor pariatur veniam",
    "bottom_margin": "deserunt velit est ut"
  }
}
```
