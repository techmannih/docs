...
```json
{
  ...
  "ftype": "in nulla fugiat",
  "source_component_id": "source_component_1",
  "name": "I1",
  "manufacturer_part_number": "consequat dolore",
  "supplier_part_numbers": {
    "id_7": ["aute incididunt sed dolore mollit"],
    "sunt23": ["eiusmod non"],
    "ut_9": ["Ut deserunt aliqua"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "velit Lorem adipisicing Excepteur",
  "supplier_part_numbers": {
    "do72": [
      "minim consequat deserunt aliqua reprehenderit",
      "mollit cillum in dolor"
    ],
    "Excepteur_cc7": ["aliquip ut labore fugiat", "cupidatat magna in"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "fugiat08": ["laboris voluptate"],
    "consequat84d": ["irure velit"],
    "ut_22": ["sed in aute deserunt esse", "pariatur et nulla dolore ullamco"],
    "nisi0d6": [
      "occaecat fugiat incididunt irure culpa",
      "laborum tempor in id proident",
      "qui commodo pariatur enim"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "ea15": ["tempor laboris cupidatat", "aliquip sint amet consequat"],
    "adb": ["ad dolor"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "aute commodo sint proident Ut",
  "supplier_part_numbers": {
    "idd": ["magna sit nostrud"],
    "est_d": [
      "veniam enim officia dolor Excepteur",
      "voluptate culpa Lorem magna enim",
      "culpa enim nisi"
    ],
    "eiusmod_e8": [
      "ex dolore in minim",
      "in ex aute",
      "adipisicing in",
      "do veniam consectetur elit exercitation"
    ],
    "utd5": ["consectetur"],
    "nostrud8d2": [
      "nisi",
      "irure mollit incididunt ut",
      "incididunt irure non",
      "dolor pariatur quis"
    ]
  },
  "voltage": "5V"
...
```json
{
  ...
  "supplier_part_numbers": {
    "consequat_4": [
      "enim cupidatat",
      "dolore tempor dolor do",
      "tempor commodo deserunt elit esse",
      "velit enim dolore dolore id"
    ],
    "id_77c": [
      "fugiat dolore nisi cillum",
      "ad",
      "occaecat pariatur velit proident",
      "cillum ullamco",
      "cupidatat"
    ],
    "veniam_e8c": ["quis cillum ut officia Lorem"],
    "Ut90": [
      "deserunt labore laborum",
      "ea quis",
      "et reprehenderit est Duis",
      "ullamco do dolore"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": [
    "laborum veniam fugiat in velit",
    "deserunt cillum mollit officia Excepteur"
  ],
  "connected_source_net_ids": [
    "dolore irure ex fugiat",
    "dolore adipisicing",
    "Lorem sit",
    "sint in ipsum sit ea"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -97596024.90276125,
  "box_width": 5890109.8172855675,
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "commodo proident exercitation sed"
}
```
...
```json
{
  ...
  "radius_x": "fugiat anim esse in",
  "radius_y": -66591848.76296793,
  "layer": "top"
}
```
...
```json
{
  ...
  "route": [
    ...
    },
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": -40686943.299569614
    }
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "amet pariatur proident minim",
  "supplier_part_numbers": {
    "fugiat_51": ["ut officia minim Lorem Excepteur", "commodo"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -26911328.404256314,
  "outer_height": 72049209.56153435,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "via": false,
  "to_layer": "bottom",
  "trace_width": "dolor deserunt anim"
}
```
