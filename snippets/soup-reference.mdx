...
```json
{
  ...
  "ftype": "reprehenderit qui sit Excepteur minim",
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "qui",
  "supplier_part_numbers": {
    "laboris_e1f": [
      "culpa non mollit eiusmod est",
      "sint enim et nisi proident",
      "Excepteur",
      "aliqua",
      "ullamco amet elit anim"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "eiusmod nisi Ut enim",
  "supplier_part_numbers": {
    "nulla_1ee": ["sed consectetur proident", "ex anim ea ad do"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["velit aliquip culpa", "Excepteur"],
  "is_power": true,
  "is_analog_signal": true,
  "trace_width": 8873843.72507833
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "in sed laborum incididunt est",
  "supplier_part_numbers": {
    "ex6": ["culpa proident nostrud sed", "pariatur"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "pariatur et consectetur",
  "supplier_part_numbers": {
    "veniam_4": [
      "dolore laboris Lorem deserunt Duis",
      "amet eiusmod id magna ut"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "dolor occaecat ad",
  "supplier_part_numbers": {
    "eu_6b": ["quis ex", "culpa magna voluptate cupidatat"],
    "ut_ade": []
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "incididunt proident dolor cupidatat eu",
  "supplier_part_numbers": {
    "commodo3d": ["consequat eiusmod Excepteur amet qui"],
    "amet_9": [
      "cillum aliqua veniam ex",
      "laborum",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "ipsum magna eiusmod"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "Ut consectetur aliquip",
  "supplier_part_numbers": {
    "dolor_1b3": ["et"]
  },
  "voltage": "5V"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "minim anim velit",
  "supplier_part_numbers": {
    "minim0": [
      "elit cillum nisi",
      "dolor eu in",
...
```json
{
  ...
  "connected_source_port_ids": ["Lorem incididunt"],
  "connected_source_net_ids": [
    "cillum reprehenderit ullamco",
    "exercitation laboris laborum",
    "laboris",
    "nostrud dolor labore sit",
    "tempor nulla ullamco Lorem magna"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "enim in consequat qui",
  "pin_styles": {},
  "box_width": 41968505.56585443,
  "symbol_name": "magna",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "message": "quis irure do laborum cillum"
}
```
...
```json
{
  ...
  "radius_x": 69162990.92748871,
  "radius_y": -35756200.56894664,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "non ut",
  "supplier_part_numbers": {
    "incididunt8": [],
    "mollit_2a": []
  }
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "reprehenderit irure"
  },
  "layer": "top",
  "footprinter_string": "commodo nulla dolor",
  "model_obj_url": "voluptate aute sed Duis",
  "model_stl_url": "ea minim",
  "model_3mf_url": "sint enim",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "ex mollit exercitation minim veniam"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -18694073.203891918,
  "outer_height": 31359726.837217033,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "voluptate fugiat qui elit proident"
}
```
...
{
  "ex4d_": {
    "left_margin": -72080528.89982146,
    "right_margin": 71445689.22205964,
    "top_margin": 44752327.27673343,
    "bottom_margin": -36424006.94011032
  }
}
```
