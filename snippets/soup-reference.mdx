...
```json
{
  ...
  "supplier_part_numbers": {
    "non_3b": ["sed laboris non", "dolor"],
    "fugiat__": ["dolore nostrud ad", "anim"],
    "sunt_a5": [
      "do veniam voluptate",
      "occaecat nisi",
      "est ex quis et",
      "dolor ut fugiat pariatur"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "quis_5_": ["ullamco do aute esse", "laborum dolor nulla eu Excepteur"],
    "aliquip4": [
      "incididunt consectetur sed officia",
      "fugiat ex ea",
      "voluptate",
      "sunt dolor minim magna cillum"
    ]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["eiusmod", "anim"],
  "is_power": true,
  "is_ground": true,
  "is_digital_signal": false,
  "is_analog_signal": true,
  "trace_width": 25062373.272748888
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "consequat_5": [
      "do sit commodo",
      "eu nisi sunt",
      "sed magna deserunt sunt ut",
      "veniam anim ut eiusmod",
      "tempor qui quis mollit do"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "voluptate ea Lorem tempor",
  "supplier_part_numbers": {
    "id_891": ["sint ut nostrud mollit"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "ipsum laborum mollit dolore labore",
  "supplier_part_numbers": {
    "dolore_bc7": ["fugiat consectetur in cupidatat Lorem"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "dolore aliquip",
  "supplier_part_numbers": {
    "irure__": [
      "ut ad",
      "anim sint sit ut Excepteur",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "irure pariatur dolore",
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "esse ut",
  "supplier_part_numbers": {
    "inb82": [
      "in est aute cillum",
      "anim eiusmod aute eu Duis",
      "quis ad eiusmod"
    ],
    "mollit_6b4": [
      "Duis cupidatat aute",
      "dolor esse elit in tempor",
      "pariatur",
      "culpa veniam deserunt"
    ],
    "enime6e": ["officia ut irure est laborum", "in et officia"],
    "est9ac": [
      "incididunt Excepteur labore pariatur in",
      "consectetur",
      "minim esse sed eu anim",
      "veniam"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "radius_x": "aliquip fugiat",
  "radius_y": "esse in aliqua",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "eiusmod ut velit exercitation",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "dolore Duis",
  "supplier_part_numbers": {
    "cupidatat0": [
    ...
    "exercitation_24": ["quis eu"],
    "magna_9": ["incididunt nisi", "laboris ea tempor ut do"]
  }
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "amet esse",
  "model_obj_url": "incididunt ipsum nisi ea",
  "model_stl_url": "labore Excepteur nisi do",
  "model_3mf_url": "id eu",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 44377828.92512074,
  "outer_height": -9870571.923673049,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "qui officia eiusmod reprehenderit"
}
```
...
{
  "in628": {
    "left_margin": "labore voluptate",
    "right_margin": 5544335.665947393
  },
  "Loremfd1": {
    "left_margin": 53624775.633523494,
    "right_margin": "ad magna elit velit sed",
    "top_margin": -89635754.7544107,
    "bottom_margin": -24640355.26180646
  },
  "nostrud_a": {
    "left_margin": "ad",
    "top_margin": "ex elit"
