...
```json
{
  ...
  "supplier_part_numbers": {
    "Ut5": ["ut aliquip est", "voluptate ullamco qui ipsum"]
  }
}
```
...
```json
{
  ...
  "name": "L1",
  "supplier_part_numbers": {
    "consequat__91": ["Duis ut incididunt nisi ex"],
    "dolore_5": ["anim amet mollit"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["consequat eu dolor sed sit"],
  "is_power": false,
...
```json
{
  ...
  "supplier_part_numbers": {
    "sunte8": [
      "voluptate Lorem est enim",
      "elit",
      "consectetur officia nulla reprehenderit",
      "mollit ea",
      "magna exercitation sint"
    ],
    "incididunt_7fc": [
      "officia elit deserunt",
      "Duis magna sed pariatur",
      "laboris officia ut irure",
      "ullamco"
    ],
    "magna264": ["nisi quis id qui nostrud"]
  }
}
```
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "qui130": ["adipisicing quis tempor", "do dolore in esse cillum"],
    "Excepteur_c": [
      "dolor magna",
      "Lorem nostrud cupidatat consequat laborum",
      "Lorem ex",
...
```json
{
  ...
  "name": "G1",
  "supplier_part_numbers": {
    "dolorec5e": ["ipsum aliqua deserunt dolor cupidatat", "in Duis"]
  }
}
```
...
```json
{
  ...
  "name": "P1",
  "supplier_part_numbers": {
    "in_": ["deserunt enim esse cillum", "tempor eu id Lorem ullamco"],
    "Duisd": ["velit", "ad velit do"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "name": "R1",
  "supplier_part_numbers": {
    "eiusmod__": ["culpa proident nulla", "consectetur pariatur cupidatat ex"],
    "Utf1e": [
      "ad",
      "ipsum nulla occaecat laboris reprehenderit",
      "sint ullamco officia laborum",
      "dolore cillum culpa"
    ],
    "consequat_": [
      "id ea",
      "labore voluptate commodo nostrud",
      "aliqua Duis eu cillum sit",
      "Duis"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": [
    "sed do est",
    "dolore",
    "anim non aliquip eiusmod reprehenderit",
    "nostrud"
  ],
  "connected_source_net_ids": ["veniam sed et Excepteur", "ex labore laborum"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "culpa ea esse dolore dolor",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "message": "veniam tempor culpa eiusmod officia"
}
```
...
```json
{
  ...
  "message": "mollit laboris irure dolor aute",
...
```json
{
  ...
  "message": "sit est adipisicing deserunt esse",
  "pcb_trace_id": "pcb_trace_1",
  "source_trace_id": "source_trace_1",
  "pcb_component_ids": ["pcb_component_1"],
...
```json
{
  ...
  "name": "L1",
  "supplier_part_numbers": {
    "in83": ["aliqua deserunt"],
    "velit_92": [
      "labore",
      "commodo id dolore",
      "aliquip incididunt ullamco Duis",
      "reprehenderit sint tempor in consectetur"
    ]
  }
}
```
