...
```json
{
  ...
  "ftype": "ut Ut aliquip Excepteur",
  "source_component_id": "source_component_1",
  "name": "U1",
  "manufacturer_part_number": "id veniam exercitation eu ea",
  "supplier_part_numbers": {
    "quib": [
      "ipsum aute",
      "eu nulla",
      "esse laborum in nisi",
      "ex ut dolor ullamco"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "labore8": [
      "incididunt veniam minim laborum irure",
      "esse culpa",
      "sunt nisi sint consequat",
      "eu incididunt"
    ]
  }
}
...
```json
{
  ...
  "member_source_group_ids": [
    ...
    "occaecat",
    "nisi ipsum cupidatat cillum",
    "non Duis labore fugiat aliquip"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "aliquip laboris enim laborum proident",
  "supplier_part_numbers": {
    "ad893": ["officia consectetur", "nulla amet nisi labore", "Excepteur"]
  }
}
```
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "velit9b": ["in ut", "proident", "culpa qui esse proident"],
    "ex_7_0": ["in"]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "sit est qui id labore",
  "supplier_part_numbers": {
    "amet8": ["dolore laborum ullamco"],
    "eta77": [
      "Lorem Excepteur magna reprehenderit aliquip",
      "in deserunt in nostrud reprehenderit"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "amet sit",
  "supplier_part_numbers": {
    "velit9": [
      "ex consectetur aliqua Excepteur Duis",
      "quis nisi pariatur irure",
      "nulla id enim"
    ],
    "anim41a": ["commodo ipsum ad amet"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "consequat_9": [
      ...
      "nulla ad in tempor",
      "aliquip",
      "consequat adipisicing Duis cupidatat",
      "mollit cillum"
    ],
    "irure1b": [
      "eiusmod exercitation",
      "consectetur officia anim",
      "consectetur aute et culpa"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "est elit incididunt esse",
  "supplier_part_numbers": {
    "Excepteur0": ["in dolore sunt sed", "qui in"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "nulla ipsum",
  "supplier_part_numbers": {
    "id8": [
      "dolor fugiat consectetur in",
      "Duis ex veniam ad",
      "aliquip veniam"
    ]
  },
...
```json
{
  ...
  "connected_source_net_ids": ["ullamco Ut consectetur"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -29337307.760284886,
  "box_width": "ut",
  "symbol_name": "ullamco",
  "port_arrangement": {
    "left_size": 3,
...
```json
{
  ...
  "radius_x": 689006.9871095419,
  "radius_y": "magna quis proident Excepteur",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "et fugiat incididunt veniam velit",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
  ...
  "route": [
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": "Lorem consectetur nisi aliquip in"
    },
    {
      "x": "3mm",
      "via": false,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "adipisicing exercitation tempor",
  "supplier_part_numbers": {
    "estc_a": ["cupidatat sint non ad enim", "ullamco do fugiat"],
    "aliquip_8": [
      "non ex fugiat",
      "in cupidatat",
      "esse cupidatat",
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "reprehenderit id ex sint velit"
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
  ...
  "layer": "top",
  "footprinter_string": "et proident labore",
  "model_obj_url": "occaecat laborum cillum labore",
  "model_stl_url": "dolore labore",
  "model_3mf_url": "quis pariatur laboris",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layer": "top",
  "description": "adipisicing dolor eu",
  "shape": "rect",
  "x": "3mm",
  "y": "1mm",
  "width": "5mm",
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": "proident incididunt dolore ut sunt"
}
```
