...
```json
{
  ...
  "ftype": "laboris qui commodo magna occaecat",
...
```json
{
  ...
  "supplier_part_numbers": {
    "labore67": [
      "in irure aute reprehenderit",
      "culpa consectetur esse exercitation"
    ],
    "ut7d": ["dolor", "labore laborum sint"],
    "ipsum_1": [
      "Lorem magna pariatur officia nulla",
      "do dolore deserunt",
      "proident aliqua nulla eu",
      "sed irure Ut"
    ]
  }
}
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["esse ad fugiat"],
  "is_ground": false
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "ex aute",
  "supplier_part_numbers": {
    "dolore_d0": [
      "consequat",
      "nulla reprehenderit aute in aliquip",
      "dolor",
      "eiusmod quis elit adipisicing consectetur",
      "cillum Excepteur fugiat Duis"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "sit_eb": ["ad adipisicing qui esse ex"],
    "occaecat_9": ["anim"],
    "magna477": ["sint ipsum in exercitation culpa"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "eu do veniam velit eiusmod",
  "supplier_part_numbers": {
    "ullamco7f1": [],
    "sed_c": ["cillum", "ad cupidatat culpa", "laboris nulla", "eiusmod"]
  }
}
```
...
```json
{
  ...
  "name": "D1",
  "supplier_part_numbers": {
    "exercitation5f6": ["voluptate exercitation dolor Ut velit"],
    "enimc6": [
      "ex mollit reprehenderit",
      "ex voluptate commodo",
      "minim incididunt laboris nostrud aliqua"
    ],
    "dolor209": ["nulla incididunt"],
    "non_4a3": [
      "sed enim",
      "in voluptate anim esse elit",
      "cillum",
      "ea aliqua"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "dolore adipisicing pariatur ipsum",
  "supplier_part_numbers": {
    "reprehenderitca5": ["officia proident"],
    "sint88": ["mollit in ut irure", "eu nulla consectetur", "irure", "amet"],
    "exercitationa78": ["eiusmod voluptate"],
    "laboris_7b": [
      "pariatur elit quis",
      "mollit velit consectetur laborum dolore",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "adipisicing dolore",
  "supplier_part_numbers": {
    "ut2": [],
    "nostrud__f": ["ipsum id sint nisi", "nisi ut"],
    "Lorem9": [
      "eu",
      "qui magna adipisicing dolor",
      "aliquip in et voluptate in",
      "et qui labore Ut eu"
    ]
  },
  "voltage": "5V"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "Ut nisi quis qui officia",
  "supplier_part_numbers": {
    "nostrud6": ["reprehenderit"],
    "tempor7a": [
      "est commodo ex nisi",
      "mollit sed ea proident",
      "eu veniam",
      "Excepteur",
      "mollit exercitation elit qui"
    ],
    "reprehenderit_7": [
      "labore cillum in esse veniam",
      "consectetur",
      "ullamco sunt eu",
      "ut",
      "sunt nisi officia tempor do"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "Ut laborum occaecat mollit",
    "fugiat officia",
    "incididunt aliquip Excepteur",
    "laboris aliqua minim velit"
  ],
  "connected_source_net_ids": ["sed", "consequat"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "sit aute aliquip laborum",
  "pin_styles": {},
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "text": "Hello, World!",
  "layer": "top",
  "color": "officia in proident mollit ea"
}
```
...
```json
{
  ...
  "message": "laboris aliqua nostrud reprehenderit qui",
...
```json
{
  ...
  "radius_x": "sed tempor mollit nulla consequat",
  "radius_y": "consectetur id aliqua ipsum",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "eiusmod aliquip consectetur laboris",
  "supplier_part_numbers": {
    "aute_b9": [
      "incididunt consequat ipsum cupidatat ullamco",
      "culpa elit pariatur deserunt in",
      "ipsum"
    ]
  }
}
...
```json
{
  ...
  "footprinter_string": "sed",
  "model_obj_url": "Duis nisi velit irure",
  "model_3mf_url": "dolor dolore aliquip dolore esse",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 95817013.615224,
  "outer_height": 387125.7082859576,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "via": false,
  "to_layer": "bottom",
  "trace_width": "anim ut ullamco esse"
}
```
...
```json
{
  "sunt8": {},
  "consequat6e": {
    "left_margin": "sit proident",
    "right_margin": "commodo amet exercitation",
    "top_margin": "elit dolor",
    "bottom_margin": -26667549.0350921
  }
}
```
