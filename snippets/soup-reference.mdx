...
```json
{
  ...
  "name": "M1",
  "manufacturer_part_number": "veniam officia exercitation in",
  "supplier_part_numbers": {
    "magnaa68": [
      "pariatur in consequat aute",
      "voluptate Ut fugiat",
      "deserunt sint",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "mollit proident ut",
  "supplier_part_numbers": {
    "Excepteur401": [
      "incididunt dolore in Duis",
      "ipsum esse veniam velit",
      "consectetur dolor ipsum qui occaecat",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "quis amet",
  "supplier_part_numbers": {
    "ut_8b7": [
      "sit veniam",
      "in do ullamco",
      "sed voluptate proident sunt id",
      "non cupidatat",
      "dolor"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ea aute occaecat",
  "supplier_part_numbers": {
    "dolor1f": [
      "officia ut nostrud et",
      "Duis labore sunt qui",
      "labore tempor eu elit ut"
    ],
    "est44": [
      "aliqua cillum veniam",
      "laborum enim dolore cillum nulla",
      "pariatur",
      "magna labore esse adipisicing"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "officia3": [
      "velit voluptate cillum dolor",
      "ea aute amet est sunt",
      "Duis cillum ullamco consectetur"
    ],
    "proident42a": ["ut proident consequat in ut", "ut sint"],
    "aute0": ["qui eu ea velit dolore", "incididunt adipisicing consequat"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "nostrud aliquip consectetur Duis cillum"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "qui aute eu adipisicing",
    "exercitation cillum"
  ],
  "connected_source_net_ids": ["et", "cupidatat"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "commodo officia proident",
  "box_width": "consequat occaecat minim Lorem aute",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "amet labore nulla magna"
}
```
...
```json
{
  ...
  "radius_x": 13913337.773308322,
  "radius_y": "enim aliqua do",
  "layer": "top"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolor_cd": [
      "Lorem Ut Duis aute",
      "aute",
      "eiusmod et Ut aute in",
      "adipisicing incididunt eu ad",
      "est"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "labore deserunt in"
  },
  "model_obj_url": "do veniam exercitation",
  "model_stl_url": "laboris non anim quis ea"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -40887267.56034045,
  "outer_height": 16613549.395372689,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
