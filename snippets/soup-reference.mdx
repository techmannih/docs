...
```json
{
  ...
  "ftype": "Excepteur proident ut",
  "source_component_id": "source_component_1",
  "name": "E1",
  "manufacturer_part_number": "irure Lorem nostrud cillum velit",
  "supplier_part_numbers": {
    "pariaturb13": [
      "ut in est",
      "sit Ut est fugiat nisi",
      "dolor",
      "exercitation aliquip Lorem"
    ],
    "dolor9fb": ["adipisicing aliquip ut"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "amet incididunt id consectetur",
  "supplier_part_numbers": {
    "qui_3e": [
      "nulla eiusmod deserunt adipisicing",
      "fugiat",
      "incididunt",
      "esse nostrud",
      "dolore consequat ex"
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["ea dolore", "ad do"],
  "is_ground": true
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "ex nostrud exercitation voluptate",
  "supplier_part_numbers": {
    "ea__": ["in aute adipisicing", "commodo dolore Duis", "ex velit cillum"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "commodoab": [
      "eu nulla esse in aliqua",
      "labore consequat ea Lorem",
      "quis"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "ut et anim irure ut",
  "supplier_part_numbers": {
    "aute07": ["voluptate ipsum culpa", "eu"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "qui labore laborum",
  "supplier_part_numbers": {
    "ullamco_b_5": ["pariatur minim dolor do", "ipsum"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["enim"],
  "connected_source_net_ids": [
    "esse nostrud labore qui",
    "dolor consequat",
    "ullamco ad sed minim"
  ]
}
```
...
```json
{
  ...
  "message": "dolore Excepteur occaecat ut ad"
}
```
...
```json
{
  ...
  "radius_x": 41495762.561106086,
  "radius_y": -97567070.17981991,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "sed do enim incididunt laborum",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "exercitation est commodo",
  "supplier_part_numbers": {
    "dolor_fe7": [
      "ipsum tempor dolore commodo nostrud",
...
```json
{
  ...
  "footprinter_string": "fugiat ut sed aute incididunt",
  "model_obj_url": "labore ut dolor",
  "model_stl_url": "ut qui do ex sint",
  "model_3mf_url": "occaecat in"
}
```
