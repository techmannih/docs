...
```json
{
  ...
  "ftype": "aute aliqua nisi irure Lorem",
  "source_component_id": "source_component_1",
  "name": "A1",
  "manufacturer_part_number": "ut sed enim ea eiusmod",
  "supplier_part_numbers": {
    "magna7": [
      "eiusmod cillum sit sed",
      "sint consectetur",
      "amet in fugiat",
      "commodo dolore"
    ],
    "consectetur733": ["amet esse Lorem do", "in", "irure", "sit id Ut"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["mollit elit occaecat Lorem"],
  "is_power": true,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": -94426008.56181805
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "est irure sit quis cillum",
  "supplier_part_numbers": {
    "Ut_c": ["ex velit", "sunt eiusmod commodo officia"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "aute enim",
  "supplier_part_numbers": {
    "sit1": ["quis voluptate velit ipsum amet"],
    "eu_0": ["ipsum"],
    "Duis__6": [
      "fugiat reprehenderit tempor commodo",
      "aliqua deserunt in ullamco"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "in commodo",
  "supplier_part_numbers": {
    "id_ddd": ["enim dolore", "Lorem"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "sed ipsum anim incididunt sunt",
  "supplier_part_numbers": {
    "ullamco_8": [
      "laborum do in id dolore",
      "eiusmod voluptate eu occaecat ut",
      "nostrud exercitation esse tempor",
      "velit dolor elit",
      "veniam"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "dolor ut dolore culpa",
  "supplier_part_numbers": {
    "et4": [
      "labore occaecat fugiat magna anim",
      "fugiat Duis aute sint aliquip",
      "proident in Lorem",
      "occaecat culpa commodo ea"
    ],
    "ullamco11e": ["sed", "id", "consequat magna Lorem do", "occaecat"],
    "cupidatat_": ["in eiusmod dolor", "velit pariatur esse"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "amet non aliquip",
  "supplier_part_numbers": {
    "exercitation_a33": [
      "in eu Ut nostrud",
      "ullamco ut laboris",
    ...
    "id__35": [
      "Ut labore culpa exercitation",
      "pariatur sit in dolor occaecat",
      "culpa Excepteur amet dolor"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "laboris in dolor",
  "supplier_part_numbers": {
    "quis_": [
      "Excepteur exercitation irure qui",
      "officia eu",
      "consectetur nulla sit"
    ],
    "laborum_2d": [
      "consequat minim in laborum exercitation",
      "sunt quis eiusmod ullamco"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "ea qui cupidatat",
    "consectetur voluptate reprehenderit quis",
    "anim quis",
    "tempor",
    "qui labore ut ipsum laboris"
  ],
  "connected_source_net_ids": ["consequat"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "esse sint aliquip Ut incididunt",
  "pin_styles": {},
  "box_width": -94147332.46366996,
  "symbol_name": "non",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "incididunt Ut velit Lorem adipisicing"
}
```
...
```json
{
  ...
  "message": "fugiat incididunt labore ut esse",
...
```json
{
  ...
  "supplier_part_numbers": {
    "labored": ["Ut"],
    "utb4b": [
      "laboris id exercitation ut",
      "fugiat consequat adipisicing dolore",
      "dolor",
      "id enim ea exercitation Excepteur",
      "laboris irure consequat est"
    ]
  }
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "amet in consequat sint"
  },
  "rotation": "90deg",
  "layer": "top",
  "model_stl_url": "sunt cupidatat dolore nostrud",
  "model_3mf_url": "minim culpa laborum dolor",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 34959812.04027498,
  "outer_height": 20527069.778813273,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "in5de": {
    "left_margin": "proident magna labore consectetur",
    "right_margin": -14755839.344147056,
    "bottom_margin": -68650232.87922738
  },
  "tempor_72": {
    "left_margin": "amet ipsum",
    "right_margin": "qui",
    "top_margin": "enim culpa qui"
  },
  "voluptate_5": {
    "left_margin": "do nisi sint dolore aute",
    "right_margin": -41615417.56744085,
    "top_margin": "reprehenderit",
    "bottom_margin": "voluptate do ipsum officia fugiat"
  }
}
```
