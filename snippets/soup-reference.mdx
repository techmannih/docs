...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "aute pariatur officia mollit",
...
```json
{
  ...
  "member_source_group_ids": [
    "id dolor",
    "Lorem Excepteur ex officia in",
    "dolor est in",
    "consectetur officia tempor sint Duis",
    "in"
  ]
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "esse36": ["ipsum qui pariatur quis", "qui consectetur laborum", "mollit"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "dolore sint",
  "supplier_part_numbers": {
    "inc": [
      "aliqua aute id fugiat",
      "exercitation qui culpa ut ipsum",
      "velit occaecat",
      "incididunt tempor cillum ex"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "anim Ut incididunt",
  "supplier_part_numbers": {
    "cupidatat_ab0": [
      "reprehenderit",
      "amet",
      "ex aliquip aliqua exercitation",
      "ullamco ut ipsum consectetur"
    ],
    "dolore_ac": ["laborum sit irure in ad"],
    "aute7a": [
      "voluptate ut deserunt cillum",
      "magna mollit ea irure voluptate"
    ],
    "aliquipac": [
      "ea magna in fugiat",
      "eu ea culpa ad",
      "aliquip dolore non cupidatat occaecat",
      "ex incididunt esse"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "minim ea sint",
  "supplier_part_numbers": {
    "aliquip_da": ["Excepteur"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["officia minim commodo", "labore laboris"],
  "connected_source_net_ids": [
    "id",
    "culpa ex ullamco",
    "nisi",
    "voluptate magna velit non id",
    "Lorem incididunt amet tempor ea"
  ]
}
```
...
```json
{
  ...
  "pin_styles": {
    "cillum_68": {
      "left_margin": 65760287.53257027
    }
  },
  "box_width": "pariatur minim eu",
  "symbol_name": "commodo dolore minim Excepteur",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "ipsum dolor elit minim ut"
}
```
...
```json
{
  ...
  "radius_x": 77462395.76495823,
  "radius_y": "nisi labore",
  "layer": "top"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "esse_44a": [
      "eu cillum consequat ex",
      "magna reprehenderit in do",
      "laboris in cillum",
      "tempor quis aliqua ea",
      "exercitation voluptate irure sit laborum"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "officia esse aliqua incididunt anim",
  "model_obj_url": "Duis mollit elit voluptate",
  "model_stl_url": "anim do adipisicing pariatur",
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "pariatur dolore fugiat sunt commodo"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -45641987.11844201,
  "outer_height": -91009339.82808273,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "ea8": {
    "left_margin": "et nisi",
    "right_margin": "Duis eiusmod proident occaecat",
    "top_margin": -71795331.76919413
  },
  "occaecat_92": {
    "left_margin": 78530782.6559417,
    "right_margin": -62069224.303562276,
    "top_margin": "commodo"
  }
}
```
