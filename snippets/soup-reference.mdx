...
```json
{
  ...
  "ftype": "dolor voluptate ex",
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "sed laboris pariatur consectetur",
  "supplier_part_numbers": {
    "occaecat74d": [
      "aliquip",
      "eiusmod aliquip nulla dolore",
      "Ut in et sed",
      "exercitation reprehenderit non est Excepteur"
    ],
    "ex10d": [
      "minim incididunt ea dolor",
      "nulla laborum sunt",
      "ad consectetur cupidatat",
      "elit dolor in dolore sunt",
      "dolore enim nostrud fugiat"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "veniam officia Lorem"
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["velit ut ullamco est Lorem", "ut Ut"],
  "is_power": true,
  "is_digital_signal": false,
  "trace_width": -86958694.57950675
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "laborum nisi culpa mollit",
  "supplier_part_numbers": {
    "Duis_f01": ["dolore ut deserunt", "amet", "nostrud tempor dolor"]
  }
}
```
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "nisi4": ["pariatur commodo veniam", "nisi Excepteur labore", "ea"],
    "Ut0b": ["tempor sed dolore ad eiusmod", "deserunt"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "in in esse culpa",
  "supplier_part_numbers": {
    "dolorec5": ["nostrud adipisicing", "aliqua culpa ut occaecat", "fugiat"]
  }
}
```
...
```json
{
  ...
  "name": "D1",
  "supplier_part_numbers": {
    "sitdb": ["fugiat", "minim sint in Ut anim", "ut irure"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "Duis do consequat nulla tempor",
  "supplier_part_numbers": {
    "ex_": ["do esse"]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "enim officia",
  "supplier_part_numbers": {
    "iruref": [
      "culpa occaecat",
      "ipsum aute reprehenderit Excepteur",
      "mollit quis enim amet",
      "aute"
    ],
    "minim_ca": [
      "officia dolor",
      "laborum ullamco",
      "aliquip",
      "in Excepteur quis labore et",
      "commodo adipisicing consequat id magna"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "ullamco ad ut dolor nulla",
  "supplier_part_numbers": {
    "sintc7": [
      "nulla",
      "Duis amet minim esse",
      "quis consectetur voluptate dolore",
      "sint et incididunt in reprehenderit"
    ],
    "reprehenderit_28": [
      "quis ut qui dolore",
      "magna aute Excepteur occaecat dolore",
      "in"
    ],
    "magna4f": ["elit ut ullamco anim do"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["ea laboris", "proident in"],
  "connected_source_net_ids": [
    "nostrud",
    "mollit exercitation esse non ad",
    "fugiat est aute",
    "laboris"
  ]
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "minim nisi",
  "pin_styles": {},
  "box_width": -8304298.701168507,
  "symbol_name": "cillum Duis dolore",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "non commodo mollit anim Excepteur",
...
```json
{
  ...
  "radius_x": "nisi commodo reprehenderit aliqua consectetur",
  "radius_y": "sed minim dolor quis",
  "layer": "top"
}
```
...
```json
{
  ...
  "route": [
    ...
    },
    {
      ...
      "y": "1mm",
      "via": false,
      "trace_width": -37477022.216150105
    }
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "dolor reprehenderit in tempor sint",
  "supplier_part_numbers": {
    "deserunt_f": [
      "voluptate ut ullamco aute mollit",
      "qui mollit non dolor anim",
      "aute ea anim labore",
      "esse Ut in proident in"
    ]
  }
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "Excepteur magna reprehenderit"
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
  ...
  "layer": "top",
  "footprinter_string": "incididunt mollit",
  "model_obj_url": "in culpa",
  "model_3mf_url": "sunt elit",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -42584567.99576997,
  "outer_height": -3116026.3454417735,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "reprehenderit2": {
    "left_margin": -27309779.44079469,
    "right_margin": "nisi",
    "bottom_margin": -23530428.878062144
  },
  "animbb": {
    "left_margin": "cillum veniam non sint",
    "right_margin": "proident sint Duis nisi",
    "top_margin": "aliquip esse dolore fugiat",
    "bottom_margin": -60223599.39677839
  }
}
```
