...
```json
{
  ...
  "ftype": "ullamco veniam amet nulla cillum",
...
```json
{
  ...
  "supplier_part_numbers": {
    "Duis_80b": [
      "aute elit",
      "adipisicing qui Lorem anim in",
      "non Excepteur eiusmod",
      "enim culpa exercitation",
      "eu sed"
    ],
    "officia4": ["enim ea dolore ex", "mollit", "ea Ut est in"],
    "commodo_4": ["cupidatat", "id amet esse fugiat ut", "dolor"],
    "consectetur_4": [
      "nisi laboris veniam pariatur",
      "tempor in minim qui",
      "fugiat",
      "laborum"
    ],
    "eiusmoddf": [
      "nisi Duis veniam ea ex",
      "ad labore aute laborum",
      "pariatur adipisicing tempor magna",
      "non culpa",
      "ex laboris"
    ]
  }
...
```json
{
  ...
  "name": "B1",
  "supplier_part_numbers": {
    "aliquipd": ["minim ut", "elit sit minim qui"],
    "officia_aba": ["pariatur occaecat veniam ex", "adipisicing nisi"],
    "aliquip_9a7": [
      "occaecat",
      "in dolore labore reprehenderit irure",
      "in est irure",
...
```json
{
  ...
  "name": "D1",
  "supplier_part_numbers": {
    "nullae": ["ullamco cupidatat", "labore", "in irure amet ipsum"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "anim70": [
      ...
      "pariatur",
      "sint do Duis in id",
      "occaecat amet in laboris irure"
    ],
    "reprehenderit_0": [
      "ea sit labore officia aliquip",
      "sit",
      "labore consequat ea incididunt"
    ],
    "reprehenderitfe": ["pariatur in ea eiusmod"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "aliquabd1": [
      "in reprehenderit",
      "deserunt aliquip aliqua do eiusmod",
      "esse ut in id",
      "elit do",
      "ut"
    ]
...
```json
{
  ...
  "supplier_part_numbers": {
    "commodo_1_1": [
      "Excepteur",
      "proident est et cillum fugiat",
      "qui dolore irure ut sed"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": ["dolor Excepteur reprehenderit", "labore"],
  "connected_source_net_ids": [
    "est enim Duis",
    "dolore irure",
    "reprehenderit proident consequat"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "amet ullamco laboris adipisicing reprehenderit",
  "box_width": "ex adipisicing eu et cupidatat",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "supplier_part_numbers": {
    "elit_fb": [
      ...
      "consequat",
      "voluptate sit adipisicing commodo dolore"
    ],
    "laboris_9e": ["id Lorem qui reprehenderit quis"],
    "sunt0_": ["veniam exercitation eiusmod", "incididunt", "quis aliqua"]
  },
  "voltage": "5V"
}
```
