...
```json
{
  ...
  "ftype": "laboris mollit Excepteur Duis velit",
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "in",
  "supplier_part_numbers": {
    "in8d6": ["dolor voluptate", "do fugiat consequat"],
    "dolore_5": ["in sit"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "minim Ut qui",
  "supplier_part_numbers": {
    "fugiat_808": [],
    "eu5d": [
      "sit",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "commodo aliqua adipisicing nisi consequat",
  "supplier_part_numbers": {
    "tempor_3ba": ["voluptate Ut", "irure laboris sed"],
    "fugiat53e": ["labore esse dolor", "est", "consectetur", "fugiat quis"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "sint nulla",
  "supplier_part_numbers": {
    "quis8e": ["reprehenderit non amet sit labore"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "irure labore ut in",
  "supplier_part_numbers": {
    "cupidatatf": [],
    "laborum_127": ["Lorem officia"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "proident eu",
  "supplier_part_numbers": {
    "in_7": [
      "eiusmod dolor proident",
      "esse et ut",
      "occaecat laboris enim ea"
    ],
    "dolor81": [
      "minim aute do",
...
```json
{
  ...
  "connected_source_port_ids": ["fugiat"],
  "connected_source_net_ids": [
    "occaecat consequat anim dolore enim",
    "incididunt dolore quis id do",
    "sunt irure",
    "aute veniam reprehenderit quis irure",
    "aliqua nisi"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "symbol_name": "Lorem elit eu incididunt commodo",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "message": "pariatur nulla dolor labore",
...
```json
{
  ...
  "message": "nulla ullamco cupidatat reprehenderit elit",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
  ...
  "route": [
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": "quis do anim magna"
    },
    {
      "x": "3mm",
      "y": "1mm",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "aliqua dolor",
  "supplier_part_numbers": {
    "nulla_": [],
    "voluptate_5": [],
    "anim1": [
      "ut dolore Duis",
      "nostrud occaecat consectetur",
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "occaecat in aute",
  "model_obj_url": "aliqua proident",
  "model_stl_url": "veniam in anim",
  "model_3mf_url": "laborum commodo reprehenderit",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "via": false,
  "to_layer": "bottom",
  "trace_width": "tempor in Lorem mollit exercitation"
}
```
...
{
  "ad_c": {
    "left_margin": -3151149.322097659,
    "right_margin": -54891311.33762788,
    "top_margin": "Duis in",
    "bottom_margin": -57849568.575733066
  }
}
```
