...
```json
{
  ...
  "ftype": "mollit amet elit ullamco",
  "source_component_id": "source_component_1",
  "name": "M1",
  "manufacturer_part_number": "ut dolore",
  "supplier_part_numbers": {
    "in_4b": [
      "esse aliquip est do",
      "mollit labore aliqua eu",
      "non cupidatat laboris ea incididunt"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "in nisi",
  "supplier_part_numbers": {
    "velitd8c": [
      "nulla",
      "ullamco",
      "adipisicing",
      "elit voluptate Duis laboris",
      "ex ullamco dolore tempor commodo"
    ],
    "commodo54": ["minim Lorem do in"],
    "officiac": ["sint culpa ullamco", "ipsum", "enim nisi", "voluptate do"],
    "dolore_b": [
      "amet sit do ex",
      "velit eu do Duis",
      "in id commodo minim",
      "velit",
      "aliquip ex dolore veniam laboris"
    ]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["sed cupidatat commodo aliqua"],
  "is_power": false,
  "is_digital_signal": false,
  "trace_width": 56310576.485143185
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "labore tempor sunt ipsum sit",
  "supplier_part_numbers": {
    "nostrud_47": ["adipisicing in", "deserunt culpa laboris commodo esse"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "cupidatat ex velit eu officia",
  "supplier_part_numbers": {
    "culpa_935": [
      "ullamco nisi id est veniam",
      "deserunt esse anim incididunt sed",
      "in",
      "Duis proident",
      "aliquip dolor culpa consectetur amet"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "enim dolor",
  "supplier_part_numbers": {
    "dolore_0": ["enim magna dolor"],
    "do2bc": ["ipsum", "culpa Excepteur cupidatat", "ipsum amet"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "Excepteur",
  "supplier_part_numbers": {
    "pariatur_40": [
      "dolore nisi et",
      "exercitation magna",
      "commodo laboris qui dolore",
      "velit consequat aliqua dolore in",
      "deserunt Lorem non id"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "proident voluptate commodo",
  "supplier_part_numbers": {
    "enim_ad": ["non ullamco sint consectetur", "id Ut", "irure"],
    "sunt4c": ["velit exercitation ipsum officia", "anim sit dolor ad"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "qui_c3d": [
      "eu est sunt tempor",
      "ea elit",
      "voluptate ut consectetur ipsum",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "consequat in commodo enim",
  "supplier_part_numbers": {
    "consectetur7c": ["reprehenderit sint esse nulla labore"],
    "ullamco_07a": ["sunt", "enim"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["ut", "et in"],
  "connected_source_net_ids": ["in adipisicing", "sed", "mollit id"]
}
```
...
```json
{
  ...
  "message": "exercitation ad nisi adipisicing"
}
```
...
```json
{
  ...
  "message": "labore consectetur quis ad",
...
```json
{
  ...
  "radius_x": -99336994.4421569,
  "radius_y": "voluptate velit cupidatat nostrud",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "sunt occaecat deserunt ullamco velit",
  "supplier_part_numbers": {
    "in0": [
      "Lorem labore ad",
      "anim eu",
      "cillum minim cupidatat",
      "in Lorem ullamco esse officia",
      "magna"
    ],
    "esseb9_": ["ipsum proident adipisicing"],
    "incididunt_f4c": [
      "sed fugiat et",
      "non Duis in",
      "culpa",
      "minim pariatur proident in",
      "anim voluptate dolore deserunt occaecat"
    ]
  },
  "capacitance": "1uF"
}
