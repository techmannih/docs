...
```json
{
  ...
  "supplier_part_numbers": {
    "velit_ac": ["culpa Excepteur exercitation in"],
    "in1c": [
      "laborum nostrud ut et",
      "amet",
      "mollit culpa",
      "Lorem adipisicing",
      "voluptate labore reprehenderit nostrud ea"
    ]
  }
}
```
...
```json
{
  ...
  "name": "L1",
  "supplier_part_numbers": {
    "dolor_3": ["proident aliquip et Excepteur ex"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["ad ipsum", "voluptate"],
  "is_power": true,
  "is_ground": false,
...
```json
{
  ...
  "supplier_part_numbers": {
    "cupidatat_8d4": [
      ...
      "sunt consectetur",
      "reprehenderit in",
      "magna occaecat eu dolor",
      "dolor eiusmod ut"
    ],
    "tempor_ab3": ["in Duis ad"],
    "eu_7c": ["mollit veniam pariatur", "nulla", "in ipsum minim amet"],
    "dolor7": [
      "dolor aute nisi",
      "reprehenderit",
      "ipsum cillum aliquip cupidatat ut"
    ],
    "ipsum_eb": [
      "sint",
      "est ullamco Ut consequat",
      "fugiat nulla et sint do",
      "ad",
      "qui eu sunt esse"
    ]
  }
...
```json
{
  ...
  "supplier_part_numbers": {
    "labore__": [
      "cillum ut laborum enim",
      "culpa dolore ullamco dolor",
      "sed aute amet ex"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "supplier_part_numbers": {
    "laboris_81": [
      "amet tempor labore veniam exercitation",
      "consequat in eu",
      "cillum eiusmod",
      "in aute mollit",
      "exercitation consequat Excepteur in Ut"
    ],
    "cupidatat__c": ["voluptate cillum exercitation nisi irure"],
    "do26": ["ad", "magna nulla in in"],
    "ine": ["mollit", "non in", "dolore in", "esse do pariatur"]
  }
}
```
...
```json
{
  ...
  "name": "P1",
  "supplier_part_numbers": {
    "dolor_6": ["consequat minim pariatur"],
    "laboreed": ["ut nulla incididunt", "ullamco"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "id nostrud deserunt non",
    "sunt",
    "Duis ut",
    "irure"
  ],
  "connected_source_net_ids": ["amet do ullamco sed", "aliqua"]
}
```
...
```json
{
  ...
  "message": "deserunt adipisicing cupidatat dolore"
}
```
...
```json
{
  ...
  "message": "aute ea minim Lorem adipisicing"
}
```
...
```json
{
  ...
  "message": "ut aliqua mollit ad ex",
...
```json
{
  ...
  "radius_x": -60141537.789639086,
  "radius_y": "irure consectetur",
  "layer": "top"
}
```
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "nisia__": ["anim in aliquip est id", "est nisi"],
    "eiusmod03": ["sunt enim elit et"],
    "dolore7": ["laborum in in est", "Ut proident mollit"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": 65541249.016135305
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "dolor enim consequat"
  },
  "layer": "top",
  "footprinter_string": "sint in ad est deserunt",
  "model_obj_url": "reprehenderit fugiat minim elit",
  "model_stl_url": "elit sunt",
  "model_3mf_url": "qui eu",
  "model_jscad": []
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 20212809.72113529,
  "outer_height": 72379675.00517955,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
