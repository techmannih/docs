...
```json
{
  ...
  "supplier_part_numbers": {
    "non6": [
      "fugiat",
      "Excepteur aute",
      "ea consectetur incididunt aliqua voluptate",
      "tempor eu eiusmod cupidatat ea"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "qui officia incididunt labore",
  "supplier_part_numbers": {
    "dolor7da": ["sit occaecat labore", "elit aliquip aliqua do"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "pariatur mollit ad ipsum esse",
  "supplier_part_numbers": {
    "sed9": ["quis velit culpa magna"],
    "culpa_": ["Lorem", "est sit", "est mollit", "in"],
    "dolor_7d": ["minim", "adipisicing eiusmod et dolor anim"],
    "voluptatee": [
      "quis",
      "dolore fugiat",
      "consequat",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "non aliqua"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "veniam tempor Ut",
  "supplier_part_numbers": {
    "dolor42": [],
    "animdd1": ["nulla proident ut labore"],
    "id_c93": ["elit"],
    "dolor_733": [
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "Ut Duis",
  "supplier_part_numbers": {
    "quis_70": ["consectetur minim"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "enim pariatur magna",
  "supplier_part_numbers": {
    "aliquip__f": ["reprehenderit", "velit nulla dolor anim esse"],
    "suntb_": ["et"],
    "do8c1": [
      "tempor cillum aliqua",
      "mollit sunt ut consectetur qui",
      "dolore ea consequat consectetur velit",
      "cillum"
    ]
  },
  "voltage": "5V"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "dolor pariatur fugiat",
  "supplier_part_numbers": {
    "qui_1": ["esse aute in Duis ipsum", "dolor"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "quis sint veniam amet",
    "incididunt commodo Lorem do",
    "elit labore irure ad aliquip",
    "Excepteur",
    "eu dolore non ipsum cillum"
  ],
...
```json
{
  ...
  "message": "aliquip ad qui commodo et"
}
```
...
```json
{
  ...
  "message": "sint mollit incididunt dolore ullamco",
...
```json
{
  ...
  "message": "in veniam consequat do",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "cupidatat aliquip dolor ut"
  },
  "model_stl_url": "ad qui commodo ex"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "occaecat ullamco laborum do"
}
```
...
{
  "exercitation_f71": {
    "left_margin": "cupidatat sed in qui laboris",
    "right_margin": 75071033.06835735,
    "top_margin": "esse officia incididunt"
  },
  "sed_ae": {
    "left_margin": "magna",
    "right_margin": "est sunt",
    "top_margin": "minim elit ut mollit",
    "bottom_margin": -30312296.70065278
  }
}
```
