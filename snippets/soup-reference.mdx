...
```json
{
  ...
  "member_source_group_ids": [
    "tempor esse",
    "anim in quis",
    "proident ea sunt ut Excepteur",
    "nisi velit ea aliquip exercitation",
    "deserunt"
  ],
  "is_power": false,
  "is_ground": false,
...
```json
{
  ...
  "supplier_part_numbers": {
    "cillum__a": [
      ...
      "minim quis Duis",
      "consequat pariatur eiusmod culpa",
      "adipisicing occaecat officia"
    ],
    "dolor_": [
      "nisi Lorem in",
      "veniam",
      "irure officia ad minim",
      "anim",
      "sit ipsum ut"
    ],
    "minim32": ["laboris aute dolor"]
  }
}
```
...
```json
{
  ...
  "name": "D1",
  "supplier_part_numbers": {
    "Duis8": ["est Ut", "Excepteur dolor commodo", "est et nisi"]
  }
}
```
...
```json
{
  ...
  "name": "G1",
  "supplier_part_numbers": {
    "pariature4": ["Duis aute exercitation nisi", "magna Lorem"],
    "magna2a0": ["incididunt"],
    "ad_6a3": ["fugiat ad culpa"],
    "incididunt_33": ["enim nostrud", "ut"],
    "fugiat3d1": ["mollit nisi voluptate", "veniam enim occaecat velit in"]
  }
}
```
...
```json
{
  ...
  "name": "P1",
  "supplier_part_numbers": {
    "fugiat_1a": ["veniam dolor adipisicing Duis", "magna sit minim dolor"],
    "iruree": [
      "consectetur mollit",
      "id",
      "nulla nisi aliquip",
      "qui consequat mollit Duis ut",
      "est"
    ]
  },
  "voltage": "5V"
...
```json
{
  ...
  "name": "R1",
  "supplier_part_numbers": {
    "qui_acb": ["id anim elit", "cillum ut ut consequat exercitation"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["exercitation"],
  "connected_source_net_ids": [
    "do commodo",
    "in do veniam sint occaecat",
    "sint",
    "eu id magna",
    "voluptate aute"
  ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -13556046.128447011,
  "box_width": 45805631.69281727,
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "magna aliqua minim fugiat"
}
```
...
```json
{
  ...
  "radius_x": "dolore voluptate",
  "radius_y": "cupidatat qui magna mollit",
  "layer": "top"
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "ullamco laboris aliqua dolore labore",
  "model_obj_url": "consequat exercitation consectetur",
  "model_stl_url": "Lorem dolore",
  "model_3mf_url": "et voluptate Ut Duis",
  "model_jscad": []
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "cillum in adipisicing sint ut"
}
```
