...
```json
{
  ...
  "ftype": "fugiat labore ea non laborum",
  "source_component_id": "source_component_1",
  "name": "F1",
  "manufacturer_part_number": "pariatur eu",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "tempor do enim in pariatur"
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["consectetur", "eiusmod consequat labore nulla"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "dolore deserunt",
  "supplier_part_numbers": {
    "sed_97e": [
      "sint deserunt",
      "Ut",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "quis veniam aute Ut voluptate",
  "supplier_part_numbers": {
    "culpa1": ["nostrud", "sed", "dolore exercitation"],
    "proident_5_": [
      "occaecat culpa nisi",
      "ut quis",
      "cupidatat sed dolor laboris"
    ],
    "mollit_8d": [
      "exercitation sed cillum",
      "Excepteur incididunt et",
      "in dolor dolore nostrud",
      "eu minim dolor",
      "occaecat ea qui dolore nisi"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "occaecat enim aliqua sint dolor",
  "supplier_part_numbers": {
    "dolore_8c6": ["dolore qui irure exercitation"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "voluptate amet deserunt commodo anim",
  "supplier_part_numbers": {
    "esse_43": [
      "in incididunt voluptate",
      "mollit velit sunt consequat est",
      "consectetur ut aute cupidatat",
      "minim non consequat",
      "nostrud officia"
    ],
    "aliqua0": ["ad ea dolore Lorem"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "consectetur velit",
  "supplier_part_numbers": {
    "tempor87": [
      "dolor",
      "culpa labore mollit commodo",
      "aliquip minim commodo pariatur"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "ea pariatur ad nostrud esse",
    "Excepteur ut ad commodo consectetur",
    "cillum culpa esse laboris",
    "officia id",
    "labore cillum Duis proident"
  ],
  "connected_source_net_ids": ["pariatur proident sint"]
}
```
...
```json
{
  ...
  "radius_x": 57098223.16876063,
  "radius_y": "consequat ullamco",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "nulla Excepteur sint reprehenderit dolore",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
  ...
  "route": [
    {
      ...
      "y": "1mm",
      "to_layer": "bottom",
      "trace_width": "dolor dolor pariatur tempor id"
    }
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "incididunt non"
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "est",
  "model_obj_url": "anim ut eu",
  "model_stl_url": "reprehenderit sint ut ipsum",
  "model_3mf_url": "proident",
  "model_jscad": {}
}
```
...
{
  "minim_78c": {
    "left_margin": 32448275.910045236,
    "right_margin": -911089.2289053053,
    "top_margin": 45886689.6566357,
    "bottom_margin": "minim laborum labore"
  },
  "nisia4_": {}
}
```
