...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "tempor dolore fugiat",
  "supplier_part_numbers": {
    "voluptated7": [],
    "ut_b5": [
      "velit adipisicing dolor officia Excepteur",
      "Ut cupidatat cillum non",
      "et consectetur in amet"
    ]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "exercitation incididunt fugiat pariatur",
    "dolore aliquip esse commodo pariatur",
    "nulla"
  ],
  "is_power": true,
  "is_ground": true,
  ...
  "trace_width": -39937882.126596145
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "ut officia nisi Excepteur",
  "supplier_part_numbers": {
    "elit7": ["aliquip id laboris sint ea", "do occaecat Ut"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "exercitation laborum commodo labore",
  "supplier_part_numbers": {
    "culpa12": [],
    "pariaturb8": [],
    "consectetur_25": ["aliquip et culpa dolor", "pariatur veniam ullamco"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "esse voluptate",
  "supplier_part_numbers": {
    "amet7": [
      "ad eiusmod consequat exercitation in",
      "dolore enim deserunt elit laboris",
      "do sint aute consequat",
      "nostrud laborum",
      "exercitation"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "sint in proident",
  "supplier_part_numbers": {
    "in_d": ["dolor aute", "quis reprehenderit"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "dolore ut ipsum eu incididunt",
  "pin_styles": {},
  "box_width": "aliqua amet",
  "symbol_name": "sit in sint",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "message": "enim deserunt ut dolore fugiat"
}
```
...
```json
{
  ...
  "message": "officia laboris do cillum sint",
...
```json
{
  ...
  "radius_x": 28624978.57684283,
  "radius_y": "sed nostrud minim officia",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "proident sit",
  "supplier_part_numbers": {
    "ut__": ["ullamco qui", "Duis Lorem consectetur", "aute ad Excepteur qui"],
    "ullamco_db": ["id do sint", "fugiat", "amet", "veniam"]
  }
}
```
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "laborum fugiat occaecat"
  },
  "layer": "top",
  "footprinter_string": "est in ut",
  "model_obj_url": "consectetur in consequat ex et",
  "model_stl_url": "Duis cillum laborum",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "dolore Excepteur nulla amet"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 94211357.44426179,
  "outer_height": 47236336.26540753,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "sit ut exercitation deserunt in"
}
```
...
{
  "utcfb": {
    "left_margin": "dolor enim dolore cupidatat labore",
    "right_margin": "cupidatat consequat irure",
    "top_margin": "exercitation pariatur amet"
  }
}
```
