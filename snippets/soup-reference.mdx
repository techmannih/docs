...
```json
{
  ...
  "ftype": "dolor Excepteur eu adipisicing anim",
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "anim in",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "reprehenderit occaecat et",
  "supplier_part_numbers": {
    "eiusmodc": [
      "adipisicing anim reprehenderit",
      "laboris tempor Ut",
      "Lorem",
      "Duis",
      "adipisicing"
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["dolor anim", "tempor in dolor ut"],
  "is_power": false,
  "is_ground": false,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "dolore eu labore in incididunt",
  "supplier_part_numbers": {
    "esse_785": [
      "nostrud aute fugiat",
      "dolor",
      "incididunt dolore aute ut sunt"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "amet anim exercitation aliquip magna",
  "supplier_part_numbers": {
    "sed_b9a": ["voluptate amet", "nulla"],
    "utd09": [],
    "dolore_b29": [
      "ut",
      "tempor et enim",
      "irure pariatur ex cillum",
      "adipisicing ut",
      "aute nulla exercitation nostrud cillum"
    ],
    "ut80": [
      "commodo est",
      "ut sunt nostrud",
    ...
    "est_a6_": [
      "adipisicing nisi sit commodo Lorem",
      "irure anim dolore Duis mollit"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "qui sed esse elit incididunt",
  "supplier_part_numbers": {
    "commodo287": [],
    "Excepteur_22": [
      "Ut quis nulla Excepteur",
      "do labore elit consectetur",
      "ullamco reprehenderit nulla sit",
      "eu qui"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "do proident sint esse",
  "supplier_part_numbers": {
    "voluptatea": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "id proident culpa pariatur nostrud",
  "supplier_part_numbers": {
    "sint_b4": ["ex quis elit sit anim", "incididunt pariatur"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "ea eiusmod",
  "supplier_part_numbers": {
    "estd9": [
      "exercitation",
      "minim proident aliqua incididunt",
      "adipisicing consectetur Excepteur reprehenderit",
      "mollit Lorem",
      "dolor enim mollit sit Duis"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "ut reprehenderit ex velit sit",
  "supplier_part_numbers": {
    "esse_36f": ["proident id veniam laboris aute"],
    "aliquip__d1": []
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "minim Lorem eu laboris proident",
    "exercitation culpa in proident in",
    "cupidatat aute eu nulla"
  ],
  "connected_source_net_ids": [
    "minim sunt laboris in sed",
    "minim id est adipisicing ex"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 70093743.16241553,
  "pin_styles": {},
  "box_width": "enim sunt exercitation",
  "symbol_name": "dolore nisi ea magna",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "cupidatat mollit eu culpa elit"
}
```
...
```json
{
  ...
  "message": "dolore ex labore dolor"
}
```
...
```json
{
  ...
  "radius_x": 4196134.925689772,
  "radius_y": "cupidatat voluptate",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "elit occaecat mollit cupidatat dolor",
  "supplier_part_numbers": {
    "cupidatat_bd7": [
      "aliqua non ipsum commodo",
      "est non",
      "et",
      "cupidatat ullamco reprehenderit"
    ],
    "exercitation_7": [],
    "dolor_0c": ["labore do", "amet", "adipisicing nisi Lorem"],
    "ipsum_7": [],
    "laborum_19": ["ullamco et est ut dolore", "aute exercitation"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "ut reprehenderit ullamco et dolore"
  },
  "rotation": "90deg",
  "layer": "top",
  "footprinter_string": "ad cupidatat pariatur nisi occaecat",
  "model_obj_url": "nulla cupidatat ipsum",
  "model_stl_url": "adipisicing officia cillum dolore",
  "model_3mf_url": "veniam nostrud id",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": 10340506.472782567
}
```
...
```json
{
  "officia_d": {
    "left_margin": "aute",
    "right_margin": -77488908.53839904,
    "bottom_margin": "laboris dolore ut deserunt"
  }
}
```
