...
```json
{
  ...
  "ftype": "ex minim tempor",
  "source_component_id": "source_component_1",
  "name": "E1",
  "manufacturer_part_number": "nulla incididunt",
  "supplier_part_numbers": {
    "ad7d0": [
      "minim aliqua commodo",
      "occaecat proident dolore enim incididunt",
      "in proident",
      "ut deserunt sunt",
      "ipsum"
    ],
    "proident9_0": ["culpa", "sint", "in et", "in ut"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "esse ea Excepteur",
  "supplier_part_numbers": {
    "Duis99c": [],
    "in9e": ["tempor id velit consectetur aute"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["ad", "Lorem sint"],
  "is_ground": false,
  "is_digital_signal": false,
  "is_analog_signal": true,
  "trace_width": 67928315.68109587
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "anim ipsum irure ex mollit",
  "supplier_part_numbers": {
    "quis_6e": [],
    "incididunt_3a": [
      "est proident elit sint ullamco",
      "esse sed eu id",
      "anim Lorem proident"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "dolor cupidatat",
  "supplier_part_numbers": {
    "quis_c0": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "officia sint",
  "supplier_part_numbers": {
    "irure4": [
      "Lorem qui laboris nulla",
      "nisi eiusmod dolor ad qui",
      "ut",
      "culpa sit adipisicing qui"
    ],
    "ea_03": ["veniam exercitation", "labore elit in minim"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "officia magna",
  "supplier_part_numbers": {
    "commodo_35": [],
    "idf": [
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "incididunt nulla voluptate dolore",
  "supplier_part_numbers": {
    "ut7b2": ["in", "qui dolore consectetur consequat aliqua", "in", "aliqua"],
    "enim_a8": ["qui reprehenderit voluptate", "occaecat ut Ut in"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "pariatur sed enim ullamco",
  "supplier_part_numbers": {
    "magnae3": []
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": [
    "sit aliquip sint",
    "quis est non nulla cupidatat"
  ],
  "connected_source_net_ids": ["nostrud exercitation"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "velit enim sit",
  "pin_styles": {},
  "box_width": "do enim qui dolore consequat",
  "symbol_name": "elit",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "message": "Duis quis Ut consequat sunt"
}
```
...
```json
{
  ...
  "radius_x": "proident mollit in consectetur exercitation",
  "radius_y": "veniam eu Excepteur",
  "layer": "top"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "eiusmod_3": [
      "deserunt tempor dolor adipisicing",
      "consectetur enim aliqua amet",
      "labore adipisicing commodo nisi",
      "in in consequat proident"
    ],
    "consectetur1_": [
      "voluptate incididunt mollit",
      "est ut pariatur laborum magna"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "magna nisi irure",
  "model_obj_url": "deserunt",
  "model_stl_url": "elit",
  "model_3mf_url": "adipisicing non commodo laboris",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -98327197.62985551,
  "outer_height": -89325006.94859025,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "y": "1mm",
  "to_layer": "bottom",
  "trace_width": "incididunt irure ut exercitation ad"
}
```
...
{
  "occaecatc43": {
    "left_margin": -21039525.475474626,
    "top_margin": -7300907.23845835
  },
  "amet_28e": {
    "right_margin": -3314504.3408598304,
    "bottom_margin": "consequat"
  },
  "dolor563": {
    "left_margin": "consectetur dolor",
    "right_margin": "Excepteur dolore enim",
    "top_margin": "tempor ipsum",
    "bottom_margin": "est in dolore proident ipsum"
  }
}
```
