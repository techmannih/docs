...
```json
{
  ...
  "ftype": "exercitation aute reprehenderit",
  ...
  "supplier_part_numbers": {
    "irure1": [
      "id anim Lorem",
      "nisi do dolor sit",
      "eiusmod ipsum eu cillum exercitation"
    ],
    "Lorem_4b": [
      "elit Duis ex magna",
      "do Duis officia Excepteur",
      "irure quis labore",
      "id sunt dolor in in"
    ]
  }
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["commodo ea non amet"],
  "is_power": true,
  "is_ground": false,
...
```json
{
  ...
  "supplier_part_numbers": {
    "irure_ae8": [
      "laborum",
      "proident tempor reprehenderit in",
...
```json
{
  ...
  "supplier_part_numbers": {
    "aliqua0_": [
      "dolor in voluptate",
      "cupidatat in sit qui",
      "sed proident in",
      "Lorem"
    ],
    "enim_584": [
      "exercitation culpa",
      "et minim aliquip cupidatat cillum",
      "esse mollit dolore Duis nisi",
      "labore adipisicing nulla ipsum"
    ],
    "fugiat46": ["ut magna ipsum", "id pariatur ad", "in exercitation"],
    "cupidatat_0": ["magna"]
  }
}
```
...
```json
{
  ...
  "name": "P1",
  "supplier_part_numbers": {
    "dolor2": ["pariatur nulla dolor", "amet et velit"],
    "id5": [
      "ex",
      "nisi anim incididunt sed reprehenderit",
      "tempor consectetur fugiat voluptate",
      "in eiusmod Duis Lorem id"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "name": "R1",
  "supplier_part_numbers": {
    "proidenta8f": ["officia proident", "id in laborum nisi pariatur"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "sed cupidatat Excepteur nisi ullamco",
    "dolor",
    "nulla velit minim quis"
  ],
  "connected_source_net_ids": ["exercitation in nulla"]
}
```
...
```json
{
  ...
  "radius_x": "tempor magna sed",
  "radius_y": 57780360.62664315,
  "layer": "top"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "irure3f": ["dolore ut"],
    "ea92b": ["nisi ut", "nulla ea elit cillum est", "aute ut"]
  }
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "elit eu Excepteur consequat quis"
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
  ...
  "layer": "top",
  "footprinter_string": "laborum ullamco Excepteur dolore irure",
  "model_obj_url": "nostrud pariatur",
  "model_stl_url": "enim sit",
  "model_3mf_url": "esse",
  "model_jscad": []
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -15093047.404034272,
  "outer_height": 73369121.23076415,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
