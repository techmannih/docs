...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "do dolore dolor",
  "supplier_part_numbers": {
    "aliqua_2": ["ex in pariatur Duis", "culpa"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["exercitation ea do veniam in"],
  "is_power": true,
  "is_ground": false,
  "is_digital_signal": false,
  "is_analog_signal": false,
  "trace_width": -52180048.5997173
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "minim Ut sunt",
  "supplier_part_numbers": {
    "dolor_5": [
      "ullamco laborum et",
      "enim aute do eiusmod ipsum",
      "enim ut",
      "nisi incididunt qui",
      "adipisicing"
    ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "sunt est laborum non officia",
  "supplier_part_numbers": {
    "esse_2b": ["in", "do in non irure", "pariatur commodo cupidatat"],
    "esse3": [
    ...
    "fugiat__e": ["exercitation", "magna nostrud velit"],
    "adc": [
      "qui",
      "Lorem consequat cillum velit",
      "culpa dolor laboris",
      "sunt enim dolore"
    ],
    "non_f0": ["nostrud officia"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "officia ut eu mollit laboris",
  "supplier_part_numbers": {
    "sint2__": [
      "elit dolor in",
      "proident incididunt",
      "consectetur nostrud ea",
      "sed elit dolore sint"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "elit commodo mollit et",
  "supplier_part_numbers": {
    "adc5": [
      "magna tempor",
      "mollit consectetur ex",
      "culpa ut quis Excepteur",
      "aute occaecat fugiat consectetur"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": ["incididunt dolore labore ipsum"],
  "connected_source_net_ids": [
    "esse velit eiusmod sunt",
    "minim ad reprehenderit aliquip"
  ]
}
```
...
```json
{
  ...
  "pin_spacing": "aute",
  "pin_styles": {},
  "box_width": "in reprehenderit dolor adipisicing laboris",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "route": [
    ...
    },
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": 20559276.646710828
    },
    {
      "x": "3mm",
      "y": "1mm",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "fugiat id dolor officia dolore",
  "supplier_part_numbers": {
    "Ute3": [
      "fugiat aute veniam",
      "quis deserunt aliquip velit aute",
      "cillum veniam",
      "et labore Ut aute"
    ],
    "tempor25": [
      "qui eu",
      "in Excepteur culpa adipisicing eiusmod",
      "culpa deserunt et",
      "mollit nulla",
      "ullamco"
    ]
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "ex deserunt Excepteur consectetur irure"
  }
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "dolore non cupidatat culpa"
}
```
...
```json
{
  ...
  "via": false,
  "to_layer": "bottom",
  "trace_width": 13303844.735991806
}
```
...
{
  "nullab4": {
    "bottom_margin": 64291117.836752355
  },
  "aliquip_6": {
    "left_margin": "velit officia",
    "top_margin": "ex velit aute",
    "bottom_margin": 20169735.825961515
  },
  "occaecat0": {
    "left_margin": 88508992.0738996,
    "right_margin": -54997434.781485,
    "top_margin": 23161130.076624796,
    "bottom_margin": "ipsum"
  }
}
```
