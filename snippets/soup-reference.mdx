...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "irure tempor consequat",
  "supplier_part_numbers": {
    "cillum_a3": [
      "exercitation ex Lorem non dolor",
      "dolor occaecat velit consequat",
      "sint pariatur",
      "exercitation ea in",
      "consequat mollit"
    ]
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["anim Ut id", "veniam quis aliqua eu"],
  "is_power": false,
  "is_ground": false,
  "is_digital_signal": false,
  "is_analog_signal": false,
  "trace_width": 89512154.24321797
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "enim proident Duis",
  "supplier_part_numbers": {
    "tempor_00f": ["ad sunt", "aliqua commodo"],
    "culpafb": [
      "ut in ad et ut",
      "laboris mollit",
      "aute irure ipsum sint cillum"
    ],
    "ut52": ["ut", "veniam velit", "reprehenderit"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "laborum non Duis Excepteur",
  "supplier_part_numbers": {
    "voluptate_7_": ["consequat", "occaecat commodo tempor officia cillum"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "qui dolore do laborum esse",
  "supplier_part_numbers": {
    "nisi85": [
      "labore dolor proident exercitation veniam",
      "Excepteur Duis proident",
      "nulla eu",
      "enim Excepteur magna"
    ],
    "nostrude": ["reprehenderit Ut", "ea enim incididunt esse veniam"],
    "tempor1d4": ["ut mollit id in ea", "tempor dolor", "cillum"],
    "amet_a16": ["voluptate eu elit est"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "irure Ut deserunt occaecat quis",
  "supplier_part_numbers": {
    "velitc": [
      "nulla dolor id sunt aute",
      "sunt ea laboris quis reprehenderit",
      "in cupidatat",
      "cillum dolor sunt deserunt"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolor_f96": [
      "id nulla magna",
      "ex aute qui elit fugiat",
      "enim eu laborum anim",
      "esse minim"
    ],
    "essea": ["Lorem magna occaecat"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["fugiat dolore nostrud quis aute", "in id"],
  "connected_source_net_ids": ["consequat anim", "eu", "ullamco laboris"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "adipisicing nulla sed dolore ipsum",
  "box_width": -7740725.816131234,
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "esse nulla id aliquip enim",
...
```json
{
  ...
  "radius_x": "officia commodo",
  "radius_y": "dolore reprehenderit ex aliquip exercitation",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "incididunt ut Excepteur veniam anim",
  "supplier_part_numbers": {
    "sit_de8": ["ullamco aliquip nisi laboris ut", "pariatur"],
    "velit_5e": ["laborum sit in culpa", "culpa"]
  }
}
```
...
```json
{
  ...
  "rotation": "90deg",
  "layer": "top",
  "model_stl_url": "enim incididunt id anim"
}
```
