...
```json
{
  ...
  "ftype": "aliqua cillum eu nisi magna",
  "source_component_id": "source_component_1",
  "name": "A1",
  "manufacturer_part_number": "adipisicing nulla aute Lorem est",
  "supplier_part_numbers": {
    "esse_a": [
      "nulla ipsum",
      "nulla id",
      "Excepteur ipsum ut laboris",
      "id magna",
      "anim ex Ut"
    ],
    "irure38_": ["Excepteur fugiat eu in", "laboris", "do enim", "ea deserunt"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "cillum ea dolore nisi consequat",
  "supplier_part_numbers": {
    "ut6": ["eu Lorem aliquip sed officia"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["officia id in"],
  "is_power": false
}
```
...
```json
{
  ...
  "name": "B1",
  "supplier_part_numbers": {
    "doloree": ["incididunt consectetur dolore ea"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "officia incididunt"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ea8": [
      "commodo mollit consequat Excepteur minim",
      "ea Ut Lorem",
      "dolor eiusmod aute",
      "quis laboris ipsum ut"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "incididunt_9c": [
      "elit proident sunt ullamco ipsum",
      "nostrud laboris cupidatat adipisicing incididunt",
      "velit ea elit",
      "sit nostrud nisi ad incididunt",
      "sed consectetur velit Lorem"
    ],
    "dolor2": ["elit aliquip", "proident aliqua non"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "elit labore ullamco",
    "consequat ad quis id nulla",
    "irure"
  ],
  "connected_source_net_ids": ["Excepteur proident ad elit"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -98764295.01546498,
  "pin_styles": {},
  "box_width": "pariatur cillum ipsum",
  "symbol_name": "culpa anim veniam qui",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "color": "eiusmod esse occaecat deserunt"
}
```
...
```json
{
  ...
  "message": "dolor aliquip ullamco amet"
}
```
...
```json
{
  ...
  "message": "sit nostrud laborum id Lorem",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
  ...
  "route": [
    {
      "x": "3mm",
      "y": "1mm",
      "trace_width": "magna pariatur Excepteur exercitation"
    },
    {
      "x": "3mm",
      "y": "1mm",
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolor_b5": ["Ut do", "ea", "dolore irure dolor aute fugiat"],
    "ea7ef": ["reprehenderit", "reprehenderit sint deserunt non et"],
    "commodo_3": ["in ipsum dolore irure"]
  }
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "reprehenderit commodo in ut id"
  },
  "rotation": "90deg",
  "layer": "top"
}
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "Excepteur Duis Lorem"
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "reprehenderit aliquip ad do exercitation"
}
```
...
{
  "sint_69": {
    "right_margin": -66642978.416234344,
    "bottom_margin": "ullamco et enim"
  }
}
```
