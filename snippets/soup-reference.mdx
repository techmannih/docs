...
```json
{
  ...
  "name": "C1",
  "manufacturer_part_number": "exercitation aute",
  "supplier_part_numbers": {
    "magnac": ["aute irure fugiat id non"],
    "ina": [
      "elit dolore nostrud",
      "officia ullamco mollit Ut sunt",
      "velit est"
    ],
    "esse_1": ["fugiat sit", "ut in aliqua", "sed est"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "tempor sint velit et",
  "supplier_part_numbers": {
    "ad_df3": ["laboris labore ex eu irure"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    ...
    "aliqua",
    "ea laboris",
    "ut esse aliquip in culpa"
  ],
  "is_power": false,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": false,
  "trace_width": 18736888.238336176
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "tempor_7": [
      "dolor",
      "est magna proident Ut",
      "elit consequat",
      "aliquip dolor commodo ex"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "Ut sint sit adipisicing elit",
  "supplier_part_numbers": {
    "dolor57": [
      "Ut incididunt nostrud dolor laboris",
      "nostrud Duis esse exercitation nisi",
      "ullamco",
      "minim laborum enim sint",
      "Excepteur"
    ],
    "officia0": ["in minim ea", "sunt ad fugiat", "aute Ut"],
    "et9": ["irure minim dolor ut"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "nulla deserunt dolore in eu",
  "supplier_part_numbers": {
    "sunt5": [
      "ex elit Ut",
      "nulla",
      "mollit qui in irure incididunt",
      "nostrud laboris exercitation eiusmod nulla"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "amet eu do magna ipsum",
  "supplier_part_numbers": {
    "irure59": ["anim", "sint Excepteur elit fugiat eiusmod"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "esse_9": [
      "magna in",
      "officia veniam est",
      "sint sed sit veniam cillum",
      "ut ut culpa nostrud sint",
      "consectetur cillum Duis"
    ],
    "veniam92_": ["veniam elit adipisicing est esse", "deserunt qui", "id"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "pariatur cupidatat nulla Excepteur",
  "supplier_part_numbers": {
    "reprehenderit4": [
      "minim",
      "Ut dolore aliquip occaecat",
      "cillum nostrud ex nisi"
    ],
    "in_7d": ["commodo eiusmod incididunt veniam"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "esse dolore",
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["adipisicing ea anim exercitation"],
  "connected_source_net_ids": [
    "ex Excepteur ullamco adipisicing",
    "dolore labore magna",
    "culpa officia aute magna veniam",
    "cillum"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 89693290.23714864,
  "pin_styles": {},
  "box_width": -48856100.3206589,
  "symbol_name": "aliquip qui",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "do consectetur ut dolore cillum"
}
```
...
```json
{
  ...
  "radius_x": "magna",
  "radius_y": "labore sint tempor minim",
  "layer": "top"
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "proident",
  "model_obj_url": "Duis officia exercitation Excepteur",
  "model_stl_url": "fugiat proident anim",
  "model_3mf_url": "laboris ex",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 4023407.9593851864,
  "outer_height": 61654885.391669154,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "sint_49": {
    "left_margin": -59077193.80353344,
    "right_margin": -95791821.55375077,
    "top_margin": 21251539.11606677,
    "bottom_margin": "veniam nulla"
  },
  "autec6": {
    "left_margin": -7123756.585293427
  },
  "officia_fb": {
    "left_margin": -27044584.697071135,
    "bottom_margin": "aliqua amet et laborum"
  }
}
```
