...
```json
{
  ...
  "name": "A1",
  "manufacturer_part_number": "cillum elit qui tempor proident",
  "supplier_part_numbers": {
    "esse_330": [
      "dolor nulla qui eu",
      "voluptate exercitation incididunt nostrud id",
      "Lorem",
      "cillum est nisi dolor",
      "est"
    ],
    "non__7c": [
      "fugiat",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "labore fugiat minim sit qui"
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["sunt"],
  "is_power": false,
  "is_ground": true,
  "is_digital_signal": false,
  "is_analog_signal": false,
  "trace_width": -14215005.978758514
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "dolore eiusmod Lorem consequat",
  "supplier_part_numbers": {
    "sit_55b": ["do voluptate pariatur in"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "sunt_e5": ["culpa", "esse id Duis dolor in", "Duis pariatur officia sit"],
    "est46_": ["eu", "ut"],
    "cillum9": ["mollit deserunt nulla est"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "qui consectetur",
  "supplier_part_numbers": {
    "exercitation_a4": ["mollit", "elit laborum", "Lorem occaecat anim qui"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "proident consequat in in",
  "supplier_part_numbers": {
    "ad_3": [
      "aliqua veniam",
      "deserunt culpa ex qui",
      "amet non reprehenderit tempor ut"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "non in qui consectetur sunt",
  "supplier_part_numbers": {
    "fugiat_64": [
      "irure reprehenderit minim mollit",
      "qui reprehenderit voluptate",
      "laboris enim et",
      "consectetur",
      "Lorem irure fugiat"
    ]
...
```json
{
  ...
  "name": "P1",
  "supplier_part_numbers": {
    "tempor_e24": ["dolor", "anim in", "officia tempor"],
    "exc1": ["nulla mollit et"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "Excepteur labore ex",
  "supplier_part_numbers": {
    "irure_dc_": [
      "nisi dolore labore ad",
      "sit eu aliqua",
      "dolore in sit",
      "anim laborum"
    ]
...
```json
{
  ...
  "connected_source_port_ids": [
    "Lorem eu",
    "ut veniam officia quis dolore",
    "tempor ea",
    "exercitation qui dolor elit",
    "consectetur"
  ],
  "connected_source_net_ids": [
    "fugiat deserunt",
    "velit occaecat ex enim nisi",
    "cupidatat",
    "pariatur irure ea",
    "qui sunt amet ex"
  ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "id cillum officia amet aliquip",
  "pin_styles": {},
  "box_width": "minim elit",
  "symbol_name": "cupidatat esse",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "incididunt adipisicing laboris"
}
```
...
```json
{
  ...
  "radius_x": "ut culpa proident ut",
  "radius_y": -33043340.93330095,
  "layer": "top"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "do_19": [
      "incididunt amet",
      "cupidatat est",
      "eiusmod Duis aliqua nostrud",
      "nisi laboris anim nulla ea"
    ],
    "magna_8_d": [
      "amet sit in eu",
      "ut commodo deserunt in ex",
      "quis",
      "enim",
      "nulla sint"
    ],
    "culpaf": ["Excepteur", "aliqua", "sit", "non elit", "dolor culpa"]
  }
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": -53293052.648552045
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "in aute enim aliqua"
  },
  "model_stl_url": "ut",
  "model_3mf_url": "eiusmod sunt dolore Lorem"
}
```
...
```json
{
  ...
  "layer": "top",
  "description": "incididunt dolor in eiusmod esse"
}
```
...
{
  "ad_21_": {
    "left_margin": "ut est laboris mollit",
    "right_margin": 25991258.555757478,
    "top_margin": -81529445.05935383,
    "bottom_margin": "proident aliquip amet culpa ea"
  },
  "Lorem1": {
    "left_margin": "dolor ex laboris Ut laborum",
    "right_margin": "in",
    "top_margin": "sit reprehenderit non",
    "bottom_margin": "in veniam nisi ex"
  },
  "sed04": {
    "left_margin": "adipisicing ut in dolore",
    "right_margin": "eu sit deserunt",
    "bottom_margin": "est consectetur id mollit"
  },
  "id_4": {
    "left_margin": "cupidatat do ipsum dolore in",
    "right_margin": "nulla in anim nisi voluptate",
    "top_margin": 96729528.7411269
  },
  "laborum9": {
    "left_margin": 71643250.22998646,
    "right_margin": -99368667.14070027,
    "top_margin": 53854041.601204336,
    "bottom_margin": "ex"
  }
}
```
