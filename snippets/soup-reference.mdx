...
```json
{
  ...
  "supplier_part_numbers": {
    "consectetur_14": ["adipisicing in sed", "eu ut est"],
    "cupidatat67": [
      "non irure occaecat nostrud consectetur",
      "eu ullamco quis",
      "consectetur dolor labore",
      "eiusmod",
      "officia"
    ]
  }
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["dolore adipisicing", "labore in"],
  "is_power": false,
  "is_ground": false,
...
```json
{
  ...
  "name": "B1",
  "supplier_part_numbers": {
    "ipsume": ["mollit commodo Ut", "et", "ut sed mollit"]
  }
}
```
...
```json
{
  ...
  "name": "D1",
  "supplier_part_numbers": {
    "reprehenderit_60_": ["laborum dolore laboris", "ex aute", "ad consequat"]
  }
}
```
...
```json
{
  ...
  "name": "G1",
  "supplier_part_numbers": {
    "Excepteur8": ["in incididunt sit pariatur commodo", "minim laboris in sit"]
  }
}
```
...
```json
{
  ...
  "name": "R1",
  "supplier_part_numbers": {
    "dolor_7e0": ["quis eu", "in Duis ut elit pariatur"],
    "aliquip_": [
      "Ut laborum",
      "pariatur amet",
      "anim pariatur velit",
      "do cupidatat esse",
      "exercitation sit adipisicing elit"
    ],
    "do_9": [
    ...
    "consectetur_ee": ["in pariatur ex Excepteur mollit"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["anim", "nostrud ut"],
  "connected_source_net_ids": ["Lorem exercitation ea Ut anim"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 96407638.66644418,
  "box_width": "sit esse nostrud ullamco dolor",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "radius_x": "laborum ad sed Lorem Ut",
  "radius_y": -23803153.69717008,
  "layer": "top"
}
```
...
```json
{
  ...
  "name": "B1",
  "supplier_part_numbers": {
    "nonce": ["dolor eiusmod in", "exercitation"],
    "esse4ef": ["fugiat ullamco"]
  }
}
```
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "et aliquip Duis exercitation tempor"
  },
  "model_obj_url": "quis",
  "model_3mf_url": "do irure consequat non",
  "model_jscad": []
}
```
