...
```json
{
  ...
  "ftype": "sed proident id laborum nulla",
  "source_component_id": "source_component_1",
  "name": "S1",
  "manufacturer_part_number": "ad consequat sint amet",
  "supplier_part_numbers": {
    "adipisicing_cd": [
      "sint ut",
      "Duis",
      "in eu consequat ad",
      "velit cillum in commodo"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "ullamco anim cupidatat ut",
  "supplier_part_numbers": {
    "occaecatc8": [
      "laboris sint tempor Ut eu",
      "minim esse nisi velit",
      "nulla mollit consectetur in Lorem",
      "ullamco enim adipisicing ipsum dolor",
      "amet"
    ],
    "minim5": [
      "sint",
      "dolor ipsum elit consequat tempor",
      "commodo dolor ex fugiat dolor"
    ]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "voluptate officia dolor laboris",
    "incididunt quis minim sunt",
    "amet in consectetur veniam ea",
    "dolor aute"
  ],
  "is_power": false,
  "is_ground": false,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "pariatur voluptate id amet",
  "supplier_part_numbers": {
    "nisi1__": [
      "nisi fugiat",
      "aliquip commodo dolor non",
      "in laboris laborum",
      "mollit",
      "aliqua"
    ],
    "quis0d6": ["nostrud laborum"],
    "voluptate_bee": [
      "consectetur ea commodo minim",
      "nulla Ut",
      "ipsum elit ut eu",
      "quis"
    ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "fugiat pariatur amet elit do",
  "supplier_part_numbers": {
    "ad_be": ["ex", "dolor in veniam quis dolor"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "pariatur dolore",
  "supplier_part_numbers": {
    "ut51a": [
      "nostrud",
      "in dolore",
      "sed",
      "mollit commodo id anim",
      "in deserunt magna Duis tempor"
    ],
    "Excepteur_2e": [
      "sit in sint sunt",
      "eiusmod",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "Ut ut Lorem",
  "supplier_part_numbers": {
    "sedc": ["ipsum", "quis Excepteur nostrud ut voluptate"],
    "mollit8": ["velit incididunt cillum"],
    "pariaturc1": ["aliquip occaecat sed Ut ut"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "dolore labore sit commodo",
  "supplier_part_numbers": {
    "velit0c5": [
      "sint ex qui",
      "laboris",
      "voluptate veniam Lorem",
      "quis veniam officia laborum"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "in amet commodo",
  "supplier_part_numbers": {
    "eiusmod_a05": [
      "dolor aliquip irure",
      "aliqua ut",
      "veniam",
      "nisi incididunt",
      "ipsum in deserunt Lorem exercitation"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    ...
    "reprehenderit laboris do mollit in"
  ],
  "connected_source_net_ids": ["anim amet dolor"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 42790343.90389973,
  "box_width": "veniam eiusmod",
  "symbol_name": "cupidatat",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "occaecat esse id dolor"
}
```
...
```json
{
  ...
  "message": "ut reprehenderit veniam",
...
```json
{
  ...
  "message": "in laborum dolor sint fugiat",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
  ...
  "route": [
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": "labore Excepteur mollit anim"
    },
    {
      "x": "3mm",
      "y": "1mm",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "irure Duis ad incididunt labore",
  "supplier_part_numbers": {
    "incididunt54": ["ut"],
    "ad_31": [
      "irure dolore ipsum adipisicing voluptate",
      "officia aliquip sunt",
      "pariatur ad"
    ]
  }
}
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "nostrud in",
  "model_obj_url": "tempor nisi occaecat Lorem",
  "model_stl_url": "sed consectetur velit",
  "model_3mf_url": "officia in consectetur elit",
  "model_jscad": {}
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "reprehenderit aliqua qui consectetur"
}
```
