...
```json
{
  ...
  "name": "E1",
  "manufacturer_part_number": "irure adipisicing ut",
  "supplier_part_numbers": {
    ...
    "cillum__": ["officia fugiat pariatur mollit id", "aute nulla"],
    "laborisc": [
      "enim ea do sit dolore",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "laborum eiusmod",
  "supplier_part_numbers": {
    "veniam0b1": [
      "eu Duis minim",
      "ex fugiat minim dolor",
      "nisi enim minim",
      "commodo ullamco tempor elit amet",
      "in amet laborum"
    ]
  }
}
...
```json
{
  ...
  "member_source_group_ids": [
    "cupidatat magna sed esse",
    "eiusmod",
    "dolore esse nulla nostrud"
  ],
  "is_power": false,
  "is_ground": false,
  "is_digital_signal": false,
  "is_analog_signal": false,
  "trace_width": 37105358.523753196
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "culpa Lorem sed",
  "supplier_part_numbers": {
    "pariature": ["culpa veniam occaecat"],
    "dolor_d8": [
      "nostrud irure laboris quis anim",
      "in minim",
      "quis sint ullamco est"
    ],
    "aliquip_94": [
      "Excepteur nulla",
      "officia incididunt esse est",
      "aute esse ex dolore velit"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "adipisicing_d3": [
      "in",
      "Excepteur magna anim dolore commodo",
      "nulla ullamco dolor Ut",
      "commodo",
      "occaecat laboris consectetur elit Lorem"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "eu deserunt culpa qui",
  "supplier_part_numbers": {
    "ea2": ["enim", "ullamco magna labore"],
    "ex37": ["eu nostrud aliqua in et"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "labore velit dolor",
  "supplier_part_numbers": {
    "sint578": ["dolor deserunt quis", "in eu exercitation laborum non"],
    "nisie42": ["aliqua commodo minim", "culpa"],
    "cupidatat2e": ["officia magna"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "amet officia cupidatat cillum dolor",
  "supplier_part_numbers": {
    "qui_843": [
      "dolore est aliqua voluptate",
      "occaecat",
      "sint deserunt",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "officia aliquip do",
  "supplier_part_numbers": {
    "Ut_82": ["Ut velit"]
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": [
    "cillum dolore pariatur commodo",
    "velit Excepteur",
    "proident quis ipsum fugiat esse"
  ],
  "connected_source_net_ids": [
    "pariatur officia",
    "ut ullamco adipisicing eu pariatur",
    "exercitation ex",
    "in mollit Lorem magna ut"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "qui dolor",
  "pin_styles": {},
  "box_width": "sit culpa Lorem sint",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "message": "esse nulla consectetur dolore"
}
```
...
```json
{
  ...
  "radius_x": -70407318.43570693,
  "radius_y": 74885212.98589602,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "ex qui labore nisi aute",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "deserunt in dolore occaecat",
  "supplier_part_numbers": {
    "aliquip5": [
      "reprehenderit",
      "magna Lorem deserunt ex",
      "nostrud fugiat Ut ea",
      "sit nulla"
    ],
    "deserunt5": ["nisi sed non dolore elit"]
  }
}
```
...
```json
{
  ...
  "rotation": "90deg",
  "layer": "top",
  "footprinter_string": "dolor",
  "model_obj_url": "labore cillum sed voluptate reprehenderit",
  "model_stl_url": "sint ut non pariatur",
  "model_3mf_url": "do Excepteur",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layer": "top",
  "description": "amet consequat cupidatat dolore"
}
```
...
{
  "ipsum_2b": {
    "left_margin": "Duis dolore",
    "right_margin": -60336489.127926506,
    "top_margin": "Excepteur ad",
    "bottom_margin": "adipisicing deserunt"
  }
}
```
