...
```json
{
  ...
  "ftype": "veniam do Duis",
  "source_component_id": "source_component_1",
  "name": "V1",
  "manufacturer_part_number": "dolor consectetur aliqua fugiat eu",
  "supplier_part_numbers": {
    "cupidatat_d": [
      "occaecat ullamco incididunt dolor ad",
      "eu dolor velit elit exercitation",
      "dolor ipsum aliqua magna sit",
      "veniam aliquip irure aute",
      "occaecat aute laboris"
    ],
    "euc8": [],
    "incididunt8f": [
      "laborum tempor sint Duis consequat",
      "mollit cupidatat id",
      "laborum eu dolor",
      "ut voluptate sed et exercitation",
      "velit deserunt"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "Excepteur_3": [
      ...
      "irure elit non",
      "occaecat ut cupidatat veniam"
    ],
    "et__a": [
      "Lorem minim voluptate Excepteur",
      "minim Lorem nostrud tempor labore",
      "dolore do voluptate non",
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["Lorem cillum", "irure"],
  "is_power": true,
  "is_ground": true,
  "is_digital_signal": false,
  "is_analog_signal": true,
  "trace_width": 68209370.9544065
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "velit qui aliqua exercitation fugiat",
  "supplier_part_numbers": {
    "elit_bfe": [
      "et reprehenderit",
      "nisi",
      "cupidatat in reprehenderit enim",
      "adipisicing in Excepteur velit",
      "Lorem"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "qui",
  "supplier_part_numbers": {
    "eud2": ["cillum in", "mollit fugiat in sunt", "ipsum aliquip"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "ad exercitation incididunt ex dolore",
  "supplier_part_numbers": {
    "culpaae": [
      "elit aliquip",
      "voluptate culpa amet",
      "cupidatat dolor nulla enim qui",
      "Ut aliquip aute laborum",
      "esse nostrud quis"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "nostrud mollit esse ut occaecat",
  "supplier_part_numbers": {
    "sint8a3": ["in ut fugiat dolore enim"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "eu sint do laboris proident",
  "supplier_part_numbers": {
    "quis_df": [
      "nulla",
      "ut commodo quis enim",
      "id dolor",
      "Excepteur adipisicing sint sit",
      "sint ipsum"
    ],
    "sunt6": [
      "proident labore sunt dolor aute",
      "dolor Duis occaecat fugiat nostrud",
      "exercitation Lorem",
      "enim",
      "dolore sint qui esse"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "name": "R1",
  "supplier_part_numbers": {
    "pariatur50c": ["laboris nulla magna id", "ad"],
    "incididunt8": ["minim ipsum", "sint ipsum"],
    "elit_53": ["in mollit"]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": ["irure", "laborum occaecat"],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 62561692.24074343,
  "pin_styles": {},
  "box_width": "fugiat officia eiusmod aliquip",
  "symbol_name": "nisi dolore mollit pariatur voluptate",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "message": "officia pariatur et deserunt labore"
}
```
  ...
  "route": [
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": 41447072.689282686
    },
    {
      "x": "3mm",
      "y": "1mm",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "adipisicing cillum",
  "supplier_part_numbers": {
    "ipsuma9": [
      "anim ex fugiat ullamco",
      "mollit nostrud ad",
      "enim laboris elit nulla Lorem",
      "incididunt",
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "fugiat irure anim Duis nisi"
  },
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "cupidatat mollit Lorem sed"
  },
  "layer": "top",
  "footprinter_string": "enim officia laboris reprehenderit",
  "model_obj_url": "Duis id ipsum",
  "model_stl_url": "occaecat id",
  "model_3mf_url": "laborum ad ex"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "commodo in deserunt"
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "minim veniam sunt culpa magna"
}
```
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": "irure dolor fugiat tempor sed"
}
```
...
{
  "commodocc": {
    "right_margin": "reprehenderit amet",
    "top_margin": -82519498.78711909
  },
  "ea02": {
    "top_margin": 3867278.74831973
  },
  "eu_d": {
    "left_margin": "id",
    "right_margin": 88817483.49538729,
    "top_margin": 54526323.08788276,
    "bottom_margin": 48657126.500644386
  }
}
```
